...
b.register('.....', function(c, d) {
    ...
    var e = b('.....'),
        f = b('.....');
    const _g = h => {
        const i = (0, f.FetchMapOptions)().interactiveItemsSlots,
            j = e.default.me.inventory.interactiveSlotsOrder;
        for (let k = 0; k < i; k++) {
            const l = j[k],
                m = e.default.me.inventory.interactiveSlots.get(`${ l }`);
            if (h.callback(m, l))
                return;
        }
    };
    ...
    var _e = {
        ...
        fall: {
            fallSpeedPerSecond: (0, b('.....').default)(100)
        }
    };
});
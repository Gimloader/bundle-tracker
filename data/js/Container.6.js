...
b.register('.....', function(c, d) {
    ...
    function C(D) {
        ...
        return F = E = function(G) {
            ...
            return A(H, G), H.prototype.checkChildren = function(I) {}, H.prototype.convertProps = function(I) {
                var J = {
                    children: I.children,
                    easing: I.easing,
                    onStart: I.onStart,
                ...
                return L.style = z({
                    position: 'relative'
                }, L.style), J.delegated = L, J;
            }, H.prototype.convertTimingProp = function(I) {
                var J = this.props[I],
                    K = 'number' == typeof J ? J : parseInt(J, 10);
    ...
    var I = function(J) {
            var K = J.childDomNode,
                ...
                M = J.childBoundingBox || L,
                N = J.parentBoundingBox || L,
                O = (0, J.getPosition)(K),
                P = O.top - N.top,
                Q = O.left - N.left;
            return [
    ...
    var O = function(P) {
            function Q() {
                ...
                return R = S = B(this, P.call.apply(P, [this].concat(U))), S.state = {
                    ...
                    domNode: null,
                    boundingBox: null
                }, S.heightPlaceholderData = {
                    domNode: null
                }, S.remainingAnimations = 0, S.childrenToAnimate = [], S.findDOMContainer = function() {
                    var W = a(j).findDOMNode(S),
                        X = W && W.parentNode;
                    ...
                    var W = S.state.children.filter(S.doesChildNeedToBeAnimated),
                        X = W.map(function(Y) {
                    ...
                    if (!M(W))
                        return !1;
                    var X = S.getChildData(M(W)),
                        Y = X.domNode,
                        Z = X.boundingBox,
                        $ = S.parentData.boundingBox;
                    if (!Y)
                        return !1;
                    var ab = S.props,
                        bb = ab.appearAnimation,
                        cb = ab.enterAnimation,
                        db = ab.leaveAnimation,
                        eb = ab.getPosition,
                        fb = W.appearing && bb,
                        gb = W.entering && cb,
                        hb = W.leaving && db;
            ...
            return A(Q, P), Q.prototype.componentDidMount = function() {
                ...
                Y && (this.state.children.filter(function(ab) {
                    ...
                    !W.isAnimationDisabled(W.props) && bb.domNode && bb.domNode.disabled && n(), bb.boundingBox && function(cb, db) {
                        var eb = cb.domNode,
                            fb = cb.boundingBox;
                        if (eb && fb) {
                            var gb = window.getComputedStyle(eb),
                                hb = [
                                    'margin-top',
                                    'margin-left',
                                    'margin-right'
                ...
                var X = this,
                    Y = this.getChildData(M(W)).domNode;
                if (Y) {
                ...
                var X = this.getChildData(M(W)),
                    Y = X.domNode,
                    Z = X.boundingBox,
                    $ = this.parentData.boundingBox;
                if (!Y)
                    return {};
                var ab = I({
                    childDomNode: Y,
                ...
                return {
                    transform: 'translate(' + ab[0] + 'px, ' + ab[1] + 'px)'
                };
                ...
                var W = this,
                    ...
                    Z = X.delegated,
                    $ = X.leaveAnimation,
                    ab = X.maintainContainerHeight,
                    bb = this.childrenWithRefs();

...
c.register('.....', function(d, e) {
    ...
    var _x = y => {
        ...
        return b(h).useEffect(() => {
            z.length ? (async () => {
                try {
                    const E = await D(z[0].originFileObj),
                        F = await (0, m.getCroppedImageBase64)(E, B);
                    y.onImageChange(F);
                } catch (E) {
...
`));
    ...
    const p = 'img-crop',
        ...
        s = (0, l.forwardRef)((t, u) => {
            ...
            const U = '[display:flex] [align-items:center] [width:60%] [margin-inline:auto]',
                V = '[display:flex] [align-items:center] [justify-content:center] [height:32px] [width:32px] [background:transparent] [border:0] [font-family:inherit] [font-size:18px] [cursor:pointer] disabled:[opacity:20%] disabled:[cursor:default]',
                W = '[flex:1]';
    ...
    const u = -1 === (0, k.compareVersions)(h.default, '4.23.0') ? 'visible' : 'open',
        v = (w, x, y) => x in w ? (console.error(`\`${ x }\` is deprecated, please use \`${ y }\` instead`), w[x]) : w[y],
        _w = (0, l.forwardRef)((x, y) => {
            const {
                quality: z = 0.4,
                fillColor: A = 'white',
                zoomSlider: B = !0,
            ...
            const ab = (0, l.useRef)(null),
                bb = (0, l.useCallback)(cb => {
                    var db;
                    const eb = document.createElement('canvas'),
                        fb = eb.getContext('2d'),
                        gb = ((null === (db = null == cb ? void 0 : cb.getRootNode) || void 0 === db ? void 0 : db.call(cb)) || document).querySelector(`.${ p }-media`),
                        {
                            width: hb,
                            height: ib,
                            x: jb,
                ...
                eb = (0, l.useRef)(),
                fb = (0, l.useRef)(),
                gb = (0, l.useCallback)((hb, ib, jb, kb) => (0, f.__awaiter)(void 0, void 0, void 0, function*() {
                    const lb = ib;
                ...
                ib = (0, l.useCallback)(jb => {
                    const kb = Array.isArray(jb) ? jb[0] : jb,
                        lb = kb.props,
                        {
                            beforeUpload: mb,
                            accept: nb
                ...
                kb = `${ p }-modal${ M ? ` ${ M }` : '' }`,
                lb = 'zh-CN' === ('undefined' == typeof window ? '' : window.navigator.language),
                mb = N || (lb ? '编辑图片' : 'Edit image'),
                nb = F || (lb ? '重置' : 'Reset');
            return (0, g.jsxs)(g.Fragment, {
                children: [
                    ib(V),
    ...
    var f = c('.....');
    const _g = (h, i) => {
        const j = (0, f.validateAndParse)(h),
            k = (0, f.validateAndParse)(i),
            l = j.pop(),
            m = k.pop(),
            n = (0, f.compareSegments)(j, k);
    ...
    function w(x, y, z, A, B, C, D) {
        ...
        var E = D ? _E : _F,
            F = _O(y.width, y.height, C),
            G = _O(y.naturalWidth, y.naturalHeight, C),
            H = {
            ...
            I = Math.round(i(s.width, u.width * s.width / 100)),
            J = Math.round(i(s.height, u.height * s.height / 100)),
            K = s.width >= s.height * A ? {
    ...
    function G(H, I, J, K, L, M) {
        var N = _O(I.width, I.height, J),
            O = _Q(K.width / N.width * (100 / H.width), L, M);
        return {
            crop: {
    ...
    function J(K, L, M, N, O, P) {
        void 0 === M && (M = 0);
        var Q = _O(L.naturalWidth, L.naturalHeight, M),
            R = _Q(function(S, T, U) {
                var V = function(W) {
            ...
            S = N.height > N.width ? N.height / K.height : N.width / K.width;
        return {
            crop: {
    ...
    var _U = function(V) {
        function W() {
            ...
            return X.imageRef = T(Q).createRef(), X.videoRef = T(Q).createRef(), X.containerPosition = {
                ...
                if (X.props.initialCroppedAreaPercentages) {
                    var Z = G(X.props.initialCroppedAreaPercentages, X.mediaSize, X.props.rotation, Y, X.props.minZoom, X.props.maxZoom),
                        $ = Z.crop,
                        ab = Z.zoom;
                ...
                if (db && X.containerRef) {
                    ...
                    var eb = X.containerRect.width / X.containerRect.height,
                        fb = (null === (Y = X.imageRef.current) || void 0 === Y ? void 0 : Y.naturalWidth) || (null === (Z = X.videoRef.current) || void 0 === Z ? void 0 : Z.videoWidth) || 0,
                        gb = (null === ($ = X.imageRef.current) || void 0 === $ ? void 0 : $.naturalHeight) || (null === (ab = X.videoRef.current) || void 0 === ab ? void 0 : ab.videoHeight) || 0,
                        hb = fb / gb,
                        ib = void 0;
                    ...
                    return (null === (bb = X.state.cropSize) || void 0 === bb ? void 0 : bb.height) === jb.height && (null === (cb = X.state.cropSize) || void 0 === cb ? void 0 : cb.width) === jb.width || X.props.onCropSizeChange && X.props.onCropSizeChange(jb), X.setState({
                        cropSize: jb
                    }, X.recomputeCropPosition), X.props.setCropSize && X.props.setCropSize(jb), jb;
                }
                ...
                X.currentDoc && (X.isTouching = !0, X.props.onTouchRequest && !X.props.onTouchRequest(Y) || (X.currentDoc.addEventListener('touchmove', X.onTouchMove, {
                    passive: !1
                }), X.currentDoc.addEventListener('touchend', X.onDragStopped), X.saveContainerPosition(), 2 === Y.touches.length ? X.onPinchStart(Y) : 1 === Y.touches.length && X.onDragStart(W.getTouchPoint(Y.touches[0]))));
                ...
                if (Y.preventDefault(), !X.isTouching) {
                    var Z = W.getMousePoint(Y),
                        $ = X.gestureZoomStart - 1 + Y.scale;
                    if (X.setNewZoom($, Z, {
                            shouldUpdatePosition: !0
                        }), X.props.onRotationChange) {
                ...
                X.currentWindow && (X.rafDragTimeout && X.currentWindow.cancelAnimationFrame(X.rafDragTimeout), X.rafDragTimeout = X.currentWindow.requestAnimationFrame(function() {
                    if (X.state.cropSize && void 0 !== Z && void 0 !== $) {
                        var ab = Z - X.dragStartPosition.x,
                            bb = $ - X.dragStartPosition.y,
                            cb = {
                ...
                if (X.currentWindow && (!X.props.onWheelRequest || X.props.onWheelRequest(Y))) {
                    ...
                    var Z = W.getMousePoint(Y),
                        $ = T(R)(Y).pixelY,
                        ab = X.props.zoom - $ * X.props.zoomSpeed / 200;
                    X.setNewZoom(ab, Z, {
                        shouldUpdatePosition: !0
                    }), X.state.hasWheelJustStarted || X.setState({
                ...
                var ab = (void 0 === $ ? {} : $).shouldUpdatePosition,
                    bb = void 0 === ab || ab;
                if (X.state.cropSize && X.props.onZoomChange) {
                    var cb = _Q(Y, X.props.minZoom, X.props.maxZoom);
                    if (bb) {
                        var db = X.getPointOnContainer(Z, X.containerPosition),
                            eb = X.getPointOnMedia(db),
                            fb = {
                                x: eb.x * cb - db.x,
                                y: eb.y * cb - db.y
                            },
                ...
                var Y = X.getCropData();
                if (Y) {
                    var Z = Y.croppedAreaPercentages,
                        $ = Y.croppedAreaPixels;
        ...
        return (0, u.__extends)(W, V), W.prototype.componentDidMount = function() {
            ...
            var Z = W.getTouchPoint(Y.touches[0]),
                $ = W.getTouchPoint(Y.touches[1]);
            this.lastPinchDistance = u(Z, $), this.lastPinchRotation = v(Z, $), this.onDragStart(N(Z, $));
        }, W.prototype.onPinchMove = function(Y) {
            var Z = this;
            if (this.currentDoc && this.currentWindow) {
                var $ = W.getTouchPoint(Y.touches[0]),
                    ab = W.getTouchPoint(Y.touches[1]),
                    bb = N($, ab);
                this.onDrag(bb), this.rafPinchTimeout && this.currentWindow.cancelAnimationFrame(this.rafPinchTimeout), this.rafPinchTimeout = this.currentWindow.requestAnimationFrame(function() {
                    var cb = u($, ab),
                        db = Z.props.zoom * (cb / Z.lastPinchDistance);
                    Z.setNewZoom(db, bb, {
                        shouldUpdatePosition: !1
                    }), Z.lastPinchDistance = cb;
                    var eb = v($, ab),
                        fb = Z.props.rotation + (eb - Z.lastPinchRotation);
            ...
            var Y = this,
                ...
                jb = Z.showGrid,
                kb = Z.style,
                lb = kb.containerStyle,
                mb = kb.cropAreaStyle,
                nb = kb.mediaStyle,
                ob = Z.classes,
                pb = ob.containerClassName,
                qb = ob.cropAreaClassName,
                rb = ob.mediaClassName,
                sb = this.getObjectFit();
            return T(Q).createElement('div', {
                ...
                src: $,
                ref: this.imageRef,
                style: (0, u.__assign)((0, u.__assign)({}, nb), {
                    transform: cb || 'translate('.concat(eb, 'px, ').concat(fb, 'px) rotate(').concat(gb, 'deg) scale(').concat(hb, ')')
                }),
                ...
                return T(Q).createElement('source', (0, u.__assign)({
                    key: tb.src
                }, tb));
    ...
    const _f = async (g, h, i = 0) => {
        ...
        const l = document.createElement('canvas'),
            m = l.getContext('2d'),
            n = Math.max(j.width, j.height) / 2 * Math.sqrt(2) * 2;

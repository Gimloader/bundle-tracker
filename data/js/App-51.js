...
const M = (t, e) => {
    ...
    pe = (t, e, r) => {
        ...
        return !e || r.layer !== e.layer || t.layer !== r.layer ? M(t, r) : W(t, e, r)
    },
    me = (t, e, r) => {
        if (!e) {
            const i = K(t.layer);
        ...
        return !r || r.layer !== e.layer || t.layer !== e.layer ? L(t, e) : W(t, e, r)
    },
    z = t => t === l.DepthSortedCharactersAndDevices ? l.DevicesAboveCharacters : t === l.DevicesUnderCharacters ? l.DepthSortedCharactersAndDevices : null,

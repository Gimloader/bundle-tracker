...
c.register('.....', function (d, e) {
            ...
            children: [
                ...
                (0, f.jsxs)(m.Container, {
                    children: [
                        ...
                        t && (0, f.jsx)(k.default, {
                            text: (0, f.jsx)(j.default, { latex: t }),
                            noBold: !0
                        })
                    ]
                })
        ...
        function v() {
            ...
            return s(_q(x = o(this, (w = p(v)).call.apply(w, [this].concat(z)))), 'state', {
                ...
                B.preventDefault(), 360 !== x.state.rotationDeg ? x.setState(function (C) {
                    return { rotationDeg: C.rotationDeg += 90 };
                }) : x.setState({ rotationDeg: 90 });
            }), x;
        }
        var B, C, D;
        return function (E, F) {
            ...
            },
            {
                key: 'render',
                value: function () {
                    var E = this, F = this.props, G = F.medium, H = F.large, I = F.alt, J = F.onClose, K = F.hideDownload, L = F.hideZoom, M = F.showRotate, N = F.imageBackgroundColor, O = void 0 === N ? 'black' : N, P = this.state, Q = P.move, R = P.zoomed, S = P.rotationDeg;
                    return w(A).createElement('div', null, w(A).createElement(g.default, {
                        name: '__react_modal_image__lightbox',
                        css: (0, g.lightboxStyles)({ imageBackgroundColor: O })
                    }), w(A).createElement('div', { className: '__react_modal_image__modal_container' }, w(A).createElement('div', {
    ...
    var f = c('.....'), g = c('.....'), _h = function (i) {
            var j = i.image, k = i.alt, l = i.zoomed, m = i.toggleZoom, n = i.toggleRotate, o = i.onClose, p = i.enableDownload, q = i.enableZoom, r = i.enableRotate;
            return a(f).createElement('div', { className: '__react_modal_image__header' }, a(f).createElement('span', { className: '__react_modal_image__icon_menu' }, p && a(f).createElement('a', {
                href: j,
                download: !0
            }, a(f).createElement(g.DownloadIcon, null)), q && a(f).createElement('a', { onClick: m }, l ? a(f).createElement(g.ZoomOutIcon, null) : a(f).createElement(g.ZoomInIcon, null)), r && a(f).createElement('a', { onClick: n }, a(f).createElement(g.RotateIcon, null)), a(f).createElement('a', { onClick: o }, a(f).createElement(g.CloseIcon, null))), k && a(f).createElement('span', { className: '__react_modal_image__caption' }, k));
        };
}), c.register('.....', function (d, e) {
    ...
    var f = c('.....'), _g = function () {
            return a(f).createElement('svg', {
                ...
                d: 'M0 0h24v24H0z',
                fill: 'none'
            }), a(f).createElement('path', { d: 'M7 14H5v5h5v-2H7v-3zm-2-4h2V7h3V5H5v5zm12 7h-3v2h5v-5h-2v3zM14 5v2h3v3h2V5h-5z' }));
        }, _h = function () {
            return a(f).createElement('svg', {
                fill: '#ffffff',
                height: '24',
                ...
                d: 'M0 0h24v24H0z',
                fill: 'none'
            }), a(f).createElement('path', { d: 'M5 16h3v3h2v-5H5v2zm3-8H5v2h5V5H8v3zm6 11h2v-3h3v-2h-5v5zm2-11V5h-2v5h5V8h-3z' }));
        }, _i = function () {
            return a(f).createElement('svg', {
                fill: '#ffffff',
                height: '24',
                ...
                width: '24',
                xmlns: 'http://www.w3.org/2000/svg'
            }, a(f).createElement('path', { d: 'M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z' }), a(f).createElement('path', {
                d: 'M0 0h24v24H0z',
                fill: 'none'
            }));
        }, _j = function () {
            return a(f).createElement('svg', {
                ...
                width: '24',
                xmlns: 'http://www.w3.org/2000/svg'
            }, a(f).createElement('path', { d: 'M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z' }), a(f).createElement('path', {
                d: 'M0 0h24v24H0z',
                fill: 'none'
            }));
        }, _k = function () {
            return a(f).createElement('svg', {
                ...
                width: '48',
                xmlns: 'http://www.w3.org/2000/svg'
            }, a(f).createElement('path', { d: 'M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2H6zm10 14.5V20H8v-3.5l4-4 4 4zm-4-5l-4-4V4h8v3.5l-4 4z' }), a(f).createElement('path', {
                d: 'M0 0h24v24H0V0z',
                fill: 'none'
            }));
        }, _l = function () {
    ...
    var _r = function (s) {
        function t() {
            ...
            for (var w = arguments.length, x = new Array(w), y = 0; y < w; y++)
                x[y] = arguments[y];
            return q(_o(v = m(this, (u = n(t)).call.apply(u, [this].concat(x)))), 'state', { loading: !0 }), q(_o(v), 'handleOnLoad', function () {
                v.setState({ loading: !1 });
        ...
        return function (C, D) {
            ...
            C.prototype = Object.create(D && D.prototype, {
                ...
                key: 'render',
                value: function () {
                    var C = this.props, D = C.id, E = C.className, F = C.src, G = C.style, H = C.handleDoubleClick;
...
`));
    ...
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.Textfit = void 0;
    var f, g = c('.....'), h = (f = g) && f.__esModule ? f : { default: f };
    ...
    var f = Object.assign || function (g) {
        ...
        }(), h = _p(c('.....')), i = _p(c('.....')), j = _p(c('.....')), k = _p(c('.....')), l = _p(c('.....')), m = _p(c('.....')), n = _p(c('.....')), o = c('.....');
    function _p(q) {
    ...
    var s = function (t) {
        ...
        return function (w, x) {
            ...
            },
            {
                key: 'process',
                value: function () {
                    var w = this, x = this.props, y = x.min, z = x.max, A = x.mode, B = x.forceSingleModeWidth, C = x.onReady, D = this._parent, E = this._child, F = (0, o.innerWidth)(D), G = (0, o.innerHeight)(D);
                    if (G <= 0 || isNaN(G))
                        ...
                        this.setState({ ready: !1 }), (0, k.default)([
                            function (O) {
                                return (0, l.default)(function () {
                                    ...
                                    if (I())
                                        return P(!0);
                                    L = parseInt((M + N) / 2, 10), w.setState({ fontSize: L }, function () {
                            ...
                            function (O) {
                                if (L = Math.min(M, N), L = Math.max(L, y), L = Math.min(L, z), L = Math.max(L, 0), I())
                                    return O(!0);
                                w.setState({ fontSize: L }, O);
                            }
                        ], function (O) {
                            O || I() || w.setState({ ready: !0 }, function () {
                                return C(L);
                            });
                        });
                    }
            ...
            },
            {
                key: 'render',
                value: function () {
                    var w = this, x = this.props, y = x.children, z = x.text, A = x.style, B = (x.min, x.max, x.mode), C = (x.forceWidth, x.forceSingleModeWidth, x.throttle, x.autoResize, x.onReady, function (D, E) {
                            var F = {};
                            for (var G in D)
                            ...
                            'autoResize',
                            'onReady'
                        ])), D = this.state, E = D.fontSize, F = D.ready, G = f({}, A, { fontSize: E }), H = { display: F ? 'block' : 'inline-block' };
    ...
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.default = function (f, g) {
        if (f === g)
            return !0;
        var h = Object.keys(f), i = Object.keys(g);
    ...
    var f, g = c('.....'), _h = (f = g) && f.__esModule ? f : { default: f };
}), c.register('.....', function (d, e) {
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.default = function (f, g) {
    ...
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.default = function (f, g) {
        var h = void 0, i = void 0, j = void 0, k = void 0, l = 0;
        function m() {
    ...
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.default = function () {
        return c++;
    };
    var f = 0;
}), c.register('.....', function (d, e) {
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.innerHeight = function (f) {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....');
    c('.....');
    var i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = h.forwardRef(function (n, o) {
            var p = n.children, q = n.classes, r = n.className, s = n.color, t = void 0 === s ? 'default' : s, u = n.component, v = void 0 === u ? 'button' : u, w = n.disabled, x = void 0 !== w && w, y = n.disableFocusRipple, z = void 0 !== y && y, A = n.focusVisibleClassName, B = n.size, C = void 0 === B ? 'large' : B, D = n.variant, E = void 0 === D ? 'round' : D, F = (0, f.default)(n, [
                    'children',
                    'classes',
                    'className',
                    'color',
            ...
            return h.createElement(k.default, (0, g.default)({
                ...
                ref: o
            }, F), h.createElement('span', { className: q.label }, p));
            ...
            return {
                root: (0, g.default)({}, o.typography.button, {
                    ...
                    '&:active': { boxShadow: o.shadows[12] },
                    color: o.palette.getContrastText(o.palette.grey[300]),
                    backgroundColor: o.palette.grey[300],
                    '&:hover': {
                        backgroundColor: o.palette.grey.A100,
                        '@media (hover: none)': { backgroundColor: o.palette.grey[300] },
                        '&$disabled': { backgroundColor: o.palette.action.disabledBackground },
                        textDecoration: 'none'
                    },
    ...
    var f = c('.....'), g = c('.....'), h = c('.....');
    c('.....');
    var i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = h.forwardRef(function (q, r) {
            var s = q.action, t = q.buttonRef, u = q.centerRipple, v = void 0 !== u && u, w = q.children, x = q.classes, y = q.className, z = q.component, A = void 0 === z ? 'button' : z, B = q.disabled, C = void 0 !== B && B, D = q.disableRipple, E = void 0 !== D && D, F = q.disableTouchRipple, G = void 0 !== F && F, H = q.focusRipple, I = void 0 !== H && H, J = q.focusVisibleClassName, K = q.onBlur, L = q.onClick, M = q.onFocus, N = q.onFocusVisible, O = q.onKeyDown, P = q.onKeyUp, Q = q.onMouseDown, R = q.onMouseLeave, S = q.onMouseUp, T = q.onTouchEnd, U = q.onTouchMove, V = q.onTouchStart, W = q.onDragLeave, X = q.tabIndex, Y = void 0 === X ? 0 : X, Z = q.TouchRippleProps, $ = q.type, ab = void 0 === $ ? 'button' : $, bb = (0, g.default)(q, [
                    'action',
                    'buttonRef',
                    'centerRipple',
                    'children',
            ...
            var db = h.useRef(null), eb = h.useState(!1), fb = eb[0], gb = eb[1];
            C && fb && gb(!1);
            var hb = (0, n.default)(), ib = hb.isFocusVisible, jb = hb.onBlurVisible, kb = hb.ref;
            function lb(mb, nb) {
            ...
            var nb = lb('start', Q), ob = lb('stop', W), pb = lb('stop', S), qb = lb('stop', function (rb) {
                    fb && rb.preventDefault(), R && R(rb);
                }), rb = lb('start', V), sb = lb('stop', T), tb = lb('stop', U), ub = lb('stop', function (vb) {
                    fb && (jb(vb), gb(!1)), K && K(vb);
                }, !1), vb = (0, l.default)(function (wb) {
                ...
                }, xb = h.useRef(!1), yb = (0, l.default)(function (zb) {
            ...
            var Cb = (0, k.default)(t, r), Db = (0, k.default)(kb, cb), Eb = (0, k.default)(Cb, Db), Fb = h.useState(!1), Gb = Fb[0], Hb = Fb[1];
            h.useEffect(function () {
                Hb(!0);
            }, []);
            var Ib = Gb && !E && !C;
    ...
    var f = c('.....'), g = 'undefined' != typeof window ? f.useLayoutEffect : f.useEffect;
    function _h(i) {
        var j = f.useRef(i);
        return g(function () {
            j.current = i;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....');
    c('.....');
    var j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = i.forwardRef(function (o, p) {
            var q = o.center, r = void 0 !== q && q, s = o.classes, t = o.className, u = (0, h.default)(o, [
                    'center',
                    'classes',
                    'className'
                ]), v = i.useState([]), w = v[0], x = v[1], y = i.useRef(0), z = i.useRef(null);
            i.useEffect(function () {
                z.current && (z.current(), z.current = null);
            }, [w]);
            var A = i.useRef(!1), B = i.useRef(null), C = i.useRef(null), D = i.useRef(null);
            i.useEffect(function () {
                return function () {
            ...
            var E = i.useCallback(function (F) {
                    var G = F.pulsate, H = F.rippleX, I = F.rippleY, J = F.rippleSize, K = F.cb;
                    x(function (L) {
                ...
                }, [s]), F = i.useCallback(function () {
                    var G = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, H = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, I = arguments.length > 2 ? arguments[2] : void 0, J = H.pulsate, K = void 0 !== J && J, L = H.center, M = void 0 === L ? r || H.pulsate : L, N = H.fakeElement, O = void 0 !== N && N;
                    if ('mousedown' === G.type && A.current)
                        A.current = !1;
                    else {
                        'touchstart' === G.type && (A.current = !0);
                        var P, Q, R, S = O ? null : D.current, T = S ? S.getBoundingClientRect() : {
                                width: 0,
                                height: 0,
                                left: 0,
                                top: 0
                        ...
                        if (M || 0 === G.clientX && 0 === G.clientY || !G.clientX && !G.touches)
                            ...
                            var U = G.touches ? G.touches[0] : G, V = U.clientX, W = U.clientY;
                            P = Math.round(V - T.left), Q = Math.round(W - T.top);
                        }
                        if (M)
                            (R = Math.sqrt((2 * Math.pow(T.width, 2) + Math.pow(T.height, 2)) / 3)) % 2 == 0 && (R += 1);
                        else {
                            var X = 2 * Math.max(Math.abs((S ? S.clientWidth : 0) - P), P) + 2, Y = 2 * Math.max(Math.abs((S ? S.clientHeight : 0) - Q), Q) + 2;
                    ...
                    F({}, { pulsate: !0 });
                }, [F]), H = i.useCallback(function (I, J) {
            ...
            return {
                ...
                ripplePulsate: { animationDuration: ''.concat(p.transitions.duration.shorter, 'ms') },
                child: {
                    opacity: 1,
                    display: 'block',
                    width: '100%',
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....');
    c('.....');
    var j = c('.....'), k = c('.....'), l = c('.....'), m = Object.values || function (n) {
            ...
            return s.componentDidMount = function () {
                ...
                var v = u.children, w = u.handleExited;
                return {
                ...
                t.key in v || (t.props.onExited && t.props.onExited(u), this.mounted && this.setState(function (w) {
                    ...
                    return delete x[t.key], { children: x };
                }));
            }, s.render = function () {
                var t = this.props, u = t.component, v = t.childFactory, w = (0, f.default)(t, [
                        'component',
                        'childFactory'
                    ]), x = this.state.contextValue, y = m(this.state.children).map(v);
                return delete w.appear, delete w.enter, delete w.exit, null === u ? a(j).createElement(k.default.Provider, { value: x }, y) : a(j).createElement(k.default.Provider, { value: x }, a(j).createElement(u, w, y));
            }, p;
        }(a(j).Component);
    ...
    function _k(l, m, n) {
        var o = _g(l.children), p = function (q, r) {
                function s(t) {
                    return t in r ? r[t] : q[t];
                }
                q = q || {}, r = r || {};
                var t, u = Object.create(null), v = [];
                for (var w in q)
        ...
        return Object.keys(_j).forEach(function (q) {
            ...
            if ((0, f.isValidElement)(r)) {
                var s = q in m, t = q in o, u = m[q], v = (0, f.isValidElement)(u) && !u.props.in;
                !t || s && !v ? t || !s || v ? t && s && (0, f.isValidElement)(u) && (_j[q] = (0, f.cloneElement)(r, {
                    onExited: n.bind(null, r),
                    in: u.props.in,
                    exit: i(r, 'exit', l),
                    enter: i(r, 'enter', l)
                })) : _j[q] = (0, f.cloneElement)(r, { in: !1 }) : _j[q] = (0, f.cloneElement)(r, {
                    onExited: n.bind(null, r),
                    in: !0,
                    exit: i(r, 'exit', l),
                    enter: i(r, 'enter', l)
    ...
    var f = c('.....');
    c('.....');
    var g = c('.....'), h = c('.....'), i = 'undefined' == typeof window ? f.useEffect : f.useLayoutEffect;
    var _j = function (k) {
        var l = k.classes, m = k.pulsate, n = void 0 !== m && m, o = k.rippleX, p = k.rippleY, q = k.rippleSize, r = k.in, s = k.onExited, t = void 0 === s ? function () {
            } : s, u = k.timeout, v = f.useState(!1), w = v[0], x = v[1], y = (0, g.default)(l.ripple, l.rippleVisible, n && l.ripplePulsate), z = {
                width: q,
                height: q,
                top: -q / 2 + p,
                left: -q / 2 + o
            }, A = (0, g.default)(l.child, w && l.childLeaving, n && l.childPulsate), B = (0, h.default)(t);
        return i(function () {
            if (!r) {
                x(!0);
            ...
            className: y,
            style: z
        }, f.createElement('span', { className: A }));
    };
}), c.register('.....', function (d, e) {
    var f = c('.....');
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.default = void 0;
    var g = f(c('.....')), h = (0, f(c('.....')).default)(g.default.createElement('path', { d: 'M8 5v14l11-7z' }), 'PlayArrow');
    d.exports.default = h;
}), c.register('.....', function (d, e) {
    var f = c('.....');
    Object.defineProperty(d.exports, '__esModule', { value: !0 }), d.exports.default = function (g, h) {
        var i = _h.default.memo(_h.default.forwardRef(function (j, k) {
            return _h.default.createElement(_i.default, (0, _g.default)({ ref: k }, j), g);
        }));
        return i.muiName = _i.default.muiName, i;
    };
    var _g = f(c('.....')), _h = f(c('.....')), _i = f(c('.....'));
}), c.register('.....', function (d, e) {
    function f() {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....');
    c('.....');
    var i = c('.....'), j = c('.....'), k = c('.....'), l = h.forwardRef(function (m, n) {
            var o = m.children, p = m.classes, q = m.className, r = m.color, s = void 0 === r ? 'inherit' : r, t = m.component, u = void 0 === t ? 'svg' : t, v = m.fontSize, w = void 0 === v ? 'default' : v, x = m.htmlColor, y = m.titleAccess, z = m.viewBox, A = void 0 === z ? '0 0 24 24' : z, B = (0, g.default)(m, [
                    'children',
                    'classes',
                    'className',
                    'color',
    ...
    var _m = (0, j.default)(function (n) {
        return {
            root: {
                ...
                transition: n.transitions.create('fill', { duration: n.transitions.duration.shorter })
            },
            colorPrimary: { color: n.palette.primary.main },
            colorSecondary: { color: n.palette.secondary.main },
            colorAction: { color: n.palette.action.active },
            colorError: { color: n.palette.error.main },
            colorDisabled: { color: n.palette.action.disabled },
            fontSizeInherit: { fontSize: 'inherit' },
            fontSizeSmall: { fontSize: n.typography.pxToRem(20) },
            fontSizeLarge: { fontSize: n.typography.pxToRem(35) }
        };
    }, { name: 'MuiSvgIcon' })(l);
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
    ...
    var _f = { readToMe: new (0, (c('.....')).default)() };
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _j;
    });
                        ...
                        (0, f.jsxs)(_w, {
                            children: [
                                (0, f.jsx)(i.default, {
                                    ...
                                    children: ({measureRef: F}) => (0, f.jsx)('div', {
                                        ref: F,
                                        style: { flex: 1 }
                                    })
                                }),
                                C && (0, f.jsx)(k.default, { audio: C }),
                                C && !B && !D && (0, f.jsx)('div', { style: { width: '2vw' } }),
                                B && (0, f.jsx)('img', {
                                ...
                                D && (0, f.jsx)(_x, {
                                    ...
                                    children: (0, f.jsx)(m.default, {
                                        text: (0, f.jsx)(o.default, { latex: D }),
                                        noBold: !0
                                    })
                                })
                            ]
                        ...
                        (0, f.jsxs)(_y, {
                            children: [
                                (0, f.jsx)(m.default, {
                                    ...
                                    paddingVertical: '6%',
                                    customStyle: { width: `calc(100% - ${ E }px)` },
                                    mode: 'multi',
...
`));
    ...
    var t, u, v, w, x = (t = function (y) {
            var z = y.measure, A = y.measureRef, B = y.contentRect;
            return (0, y.children)({
                measure: z,
                measureRef: A,
                contentRect: B
            ...
            function z() {
                ...
                return (z = y.call.apply(y, [this].concat(C)) || this).state = {
                    ...
                    E && (F.entry = E[0].contentRect), z._animationFrameID = z._window.requestAnimationFrame(function () {
                        null !== z._resizeObserver && (z.setState({ contentRect: F }), 'function' == typeof z.props.onResize && z.props.onResize(F));
                    });
            ...
            return E.componentDidMount = function () {
                ...
                var F = this.props, G = (F.innerRef, F.onResize, (0, g.default)(F, [
                        'innerRef',
                        'onResize'
                    ]));

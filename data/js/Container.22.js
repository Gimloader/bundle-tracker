...
c.register('.....', function(d, e) {
    ...
    const w = x => {
        ...
        const S = z('dropdown', D),
            [T, U] = (0, u.default)(S),
            {
                token: V
            } = v.default.useToken(),
            W = l.Children.only(E),
            X = (0, s.cloneElement)(W, {
                className: b(g)(`${ S }-trigger`, {
                    [`${ S }-rtl`]: 'rtl' === A
                }, W.props.className),
                disabled: G
            }),
        ...
        return T(l.createElement(h.default, Object.assign({
            alignPoint: Z
        }, (0, k.default)(x, ['rootClassName']), {
            mouseEnterDelay: P,
            mouseLeaveDelay: Q,
            visible: $,
            ...
            overlay: () => {
                ...
                return gb = (null == B ? void 0 : B.items) ? l.createElement(n.default, Object.assign({}, B)) : 'function' == typeof fb ? fb() : fb, H && (gb = H(gb)), gb = l.Children.only('string' == typeof gb ? l.createElement('span', null, gb) : gb), l.createElement(o.OverrideProvider, {
                    ...
                    expandIcon: l.createElement('span', {
                        className: `${ S }-menu-submenu-arrow`
                    }, l.createElement(f.default, {
                        className: `${ S }-menu-submenu-arrow-icon`
                    })),
                    mode: 'vertical',
                    selectable: !1,
                    onClick: eb,
                ...
                if ([].concat(t, [
                    ...
                    var U = function(V, W) {
                        ...
                        W = function(X, Y, Z, $) {
                            ...
                            var ib = (ab = {}, (0, A.default)(ab, n, eb), (0, A.default)(ab, o, fb), ab),
                                jb = (bb = {}, (0, A.default)(bb, l, Z ? fb : eb), (0, A.default)(bb, m, Z ? eb : fb), (0, A.default)(bb, o, gb), (0, A.default)(bb, p, gb), bb),
                                kb = (cb = {}, (0, A.default)(cb, n, eb), (0, A.default)(cb, o, fb), (0, A.default)(cb, p, gb), (0, A.default)(cb, q, hb), (0, A.default)(cb, l, Z ? gb : hb), (0, A.default)(cb, m, Z ? hb : gb), cb);
                            switch (null === (db = {
                                    inline: ib,
                                    horizontal: jb,
                                    vertical: kb,
                    ...
                    if ([
                        ...
                        J(V, !0), N(), L.current = (0, i.default)(function() {
                            T();
                            var ab = U.getAttribute('aria-controls'),
                                bb = v(document.getElementById(ab), Q);
                            X(bb);
                        }, 5);
                    else if (W.offset < 0) {
                        var ab = H(V, !0),
    ...
    var n = c('.....'),
        ...
        C = function(D) {
            ...
            var Lb = k.createElement(m.default.Item, (0, g.default)({
                role: 'none'
            }, W, {
                component: 'li',
                style: F,
        ...
        return (s || []).map(function(t, u) {
            if (t && 'object' === (0, h.default)(t)) {
                ...
                return x || 'group' === z ? 'group' === z ? j.createElement(l.default, (0, f.default)({
                    ...
                    key: B
                }, A)) : j.createElement(o.default, (0, f.default)({
                    key: B
                }, A), w);
            }
            return null;
        ...
        return (0, i.default)(H, [{
            ...
            },
            {
                ...
                value: function() {
                    ...
                    }, this.getComponent())), !K && Q && (V = null), m.createElement(x.default.Provider, {
    ...
    function _o(p, q, r, s) {
        ...
        var ib = (0, n.default)(fb),
            jb = (0, h.default)(ib, 1)[0],
            kb = i.useMemo(function() {
                var lb, mb, nb;
                switch (U) {
                    case 'appear':
        ...
        var qb = Y;
        return kb[j.STEP_PREPARE] && _ob === j.STEP_START && (qb = (0, f.default)({
            transition: 'none'
        }, qb)), [
            U,
            _ob,
    ...
    var f = c('.....'),
        ...
        p = i.forwardRef(function(q, r) {
            ...
            var gb = w;
            return i.Children.count(w) > 1 && (gb = i.createElement('div', {
    ...
    var f = function(g) {
        ...
        function p(q, r, s, t) {
            var u = r && r.prototype instanceof _z ? r : _z,
            ...
            dispatchException: function($) {
                ...
                for (var cb = this.tryEntries.length - 1; cb >= 0; --cb) {
                    ...
                    if (db.tryLoc <= this.prev) {
                        var fb = P.call(db, 'catchLoc'),
                            gb = P.call(db, 'finallyLoc');
                        if (fb && gb) {
    ...
    var f = c('.....'),
        ...
        k = h.forwardRef(function(l, m) {
            ...
            var y = (0, g.default)({
                ...
                z = q;
            return h.Children.count(q) > 1 && (z = h.createElement('div', {
                className: ''.concat(n, '-content')
            }, q)), w && (z = w(z)), h.createElement(i.default, (0, f.default)({
                visible: o,
                ref: x,
                removeOnLeave: !0
            }, v), function(A, B) {
    ...
    const t = (0, g.forwardRef)((u, v) => {
        var w, x;
        const y = g.useContext(p.default),
            z = y || {},
            {
                getPrefixCls: A,
                getPopupContainer: B,
            ...
            S = (0, h.default)(R, ['collapsedWidth']),
            T = (0, q.default)(L) || M;
        null === (w = z.validator) || void 0 === w || w.call(z, {
            mode: O
        });
        const U = (0, i.default)(function() {
            ...
            V = z.mode || O,
            W = null != P ? P : z.selectable,
            X = g.useMemo(() => void 0 !== K ? K : J, [
                J,
                K
            ]),
            Y = {
        ...
        if ('function' == typeof H)
            ...
            cb = (0, m.cloneElement)(db, {
                className: b(j)(`${ Z }-submenu-expand-icon`, null === (x = null == db ? void 0 : db.props) || void 0 === x ? void 0 : x.className)
            });
        }
        const eb = g.useMemo(() => ({
            prefixCls: Z,
        ...
        return $(g.createElement(p.default.Provider, {
            value: null
    ...
    const q = r => {
            ...
            return {
                [`${ t }-submenu`]: {
                    ...
                    '&-arrow': {
                        ...
                        '&::before': {
                            transform: `rotate(45deg) translateY(-${ y })`
                        },
                        '&::after': {
                            transform: `rotate(-45deg) translateY(${ y })`
                        }
        ...
        s = t => {
            ...
            return [{
                    '': {
                        [`${ v }`]: Object.assign(Object.assign({}, (0, p.clearFix)()), {
                            '&-hidden': {
                                display: 'none'
                            }
                        })
                ...
                },
                {
                    [v]: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (0, p.resetComponent)(t)), (0, p.clearFix)()), {
                        ...
                        [`${ v }-item, ${ v }-submenu, ${ v }-submenu-title`]: {
                        ...
                        [`${ v }-item-group`]: {
                            [`${ v }-item-group-list`]: {
                                margin: 0,
                                padding: 0,
                                [`${ v }-item, ${ v }-submenu-title`]: {
                                    paddingInline: `${ 2 * w }px ${ C }px`
                                }
                            }
                        },
                        '&-submenu': {
                            ...
                            [`> ${ v }`]: Object.assign(Object.assign(Object.assign({
                                ...
                                [`${ v }-submenu-title::after`]: {
                                    transition: `transform ${ x } ${ z }`
                                }
                            })
                        }
                    }), r(t)), {
                        [`&-inline-collapsed ${ v }-submenu-arrow,\n        &-inline ${ v }-submenu-arrow`]: {
                            '&::before': {
                                transform: `rotate(-45deg) translateX(${ J })`
                            },
                            '&::after': {
                                transform: `rotate(45deg) translateX(-${ J })`
                            }
    ...
    var _f = g => {
        ...
        return {
            [`${ h }-horizontal`]: {
                ...
                [`> ${ h }-item:hover,\n        > ${ h }-item-active,\n        > ${ h }-submenu ${ h }-submenu-title:hover`]: {
                    backgroundColor: 'transparent'
                },
    ...
    var _h = (i, j) => {
        ...
        return {
            [`${ k }-${ j }`]: {
                ...
                [`${ k }-item-disabled, ${ k }-submenu-disabled`]: {
                    color: `${ C } !important`
                },
                [`${ k }-item:hover, ${ k }-submenu-title:hover`]: {
                    [`&:not(${ k }-item-selected):not(${ k }-submenu-selected)`]: {
                        color: z
                    }
                },
                [`&:not(${ k }-horizontal)`]: {
                ...
                [`${ k }-item, ${ k }-submenu-title`]: {
                    [`&:not(${ k }-item-disabled):focus-visible`]: Object.assign({}, g(i))
                },
                [`&${ k }-submenu > ${ k }`]: {
                    backgroundColor: J
                },
                ...
                [`&${ k }-horizontal`]: Object.assign(Object.assign({}, 'dark' === j ? {
                    borderBottom: 0
                } : {}), {
                    [`> ${ k }-item, > ${ k }-submenu`]: {
                        top: t,
    ...
    var _h = i => {
        ...
        return [{
                ...
                [`${ j }-submenu-popup`]: {
                    [`${ j }-vertical`]: Object.assign(Object.assign({}, g(i)), {
                        boxShadow: w
                    })
                }
            },
            ...
            },
            {
                [`${ j }-inline-collapsed`]: {
                    ...
                    [`${ j }-item-group-title`]: Object.assign(Object.assign({}, f.textEllipsis), {
                        paddingInline: v
                    })
                }
            }
    ...
    const h = f.createContext(null),
        _i = j => {
            const {
                children: k
            } = j, l = g(j, ['children']), m = f.useContext(h), n = f.useMemo(() => Object.assign(Object.assign({}, m), l), [
                m,
                l.prefixCls,
                l.mode,
                l.selectable
        ...
        return (m || []).map((n, o) => {
            if (n && 'object' == typeof n) {
                const p = n,
                    ...
                    v = null != s ? s : `tmp-${ o }`;
                return r || 'group' === t ? 'group' === t ? g.createElement(f.default, Object.assign({
                    key: v
                }, u, {
                    title: q
                }), l(r)) : g.createElement(j.default, Object.assign({
                    key: v
                }, u, {
                    title: q
                }), l(r)) : 'divider' === t ? g.createElement(h.default, Object.assign({
                    key: v
                }, u)) : g.createElement(i.default, Object.assign({
                    key: v
                }, u), q);
            }
            return null;
    ...
    var _k = l => {
        const {
            ...
            getPrefixCls: q
        } = h.useContext(i.ConfigContext), r = q('menu', m), s = b(f)({
    ...
    var _o = p => {
        ...
        let F = j.createElement(g.default, Object.assign({}, (0, i.default)(p, [
            ...
            className: b(f)((0, m.isValidElement)(t) ? null === (q = t.props) || void 0 === q ? void 0 : q.className : '', `${ w }-item-icon`)
        }), (G => {
            const H = j.createElement('span', {
                className: `${ w }-title-content`
            }, s);
            return (!t || (0, m.isValidElement)(s) && 'span' === s.type) && s && G && x && 'string' == typeof s ? j.createElement('div', {
                className: `${ w }-inline-collapsed-noicon`
            }, s.charAt(0)) : H;
        })(A));
    ...
    const n = h.forwardRef((o, p) => {
            ...
            return h.createElement(t, Object.assign(Object.assign({
                className: v
            }, u), {
                ref: p
            }), s);
        ...
        o = h.forwardRef((p, q) => {
            const {
                direction: r
            } = h.useContext(i.ConfigContext), [s, t] = h.useState([]), {
                prefixCls: u,
                className: v,
                rootClassName: w,
                children: x,
            ...
            return B(h.createElement(_l.Provider, {
                value: E
            ...
            [l]: Object.assign(Object.assign({
                ...
                [`${ l }-sider`]: {
                    ...
                    '&-children': {
                        ...
                        marginTop: -0.1,
                        paddingTop: 0.1,
                        [`${ k }-menu${ k }-menu-inline-collapsed`]: {
                            width: 'auto'
                        }
                    },
                    '&-has-trigger': {
    ...
    var _m = n => {
        ...
        if (q) {
            ...
            z = j.createElement(j.Fragment, null, (0, k.cloneElement)(q, {
                className: b(f)((0, k.isValidElement)(q) ? null === (o = q.props) || void 0 === o ? void 0 : o.className : '', `${ u }-item-icon`)
            }), A ? r : j.createElement('span', {
                className: `${ u }-title-content`
            }, r));
        } else
            z = v && !y.length && r && 'string' == typeof r ? j.createElement('div', {
                className: `${ u }-inline-collapsed-noicon`
            }, r.charAt(0)) : j.createElement('span', {
                className: `${ u }-title-content`
            }, r);
        const B = j.useMemo(() => Object.assign(Object.assign({}, t), {
                firstLevel: !1
            }), [t]),
            C = 'horizontal' === x ? [
                0,
                ...
                [`${ q }, ${ q }-menu-submenu`]: {
                    [r]: Object.assign(Object.assign({
                        ...
                        [`${ r }-item, ${ r }-submenu-title`]: Object.assign(Object.assign({
                            ...
                            '&:hover, &-active': {
                                backgroundColor: p.controlItemBgHover
                            }
                        }, (0, f.genFocusStyle)(p)), {
                            '&-selected': {
                                ...
                                '&:hover, &-active': {
                                    backgroundColor: p.controlItemBgActiveHover
                                }
                            },
                            '&-disabled': {
                                color: B,
                        ...
                        [`${ r }-submenu-title`]: {
                            paddingInlineEnd: D + p.fontSizeSM
                        },
                        [`${ r }-submenu-vertical`]: {
                            position: 'relative'
                        },
                        ...
                        [`${ r }-submenu-selected ${ q }-menu-submenu-title`]: {
                            color: p.colorPrimary
                        }
                    })
                }
    ...
    var _p = (0, k.default)('Dropdown', (q, r) => {
        ...
        zIndexPopup: q.zIndexPopupBase + 50
    }));
}), c.register('.....', function(d, e) {
    a(d.exports, 'default', function() {
        return _f;
        ...
        return {
            [`${ h }-button`]: {
                ...
                [`&${ i }-btn-group > ${ i }-btn`]: {
                    ...
                    [`&:last-child:not(:first-child):not(${ i }-btn-icon-only)`]: {
                        paddingInline: j
                    }
                }
            }

    ...
    const q = {
        ...
        t = u => {
            ...
            if (s.includes(`${ x }`)) {
                ...
                return k.createElement('div', {
                    className: `${ y } ${ v }-image`
                }, k.createElement(z, null));
            }
            const A = k.createElement(q[x]);
            return null === w || !1 === w ? null : k.createElement('div', {
                className: y
            }, w || A);
        },
        u = v => {
        ...
        v = w => {
            ...
            const {
                getPrefixCls: H,
                direction: I
            } = k.useContext(l.ConfigContext), J = H('result', x), [K, L] = (0, p.default)(J), M = b(j)(J, `${ J }-${ E }`, y, z, {
                [`${ J }-rtl`]: 'rtl' === I
            }, L);

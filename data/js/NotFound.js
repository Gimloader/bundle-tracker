...
a.register('Yh+T2', function(b, c) {
    ...
    const o = {
        ...
        r = _w => {
            ...
            if (q.includes(`${ u }`)) {
                ...
                return i.createElement('div', {
                    className: `${ v } ${ s }-image`
                }, i.createElement(_w, null));
            }
            const w = i.createElement(o[u]);
            return null === t || !1 === t ? null : i.createElement('div', {
                className: v
            }, t || w);
        },
        s = _i => {
        ...
        t = _i => {
            ...
            const {
                getPrefixCls: E,
                direction: F
            } = i.useContext(j.ConfigContext), G = E('result', u), [H, _I] = (0, n.default)(G), J = _b(h)(G, `${ G }-${ B }`, v, w, {
                [`${ G }-rtl`]: 'rtl' === F
            }, _I);
    ...
    t.PRESENTED_IMAGE_403 = p[403], t.PRESENTED_IMAGE_404 = p[404], t.PRESENTED_IMAGE_500 = p[500];
    var u = t;
}), a.register('H35K3', function(_b, c) {
    ...
    h.displayName = 'WarningFilled';
    var _i = e.forwardRef(h);
}), a.register('YAMpk', function(b, c) {
...
}), a.register('dTDgg', function(b, c) {
    _h(b.exports, 'default', function() {
        return _e;
    });
    var d = a('LEQ5w');
    var _e = () => d.createElement('svg', {
        width: '252',
        height: '294'
    ...
    const f = _h => {
            ...
            return {
                ...
                [`${ g } ${ g }-icon`]: {
                    ...
                    textAlign: 'center',
                    [`& > ${ i }`]: {
                        fontSize: _h.resultIconFontSize
                    }
                },
                [`${ g } ${ g }-title`]: {
                    color: _h.colorTextHeading,
                    fontSize: _h.resultTitleFontSize,
                    lineHeight: h,
                    marginBlock: n,
                    textAlign: 'center'
                },
                [`${ g } ${ g }-subtitle`]: {
                    color: _h.colorTextDescription,
                    fontSize: _h.resultSubtitleFontSize,
                    lineHeight: _o,
                    textAlign: 'center'
                },
                [`${ g } ${ g }-content`]: {
                    marginTop: m,
                    padding: `${ m }px ${ 2.5 * j }px`,
                    backgroundColor: _h.colorFillAlter
                },
                [`${ g } ${ g }-extra`]: {
                    margin: _h.resultExtraMargin,
                    textAlign: 'center',
                    '& > *': {
                        marginInlineEnd: l,
                        '&:last-child': {
        ...
        g = _h => {
            ...
            return {
                [`${ h }-success ${ h }-icon > ${ i }`]: {
                    color: _h.resultSuccessIconColor
                },
                [`${ h }-error ${ h }-icon > ${ i }`]: {
                    color: _h.resultErrorIconColor
                },
                [`${ h }-info ${ h }-icon > ${ i }`]: {
                    color: _h.resultInfoIconColor
                },
                [`${ h }-warning ${ h }-icon > ${ i }`]: {
                    color: _h.resultWarningIconColor
                }
            };
        },
        h = _h => (_h => [
    ...
    var i = (0, d.default)('Result', _h => {
        const {
            paddingLG: j,
            fontSizeHeading3: k
        } = _h, l = _h.fontSize, m = `${ j }px 0 0 0`, n = _h.colorInfo, o = _h.colorError, p = _h.colorSuccess, q = _h.colorWarning, r = (0, e.merge)(_h, {
            resultTitleFontSize: k,
            resultSubtitleFontSize: l,
            resultIconFontSize: 3 * k,
            resultExtraMargin: m,
            resultInfoIconColor: n,
            resultErrorIconColor: o,
            resultSuccessIconColor: p,
            resultWarningIconColor: q
        });
        return [h(r)];
    }, {
        imageWidth: 250,

...
var R = {
    ...
    V = function(a, l) {
        return e.createElement(D, W({}, a, {
            ref: l,
            icon: R
        }))
    },
    b = e.forwardRef(V);
const w = () => e.createElement("svg", {
        width: "252",
        height: "294"
    }, e.createElement("title", null, "No Found"), e.createElement("defs", null, e.createElement("path", {
    ...
    T = () => e.createElement("svg", {
        width: "254",
        height: "294"
    }, e.createElement("title", null, "Server Error"), e.createElement("defs", null, e.createElement("path", {
    ...
    _ = t => {
        ...
        return {
            [a]: {
                padding: `${m(t.calc(s).mul(2).equal())} ${m(o)}`,
                "&-rtl": {
                    direction: "rtl"
                }
            },
            ...
            [`${a} ${a}-content`]: {
                marginTop: s,
                padding: `${m(s)} ${m(t.calc(c).mul(2.5).equal())}`,

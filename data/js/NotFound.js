...
c.register('17YZM', function(d, e) {
    ...
    const q = {
        ...
        t = a => {
            ...
            const y = k.createElement(q[w]);
            return null === v || !1 === v ? null : k.createElement('div', {
                className: x
            }, v || y);
        },
        u = a => {
        ...
        v = a => {
            ...
            const {
                getPrefixCls: G,
                direction: H
            } = k.useContext(l.ConfigContext), I = G('result', w), [J, _K] = (0, p.default)(I), L = b(j)(I, `${ I }-${ D }`, x, y, {
                [`${ I }-rtl`]: 'rtl' === H
            }, _K);
            return J(k.createElement('div', {
                className: L,
                style: B
            }, k.createElement(t, {
                prefixCls: I,
    ...
    var _g = () => f.createElement('svg', {
        width: '252',
        height: '294'
    }, f.createElement('defs', null, f.createElement('path', {
    ...
    const h = a => {
            ...
            return {
                ...
                [`${ i } ${ i }-icon`]: {
                    ...
                    textAlign: 'center',
                    [`& > ${ k }`]: {
                        fontSize: a.resultIconFontSize
                    }
                },
                [`${ i } ${ i }-title`]: {
                    color: a.colorTextHeading,
                    fontSize: a.resultTitleFontSize,
                    lineHeight: j,
                    marginBlock: p,
                    textAlign: 'center'
                },
                [`${ i } ${ i }-subtitle`]: {
                    ...
                    fontSize: a.resultSubtitleFontSize,
                    lineHeight: _q,
                    textAlign: 'center'
                },
                [`${ i } ${ i }-content`]: {
                    marginTop: o,
                    padding: `${ o }px ${ 2.5 * l }px`,
                    backgroundColor: a.colorFillAlter
                },
                [`${ i } ${ i }-extra`]: {
                    margin: a.resultExtraMargin,
                    textAlign: 'center',
                    '& > *': {
                        marginInlineEnd: n,
                        '&:last-child': {
        ...
        i = a => {
            ...
            return {
                [`${ j }-success ${ j }-icon > ${ k }`]: {
                    color: a.resultSuccessIconColor
                },
                [`${ j }-error ${ j }-icon > ${ k }`]: {
                    color: a.resultErrorIconColor
                },
                [`${ j }-info ${ j }-icon > ${ k }`]: {
                    color: a.resultInfoIconColor
                },
                [`${ j }-warning ${ j }-icon > ${ k }`]: {
                    color: a.resultWarningIconColor
                }
            };
        },
        j = a => (a => [
    ...
    var k = (0, f.default)('Result', a => {
        const {
            paddingLG: l,
            fontSizeHeading3: m
        } = a, n = a.fontSize, o = `${ l }px 0 0 0`, p = a.colorInfo, q = a.colorError, r = a.colorSuccess, s = a.colorWarning, t = (0, g.merge)(a, {
            resultTitleFontSize: m,
            resultSubtitleFontSize: n,
            resultIconFontSize: 3 * m,
            resultExtraMargin: o,
            resultInfoIconColor: p,
            resultErrorIconColor: q,

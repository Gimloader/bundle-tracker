...
r.register("g107V", (function(t, n) {
    ...
    const M = {
        ...
        k = e => {
            ...
            const l = d.createElement(M[a]);
            return null === n || !1 === n ? null : d.createElement("div", {
                className: o
            }, n || l)
        },
        g = e => {
        ...
        F = e => {
            ...
            const {
                getPrefixCls: M,
                direction: E
            } = d.useContext(u.ConfigContext), v = M("result", r), [F, y] = (0, m.default)(v), x = t(c)(v, `${v}-${f}`, n, a, {
                [`${v}-rtl`]: "rtl" === E
            }, y);
    ...
    F.PRESENTED_IMAGE_403 = E[403], F.PRESENTED_IMAGE_404 = E[404], F.PRESENTED_IMAGE_500 = E[500];
    var y = F
})), r.register("xUSpf", (function(t, n) {
    e(t.exports, "default", (function() {
        return c
    }));
    var a = r("dnh3u"),
        ...
        i = r("dwKuN"),
        s = function(e, t) {
            return o.createElement(i.default, (0, a.default)((0, a.default)({}, e), {}, {
                ref: t,
                icon: l.default
            }))
        };
...
})), r.register("kGWG0", (function(t, n) {
    e(t.exports, "default", (function() {
        return o
    }));
    var a = r("fywoC");
    var o = () => a.createElement("svg", {
        width: "252",
        height: "294"
    ...
    const l = e => {
        ...
        s = e => (e => [l(e), i(e)])(e);
    var c = (0, a.default)("Result", (e => {
        const {
            paddingLG: t,
            fontSizeHeading3: r
        } = e, n = e.fontSize, a = `${t}px 0 0 0`, l = e.colorInfo, i = e.colorError, c = e.colorSuccess, d = e.colorWarning, u = (0, o.merge)(e, {
            resultTitleFontSize: r,
            resultSubtitleFontSize: n,
            resultIconFontSize: 3 * r,
            resultExtraMargin: a,
    ...
    function i(e, t, r) {
        return function(n) {
            const {
                prefixCls: i,
                style: s
            } = n, c = o.useRef(null), [d, u] = o.useState(0), [f, p] = o.useState(0), [h, m] = (0, a.default)(!1, {
                value: n.open
            }), {
                getPrefixCls: M
            } = o.useContext(l.ConfigContext), E = M(t || "select", i);
            return o.useEffect((() => {
    ...
    var a = r("lt5sb"),
        o = r("aWAHQ");
    const l = new(0, a.Keyframes)("antMoveDownIn", {
            "0%": {
        ...
        i = new(0, a.Keyframes)("antMoveDownOut", {
            "0%": {
                transform: "translate3d(0, 0, 0)",
                transformOrigin: "0 0",
                opacity: 1
        ...
        s = new(0, a.Keyframes)("antMoveLeftIn", {
            "0%": {
        ...
        p = (e, t) => {
            ...
            return [(0, o.initMotion)(n, a, l, e.motionDurationMid), {
                [`\n        ${n}-enter,\n        ${n}-appear\n      `]: {
                    opacity: 0,
    ...
    const M = e => {
        const {
            ...
            style: x,
            wrap: C = !1
        } = e, L = p(e, ["size", "align", "className", "rootClassName", "children", "direction", "prefixCls", "split", "style", "wrap"]), w = (0, c.default)(), [b, B] = i.useMemo((() => (Array.isArray(d) ? d : [d, d]).map((e => function(e) {
            return "string" == typeof e ? m[e] : e || 0
        }(e)))), [d]), j = (0, l.default)(k, {
            keepEmpty: !0
        }), D = void 0 === M && "horizontal" === g ? "center" : M, z = r("space", F), [W, A] = (0, f.default)(z), O = t(o)(z, A, `${z}-${g}`, {
            [`${z}-rtl`]: "rtl" === a,
            [`${z}-align-${D}`]: D
        }, E, v), S = `${z}-item`, $ = "rtl" === a ? "marginLeft" : "marginRight";
        let N = 0;
        const H = j.map(((e, t) => {
                null != e && (N = t);
                const r = e && e.key || `${S}-${t}`;
        ...
        const I = {};
        return C && (I.flexWrap = "wrap", w || (I.marginBottom = -B)), w && (I.columnGap = b, I.rowGap = B), W(i.createElement("div", Object.assign({
            className: O,
            style: Object.assign(Object.assign({}, I), x)
        }, L), i.createElement(h.Provider, {
            value: _
        }, H)))
    };
    M.Compact = d.default;
    ...
    function l(e) {
        ...
        return p || ("vertical" === r ? n < f && (h = {
            marginBottom: d / (s ? 2 : 1)
        }) : h = Object.assign(Object.assign({}, n < f && {
            [l]: d / (s ? 2 : 1)
        }), c && {
            paddingBottom: u
        })), null == i ? null : a.createElement(a.Fragment, null, a.createElement("div", {
            className: t,
            style: h
        }, i), n < f && s && a.createElement("span", {
            className: `${t}-split`,
            style: h
        }, s))
    }
    ...
    e.exports = function(e, t) {
        ...
        try {
            if (l = n(), i = document.createRange(), s = document.getSelection(), (c = document.createElement("span")).textContent = e, c.ariaHidden = "true", c.style.all = "unset", c.style.position = "fixed", c.style.top = 0, c.style.clip = "rect(0, 0, 0, 0)", c.style.whiteSpace = "pre", c.style.webkitUserSelect = "text", c.style.MozUserSelect = "text", c.style.msUserSelect = "text", c.style.userSelect = "text", c.addEventListener("copy", (function(n) {
                ...
                })), document.body.appendChild(c), i.selectNodeContents(c), s.addRange(i), !document.execCommand("copy")) throw new Error("copy command was unsuccessful");
            d = !0
        } catch (n) {
            ...
            s && ("function" == typeof s.removeRange ? s.removeRange(i) : s.removeAllRanges()), c && document.body.removeChild(c), l()
        }
        return d
    }
    ...
    var n = e.exports && e.exports.__assign || function() {
        ...
        l = e.exports && e.exports.__importStar || function(e) {
            if (e && e.__esModule) return e;
            var t = {};
            if (null != e)
    ...
    var a = r("hxEiv"),
        o = r("beXRF");
    r("fywoC");
    var l = e => e.external || !e.to ? (0, a.jsx)("a", {
        href: e.to,
    ...
    const c = () => s || (s = function() {
        const e = new Map,
            t = new(0, a.default)((0, i.default)(((t, r) => {
                var n;

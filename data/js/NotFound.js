...
c.register('N7Y6t', function(b, t) {
    ...
    const o = {
        ...
        t = a => {
            ...
            const {
                getPrefixCls: F,
                direction: G
            } = i.useContext(j.ConfigContext), H = F('result', u), [I, J] = (0, n.default)(H), K = b(h)(H, `${ H }-${ B }`, v, w, {
                [`${ H }-rtl`]: 'rtl' === G
            }, J);
...
}), c.register('sewjV', function(b, i) {
    a(b.exports, 'default', function() {
        return e;
    });
    var d = c('uPP4W');
    var e = () => d.createElement('svg', {
        width: '252',
        height: '294'
    ...
    const f = a => {
            ...
            return {
                ...
                [`${ g } ${ g }-icon`]: {
                    ...
                    textAlign: 'center',
                    [`& > ${ i }`]: {
                        fontSize: p.resultIconFontSize
                    }
                },
                [`${ g } ${ g }-title`]: {
                    color: p.colorTextHeading,
                    fontSize: p.resultTitleFontSize,
                    lineHeight: h,
                    marginBlock: n,
                    textAlign: 'center'
                },
                [`${ g } ${ g }-subtitle`]: {
                    ...
                    fontSize: p.resultSubtitleFontSize,
                    lineHeight: o,
                    textAlign: 'center'
                },
                [`${ g } ${ g }-content`]: {
                    ...
                    backgroundColor: p.colorFillAlter
                },
                [`${ g } ${ g }-extra`]: {
                    margin: p.resultExtraMargin,
                    textAlign: 'center',
                    '& > *': {
                        marginInlineEnd: l,
                        '&:last-child': {
        ...
        g = a => {
            ...
            return {
                [`${ h }-success ${ h }-icon > ${ i }`]: {
                    color: j.resultSuccessIconColor
                },
                [`${ h }-error ${ h }-icon > ${ i }`]: {
                    color: j.resultErrorIconColor
                },
                [`${ h }-info ${ h }-icon > ${ i }`]: {
                    color: j.resultInfoIconColor
                },
                [`${ h }-warning ${ h }-icon > ${ i }`]: {
                    color: j.resultWarningIconColor
                }
            };
        },
        h = a => (a => [
    ...
    var i = (0, d.default)('Result', a => {
        const {
            paddingLG: j,
            fontSizeHeading3: k
        } = l, m = l.fontSize, n = `${ j }px 0 0 0`, o = l.colorInfo, p = l.colorError, q = l.colorSuccess, r = l.colorWarning, s = (0, e.merge)(l, {
            resultTitleFontSize: k,
            resultSubtitleFontSize: m,
            resultIconFontSize: 3 * k,
            resultExtraMargin: n,
            resultInfoIconColor: o,
            resultErrorIconColor: p,
            resultSuccessIconColor: q,

...
var R = {
    ...
    V = function(a, r) {
        return e.createElement(D, A({}, a, {
            ref: r,
            icon: R
        }))
    },
    w = e.forwardRef(V);
const b = () => e.createElement("svg", {
        width: "252",
        height: "294"
    }, e.createElement("title", null, "No Found"), e.createElement("g", {
        fill: "none",
        fillRule: "evenodd"
    ...
    T = () => e.createElement("svg", {
        width: "254",
        height: "294"
    }, e.createElement("title", null, "Server Error"), e.createElement("g", {
        fill: "none",
        fillRule: "evenodd"
    }, e.createElement("path", {
        fill: "#E4EBF7",
    ...
    _ = t => {
        ...
        return {
            [a]: {
                padding: `${p(t.calc(s).mul(2).equal())} ${p(o)}`,
                "&-rtl": {
                    direction: "rtl"
                }
            },
            ...
            [`${a} ${a}-content`]: {
                marginTop: s,
                padding: `${p(s)} ${p(t.calc(c).mul(2.5).equal())}`,
    ...
    G = t => {
        ...
        return {
            [`${a}-success ${a}-icon > ${r}`]: {
                color: t.resultSuccessIconColor
            },
            [`${a}-error ${a}-icon > ${r}`]: {
                color: t.resultErrorIconColor
            },
            [`${a}-info ${a}-icon > ${r}`]: {
                color: t.resultInfoIconColor
            },
            [`${a}-warning ${a}-icon > ${r}`]: {
    ...
    U = () => e.createElement("svg", {
        width: "251",
        height: "294"
    }, e.createElement("title", null, "Unauthorized"), e.createElement("g", {
        fill: "none",
        fillRule: "evenodd"
    }, e.createElement("path", {
        fill: "#E4EBF7",
    ...
    Q = ({
        ...
        const c = e.createElement(J[r]);
        return a === null || a === !1 ? null : e.createElement("div", {
            className: l
        }, a || c)
    },
    Y = ({
    ...
    E = ({
        ...
        const {
            ...
            direction: f,
            result: i
        } = e.useContext(z), n = M("result", t), [L, v, B] = q(n), g = u(n, `${n}-${s}`, a, i == null ? void 0 : i.className, r, {
            [`${n}-rtl`]: f === "rtl"
        }, v, B), C = Object.assign(Object.assign({}, i == null ? void 0 : i.style), o);
...
E.PRESENTED_IMAGE_403 = d[403];
E.PRESENTED_IMAGE_404 = d[404];
E.PRESENTED_IMAGE_500 = d[500];
const D1 = () => m.jsxs("div", {
    style: {
        flex: 1
    },
    children: [m.jsx(N, {
        ...
        status: 404,
        title: "Hmmm, we couldn't find that...",

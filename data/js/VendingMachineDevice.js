...
c.register('.....', function(d, e) {
            ...
            super(H), (0, g.default)(this, 'grayScalePipelines', []), (0, g.default)(this, 'grayScaleFactor', 0), (0, g.default)(this, 'animationSpeedFactor', 1), (0, g.default)(this, 'rays', []), (0, g.default)(this, 'cumulTime', 0), (0, g.default)(this, 'currentRaysAngle', 0), (0, g.default)(this, 'onUpdate', I => {
                if (this.cull.isInsideView) {
                    if (this.currentRaysAngle += I / 10000 * this.animationSpeedFactor, this.rays.forEach((J, K) => {
                        ...
                        this.cumulTime += I;
                        const J = this.y - k.Consts.LEGS_HEIGHT / 2,
                            K = 5;
                ...
                this.visualEditing.add.circle({
                    ...
                    resizable: !0,
                    onChange: J => {
                        (0, F.ReplaceVisualEditingPreview)(J.x, J.y, {
                            radius: J.radius
                        });
                    }
                });
    ...
    const _g = {
        ...
        _j = {
            ...
            fundingStatus: {
                message: (k, l, m) => `${ (0, f.numberWithCommas)(k) }/${ (0, f.numberWithCommas)(l) } ${ m }`
            },
    ...
    const _k = l => {
        ...
        _l = (m, n, o) => {
            ...
            n.view.rotation = p;
            const q = p,
                r = Math.atan(19.5 * m.options.raysWidthFactor / 380),
                s = m.options.width / 2,
                t = (m.options.height - g.Consts.LEGS_HEIGHT) / 2;
    ...
    const m = (n, o) => {
        ...
        _o = p => {
            if (p.options.grantAction === l.GrantAction.grantItem && p.options.matchItemRarity) {
                ...
                var r;
                const s = null !== (r = null == q ? void 0 : q.rarity) && void 0 !== r ? r : g.InventoryItemRarity.common,
                    t = f.InventoryRarityColorsHex[s];
                return {
                    rays: t.a,
                    bg1: t.b,
                    bg2: t.a
        ...
        _q = (r, s = !1) => {
            ...
            const x = n(r.raysGrayscale, r.grayScaleFactor),
                y = n(r.bg1Grayscale, r.grayScaleFactor),
                z = n(r.bg2Grayscale, r.grayScaleFactor);
            r.rays.forEach(A => {
                A.view.tint = x;
    ...
    const _l = m => {
        ...
        m.priceAreaInfoRectangle || (m.priceAreaInfoRectangle = m.parts.add.sprite({
            ...
            onLoad: () => {
                ...
                m.updateFontSize();
                const q = f.Consts.REQUIRED_ITEM_MAX_SIZE,
                    r = s => {
                        s.view.y = m.y + n;
                        const t = m.priceText.getBounds().width,
                            u = q + t + 7;
    ...
    const _f = (g, h) => {
            g.grayScalePipelines.push(g.scene.plugins.get('rexGrayScalePipeline').add(h.view, {
                intensity: g.grayScaleFactor
            }));
        },
        g = (h, i) => {
    ...
    var f = c('.....'),
        ...
        k = c('.....');
    const _l = m => {
        const n = -h.Consts.LEGS_HEIGHT / 2,
            o = {
    ...
    var f = c('.....'),
        ...
        h = c('.....');
    var _i = j => {
        const k = (0, g.VendingMachineDeviceAmountRequiredToPurchase)(j),
            l = (0, g.VendingMachineDeviceAmountOfRequiredItemIHave)(j);
    ...
    var f = c('.....'),
        g = c('.....'),
        h = c('.....');
    const _i = j => Math.max(0, (0, g.GetCost)(j) - ((0, h.VendingMachineDeviceFundingIsEnabled)(j) && j.state.fundedAmount || 0)),
        _j = k => {
            let l = 0;
    ...
    var _h = i => {
        ...
        if (i.options.useLimitedStock && i.state.currentStock <= 0)
            return !1;
        const j = (0, f.VendingMachineDeviceAmountRequiredToPurchase)(i),
            k = (0, f.VendingMachineDeviceAmountOfRequiredItemIHave)(i);
    ...
    var _k = l => {
        ...
        const m = (0, i.VendingMachineDeviceAmountRequiredToPurchase)(l),
            n = (0, i.VendingMachineDeviceAmountOfRequiredItemIHave)(l),
            o = (0, j.VendingMachineDeviceFundingIsEnabled)(l);
        return n < m && !o ? {
            ...
            text: g.InteractionMessages.fundingStatus.message(l.state.fundedAmount || 0, (0, h.GetCost)(l), (0, f.ItemName)(l.options.requiredItemId))
        } : {};
    };
}), c.register('.....', function(d, e) {
    a(d.exports, 'default', function() {
    ...
    var _i = j => {
        ...
        }) : j.interactiveZones.add.circle({
            r: j.options.radius
        }), j.interactiveZones.setCanInteractThroughColliders(!0), j.interactiveZones.onInteraction = () => {

...
t.register("iC8LK", (function(i, s) {
    var e, n, o, h, a;
    i.exports, i.exports = (h = t("3J43T"), a = t("fywoC"), e = {
        21: function(t, i, s) {
            var e = this && this.__createBinding || (Object.create ? function(t, i, s, e) {
                    void 0 === e && (e = s);
                ...
                o = this && this.__importStar || function(t) {
                    ...
                    var i = {};
                    if (null != t)
                        for (var s in t) "default" !== s && Object.prototype.hasOwnProperty.call(t, s) && e(i, t, s);
                    return n(i, t), i
                };
            Object.defineProperty(i, "__esModule", {
                value: !0
            }), i.Fireworks = i.useFireworks = void 0;
            var h = o(s(156)),
                a = s(522);
            i.useFireworks = t => {
                var {
                    initialStart: i = !0,
                    initialOptions: s = {}
                } = t, [e, n] = (0, h.useState)(i), [o, a] = (0, h.useState)(s);
                return {
                    enabled: e,
                    options: o,
                    setOptions: a,
            ...
            class r extends h.Component {
                componentDidMount() {
                    this._ref && (this._fw = new a.Fireworks(this._ref, this.props.options), this.toggleStart())
                }
                componentDidUpdate() {
                    var t;
                    this.toggleStart(), this.props.options && (null === (t = this._fw) || void 0 === t || t.setOptions(Object.assign({}, this.props.options)))
                }
                componentWillUnmount() {
                    var t, i;
                    null === (t = this._fw) || void 0 === t || t.unmount(), null === (i = this._fw) || void 0 === i || i.stop()
                }
                toggleStart() {
                    var t, i;
                    this.props.enabled ? null === (t = this._fw) || void 0 === t || t.start() : null === (i = this._fw) || void 0 === i || i.stop()
                }
                render() {
    ...
    t.exports, t.exports = (() => {
                ...
                511: (t, i, s) => {
                    ...
                    i.Explosion = class {
                        ...
                        constructor(t) {
                            ...
                            for (this._coordinates = [], this._alpha = 1, this._x = i, this._y = s, this._ctx = n, this._gravity = h, this._friction = a, this._flickering = c, this._lineWidth = d, this._explosionLength = _; this._explosionLength--;) this._coordinates.push([i, s]);
                            this._angle = (0, e.randomFloat)(0, 2 * Math.PI), this._speed = (0, e.randomInt)(1, 10), this._hue = (0, e.randomInt)(o - 20, o + 20), this._brightness = (0, e.randomInt)(r.min, r.max), this._decay = (0, e.randomFloat)(r.decay.min, r.decay.max)
                        }
                    }
                },
                909: (t, i) => {
                ...
                668: (t, i, s) => {
                    ...
                    i.Trace = class {
                        ...
                        constructor(t) {
                            ...
                            for (this._coordinates = [], this._currentDistance = 0, this._x = i, this._y = s, this._sx = i, this._sy = s, this._dx = n, this._dy = o, this._ctx = h, this._hue = a, this._speed = r, this._traceLength = c, this._acceleration = d, this._totalDistance = (0, e.getDistance)(i, s, n, o); this._traceLength--;) this._coordinates.push([i, s]);
                            this._angle = Math.atan2(o - s, n - i), this._brightness = (0, e.randomInt)(50, 70)
                        }
                    }
                }
            },
        ...
        return (() => {
            ...
            t.Fireworks = class {
                ...
                initTrace() {
                    this._ds = (0, h.randomInt)(this.delay.min, this.delay.max), (this._tick > this._ds || this._m && this.mouse.max > this._traces.length) && (this._traces.push(new i.Trace({
                        x: this._width * (0, h.randomInt)(this.rocketsPoint.min, this.rocketsPoint.max) / 100,
                        y: this._height,
                        dx: this._mx && this.mouse.move || this._m ? this._mx : (0, h.randomInt)(this.boundaries.x, this.boundaries.width - 2 * this.boundaries.x),
                        dy: this._my && this.mouse.move || this._m ? this._my : (0, h.randomInt)(this.boundaries.y, .5 * this.boundaries.height),
                        ctx: this._ctx,
                        hue: (0, h.randomInt)(this.hue.min, this.hue.max),
                ...
                drawTrace() {
                    ...
                    for (this._ctx.lineWidth = (0, h.randomFloat)(this.lineWidth.trace.min, this.lineWidth.trace.max); t--;) this._traces[t].draw(), this._traces[t].update(((i, s, e) => {
                        this.initExplosion(i, s, e), this._sound.play(), this._traces.splice(t, 1)
                    }))
                }
                initExplosion(t, i, s) {
                    for (var e = this.particles; e--;) this._explosions.push(new o.Explosion({
                        x: t,
                        y: i,
                        ctx: this._ctx,
                        hue: s,
                        ...
                        flickering: (0, h.randomInt)(0, 100) <= this.flickering,
                        lineWidth: (0, h.randomFloat)(this.lineWidth.explosion.min, this.lineWidth.explosion.max),
                ...
                constructor(t) {
                    ...
                    this._tick = 0, this._timestamp = performance.now(), this._version = "1.4.0", this._running = !1, this._m = !1, t instanceof HTMLCanvasElement ? (this._container = t, this._canvas = t) : (this._container = t, this._canvas = document.createElement("canvas"), this._container.appendChild(this._canvas)), this._ctx = this._canvas.getContext("2d"), this._sound = new n.Sound(r), this.setSize(), this.setBoundaries(Object.assign({
                        visible: !1,
                        x: 50,
                        y: 50
                    }, s)), this.autoresize = i, this.trace = u, this.explosion = x, this.gravity = f, this.opacity = v, this.particles = g, this.friction = y, this.acceleration = b, this.flickering = l, this.intensity = m, this.traceSpeed = p, this.lineStyle = _, this.hue = Object.assign({
                        min: 0,
                        max: 360
                    }, h), this.rocketsPoint = Object.assign({
                        min: 50,
                        max: 50

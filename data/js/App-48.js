...
function It(t, r, n, i) {
    if (!i) return t;
    const e = t.findIndex(d => d.value === r);
    if (e === -1) return t;
    const c = i > 0 ? 1 : -1,
        s = t[e + c];
    if (!s) return t;
...
const wt = p.forwardRef(St),
    ...
    jt = () => o.jsx(Ct, {
        children: "You have no items/resources in your inventory."
    }),
    Ct = l.div.attrs({
        className: "maxWidth"
    })`
...
`,
    Dt = y(t => {
        const r = p.useRef(null),
            ...
            a = () => {
                var g, u;
                i(), s((u = (g = r.current) == null ? void 0 : g.getBoundingClientRect()) == null ? void 0 : u.x)
            },
            m = () => {
                var u, x, I;
...
`,
    ...
    zt = y(t => {
        ...
        const i = e => {
            const c = e.map(s => s.slotNumber);
            for (let s = c.length + 1; s <= 5; s++) c.push(s);
            r.interactiveSlotsOrder.replace(c), Rt({
                order: c
            })
        };
        return o.jsxs(Et, {
            children: [o.jsx(At, {
                ...
                children: n.map(e => o.jsx(U.Item, {
                    ...
                    children: o.jsx(Dt, {
                        ...
                        onSelect: e.empty ? void 0 : () => t.select(e.slotNumber)
                    })
                }, e.slotNumber + "-item"))
            })]
        })
    ...
    Ht = t => {
        ...
        return o.jsxs(Kt, {
            children: [o.jsx(z, {
                onClick: () => c(e),
                ariaLabel: "Drop",
                children: e === 1 ? "Drop" : "Drop All"
            }), e > 1 ? o.jsx(z, {
                onClick: () => c(Math.ceil(e / 2)),
                style: {
                    marginLeft: 10
                },
                ariaLabel: "Drop Half",
...
`,
    te = y(t => {
        const {
            ...
            if (!i && !e) return null;
            if (i) {
                const m = c.interactiveSlots.get(`${i}`);
                if (!m) return null;
                const d = E(m.itemId);
                return d ? {
                    slotNumber: i,
        ...
        return p.useEffect(() => {
            a && f(a), a || n()
        }, [a == null ? void 0 : a.itemId, a == null ? void 0 : a.slotNumber, a == null ? void 0 : a.count]), o.jsxs(o.Fragment, {
            children: [o.jsx(gt, {
                open: r,
                onClose: n,
                placement: "bottom",
...
`,
    ...
    se = l(j.div).attrs({
        className: "medium-shadow flex-column scroll-y"
    })`

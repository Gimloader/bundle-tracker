...
c.register('.....', function(d, e) {
    ...
    var _t = u => {
        ...
        return (0, g.jsx)(_u, {
            style: {
                background: (0, p.CraftingTableDeviceUIBackgroundColor)(u.style)
            },
            children: (() => {
    ...
    var _A = (0, i.observer)(B => {
        ...
        return C ? (0, f.jsxs)(f.Fragment, {
            children: [
                ...
                (0, f.jsx)(_D, {
                    children: (0, r.default)(C.id, B.itemAmount)
                }),
                (0, f.jsxs)(_B, {
                    children: [
                        (0, f.jsx)(_E, {
...
`));
    ...
    var _w = (0, p.observer)(x => {
        ...
        const C = g.useMemo(() => {
            ...
            D = Math.max(1, (() => {
                const E = Math.max(x.itemDisposalAt - (0, o.GetServerGameTimeWithCompensation)(), 0),
                    F = Math.ceil(E / 1000);
                return isNaN(F) ? 0 : F;
            })());
        return (0, f.jsxs)(_x, {
...
`), j.Fonts.ProductSans, j.FontWeights.Bold),
                ...
                l.forEach(function(s) {
                    return function(t, u, v) {
                        ...
                        var w = t.physics,
                            ...
                            z = w.tiltAngle,
                            A = w.wobble,
                            B = 'translate3d(' + (x + 10 * Math.cos(A)) + 'px, ' + (y + 10 * Math.sin(A)) + 'px, 0) rotate3d(1, 1, 1, ' + z + 'rad)';
    ...
    var _q = r => {
        ...
        const t = Math.max(r.itemFinishesCraftingAt - (0, m.GetServerGameTimeWithCompensation)(), 0),
            u = Math.max(100 - t / r.craftingDurationMs * 100, 0);
        if (isNaN(t))
            return null;
        const v = Math.max(1, Math.ceil(t / 1000)),
            w = `Ready in ${ v } ${ (0, l.plural)('second', v) }`;
...
`));
    ...
    var _p = (0, g.observer)(q => {
        ...
        return x >= v ? y += ` (${ (0, i.numberWithCommas)(v) })` : (w = !1, y += ` (${ (0, i.numberWithCommas)(x) }/${ (0, i.numberWithCommas)(v) })`), (0, f.jsxs)(_q, {
            style: {
                background: w ? 'rgba(255,255,255, 0.1)' : 'rgba(198, 40, 40, 0.5)'
            },
            children: [
                (0, f.jsx)('img', {
...
`));
    ...
    var _m = n => {
        ...
        return (0, f.jsxs)(f.Fragment, {
            children: [
                (0, f.jsx)(_n, {
                    src: (0, h.default)(o.itemId).previewImage
                }),
                (0, f.jsx)(_o, {
                    children: (0, i.default)(n.recipe.itemId, n.recipe.itemAmount)
                })
            ]
        });
    };
...
`));
    ...
    var _q = (0, g.observer)(r => {
        ...
        return s.length ? (0, f.jsxs)(_r, {
            children: [
                (0, f.jsx)(_s, {
                    children: m.default.selectItem(r.style)
                }),
            ...
            children: (0, f.jsx)(_s, {
                children: m.default.noItems(r.style)
            })
        });
    });
...
`), i.Fonts.ProductSans, i.FontWeights.Bold);
    ...
    let o, p, q, r, s, t = u => u;
    var _u = v => {
        const w = (0, l.default)(v.recipeId),
            x = h.useMemo(() => (0, j.default)(w.itemId).previewImage, [w.itemId]),
            y = (0, k.default)(w);
        return (0, f.jsxs)(_v, {
            onClick: v.onSelect,
            children: [
                ...
                (0, f.jsxs)(_x, {
                    children: [
                        (0, f.jsx)(_y, {
                            children: (0, m.default)(w.itemId, w.itemAmount)
                        }),
                        (0, f.jsx)(_z, {
                            style: {
                                color: y ? '#a5d6a7' : '#ef9a9a'
                            },

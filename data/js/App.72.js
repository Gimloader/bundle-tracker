...
c.register('.....', function (d, e) {
                ...
                (0, g.jsxs)(_s, {
                    children: [
                        ...
                        (0, g.jsx)(k.default, {
                            ...
                            children: (0, l.getUser)().passwordless ? (0, g.jsx)(n.default, {}) : s ? (0, g.jsx)(o.default, {}) : (0, g.jsx)(m.default, { continue: t })
                        })
                    ]
                })
            ]
    ...
    const _s = h.default.div.attrs({ className: 'flex-column vc' })(q || (q = (t => t)`
  flex: 1;
  background: ${ 0 };
  color: ${ 0 };
  h1 {
...
`), i.default.Snow, i.default.Black, j.FontWeights.UltraBold);
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _j;
    });
...
`), h.default.White);
    ...
    var _n = o => {
        const [p, q] = i.useState(''), r = p !== m, s = () => {
                r || o.continue();
            };
        return (0, f.jsxs)(f.Fragment, {
            children: [
                (0, f.jsx)('h1', { children: 'Are you sure you want to delete your account?' }),
                (0, f.jsxs)('p', {
                    children: [
                        (0, j.isStudent)() ? 'By deleting your account, you will be removed from all classes\nyou\'re currently part of. You will also lose any content you\'ve\ncreated and cosmetics earned.' : l,
    ...
    c('.....');
    var h = c('.....'), i = c('.....'), j = c('.....');
    var _k = () => (0, f.jsxs)(f.Fragment, {
        children: [
            (0, f.jsx)('h1', { children: 'Add a password to delete your account' }),
            (0, f.jsx)('p', { children: 'In order to delete your account, you\'ll first need to attach a password to your account. You can attach a password in settings.' }),
            (0, f.jsx)(g.default, {}),
            (0, f.jsx)(j.default, {
                onClick: () => (0, i.NavigateTo)(h.SETTINGS),
    ...
    var _m = () => {
        const [n, o, p] = (0, k.useBoolean)(!1), [q, r] = j.useState(''), s = !q.length;
        return (0, f.jsxs)(f.Fragment, {
            children: [
                (0, f.jsx)('h1', { children: 'Last chance.' }),
                (0, f.jsx)('p', { children: 'Deleting your account is permanent and cannot be reversed. If you are confident you want to delete your account, enter your password below. Once you click "Delete My Account", your account will be permanently deleted.' }),
                (0, f.jsx)(g.default, {}),
                (0, f.jsx)(h.default.Password, {
                    size: 'large',
                ...
                (0, f.jsx)(l.default, {
                    onClick: () => {
                        if (s || n)
                            return;
                        const t = (0, k.isStudent)();
                        o(), (0, k.request)({
                            url: '/api/user/delete',
                            data: { password: q },
                            success: () => {
                                (0, k.request)({ url: '/logout' }), i.default.success({
                                    title: 'Account deleted',
                                    content: t ? 'You will be removed from all classes you are part of and all content you\'ve created on Gimkit will be deleted. This process normally takes a few minutes, but can sometimes take up to a few hours.' : 'Your account and all the content you\'ve created will be deleted. Additionally, if you had an active subscriptions, we\'ve canceled them. This process normally only takes a few minutes, but can sometimes take a few hours.',

...
c.register('.....', function (d, e) {
    ...
    let v;
    const w = h.lazy(() => c('.....')), x = h.lazy(() => c('.....'));
    var _y = () => {
        (0, n.useDidMount)(() => {
            (0, o.loadFont)('https://fonts.googleapis.com/css2?family=Fugaz+One&display=swap');
        });
        const {pathname: z} = (0, t.useLocation)(), A = h.useMemo(() => (0, s.matchPath)({ path: p.CREATIVE_MAP }, z) ? (0, g.jsx)(w, {}) : (0, s.matchPath)({ path: p.CREATIVE_DISCOVERY }, z) ? (0, g.jsx)(x, {}) : (0, g.jsx)(u.default, {}), [z]);
                                ...
                                options: [
                                    {
                                        ...
                                        icon: (0, g.jsx)(r.default, { name: 'fas fa-hammer' })
                                    },
                                    {
                                        id: 'creative-explore',
                                        label: 'Discovery',
                                        path: p.CREATIVE_DISCOVERY,
                                        icon: (0, g.jsx)(r.default, { name: 'fas fa-gamepad-alt' })
                                    }
                                ]
                            })
                        }),
...
`), q => q.background, q => q.color, q => q.hoverBackground);
    ...
    var _t = () => {
        ...
        return w ? (0, f.jsx)('div', {
            ...
            style: { marginTop: 100 },
            children: (0, f.jsx)(q.default, { style: { color: r.default.White } })
        }) : (0, f.jsxs)(_u, {
            children: [
                (0, f.jsx)(h.default, {}),
                (0, f.jsxs)(j.default, {
                    ...
                    children: [
                        u.completedTutorial ? null : (0, f.jsx)(k.default, { children: (0, f.jsx)(m.default, {}) }),
                        (0, f.jsx)(k.default, { children: (0, f.jsx)(n.default, { mapLimit: u.mapLimit }) }),
                        (0, f.jsx)(k.default, { children: (0, f.jsx)(o.default, {}) })
                    ]
                })
            ]
        });
    };
    const _u = (0, g.default)(i.CenteredColumn).attrs({ className: 'maxWidth' })(s || (s = (v => v)`
  padding: 35px 0px;
`));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
    ...
    var _r = () => (0, f.jsxs)(_s, {
        children: [
            (0, f.jsxs)(_t, {
                children: [
                    (0, f.jsx)(_u, { src: '/client/img/svgLogoWhite.svg' }),
                    (0, f.jsx)(_v, { children: 'Creative' })
                ]
            }),
            (0, f.jsx)(_w, { children: (0, f.jsx)(k.default, { children: 'Welcome to Gimkit Creative, where you can build your very own game modes, maps, & worlds! Creative is in early access, so there may be bugs & issues. Have fun building!' }) })
        ]
    });
    const _s = (0, g.default)(i.CenteredColumn)(l || (l = q`
  width: ${ 0 };
  max-width: ${ 0 };
`), h.CreativeContentWidth.width, h.CreativeContentWidth.maxWidth), _t = (0, g.default)(i.CenteredColumn)(m || (m = q``)), _u = g.default.img(n || (n = q`
  height: 35px;
...
`)), _v = g.default.div(o || (o = q`
  ...
  line-height: 1;
  margin-top: 10px;
`), j.Fonts.FugazOne), _w = g.default.div(p || (p = q`
  margin-top: 15px;
  font-size: 18px;
  text-align: center;
`));
    ...
    const _j = g.default.div.attrs({ className: 'maxWidth light-shadow' })(h || (h = (k => k)`
  background: rgba(255, 255, 255, 0.1);
  padding: 35px;
  border-radius: 12px;
...
`));
    ...
    var _t = () => (0, f.jsxs)(_u, {
        children: [
            (0, f.jsx)(_v, { children: (0, f.jsx)(_w, {}) }),
            (0, f.jsxs)(_x, {
                children: [
                    (0, f.jsx)(_y, { children: (0, f.jsx)(k.default, { children: 'Complete the Gimkit Creative tutorial and receive the Blueprint Gim for free!' }) }),
                    (0, f.jsx)(_z, { children: 'The tutorial takes about 10 minutes to complete.' }),
                    (0, f.jsx)(h.default, {
                        size: 'small',
    ...
    const _u = g.default.div.attrs({ className: 'maxWidth flex-center' })(m || (m = s``)), _v = g.default.div(n || (n = s``)), _w = g.default.img.attrs({ src: (0, l.default)('characters/spine/preview/construction.png') })(o || (o = s`
  height: 155px;
...
`)), _y = g.default.div(q || (q = s`
  ...
  font-size: 18px;
  line-height: 1.3;
`), i.FontWeights.Bold), _z = g.default.div(r || (r = s`
  margin-top: 6px;
  font-size: 14px;
...
`), k.default.White);
    ...
    var _w = x => {
        const {
                ...
                isLoading: z,
                error: A
            } = (0, h.default)(), [B, C, D] = (0, i.useBoolean)(!1);
        if (z || A)
            return null;
        const E = y.length < x.mapLimit, F = y.slice(0, x.mapLimit), G = y.slice(x.mapLimit);
            ...
            children: [
                (0, f.jsxs)(_x, {
                    children: [
                        ...
                        y.length ? (0, f.jsxs)(l.default, {
                            direction: 'vertical',
                            size: 14,
                            className: 'maxWidth',
                            style: { marginTop: 20 },
                            children: [
                                F.map(H => (0, f.jsx)(m.default, {
                                    id: H._id,
                                    name: H.name,
                                    disabled: !1
                                }, H._id)),
                                G.length ? (0, f.jsxs)(l.default, {
                                    direction: 'vertical',
                                    size: 14,
    ...
    const _x = g.default.div.attrs({ className: 'maxWidth' })(p || (p = v``)), _y = g.default.div.attrs({ className: 'flex between maxWidth vc' })(q || (q = v``)), _z = g.default.div(r || (r = v``)), _A = g.default.div(s || (s = v`
  font-family: ${ 0 };
  text-transform: uppercase;
  font-size: 22px;
  line-height: 1;
  margin-bottom: 3px;
`), k.Fonts.FugazOne), _B = g.default.div(t || (t = v`
  font-size: 14px;
  color: rgba(255, 255, 255, 0.8);
`)), _C = g.default.div.attrs({ className: 'maxWidth' })(u || (u = v`
...
`));
    ...
    var f = c('.....'), g = c('.....'), h = c('.....');
    const i = ['creative-created-maps'], _j = () => h.default.invalidateQueries(i);
    var _k = () => (0, f.useQuery)(i, () => (0, g.requestAsPromise)({ url: '/api/created-maps' }));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _u;
    });
    ...
    let t;
    var _u = v => {
        const [w, x, y] = (0, p.useBoolean)(!1), [z, A, B] = (0, p.useBoolean)(!1), [C, D] = g.useState(''), [E, F] = g.useState(''), [G, H, I] = (0, p.useBoolean)(!1), [J, K, L] = (0, p.useBoolean)(!1), [M, N, O] = (0, p.useBoolean)(!1);
        g.useEffect(() => {
            D('');
        }, [w]), g.useEffect(() => {
            F('');
        }, [z]);
        const P = (null == C ? void 0 : C.trim().length) < 2, Q = () => {
                P || G || (H(), (0, p.request)({
                    ...
                    error: R => {
                        (0, p.throwMessageError)({
                            e: R,
                            default: { title: 'Error renaming map' }
                        });
                    },
                    both: () => {
                        y(), I();
        ...
        return (0, f.jsxs)(f.Fragment, {
            children: [
                (0, f.jsxs)(_v, {
                    onClick: () => {
                        v.disabled || M || (N(), (0, p.request)({
                            url: '/api/matchmaker/intent/map/edit/create',
                            data: { mapId: v.id },
                            success: S => window.location.href = `/host?id=${ S }`,
                            error: S => {
                                (0, p.throwMessageError)({
                                    e: S,
                                    default: { title: 'Error loading into your map. Please try again.' }
                                });
                            },
                            both: O
                        }));
                                    ...
                                    items: [
                                        {
                                            key: `rename-${ v.id }`,
                                            label: 'Rename',
                                            icon: (0, f.jsx)(r.default, { name: 'far fa-edit' }),
                                            onClick: S => {
                                                S.domEvent.stopPropagation(), x();
                                            }
                                        },
                                        {
                                            key: `delete-${ v.id }`,
                                            label: 'Delete',
                                            icon: (0, f.jsx)(r.default, { name: 'far fa-trash-alt' }),
                                            danger: !0,
                                            onClick: S => {
                                                S.domEvent.stopPropagation(), A();
                                            }
                                        }
                                    ]
                                },
                                children: (0, f.jsx)(i.default, {
                                    icon: (0, f.jsx)(r.default, { name: 'far fa-ellipsis-h' }),
                                    type: 'text',
                            ...
                            onClick: () => {
                                R || J || (K(), (0, p.request)({
                                    ...
                                    error: S => {
                                        (0, p.throwMessageError)({
                                            e: S,
                                            default: { title: 'Error deleting map' }
                                        });
                                    },
                                    both: () => {
                                        B(), L();
    ...
    const _v = (0, h.default)(s.VerticallyCentered).attrs({ className: 'maxWidth between' })(t || (t = (w => w)`
  padding: 11px 16px;
  background: rgba(255, 255, 255, 0.1);
  border-radius: 5px;
  font-weight: ${ 0 };
...
`), n.FontWeights.Bold, w => w.disabled ? 'not-allowed' : 'pointer');
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _w;
    });
    ...
    let v;
    var _w = x => {
        const y = m.useRef(null), [z, A] = m.useState(''), [B, C] = m.useState(), [D, E, F] = (0, n.useBoolean)(!1), G = (null == z ? void 0 : z.trim().length) < 2 || !B;
        m.useEffect(() => {
            x.open && setTimeout(() => {
                var H;
                ...
                G || D || (E(), (0, n.request)({
                    ...
                    success: I => {
                        (0, p.AnalyticsTrackEvent)({
                            ...
                            properties: { mapStyle: B }
                        }), (0, o.invalidateCreatedMaps)(), (0, n.request)({
                            url: '/api/matchmaker/intent/map/edit/create',
                            data: { mapId: I },
                            success: J => window.location.href = `/host?id=${ J }`,
                            both: x.close
                        });
                    },
                    error: I => {
                        (0, n.throwMessageError)({
                            e: I,
                            default: { title: 'Error creating map' }
                        });
                    },
                    both: () => {
                        F(), A('');
                                ...
                                (0, f.jsxs)('div', {
                                    ...
                                    children: [
                                        (0, f.jsx)(s.default, {
                                            ...
                                            selected: B === u.default.topDown,
                                            onSelect: () => I(u.default.topDown)
                                        }),
                                        (0, f.jsx)(s.default, {
                                            image: (0, t.default)('creative/platformer.jpeg'),
                                            name: 'Platformer',
                                            description: 'Players move left & right, but can also jump',
                                            selected: B === u.default.platformer,
                                            onSelect: () => I(u.default.platformer)
                                        })
                                    ]
                                })
                            ]
    ...
    const _x = q.default.div(v || (v = (y => y)`
  font-family: ${ 0 };
  text-transform: uppercase;
  font-size: 20px;
...
`), r.Fonts.FugazOne);
    ...
    var _r = s => {
        ...
        return (0, f.jsxs)(_s, {
            onClick: s.onSelect,
            style: { borderColor: s.selected ? j.default.Yellow : 'rgba(255, 255, 255, 0.1)' },
            children: [
                s.tag ? (0, f.jsx)(_v, { children: s.tag }) : null,
                (0, f.jsx)(_t, { style: { backgroundImage: `url("${ t }")` } }),
                (0, f.jsxs)(_u, {
                    children: [
                        (0, f.jsx)(_w, { children: u }),
                        (0, f.jsx)(_x, { children: v })
                    ]
                })
            ]
        });
...
`)), _t = g.default.div.attrs({ className: 'maxWidth' })(l || (l = q`
  height: 132px;
  background-size: cover;
  background-position: center -57px;
  mask-image: linear-gradient(to bottom, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0));
`)), _u = (0, g.default)(h.CenteredColumn).attrs({ className: 'maxWidth' })(m || (m = q`
  padding: 10px;
  padding-top: 0px;
`)), _v = g.default.div(n || (n = q`
  ...
  top: 10px;
  z-index: 2;
`), i.Fonts.FugazOne, j.default.Yellow, j.default.Black), _w = g.default.div(o || (o = q`
  font-family: ${ 0 };
  text-transform: uppercase;
  font-size: 16px;
`), i.Fonts.FugazOne), _x = g.default.div(p || (p = q`
  font-family: ${ 0 };
  font-size: 13px;
  margin-top: -3px;
`), i.Fonts.SFPro);
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....');
    c('.....');
    var j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....');
    var _o = p => {
        return (0, n.OwnsSeasonTicket)() ? null : (0, f.jsx)(h.default, {
            theme: { algorithm: i.default.defaultAlgorithm },
            children: (0, f.jsx)(g.default, {
                showIcon: !0,
                style: {
                    marginTop: null !== (d = p.marginTop) && void 0 !== d ? d : 0,
                    marginBottom: null !== (c = p.marginBottom) && void 0 !== c ? c : 0
                },
            ...
            children: [
                ...
                (0, f.jsx)('div', {
                    children: (0, f.jsx)(h.default.Text, {
                        ...
                        children: (0, f.jsx)(l.default, { name: 'fas fa-external-link' })
                    })
                })
            ]
        })
    ...
    var _s = () => (0, f.jsxs)(_t, {
        children: [
            (0, f.jsx)(n.Title, { children: 'Resources' }),
            (0, f.jsxs)(g.default, {
                size: 10,
                direction: 'vertical',
                className: 'maxWidth',
    ...
    const _t = i.default.div(o || (o = q``)), _u = (0, i.default)(m.VerticallyCentered).attrs({ className: 'maxWidth' })(p || (p = q`
  padding: 20px;
  background: rgba(255, 255, 255, 0.1);
  cursor: pointer;
...
`));
    ...
    var _i = () => (0, f.useQuery)(h, () => (0, g.requestAsPromise)({ url: '/api/created-map/basics' }));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _r;
    });
    ...
    d.exports = import('./' + c('.....').resolve('1wUUq')).then(() => c('.....'));
}), c.register('.....', function (d, e) {
    d.exports = import('./' + c('.....').resolve('3X4Jt')).then(() => c('.....'));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _k;
    });

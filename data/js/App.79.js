...
`));
    ...
    var f = c('.....'),
        ...
        j = (k, l, m) => {
            let n = (m = m || document.querySelector(`[data-br="${ k }"]`)).parentElement,
                o = p => m.style.maxWidth = p + 'px';
            m.style.maxWidth = '';
            let p, q = n.clientWidth,
                r = n.clientHeight,
                s = q / 2 - 0.25,
                t = q + 0.5;
            if (q) {
        ...
        k = j.toString(),
        l = (m, n = '') => b(f).createElement('script', {
            suppressHydrationWarning: !0,
            dangerouslySetInnerHTML: {
                __html: (m ? '' : `self.${ g }=${ k };`) + n
            }
        }),
        m = b(f).createContext(!1),
        _n = ({
            children: o
        }) => b(f).createElement(m.Provider, {
            value: !0
        }, l(!1), o),
        _o = ({
            as: p = 'span',
...
`), k.default.White);
    ...
    var _w = x => {
        ...
        if (z || A)
            return null;
        const E = y.length < x.mapLimit,
            F = y.slice(0, x.mapLimit),
            G = y.slice(x.mapLimit);
...
`));
    ...
    var _u = v => {
        ...
        const P = (null == C ? void 0 : C.trim().length) < 2,
            Q = () => {
                P || G || (H(), (0, p.request)({
...
`), n.FontWeights.Bold, w => w.disabled ? 'not-allowed' : 'pointer');
    ...
    var _w = x => {
        const y = m.useRef(null),
            [z, A] = m.useState(''),
            [B, C] = m.useState(),
            [D, E, F] = (0, n.useBoolean)(!1),
            G = (null == z ? void 0 : z.trim().length) < 2 || !B;
        m.useEffect(() => {
            x.open && setTimeout(() => {
                var H;
...
`), r.Fonts.FugazOne);
    ...
    var _r = s => {
        ...
        return (0, f.jsxs)(_s, {
            onClick: s.onSelect,
            style: {
                borderColor: s.selected ? j.default.Yellow : 'rgba(255, 255, 255, 0.1)'
            },
            children: [
                s.tag ? (0, f.jsx)(_v, {
                    children: s.tag

    ...
    class B extends g.Component {
        ...
        constructor(...a) {
            super(...a), (0, e.default)(this, 'state', {
                ...
                '3' !== C || (0, h.isUpgraded)() || (0, h.isStudent)() ? this.setState({
                    currentTabKey: C
                }) : this.setState({
                    upgradeModalOpen: !0
                });
...
`), E => E.url, E => E.isMiddle ? 13 : 0, E => E.isMiddle ? 13 : 0);
            ...
            super(...a), (0, e.default)(this, 'state', {
                ...
                o.append('file', n), this.setState({
                    ...
                    success: p => {
                        this.setState({
                            loading: !1
                        }), this.props.onPhotoUploaded(p.url);
                    },
                    error: p => {
                        this.setState({
                            loading: !1
    ...
    var _s = (0, h.observer)(j.forwardRef((t, u) => {
        var v;
        const w = (0, i.useLocalObservable)(() => r()),
            x = (0, p.default)(w) && !t.blockAddingNewQuestions,
            y = () => {
                const z = r();
...
`)),
    ...
    const _f = g => ({
        ...
        connect: ({
            ...
            const {
                port1: i,
                port2: j
            } = new MessageChannel(), k = await h('connect', {
                port: i
            }, [i]);
    ...
    b('.....'), b('.....'), b('.....'), b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    b('.....'), b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    ...
    const _e = f => null === f || void 0 === f.MediaStream || void 0 !== f.MediaRecorder && void 0 === f.MediaRecorder.isTypeSupported ? Promise.resolve(!1) : new Promise(g => {
        ...
        if (h.getContext('2d'), 'function' != typeof h.captureStream)
            return g(!1);
        const i = h.captureStream(),
            j = 'audio/webm';
        try {
            const k = new f.MediaRecorder(i, {
                mimeType: j
            });
            k.addEventListener('dataavailable', ({
                data: l
            }) => g(l.type === j)), k.start(), setTimeout(() => k.stop(), 10);
        } catch (f) {
        ...
        return n.addEventListener = (q = n.addEventListener, (u, v, w) => {
            ...
            return 'function' == typeof v && ('dataavailable' === u ? (x = y => {
                ...
                if (void 0 === y.error)
                    ...
                    y instanceof ErrorEvent ? v.call(n, y) : v.call(n, new ErrorEvent('error', {
                        error: y.error
                    }));
    ...
    const _e = f => (g, h, i, j = 2) => {
        ...
        if (h + l + m > g.byteLength)
            return null;
        if ('binary' === i) {
            const n = (m / Float32Array.BYTES_PER_ELEMENT - 1) / j,
                o = Array.from({
                    length: j
                }, () => new Float32Array(n));
            for (let p = 0; p < n; p += 1) {
    ...
    const h = 'Missing AudioWorklet support. Maybe this is not running in a secure context.',
        _i = (j, k, l, m) => (n, o, p) => {
            var q;
            const r = null === (q = o.getAudioTracks()[0]) || void 0 === q ? void 0 : q.getSettings().sampleRate,
                s = new(0, g.MinimalAudioContext)({
                    latencyHint: 'playback',
                    sampleRate: r
                }),
                t = Math.max(1024, Math.ceil(s.baseLatency * s.sampleRate)),
                u = new(0, g.AudioBuffer)({
                    length: t,
                    sampleRate: s.sampleRate
                }),
                v = [],
                w = (0, f.addRecorderAudioWorkletModule)(x => {
            ...
            let x = null,
                ...
                B = !0;
            const C = D => {
                    n.dispatchEvent(j('dataavailable', {
                        data: new Blob(D, {
                            type: p
                        })
                    }));
                ...
                D = async (E, F) => {
                    ...
                    null !== z && (null !== x && (o.removeEventListener('addtrack', x), o.removeEventListener('removetrack', x)), null !== y && clearTimeout(y), z.then(async ({
                        ...
                        null !== A && (A.catch(() => {}), A = null), await J.stop(), I.disconnect(J), G.stop();
            ...
            return _G(), {
                ...
                start(H) {
                    ...
                    const J = o.getAudioTracks(),
                        K = 0 === J.length ? 2 : null !== (I = J[0].getSettings().channelCount) && void 0 !== I ? I : 2;
                    z = Promise.all([
                        E(),
                        w.then(() => (async (L, M, N, O, P) => {
                            ...
                            if (void 0 === g.AudioWorkletNode)
                                throw new Error(h);
                            return {
                                audioBufferSourceNode: new(0, g.AudioBufferSourceNode)(M, {
                                    buffer: L
                                }),
                                encoderId: Q,
                                mediaStreamAudioSourceNode: new(0, g.MediaStreamAudioSourceNode)(M, {
                                    mediaStream: O
                                }),
                                port: R,
                                recorderAudioWorkletNode: (0, f.createRecorderAudioWorkletNode)(g.AudioWorkletNode, M, {
                                    channelCount: N
                                })
                            };
                        })(u, s, K, o, p))
                        ...
                        const Q = new(0, g.ConstantSourceNode)(s, {
                            offset: 0
                        });
                    ...
                    const L = o.getTracks();
                    x = () => {
                        F(), n.dispatchEvent(new ErrorEvent('error', {
                            error: k()
                        }));
    ...
    const _m = (0, g.createAddRecorderAudioWorkletModule)(Blob, URL, l.worklet),
        _n = (0, j.createRecorderAudioWorkletNodeFactory)(h.createListener, (0, i.createPostMessageFactory)(e.generateUniqueNumber), f.on, k.validateState);
}), b.register('.....', function(c, d) {
    ...
    const _e = f => g => f(h => {
        ...
        const j = () => {
            const k = g.inputs;
            (i.length !== k.size || i.some(({
                id: l
            }) => !k.has(l))) && (i = Array.from(k.values()), h.next(i));
        };
    ...
    const _e = (f, g) => {
        ...
        return i => {
            const j = (...f) => {
                const k = i((l => 'function' == typeof l[0])(f) ? g({
                    next: f[0]
                }) : g(...f));
                return void 0 !== k ? k : h;
            };
            return j[Symbol.observable] = () => ({
                subscribe: (...f) => ({
                    unsubscribe: j(...f)
                })
            }), f(j);
                ...
                p = function(q) {
                    ...
                    function u() {
                        var v = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            ...
                            x = void 0 === u && (v instanceof Error || void 0 !== v.code && 'Exception' === v.code.slice(-9)) ? {
                                cause: v,
                                missingParameters: {}
                            } : {
                                cause: u,
        ...
        _i = (j, k, l) => ({
            ...
            isSupported: async () => {
                if (await (0, g.isSupportingTransferables)()) {
                    const m = l();
                    return {
                        result: m instanceof Promise ? await m : m
                    };
                }
                return {
                    result: !1
    ...
    const _e = () => new Promise(f => {
        ...
        h.onmessage = ({
            data: j
        }) => f(null !== j), i.postMessage(g, [g]);
    });
}), b.register('.....', function(c, d) {
    b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    ...
    const _e = (f, g, h, i) => (j, k, l = {}) => {
        const m = new j(k, 'recorder-audio-worklet-processor', {
            ...
            n = new Map(),
            o = g(n, m.port),
            p = h(m.port, 'message')(f(n));
        m.port.start();
        let q = 'inactive';
        return Object.defineProperties(m, {
            pause: {
                get: () => async () => (i(['recording'], q), q = 'paused', o({
                    method: 'pause'
                }))
            },
            port: {
            ...
            resume: {
                get: () => async () => (i(['paused'], q), q = 'recording', o({
                    method: 'resume'
                }))
            },
            stop: {
    ...
    const Dd = (0, g.createAddActiveInputConnectionToAudioNode)(gd.insertElementInSet),
        ...
        _rf = mf ? (0, j.createAddAudioWorkletModule)(Id, wc.createNotSupportedError, (0, eb.createEvaluateSource)(Jd), nf, (0, hb.createFetchSource)(f.createAbortError), Od, qf, Qd, Xd, new WeakMap(), new WeakMap(), (0, Nc.createTestAudioWorkletProcessorPostMessageSupport)(Xd, Pd), Jd) : void 0,
                    ...
                    return l.default(I, [{
                        ...
                        },
                        {
                            ...
                            value: function(J) {
                                ...
                                if (void 0 !== L && s(L)) {
                                    var S = x(this._automationEvents, M, N, L, this._defaultValue),
                                        T = j.default(S, 2),
                                        U = T[0],
                                        V = T[1];
                                    return C(J, U, V, L);
    ...
    c.exports = function(i, j, k) {
        return j && f(i.prototype, j), k && f(i, k), Object.defineProperty(i, 'prototype', {
            writable: !1
        }), i;
    }, c.exports.__esModule = !0, c.exports.default = c.exports;
}), b.register('.....', function(c, d) {
    ...
    const h = i => {
        ...
        _j = (k, l, m, n, o, p, q, r, s, t, u, v, w) => {
            ...
            return (y, z, A = {
                ...
                const E = p(y),
                    F = void 0 === E.audioWorklet ? o(z).then(([G, H]) => {
                        ...
                        n(E.currentTime, E.sampleRate, () => G(class {}, void 0, (H, I) => {
                            if ('' === H.trim())
                                throw l();
    ...
    const e = /^import(?:(?:[\s]+[\w]+|(?:[\s]+[\w]+[\s]*,)?[\s]*\{[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?(?:[\s]*,[\s]*[\w]+(?:[\s]+as[\s]+[\w]+)?)*[\s]*}|(?:[\s]+[\w]+[\s]*,)?[\s]*\*[\s]+as[\s]+[\w]+)[\s]+from)?(?:[\s]*)("([^"\\]|\\.)+"|'([^'\\]|\\.)+')(?:[\s]*);?/,
        _f = (g, h) => {
            ...
            let j = g.replace(/^[\s]+/, ''),
                k = j.match(e);
            for (; null !== k;) {
                const l = k[1].slice(1, -1),
                    m = k[0].replace(/([\s]+)?;?$/, '').replace(l, new URL(l, h).toString());
    ...
    var e = b('.....'),
        f = b('.....');
    const _g = (h, i, j, k) => {
        const l = (0, e.getValueForKey)(h, i),
            m = (0, f.pickElementFromSet)(l, n => n[0] === j && n[1] === k);
        ...
        const q = p.listener,
            {
                ...
                const G = () => {
                    ...
                    J = (K, L, M) => {
                        ...
                        N.connect(B, 0, K), N.start(), Object.defineProperty(N.offset, 'defaultValue', {
                            get: () => L
                        });
                        const O = g({
                            context: o
                        }, C, N.offset, e.MOST_POSITIVE_SINGLE_FLOAT, e.MOST_NEGATIVE_SINGLE_FLOAT);
                        var P, Q, R, S, T, U, V;
        ...
        _G = (H, I, J, K, L, M, N, O, P, Q, R, S, T, U, V, W) => class extends Q {
            ...
            connect(X, Y = 0, Z = 0) {
                ...
                if ((0, f.isAudioNode)(X)) {
                    ...
                    try {
                        const cb = (0, j.connectNativeAudioNodeToNativeAudioNode)(this._nativeAudioNode, bb, Y, Z),
                            db = (0, y.isPassiveAudioNode)(this);
                ...
                const gb = ((hb, ib, jb, kb) => {
                    const {
                        activeInputs: lb,
                        passiveInputs: mb
                    } = (0, r.getAudioParamConnections)(ib), {
                        outputs: nb
                    } = (0, q.getAudioNodeConnections)(hb), ob = (0, s.getEventListenersOfAudioNode)(hb), pb = qb => {
                        const rb = (0, t.getNativeAudioNode)(hb),
                            sb = (0, u.getNativeAudioParam)(ib);
                        if (qb) {
            ...
            disconnect(X, Y, Z) {
                let $;
                const ab = R(this._context),
                    bb = V(ab);
                if (void 0 === X)
                    $ = ((cb, db) => {
                        const eb = (0, q.getAudioNodeConnections)(cb),
                            fb = [];
                    ...
                    if (X < 0 || X >= this.numberOfOutputs)
                        throw L();
                    $ = ((cb, db, eb) => {
                        const fb = (0, q.getAudioNodeConnections)(cb),
                            gb = [];
    ...
    var e = b('.....'),
        f = b('.....');
    const _g = (h, i, j) => {
        const k = (0, e.getValueForKey)(h, i),
            l = (0, f.pickElementFromSet)(k, m => m[0] === j);
    ...
    const _e = (f, g) => new Promise(h => {
        if (null !== g)
            ...
            const i = f.createScriptProcessor(256, 1, 1),
                j = f.createGain(),
                k = f.createBuffer(1, 2, 44100),
    ...
    const _f = g => {
        ...
        g.connect = (i = g.connect.bind(g), (k, l = 0, m = 0) => {
            const n = (0, e.isNativeAudioNode)(k) ? i(k, l, m) : i(k, l),
                o = h.get(k);
    ...
    const _f = (g, h, i, j, k, l, m, n, o, p, q, r, s) => (t, u, v, w = null, x = null) => {
        const y = new(0, e.AutomationEventList)(v.defaultValue),
            z = u ? j(y) : null,
            A = {
                get defaultValue() {
                ...
                setValueCurveAtTime(B, C, D) {
                    ...
                    if (null !== r && 'webkitAudioContext' === r.name) {
                        const F = C + D,
                            G = t.context.sampleRate,
                            H = Math.ceil(C * G),
                            I = Math.floor(F * G),
                            J = I - H,
                            K = new Float32Array(J);
                        for (let L = 0; L < J; L += 1) {
                            const M = (E.length - 1) / D * ((H + L) / G - C),
                                N = Math.floor(M),
                                O = Math.ceil(M);
    ...
    const g = {
        ...
        _h = (i, j, k, l, m, n, o, p, q, r, s, t, u, v) => class extends j {
            ...
            constructor(w, x, y) {
                ...
                u(C);
                const D = e.NODE_NAME_TO_PROCESSOR_CONSTRUCTOR_MAPS.get(A),
                    E = null == D ? void 0 : D.get(x),
                    F = B || 'closed' !== A.state ? A : null !== (z = o(A)) && void 0 !== z ? z : A,
                    G = m(F, B ? null : w.baseLatency, r, x, E, C);
    ...
    const _k = (l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A) => (B, C, D) => {
        ...
        const G = async (H, I) => {
            let J = v(H),
                K = null;
            const L = (0, j.isOwnedByContext)(J, I),
                M = Array.isArray(C.outputChannelCount) ? C.outputChannelCount : Array.from(C.outputChannelCount);
            if (null === w) {
                const N = M.reduce((O, P) => O + P, 0),
                    O = p(I, {
            ...
            if (E.set(I, null === K ? J : K[2]), null !== K) {
                if (null === F) {
                    ...
                    if (null === x)
                        throw new Error('Missing the native OfflineAudioContext constructor.');
                    const R = H.channelCount * H.numberOfInputs,
                        S = void 0 === D.parameterDescriptors ? 0 : D.parameterDescriptors.length,
                        T = R + S,
                        U = async () => {
                            const V = new x(T, 128 * Math.ceil(H.context.length / 128), I.sampleRate),
                                W = [],
                                X = [];
                    ...
                    F = (async (V, W, X, Y, Z, $, ab) => {
                        const bb = null === W ? 128 * Math.ceil(V.context.length / 128) : W.length,
                            cb = Y.channelCount * Y.numberOfInputs,
                            db = Z.reduce((eb, fb) => eb + fb, 0),
                            eb = 0 === db ? null : X.createBuffer(db, bb, X.sampleRate);
                        if (void 0 === $)
                            throw new Error('Missing the processor constructor.');
                        const fb = (0, h.getAudioNodeConnections)(V),
                            gb = await (0, i.getAudioWorkletProcessor)(X, V),
                            hb = (0, g.createNestedArrays)(Y.numberOfInputs, Y.channelCount),
                            ib = (0, g.createNestedArrays)(Y.numberOfOutputs, Z),
                            jb = Array.from(V.parameters.keys()).reduce((kb, lb) => ({
                                ...kb,
                        ...
                        for (let kb = 0; kb < bb; kb += 128) {
                            ...
                            void 0 !== $.parameterDescriptors && null !== W && $.parameterDescriptors.forEach(({
                                name: lb
                            }, mb) => {
                            ...
                            try {
                                const nb = hb.map((ob, pb) => 0 === fb.activeInputs[pb].size ? [] : ob),
                                    ob = ab(kb / X.sampleRate, X.sampleRate, () => gb.process(lb, ib, jb));
                                if (null !== eb)
    ...
    var e = b('.....'),
        ...
        g = b('.....');
    const _h = (i, j) => {
        const k = (0, g.getValueForKey)(e.NODE_TO_PROCESSOR_MAPS, i),
            l = (0, f.getNativeAudioNode)(j);
    ...
    const _e = (f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y) => class extends t {
        ...
        constructor(z, A) {
            super(z, A), this._nativeContext = z, this._audioWorklet = void 0 === f ? void 0 : {
                addModule: (B, C) => f(this, B, C)
            };
        }
    };
}), b.register('.....', function(c, d) {
    ...
    const _g = (h, i, j, k, l, m, n, o, p, q, r) => (s, t) => {
        ...
        return i(p, () => p(u)) ? u.decodeAudioData(t).then(w => ((0, e.detachArrayBuffer)(t).catch(() => {}), i(o, () => o(w)) || r(w), v.add(w), w)) : new Promise((w, x) => {
            const y = async () => {
                try {
    ...
    const _e = f => g => new Promise((h, i) => {
        ...
        if (null === j)
            ...
            const k = f.document.createElement('script'),
                l = new Blob([g], {
            ...
            if (void 0 === s.createIIRFilter ? t = h(s, {
                ...
                if (null === p) {
                    ...
                    p = (async () => {
                        ...
                        return ((x, y, z, A) => {
                            const B = z instanceof Float64Array ? z : new Float64Array(z),
                                C = A instanceof Float64Array ? A : new Float64Array(A),
                                D = B.length,
                                E = C.length,
                                F = Math.min(D, E);
                            if (1 !== B[0]) {
                            ...
                            const G = new Float32Array(32),
                                ...
                                I = y.createBuffer(x.numberOfChannels, x.length, x.sampleRate),
                                J = x.numberOfChannels;
                            for (let K = 0; K < J; K += 1) {
                                const L = x.getChannelData(K),
                                    M = I.getChannelData(K);
    ...
    const _e = (f, g) => (h, i, j) => {
        ...
        j && 'explicit' !== k.channelCountMode && (k.channelCountMode = 'explicit'), 0 === k.maxChannelCount && Object.defineProperty(k, 'maxChannelCount', {
            value: i
        });
        const l = f(h, {
            channelCount: i,
                        ...
                        if ('processorerror' === g[0]) {
                            ...
                            if (null !== u) {
                                ...
                                void 0 !== v ? g[1] = v : (g[1] = w => {
                                    'error' === w.type ? (Object.defineProperties(w, {
                                        type: {
                                            value: 'processorerror'
                                        }
                                    }), u(w)) : u(new ErrorEvent(g[0], {
                                        ...w
                                    }));
                                }, s.set(u, g[1]));
                            }
    ...
    const _l = (m, n, o, p, q, r, s, t, u, v, w, x, y) => (z, A, B, C) => {
        ...
        if ('explicit' !== C.channelCountMode)
            throw u();
        const E = C.channelCount * C.numberOfInputs,
            F = D.reduce((G, H) => G + H, 0),
            G = void 0 === B.parameterDescriptors ? 0 : B.parameterDescriptors.length;
        if (E + G > 6 || F > 6)
            throw u();
        ...
        if (void 0 !== B.parameterDescriptors)
            for (const {
                ...
                Object.defineProperties(Q.offset, {
                    ...
                    maxValue: {
                        get: () => void 0 === N ? e.MOST_POSITIVE_SINGLE_FLOAT : N
                    },
                    minValue: {
                        get: () => void 0 === O ? e.MOST_NEGATIVE_SINGLE_FLOAT : O
                    }
                }), L.push(Q);
            }
        const R = P(z, {
            ...
            S = (0, Q.computeBufferSize)(A, z.sampleRate),
            T = t(z, S, E + G, Math.max(1, F)),
            U = q(z, {
        ...
        const Y = new(0, k.ReadOnlyMap)(void 0 === B.parameterDescriptors ? [] : B.parameterDescriptors.map(({
            name: Z
        }, $) => {
            const ab = L[$];
        ...
        R.connect(T);
        let Z = C.channelInterpretation,
            $ = null;
        const ab = 0 === C.numberOfOutputs ? [T] : V,
            bb = {
                get bufferSize() {
                    return S;
                },
        ...
        const hb = (0, j.createNestedArrays)(C.numberOfInputs, C.channelCount),
            ib = (0, j.createNestedArrays)(C.numberOfOutputs, D),
            jb = void 0 === B.parameterDescriptors ? [] : B.parameterDescriptors.reduce((kb, {
                name: lb
            }) => ({
                ...kb,
                [lb]: new Float32Array(128)
        ...
        T.onaudioprocess = ({
            ...
            if (null !== gb) {
                ...
                for (let qb = 0; qb < S; qb += 128) {
                    ...
                    void 0 !== B.parameterDescriptors && B.parameterDescriptors.forEach(({
                        name: tb
                    }, ub) => {
        ...
        const ob = s(z, {
            ...
            pb = () => T.connect(ob).connect(z.destination),
            _qb = () => {
    ...
    const _f = (g, h, i, j) => (k, {
        ...
        const n = k.createBuffer(1, 2, 44100),
            o = h(k, {
                buffer: null,
                channelCount: 2,
                channelCountMode: 'max',
    ...
    const _m = (n, o, p, q) => (r, s, {
        ...
        const y = (0, p.computeBufferSize)(s, r.sampleRate),
            z = w instanceof Float64Array ? w : new Float64Array(w),
            A = x instanceof Float64Array ? x : new Float64Array(x),
            B = z.length,
            C = A.length,
            D = Math.min(B, C);
        if (0 === B || B > 20)
        ...
        for (let I = 0; I < t; I += 1) {
            F.push(0);
            const J = new Float32Array(32),
                K = new Float32Array(32);
            I.fill(0), K.fill(0), G.push(I), H.push(K);
        }
        E.onaudioprocess = L => {
            const M = L.inputBuffer,
                N = L.outputBuffer,
                O = M.numberOfChannels;
            for (let P = 0; P < O; P += 1) {
                const Q = M.getChannelData(P),
                    R = N.getChannelData(P);
                F[P] = (0, f.filterBuffer)(z, B, A, C, D, G[P], H[P], F[P], 32, Q, R);
            }
        };
        const L = r.sampleRate / 2,
            M = {
                get bufferSize() {
                    return y;
                },
    ...
    const _f = (g, h) => {
        ...
        return (0, e.assignNativeAudioNodeOptions)(i, h), 1 === i.numberOfOutputs && Object.defineProperty(i, 'numberOfOutputs', {
            get: () => 0
        }), i;
    };
}), b.register('.....', function(c, d) {
    ...
    const _e = (f, {
        ...
        const i = h.slice(0, 1),
            j = f.createMediaStreamSource(new MediaStream(i));
        return Object.defineProperty(j, 'mediaStream', {
            value: g
        }), j;
    };
}), b.register('.....', function(c, d) {
    ...
    const _e = (f, g) => (h, {
        ...
        const j = new MediaStream([i]),
            k = h.createMediaStreamSource(j);
        if ('audio' !== i.kind)
            throw f();
        if (g(h))
            throw new TypeError();
    ...
    const _e = f => (g, {
        ...
        const k = i instanceof Float32Array ? i : new Float32Array(i),
            l = j instanceof Float32Array ? j : new Float32Array(j),
            m = g.createPeriodicWave(l, k, {
                disableNormalization: h
            });
    ...
    const _f = (g, h, i, j, k, l) => {
        ...
        return (s, {
            ...
            Object.defineProperty(z.gain, 'defaultValue', {
                get: () => 0
            }), Object.defineProperty(z.gain, 'maxValue', {
                get: () => 1
            }), Object.defineProperty(z.gain, 'minValue', {
                get: () => -1
            });
            const C = {
                get bufferSize() {},
    ...
    const _g = (h, i, j, k, l, m, n) => (o, p) => {
        ...
        if (null !== r && r.length < 2)
            throw i();
        (0, e.assignNativeAudioNodeOption)(q, {
            curve: r
        }, 'curve'), (0, e.assignNativeAudioNodeOption)(q, p, 'oversample');
        let s = null,
            t = !1;
    ...
    const _g = (h, i, j, k, l) => (m, {
        ...
        const q = m.createWaveShaper(),
            r = m.createWaveShaper();
        ...
        const z = {
            ...
            set curve(A) {
                ...
                if (null === A)
                    ...
                    const B = A.length,
                        C = new Float32Array(B + 2 - B % 2),
                        D = new Float32Array(B + 2 - B % 2);
                    C[0] = A[0], D[0] = -A[B - 1];
                    const E = Math.ceil((B + 1) / 2),
                        F = (B + 1) / 2 - 1;
                    for (let G = 1; G < E; G += 1) {
                        const H = G / E * F,
                            I = Math.floor(H),
                ...
                return void 0 !== v ? Promise.resolve(v) : (async (w, x) => {
                    ...
                    if (r.set(x, null === y ? z : y), null !== y) {
                        if (null === s) {
                            if (null === n)
                                throw new Error('Missing the native OfflineAudioContext constructor.');
                            const E = new n(6, w.context.length, x.sampleRate),
                                F = i(E, {
                                    channelCount: 1,
                                    channelCountMode: 'explicit',
                                    channelInterpretation: 'speakers',
    ...
    const _e = (f, g, h) => async (i, j, k) => {
        ...
        await Promise.all(l.activeInputs.map((m, n) => Array.from(m).map(async ([o, p]) => {
            const q = g(o),
                r = await q.render(o, j),
                s = i.context.destination;
    ...
    const _e = f => () => {
        if (null === f)
            return !1;
        const g = new f(1, 1, 44100).createGain(),
            h = g.connect(g) === g;
    ...
    const _e = (f, g) => async () => {
        ...
        if (null === g)
            return !1;
        const h = new Blob(['let c,p;class A extends AudioWorkletProcessor{constructor(){super();this.port.onmessage=(e)=>{p=e.data;p.onmessage=()=>{p.postMessage(c);p.close()};this.port.postMessage(0)}}process(){c=1}}registerProcessor("a",A)'], {
                type: 'application/javascript; charset=utf-8'
            }),
    ...
    const _e = (f, g) => async () => {
        ...
        if (null === g)
            return !1;
        const h = new Blob(['class A extends AudioWorkletProcessor{process(i){this.port.postMessage(i,[i[0][0].buffer])}}registerProcessor("a",A)'], {
                type: 'application/javascript; charset=utf-8'
            }),
            i = new g(1, 128, 44100),
            j = URL.createObjectURL(h);
        let k = !1,
            l = !1;
        try {
    ...
    const _e = f => () => {
        ...
        if (void 0 === g.createConstantSource)
            return Promise.resolve(!0);
        const h = g.createConstantSource(),
            i = g.createStereoPanner();
    ...
    const _e = f => ({
        ...f,
        outputChannelCount: void 0 !== f.outputChannelCount ? f.outputChannelCount : 1 === f.numberOfInputs && 1 === f.numberOfOutputs ? [f.channelCount] : Array.from({
            length: f.numberOfOutputs
        }, () => 1)
    });
}), b.register('.....', function(c, d) {
    ...
    const _e = f => {
        const g = f.createBuffer(1, 1, 44100),
            h = f.createBufferSource();
    ...
    const _e = f => {
        ...
        f.start = (g = f.start, (h = 0, i = 0, j) => {
            const k = f.buffer,
                l = null === k ? i : Math.min(k.duration, i);
...
b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    ...
    const _h = (i, j, k, l, m) => (n, o, p, q) => {
        const r = p.getAudioTracks(),
            s = [],
            t = 0 === r.length ? void 0 : r[0].getSettings().channelCount,
            u = new o(p, {
                mimeType: 'audio/webm;codecs=pcm'
            }),
            v = 0 === r.length ? void 0 : r[0].getSettings().sampleRate;
        let w = null,
            x = () => {};
        const y = z => {
                n.dispatchEvent(i('dataavailable', {
                    data: new Blob(z, {
                        type: q
                    })
                }));
            ...
            z = async (A, B) => {
                ...
                'inactive' !== u.state && (null !== w && (w.catch(() => {}), w = null), x(), x = () => {}, u.stop());
            };
        return u.addEventListener('error', () => {
            A(), n.dispatchEvent(new ErrorEvent('error', {
                error: j()
            }));
            ...
            start(B) {
                ...
                if ('inactive' === u.state) {
                    ...
                    let C = !1,
                        D = !1,
                        E = 0,
                        F = (0, e.instantiate)(q, v);
                    x = () => {
                        D = !0;
                    };
                    const G = (0, g.on)(u, 'dataavailable')(({
                        data: H
                    }) => {
                        E += 1, F = F.then(async ({
                            dataView: I = null,
                            ...
                            return S.forEach(U => L.postMessage(U, U.map(({
                                buffer: V
                            }) => V))), 0 !== E || 'inactive' !== u.state && !P || ((0, e.encode)(K, null).then(U => {
                                y([
                                    ...s,
                                    ...U
    ...
    c.exports,
        function(e, f, g, h) {
            ...
            var y = function() {
                ...
                return F.default(z, [{
                    ...
                    },
                    {
                        key: 'getInt8',
                        value: function(N) {
                            var O = this._findDataViewWithOffset(N),
                                P = E.default(O, 2),
                                Q = P[0],
                                R = P[1];
                    ...
                    },
                    {
                        key: 'setInt8',
                        value: function(N, O) {
                            var P = this._findDataViewWithOffset(N),
                                Q = E.default(P, 2),
                                R = Q[0],
                                S = Q[1];
                            R.setInt8(N - S, O);
            ...
            e.MultiBufferDataView = y, Object.defineProperty(e, '__esModule', {
                value: !0
            });
        }(c.exports, b('.....'), b('.....'), b('.....'));
}), b.register('.....', function(c, d) {
    ...
    b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....'), b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    ...
    b('.....'), b('.....'), b('.....');
}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {}), b.register('.....', function(c, d) {
    a(c.exports, 'worker', function() {
        return _e;
    });
    ...
    var _o = p => {
        const q = f.useRef(),
            [r, s] = f.useState(p.latex);
        return f.useEffect(() => {
            const t = new(0, g.MathfieldElement)({
            ...
            children: [
                ...
                (null == r ? void 0 : r.length) ? null : (0, e.jsx)(_r, {
                    children: 'Enter math...'
                })
            ]
        });
...
`), j.Fonts.SFPro);
    ...
    const p = (0, b('.....').observer)(q => {
            const r = q.question.type === l.QuestionType.multipleChoice,
                s = q.question.type === l.QuestionType.textInput;
            return (0, e.jsxs)(e.Fragment, {
                children: [
                    (0, e.jsx)(_q, {
                        children: (0, m.plural)('Answer', q.question.answers.length)
                    }),
...
`), i.default.Black, j.Fonts.SFPro, j.FontWeights.UltraBold);
    ...
    const A = B => {
        ...
        return B.correct ? (0, e.jsx)(n.default, {
            ...C
        }) : (0, e.jsx)(o.default, {
            ...C
        });

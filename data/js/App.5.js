...
c.register('.....', function(d, e) {
    ...
    var _n = h.forwardRef((o, p) => {
        const {
            ...
            E(I => Object.assign(Object.assign({}, I), {
                [G]: H
            }));
        }, G = (H, I) => H || (I ? 'rtl' === B ? 'left' : 'right' : 'top'), H = A('slider', q), [I, J] = (0, k.default)(H), K = a(f)(s, t, {
            [`${ H }-rtl`]: 'rtl' === B
        }, J);
        ...
        return I(h.createElement(g.default, Object.assign({}, z, {
            ...
            handleRender: (N, O) => {
                ...
                const ab = !!$ && (D[Q] || R),
                    bb = null !== (P = null != V ? V : w) && void 0 !== P ? P : void 0 === V && ab,
                    cb = Object.assign(Object.assign({}, N.props), {
                        onMouseEnter: () => F(Q, !0),
                        onMouseLeave: () => F(Q, !1)
                    }),
                ...
                var T = i(Q),
                    ...
                    W = function(X) {
                        ...
                        var Y, Z = i(X),
                            ...
                            bb = $ - U,
                            cb = ab - V,
                            db = l.current.getBoundingClientRect(),
                            eb = db.width,
                            fb = db.height;
                        switch (m) {
                            case 'btt':
    ...
    function _l(m) {
        var n = m.prefixCls,
            ...
            y = s.included,
            z = ''.concat(n, '-text'),
            A = (0, j.getDirectionStyle)(v, _l, t, u);
    ...
    var _j = h.forwardRef((k, l) => {
        const {
            open: m
        } = k, n = (0, h.useRef)(null), o = (0, h.useRef)(null);
    ...
    const j = k => {
            ...
            return {
                [l]: Object.assign(Object.assign({}, (0, g.resetComponent)(k)), {
                    ...
                    '&:hover': {
                        [`${ l }-rail`]: {
                            backgroundColor: k.colorFillSecondary
                        },
                        [`${ l }-track`]: {
                            backgroundColor: k.colorPrimaryBorderHover
                        },
                        [`${ l }-dot`]: {
                            borderColor: q
                        },
                        [`${ l }-handle::after`]: {
                            boxShadow: `0 0 0 ${ k.handleLineWidth }px ${ k.colorPrimaryBorderHover }`
                        },
                        [`${ l }-dot-active`]: {
                    ...
                    [`${ l }-dot`]: {
                        ...
                        '&-active': {
                            borderColor: k.colorPrimaryBorder
                        }
                    },
                    [`&${ l }-disabled`]: {
                        cursor: 'not-allowed',
                        [`${ l }-rail`]: {
                            backgroundColor: `${ k.colorFillSecondary } !important`
                        },
                        [`${ l }-track`]: {
                            backgroundColor: `${ k.colorTextDisabled } !important`
                        },
                        [`\n          ${ l }-dot\n        `]: {
                            backgroundColor: k.colorBgElevated,
        ...
        l = m => {
            ...
            return {
                [`${ n }-horizontal`]: Object.assign(Object.assign({}, k(m, !0)), {
                    [`&${ n }-with-marks`]: {
                        marginBottom: o
                    }
                })
        ...
        m = n => {
            ...
            return {
                [`${ o }-vertical`]: Object.assign(Object.assign({}, k(n, !1)), {
                    height: '100%'
                })
            };
        };

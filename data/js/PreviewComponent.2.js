    ...
    d = b.exports, e = 'Howl', f = function() {
        ...
        function() {
            ...
            i.prototype = {
                ...
                volume: function(j) {
                    var k = this || c;
                    if (j = parseFloat(j), k.ctx || _s(), void 0 !== j && j >= 0 && j <= 1) {
                ...
                mute: function(j) {
                    var k = this || c;
                    k.ctx || _s(), k._muted = j, k.usingWebAudio && k.masterGain.gain.setValueAtTime(j ? 0 : k._volume, c.ctx.currentTime);
                    for (var l = 0; l < k._howls.length; l++)
                        if (!k._howls[l]._webAudio)
                            for (var m = k._howls[l]._getSoundIds(), n = 0; n < m.length; n++) {
                                var o = k._howls[l]._soundById(m[n]);
                ...
                unload: function() {
                    for (var j = this || c, k = j._howls.length - 1; k >= 0; k--)
                        j._howls[k].unload();
                    return j.usingWebAudio && j.ctx && void 0 !== j.ctx.close && (j.ctx.close(), j.ctx = null, _s()), j;
                },
                codecs: function(j) {
                ...
                _setupCodecs: function() {
                    ...
                    if (!k || 'function' != typeof k.canPlayType)
                        return j;
                    var l = k.canPlayType('audio/mpeg;').replace(/^no$/, ''),
                        m = j._navigator ? j._navigator.userAgent : '',
                        n = m.match(/OPR\/([0-6].)/g),
                        o = n && parseInt(n[0].split('/')[1], 10) < 33,
                        p = -1 !== m.indexOf('Safari') && -1 === m.indexOf('Chrome'),
                        q = m.match(/Version\/(.*?) /),
                        r = p && q && parseInt(q[1], 10) < 15;
                    return j._codecs = {
                ...
                _unlockAudio: function() {
                    ...
                    if (!j._audioUnlocked && j.ctx) {
                        ...
                        var k = function(l) {
                            ...
                            for (var m = 0; m < j._howls.length; m++)
                                if (!j._howls[m]._webAudio)
                                    for (var n = j._howls[m]._getSoundIds(), o = 0; o < n.length; o++) {
                                        var p = j._howls[m]._soundById(n[o]);
                                        p && p._node && !p._node._unlocked && (p._node._unlocked = !0, p._node.load());
                                    }
                            j._autoResume();
                            var n = j.ctx.createBufferSource();
                            n.buffer = j._scratchBuffer, n.connect(j.ctx.destination), void 0 === n.start ? n.noteOn(0) : n.start(0), 'function' == typeof j.ctx.resume && j.ctx.resume(), n.onended = function() {
                                n.disconnect(0), j._audioUnlocked = !0, document.removeEventListener('touchstart', k, !0), document.removeEventListener('touchend', k, !0), document.removeEventListener('click', k, !0), document.removeEventListener('keydown', k, !0);
                                for (var o = 0; o < j._howls.length; o++)
                                    j._howls[o]._emit('unlock');
                            };
                        };
            ...
            k.prototype = {
                init: function(l) {
                    ...
                    return j.ctx || _s(), m._autoplay = l.autoplay || !1, m._format = 'string' != typeof l.format ? l.format : [l.format], m._html5 = l.html5 || !1, m._muted = l.mute || !1, m._loop = l.loop || !1, m._pool = l.pool || 5, m._preload = 'boolean' != typeof l.preload && 'metadata' !== l.preload || l.preload, m._rate = l.rate || 1, m._sprite = l.sprite || {}, m._src = 'string' != typeof l.src ? l.src : [l.src], m._volume = void 0 !== l.volume ? l.volume : 1, m._xhr = {
                    ...
                    }, m._duration = 0, m._state = 'unloaded', m._sounds = [], m._endTimers = {}, m._queue = [], m._playLock = !1, m._onend = l.onend ? [{
                        fn: l.onend
                    }] : [], m._onfade = l.onfade ? [{
                        fn: l.onfade
                    }] : [], m._onload = l.onload ? [{
                        fn: l.onload
                    }] : [], m._onloaderror = l.onloaderror ? [{
                        fn: l.onloaderror
                    }] : [], m._onplayerror = l.onplayerror ? [{
                        fn: l.onplayerror
                    }] : [], m._onpause = l.onpause ? [{
                        fn: l.onpause
                    }] : [], m._onplay = l.onplay ? [{
                        fn: l.onplay
                    }] : [], m._onstop = l.onstop ? [{
                        ...
                        fn: l.onmute
                    }] : [], m._onvolume = l.onvolume ? [{
                        fn: l.onvolume
                    }] : [], m._onrate = l.onrate ? [{
                        fn: l.onrate
                    }] : [], m._onseek = l.onseek ? [{
                        fn: l.onseek
                    }] : [], m._onunlock = l.onunlock ? [{
                        fn: l.onunlock
                    }] : [], m._onresume = [], m._webAudio = j.usingWebAudio && !m._html5, void 0 !== j.ctx && j.ctx && j.autoUnlock && j._unlockAudio(), j._howls.push(m), m._autoplay && m._queue.push({
                        event: 'play',
                        action: function() {
                            m.play();
                        }
                ...
                play: function(l, m) {
                    ...
                    var p = o ? n._soundById(o) : n._inactiveSound();
                    if (!p)
                        return null;
                    if (o && !l && (l = p._sprite || '__default'), 'loaded' !== n._state) {
                        p._sprite = l, p._ended = !1;
                        var q = p._id;
                    ...
                    if (o && !p._paused)
                        return m || n._loadQueue('play'), p._id;
                    n._webAudio && j._autoResume();
                    var q = Math.max(0, p._seek > 0 ? p._seek : n._sprite[l][0] / 1000),
                        r = Math.max(0, (n._sprite[l][0] + n._sprite[l][1]) / 1000 - q),
                        _s = 1000 * r / Math.abs(p._rate),
                        t = n._sprite[l][0] / 1000,
                        u = (n._sprite[l][0] + n._sprite[l][1]) / 1000;
                    p._sprite = l, p._ended = !1;
                    var v = function() {
                        p._paused = !1, p._seek = q, p._start = t, p._stop = u, p._loop = !(!p._loop && !n._sprite[l][2]);
                    };
                    if (!(q >= u)) {
                        var w = p._node;
                        if (n._webAudio) {
                            var x = function() {
                                n._playLock = !1, v(), n._refreshBuffer(p);
                                var y = p._muted || n._muted ? 0 : p._volume;
                                w.gain.setValueAtTime(y, j.ctx.currentTime), p._playStart = j.ctx.currentTime, void 0 === w.bufferSource.start ? p._loop ? w.bufferSource.noteGrainOn(0, q, 86400) : w.bufferSource.noteGrainOn(0, q, r) : p._loop ? w.bufferSource.start(0, q, 86400) : w.bufferSource.start(0, q, r), _s !== 1 / 0 && (n._endTimers[p._id] = setTimeout(n._ended.bind(n, p), _s)), m || setTimeout(function() {
                                    n._emit('play', p._id), n._loadQueue();
                                }, 0);
                            };
                            'running' === j.state && 'interrupted' !== j.ctx.state ? x() : (n._playLock = !0, n.once('resume', x), n._clearTimer(p._id));
                        } else {
                            var x = function() {
                                w.currentTime = q, w.muted = p._muted || n._muted || j._muted || w.muted, w.volume = p._volume * j.volume(), w.playbackRate = p._rate;
                                try {
                                    var y = w.play();
                                    if (y && 'undefined' != typeof Promise && (y instanceof Promise || 'function' == typeof y.then) ? (n._playLock = !0, v(), y.then(function() {
                                            n._playLock = !1, w._unlocked = !0, m ? n._loadQueue() : n._emit('play', p._id);
                                        }).catch(function() {
                                            n._playLock = !1, n._emit('playerror', p._id, 'Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.'), p._ended = !0, p._paused = !0;
                                        })) : m || (n._playLock = !1, v(), n._emit('play', p._id)), w.playbackRate = p._rate, w.paused)
                                        return void n._emit('playerror', p._id, 'Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.');
                                    '__default' !== l || p._loop ? n._endTimers[p._id] = setTimeout(n._ended.bind(n, p), _s) : (n._endTimers[p._id] = function() {
                                        n._ended(p), w.removeEventListener('ended', n._endTimers[p._id], !1);
                                    }, w.addEventListener('ended', n._endTimers[p._id], !1));
                                } catch (l) {
                                    n._emit('playerror', p._id, l);
                                }
                            };
                            'data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA' === w.src && (w.src = n._src, w.load());
                            var y = window && window.ejecta || !w.readyState && j._navigator.isCocoonJS;
                            if (w.readyState >= 3 || y)
                                x();
                            else {
                                n._playLock = !0, n._state = 'loading';
                                var z = function() {
                                    n._state = 'loaded', x(), w.removeEventListener(j._canPlayEvent, z, !1);
                                };
                                w.addEventListener(j._canPlayEvent, z, !1), n._clearTimer(p._id);
                            }
                        }
                        return p._id;
                    }
                ...
                volume: function() {
                    ...
                    for (var q = 0; q < m.length; q++)
                        (n = o._soundById(m[q])) && (n._volume = l, p[2] || o._stopFade(m[q]), o._webAudio && n._node && !n._muted ? n._node.gain.setValueAtTime(l, j.ctx.currentTime) : n._node && !n._muted && (n._node.volume = l * j.volume()), o._emit('volume', n._id));
                    return o;
                },
                ...
                rate: function() {
                    ...
                    for (var q = 0; q < m.length; q++)
                        if (n = o._soundById(m[q])) {
                            o.playing(m[q]) && (n._rateSeek = o.seek(m[q]), n._playStart = o._webAudio ? j.ctx.currentTime : n._playStart), n._rate = l, o._webAudio && n._node && n._node.bufferSource ? n._node.bufferSource.playbackRate.setValueAtTime(l, j.ctx.currentTime) : n._node && (n._node.playbackRate = l);
                            var r = o.seek(m[q]),
                                s = (o._sprite[n._sprite][0] + o._sprite[n._sprite][1]) / 1000 - r,
                                t = 1000 * s / Math.abs(n._rate);
                            !o._endTimers[m[q]] && n._paused || (o._clearTimer(m[q]), o._endTimers[m[q]] = setTimeout(o._ended.bind(o, n), t)), o._emit('rate', n._id);
                        }
                    return o;
                },
                seek: function() {
                    ...
                    var p = n._soundById(m);
                    if (p) {
                        if (!('number' == typeof l && l >= 0)) {
                            if (n._webAudio) {
                                var q = n.playing(m) ? j.ctx.currentTime - p._playStart : 0,
                                    r = p._rateSeek ? p._rateSeek - p._seek : 0;
                                return p._seek + (r + q * Math.abs(p._rate));
                            }
                            return p._node.currentTime;
                        }
                        var q = n.playing(m);
                        q && n.pause(m, !0), p._seek = l, p._ended = !1, n._clearTimer(m), n._webAudio || !p._node || isNaN(p._node.duration) || (p._node.currentTime = l);
                        var r = function() {
                            q && n.play(m, !0), n._emit('seek', m);
                        };
                        if (q && !n._webAudio) {
                            var s = function() {
                                n._playLock ? setTimeout(s, 0) : r();
                            };
                            setTimeout(s, 0);
                        } else
                            r();
                ...
                playing: function(l) {
                    ...
                    for (var n = 0; n < m._sounds.length; n++)
                        if (!m._sounds[n]._paused)
                            return !0;
                    return !1;
                },
                duration: function(l) {
                ...
                off: function(l, m, n) {
                    ...
                    if ('number' == typeof m && (n = m, m = null), m || n)
                        ...
                        for (q = 0; q < r.length; q++)
                            0 === r[q].indexOf('_on') && Array.isArray(o[r[q]]) && (o[r[q]] = []);
                    }
                    return o;
                },
                once: function(l, m, n) {
            ...
            l.prototype = {
                ...
                create: function() {
                    var m = this,
                        n = m._parent,
                        o = j._muted || m._muted || m._parent._muted ? 0 : m._volume;
            ...
            var m = {},
                n = function(o) {
                    ...
                    if (/^data:[^;]+;base64,/.test(p)) {
                        ...
                        q.open(o._xhr.method, p, !0), q.withCredentials = o._xhr.withCredentials, q.responseType = 'arraybuffer', o._xhr.headers && Object.keys(o._xhr.headers).forEach(function(r) {
                            q.setRequestHeader(r, o._xhr.headers[r]);
                        }), q.onload = function() {
                            var r = (q.status + '')[0];
                            '0' === r || '2' === r || '3' === r ? _p(q.response, o) : o._emit('loaderror', null, 'Failed loading audio file with status: ' + q.status + '.');
                        }, q.onerror = function() {
                ...
                r = function() {
                    if (j.usingWebAudio) {
                        ...
                        var s = /iP(hone|od|ad)/.test(j._navigator && j._navigator.platform),
                            t = j._navigator && j._navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/),
                            u = t ? parseInt(t[1], 10) : null;
                        if (s && u && u < 9) {
        ...
        function() {
            ...
            HowlerGlobal.prototype._pos = [
                ...
                }, k._onstereo = j.onstereo ? [{
                    fn: j.onstereo
                }] : [], k._onpos = j.onpos ? [{
                    fn: j.onpos
                }] : [], k._onorientation = j.onorientation ? [{
                    fn: j.onorientation
                }] : [], i.call(this, j);

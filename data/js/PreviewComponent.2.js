        ...
        function() {
            ...
            k.prototype = {
                ...
                play: function(l, m) {
                    ...
                    var t = Math.max(0, r._seek > 0 ? r._seek : n._sprite[l][0] / 1000),
                        u = Math.max(0, (n._sprite[l][0] + n._sprite[l][1]) / 1000 - t),
                        v = 1000 * u / Math.abs(r._rate),
                        w = n._sprite[l][0] / 1000,
                        x = (n._sprite[l][0] + n._sprite[l][1]) / 1000;
                    r._sprite = l, r._ended = !1;
                    var y = function() {
                ...
                rate: function() {
                    ...
                    for (var s = 0; s < m.length; s++)
                        if (n = o._soundById(m[s])) {
                            ...
                            var t = o.seek(m[s]),
                                u = (o._sprite[n._sprite][0] + o._sprite[n._sprite][1]) / 1000 - t,
                                v = 1000 * u / Math.abs(n._rate);
                ...
                seek: function() {
                    ...
                    if (r) {
                        if (!('number' == typeof l && l >= 0)) {
                            if (n._webAudio) {
                                var s = n.playing(m) ? j.ctx.currentTime - r._playStart : 0,
                                    t = r._rateSeek ? r._rateSeek - r._seek : 0;

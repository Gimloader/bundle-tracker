...
c.register('.....', function(d, e) {
    ...
    var _I = (0, j.observer)(J => {
        ...
        const S = h.useMemo(() => K === s.OptionsMenuScreen.mapOptions, [K]),
            T = h.useMemo(() => K === s.OptionsMenuScreen.editing, [K]),
            U = h.useMemo(() => K === s.OptionsMenuScreen.permissions, [K]),
            V = h.useMemo(() => K === s.OptionsMenuScreen.saving, [K]),
            W = h.useMemo(() => K === s.OptionsMenuScreen.help, [K]),
            X = h.useMemo(() => K === s.OptionsMenuScreen.publishing, [K]),
            Y = () => {
            ...
            children: [
                (0, f.jsxs)('div', {
                    children: [
                        ...
                        G.description ? (0, f.jsx)(k.default.Text, {
...
`));
    ...
    var f = c('.....'),
        ...
        l = c('.....');
    var _m = n => {
        const o = (0, h.default)().worldManager.devices.allDevices.find(p => p.deviceOption.id === g.default.mapOptions),
            p = q => {

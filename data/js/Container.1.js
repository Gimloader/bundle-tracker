...
c.register('.....', function (d, e) {
    ...
    var _u = v => {
        ...
        if ((0, i.useDidMount)(() => {
                (0, h.request)({
                    url: '/api/news/fetch',
                    data: { isStudent: (0, h.isStudent)() },
                    success: J => {
                        z(J);
                        const K = null != A ? A : 0, L = J[0];
                        L && (L && L.publishDate > K && v.allowAutoOpen && H(), B(L.publishDate));
                    },
                    error: J => {
                        v.open && (0, h.throwMessageError)({
                            e: J,
                            default: { title: 'Error loading news' }
                        });
                    },
                    both: () => {
                        x(!1);
        ...
        return (0, f.jsxs)(f.Fragment, {
            children: [
                (0, f.jsx)(_v, {}),
                (0, f.jsx)(l.default, {
                    theme: { algorithm: p.default.defaultAlgorithm },
                        ...
                        children: [
                            ...
                            y.length ? 1 !== y.length && E ? (0, f.jsxs)('div', {
                                ...
                                children: (0, f.jsx)(o.default, {
                                    ...
                                    direction: 'vertical',
                                    style: { paddingBottom: 35 },
                                    split: (0, f.jsx)(m.default, { style: { margin: 0 } }),
...
`));
    ...
    function _g(h, i) {
        void 0 === i && (i = null);
        var j = (0, f.useState)(_m()), k = j[0], l = j[1];
        function _m() {
        ...
        return (0, f.useEffect)(function () {
            ...
            if ('undefined' != typeof window)
                return window.addEventListener('storage', p), function () {
    ...
    const x = b(j)(() => c('.....')), y = () => (0, f.jsx)(i.default, {
            active: !0,
            title: !1,
            paragraph: { rows: 14 },
            style: { padding: 20 }
        ...
        return (0, f.jsx)(_A, {
            children: (() => {
                ...
                const {
                    ...
                    var H, I;
                    const J = D.replace(/-/g, ''), K = Object.keys(B).find(L => L.replace(/-/g, '') === J);
                    if (!K)
                        return null;
                    const L = B[K];
                    var M;
                ...
                return (0, f.jsxs)(g.Suspense, {
                    ...
                    children: [
                        ...
                        (0, f.jsxs)(_C, {
                            children: [
                                (0, f.jsxs)(_D, {
                                    style: { marginTop: A.isFirstItem && !G ? 30 : 0 },
                                    children: [
                                        (0, f.jsx)(_E, { children: F }),
                                        (0, f.jsxs)(_F, {
                                            children: [
                                                (0, f.jsx)(p.default, {
    ...
    const _A = l.default.div.attrs({ className: 'maxWidth' })(q || (q = w``)), _B = l.default.img.attrs({ className: 'maxWidth' })(r || (r = w`
  margin-bottom: 25px;
`)), _C = l.default.div.attrs({ className: 'maxWidth' })(s || (s = w`
  padding: 0px 20px;
  font-family: ${ 0 };
`), o.Fonts.SFPro), _D = l.default.div.attrs({ className: 'maxWidth flex between vc' })(t || (t = w`
  line-height: 1;
  margin-bottom: 20px;
`)), _E = l.default.div(u || (u = w`
  font-size: 28px;
  font-weight: ${ 0 };
`), o.FontWeights.Bold), _F = l.default.div.attrs({ className: 'flex vc' })(v || (v = w`
...
`));
    ...
    const _u = g.default.div.attrs({ className: 'maxWidth flex vc between' })(o || (o = s`
  color: ${ 0 };
  padding: 20px;
  background: #730aad;
`), h.default.White), _v = g.default.div(p || (p = s``)), _w = g.default.div(q || (q = s`
  font-size: 16px;
  font-weight: ${ 0 };
`), m.FontWeights.Bold), _x = g.default.div(r || (r = s`
  font-size: 12px;
  font-style: italic;
  opacity: 0.9;
`));
    ...
    let x, y, z, A = B => B;
    var _B = C => {
        const [D, E] = g.useState(!1), {navigation: F} = g.useContext(l.default), {
                ref: G,
                height: H
        ...
        const I = g.useMemo(() => {
            ...
            }, [C.alpha]), K = g.useMemo(() => J === q.SiteHeaderAlpha.none ? 1 : J === q.SiteHeaderAlpha.darker ? I === p.SiteHeaderTheme.light ? 0.9 : 0.75 : I === p.SiteHeaderTheme.light ? 0.85 : 0.45, [
                J,
                I
        ...
        return (0, f.jsx)(f.Fragment, {
            children: (0, f.jsxs)(t.default, {
                theme: {
                    ...
                    token: { fontFamily: s.Fonts.SFPro }
                },
                children: [
                    (0, f.jsxs)(_C, {
                        ref: G,
                            ...
                            (0, f.jsx)(_D, {
                                ...
                                children: (0, f.jsx)(i.default.Provider, {
                                    ...
                                    children: (0, f.jsxs)(_E, {
                                        children: [
                                            (0, f.jsx)(w.default, { theme: C.theme }),
                                            (0, h.isLoggedIn)() ? (0, f.jsx)(v.default, {
                                                showUpgradeModal: () => E(!0),
                                                theme: I
                                            }) : (0, f.jsx)(n.default, { theme: C.theme })
                                        ]
                                    })
                                })
                            }),
    ...
    const _C = m.default.div.attrs({ className: 'maxWidth' })(x || (x = A`
  height: auto;
  position: fixed;
  top: 0;
  left: 0;
...
`), E => E.background, E => E.hideBorder ? 'rgba(255,255,255,0)' : E.borderColor), _E = m.default.div.attrs({ className: 'flex maxWidth between vc' })(z || (z = A``));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _h;
    });
    ...
    var _p = (0, g.observer)(q => {
        const r = (0, l.useMediaMatch)('(max-width: 600px)'), s = (0, l.useMediaMatch)('(max-width: 750px)'), t = [];
        return t.push({
            key: 'join',
            item: (0, f.jsx)(n.default, {
                ...
                icon: (0, f.jsx)('i', { className: 'far fa-gamepad' }),
            ...
            item: (0, f.jsx)(n.default, {
                ...
                icon: (0, f.jsx)('i', { className: 'far fa-users' }),
                theme: o.SiteHeaderTheme.light,
                fontSize: 15,
            ...
            item: (0, f.jsx)(n.default, {
                ...
                icon: (0, f.jsx)('i', { className: 'far fa-user-plus' }),
                theme: o.SiteHeaderTheme.light,
                fontSize: 15,
                children: 'Sign Up'
            })
    ...
    let q, r, s = t => t;
    var _t = u => {
        const {width: v} = (0, o.useWindowSize)(), [w, x, y] = (0, p.useBoolean)(!1), [z, A] = k.useState(!1), [B, C] = k.useState(null), D = k.useRef(), [E] = (0, n.default)(D), F = k.useRef(), [G] = (0, n.default)(F);
        return k.useEffect(() => {
            !!v && !!E && !G && (!B || v > B) && C(v);
        }, [
            v,
            ...
            children: [
                ...
                z ? (0, f.jsx)('div', {
                    ...
                    children: (0, f.jsx)(j.default, {
                        size: 10,
                        split: (0, f.jsx)(h.default, { type: 'vertical' }),
                        direction: 'horizontal',
                        children: u.items.map(H => (0, f.jsx)(k.Fragment, { children: H.item }, H.key))
                    })
                }),
                z ? (0, f.jsx)(i.default, {
                    placement: 'right',
                    ...
                    children: (0, f.jsx)(j.default, {
                        size: 2,
                        split: (0, f.jsx)(h.default, { type: 'horizontal' }),
                        direction: 'vertical',
                        className: 'maxWidth',
...
`));
    ...
    const _o = h.default.div.attrs({ className: 'flex-center' })(m || (m = (p => p)`
  line-height: 1;
...
`), p => p.color, l.Fonts.SFPro, l.FontWeights.Bold);
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = c('.....'), x = c('.....'), y = c('.....'), z = c('.....'), A = c('.....'), B = c('.....'), C = c('.....'), D = c('.....'), E = c('.....');
    let F, G, H, I = J => J;
    ...
    var _K = L => {
                    ...
                    children: (0, f.jsxs)(k.default, {
                        ...
                        children: [
                            (0, p.isStudent)() ? null : (0, f.jsxs)(_L, {
                                children: [
                                    (0, f.jsx)(_M, { children: (0, p.getFirstName)((0, p.getUser)()) }),
                                    (0, f.jsx)(_N, { children: (0, s.default)((0, p.getUser)().type) })
                                ]
                            }),
        ...
        return S.push({
            ...
            item: (0, f.jsx)(C.default, {
                ...
                icon: (0, f.jsx)(J, { src: '/client/img/header/creative.svg' }),
                theme: L.theme,
                children: 'Creative'
            })
        }), S.push({
            ...
            item: (0, f.jsx)(C.default, {
                path: n.COSMOS_BASE,
                icon: (0, f.jsx)(J, { src: D.default.iconImage }),
                theme: L.theme,
            ...
            item: (0, f.jsx)(i.default, {
                theme: { algorithm: l.default.defaultAlgorithm },
                children: (0, f.jsx)(j.default, {
                    trigger: ['click'],
                    overlay: T,
                    children: (0, f.jsx)('div', {
                        ...
                        children: (0, f.jsx)(C.default, {
                            icon: (0, f.jsx)(J, { src: '/client/img/header/smile.svg' }),
                            theme: L.theme,
                            children: 'Me'
                        })
                    })
  ...
  font-family: ${ 0 };
  color: rgba(0, 0, 0, 0.8);
`), r.Fonts.SFPro), _M = q.default.div(G || (G = I`
  font-size: 18px;
  font-weight: ${ 0 };
`), r.FontWeights.Bold), _N = q.default.div(H || (H = I`
  font-size: 12px;
`));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
    ...
    var _f = {
        icon: {
            ...
            children: [{
                    tag: 'path',
                    attrs: { d: 'M928 160H96c-17.7 0-32 14.3-32 32v640c0 17.7 14.3 32 32 32h832c17.7 0 32-14.3 32-32V192c0-17.7-14.3-32-32-32zm-792 72h752v120H136V232zm752 560H136V440h752v352zm-237-64h165c4.4 0 8-3.6 8-8v-72c0-4.4-3.6-8-8-8H651c-4.4 0-8 3.6-8 8v72c0 4.4 3.6 8 8 8z' }
                }]
        },
        name: 'credit-card',
        theme: 'outlined'
    ...
    var _f = {
        icon: {
            ...
            children: [{
                    tag: 'path',
                    attrs: { d: 'M923 283.6a260.04 260.04 0 00-56.9-82.8 264.4 264.4 0 00-84-55.5A265.34 265.34 0 00679.7 125c-49.3 0-97.4 13.5-139.2 39-10 6.1-19.5 12.8-28.5 20.1-9-7.3-18.5-14-28.5-20.1-41.8-25.5-89.9-39-139.2-39-35.5 0-69.9 6.8-102.4 20.3-31.4 13-59.7 31.7-84 55.5a258.44 258.44 0 00-56.9 82.8c-13.9 32.3-21 66.6-21 101.9 0 33.3 6.8 68 20.3 103.3 11.3 29.5 27.5 60.1 48.2 91 32.8 48.9 77.9 99.9 133.9 151.6 92.8 85.7 184.7 144.9 188.6 147.3l23.7 15.2c10.5 6.7 24 6.7 34.5 0l23.7-15.2c3.9-2.5 95.7-61.6 188.6-147.3 56-51.7 101.1-102.7 133.9-151.6 20.7-30.9 37-61.5 48.2-91 13.5-35.3 20.3-70 20.3-103.3.1-35.3-7-69.6-20.9-101.9zM512 814.8S156 586.7 156 385.5C156 283.6 240.3 201 344.3 201c73.1 0 136.5 40.8 167.7 100.4C543.2 241.8 606.6 201 679.7 201c104 0 188.3 82.6 188.3 184.5 0 201.2-356 429.3-356 429.3z' }
                }]
        },
        name: 'heart',
        theme: 'outlined'
    ...
    var _p = (0, j.observer)(q => {
        const {
                navigation: {homeUrl: r}
            } = g.useContext(k.default), s = q.theme === l.SiteHeaderTheme.dark ? '/client/img/svgLogoWhite.svg' : '/client/img/svgLogo.svg';
        return (0, f.jsx)(_q, {
            to: r,
            children: (0, f.jsx)(_r, { src: s }, s)
        });
    });
    const _q = (0, h.default)(i.Link)(m || (m = o``)), _r = h.default.img.attrs({ alt: 'Gimkit Logo' })(n || (n = o`
  height: 32px;
  margin-right: 90px;
`));
});
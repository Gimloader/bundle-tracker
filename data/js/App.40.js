...
c.register('.....', function (d, e) {
    ...
    var g = c('.....');
    c('.....');
    var h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....');
    let r, s, t = u => u;
    var _u = () => {
        const v = (0, j.isLoggedIn)();
        return (0, p.useDidMount)(() => {
            v || (0, j.loadFont)('https://fonts.googleapis.com/css2?family=Rubik:wght@400;500&display=swap');
        }), v ? (0, g.jsx)(n.Navigate, {
            to: k.DASHBOARD,
            replace: !0
        }) : (0, g.jsxs)(g.Fragment, {
            children: [
    ...
    const _v = h.default.div.attrs({ className: 'flex-column vc maxWidth' })(r || (r = t`
  flex: 1;
  background: ${ 0 };
  font-family: 'Rubik', sans-serif;
  color: ${ 0 };
`), i.default.Snow, i.default.White), _w = h.default.div.attrs({ className: 'flex-center flex-column maxWidth' })(s || (s = t`
  color: ${ 0 };
`), i.default.Black);
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
    ...
    let o, p, q, r, s, t, u, v = w => w;
    const w = g.default.div.attrs({ className: 'maxWidth flex hc' })(o || (o = v`
  align-items: center;
  margin-top: 40px;
  margin-bottom: 60px;
  width: 90%;
...
`), 890), x = g.default.div.attrs({ className: 'flex hc vc flex-column' })(p || (p = v`
  background: ${ 0 };
  padding: 48px;
  border-style: solid;
  border-color: ${ 0 };
...
`), l.default.White, l.default.Black, 890), y = g.default.h1(q || (q = v`
  color: ${ 0 };
  font-size: 48px;
  font-weight: 700;
  margin-bottom: 15px;
...
`), l.default.Black), z = g.default.div(r || (r = v`
  font-size: 17px;
  color: #1d2d35;
  margin-bottom: 31px;
  @media (max-width: 460px) {
...
`)), A = g.default.div.attrs({ className: 'flex' })(s || (s = v`
  width: 150px;
...
`), 890), B = g.default.div(t || (t = v`
  ...
  border-color: #1d2d35;
  margin-right: 10px;
`)), C = g.default.div.attrs({ className: 'flex vc' })(u || (u = v`
...
`));
        ...
        children: [
            ...
            (0, f.jsxs)(x, {
                children: [
                    ...
                    (0, f.jsx)('div', { className: 'flex flex-column vc' }),
                    (0, f.jsx)(m.default, {
                        to: n.REGISTER_BASE,
                        ...
                        children: [
                            (0, f.jsx)(m.default, {
                                ...
                                children: (0, f.jsxs)(j.default, {
                                    type: 'link',
                                    children: [
                                        (0, f.jsx)('i', { className: 'far fa-gamepad-alt' }),
                                        '\xA0 Join Game'
                                    ]
                                })
                            }),
                            (0, f.jsx)(k.default, { type: 'vertical' }),
                            (0, f.jsx)(m.default, {
                                to: n.LOGIN,
                                children: (0, f.jsxs)(j.default, {
                                    type: 'link',
                                ...
                                children: [
                                    ...
                                    (0, f.jsx)(m.default, {
                                        ...
                                        children: (0, f.jsxs)(j.default, {
                                            type: 'link',
                                            children: [
                                                (0, f.jsx)('i', { className: 'far fa-users' }),
                                                '\xA0 Group Pricing'
                                            ]
                                        })
                                    })
    ...
    let l;
    const m = n => (0, f.jsx)('div', { style: { height: n.height } });
    var _n = () => (0, f.jsxs)(_o, {
        children: [
            (0, f.jsx)(h.default, {
                title: 'Answer',
    ...
    const _o = g.default.div.attrs({ className: 'flex-center flex-column maxWidth' })(l || (l = (p => p)``));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _q;
    });
            ...
            children: (0, f.jsxs)(_r, {
                ...
                children: [
                    (0, f.jsxs)(_s, {
                        ...
                        marginRight: s ? 55 : 0,
                        children: [
                            (0, f.jsx)(_t, { children: r.title }),
                            (0, f.jsx)(_u, { children: r.description })
                        ]
                    }),
                    (0, f.jsx)(_v, {
                        style: { transform: `rotate(${ s ? 2 : -2 }deg)` },
                        src: r.image
                    })
                ]
            })
    ...
    const _r = h.default.div.attrs({ className: 'flex vc hc' })(j || (j = o`
  flex-direction: ${ 0 };
  @media (max-width: ${ 0 }px) {
    flex-direction: column;
  }
`), s => s.row ? 'row' : 'row-reverse', p), _s = h.default.div(k || (k = o`
  max-width: 530px;
  margin-left: ${ 0 }px;
  margin-right: ${ 0 }px;
  @media (max-width: ${ 0 }px) {
...
`), t => t.marginLeft, t => t.marginRight, p), _t = h.default.div(l || (l = o`
  font-size: 40px;
  font-weight: ${ 0 };
  @media (max-width: ${ 0 }px) {
    font-size: 32px;
  }
`), g.FontWeights.Bold, p), _u = h.default.div(m || (m = o`
  font-size: 19px;
  @media (max-width: ${ 0 }px) {
    font-size: 16px;
  }
`), p), _v = h.default.img(n || (n = o`
  height: 390px;
  @media (max-width: ${ 0 }px) {
    margin-top: 20px;
    height: 320px;
...
`));
    ...
    var _p = () => (0, f.jsxs)(_q, {
        children: [
            (0, f.jsxs)(_r, {
                children: [
                    (0, f.jsx)(_s, { children: 'Always new ways to play...' }),
                    (0, f.jsx)(_t, { children: 'That\'s just the core of Gimkit. With 10+ unique game modes and more in development, there\'s always a new way to play.' })
                ]
            }),
            (0, f.jsx)(_u, {})
        ]
    });
    const _q = i.default.div.attrs({ className: 'maxWidth flex flex-column vc' })(j || (j = o`
  background: #0a2540;
  color: ${ 0 };
  padding: 100px 30px;
`), g.default.White), _r = i.default.div(k || (k = o`
  max-width: 600px;
  text-align: center;
`)), _s = i.default.div(l || (l = o`
  color: ${ 0 };
  font-size: 40px;
  font-weight: ${ 0 };
...
`), g.default.White, h.FontWeights.Bold), _t = i.default.div(m || (m = o`
  color: #adbdcc;
  font-size: 19px;
  margin-top: 4px;
  @media (max-width: 580px) {
...
`)), _u = i.default.img.attrs({ src: '/client/img/home/modes.png' })(n || (n = o`
  width: 100%;
  max-width: 1000px;
  margin-top: 35px;
...
`));
    ...
    c('.....');
    var h = c('.....'), i = c('.....');
    let j, k, l, m, n, o, p = q => q;
    var _q = r => {
        const s = 'left' === r.imageSide;
        return (0, f.jsx)(i.default, {
            children: (0, f.jsxs)(_r, {
                ...
                children: [
                    ...
                    (0, f.jsx)(_v, {
                        marginLeft: s ? 0 : 50,
                        marginRight: s ? 50 : 0,
                        children: (0, f.jsx)(_w, { src: r.image })
                    })
                ]
            })
        });
    };
    const _r = h.default.div.attrs({ className: 'maxWidth flex vc' })(j || (j = p`
  flex-direction: ${ 0 };
  @media (max-width: 890px) {
    flex-direction: column !important;
  }
`), s => s.flexDirection), _s = h.default.div(k || (k = p`
  width: 100%;
  max-width: 420px;
  @media (max-width: 890px) {
    margin-bottom: 25px;
...
`)), _t = h.default.div(l || (l = p`
  font-size: 40px;
  font-weight: ${ 0 };
`), g.FontWeights.Bold), _u = h.default.div(m || (m = p`
  font-size: 19px;
  margin-top: 8px;
...
`), w => w.marginLeft, w => w.marginRight), _w = h.default.img.attrs({ className: 'maxWidth' })(o || (o = p``));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _s;
    });
    ...
    var _s = () => (0, f.jsxs)(_t, {
        children: [
            (0, f.jsxs)(_u, {
                children: [
                    (0, f.jsx)(_v, { children: 'Game on.' }),
                    (0, f.jsx)(_w, { children: 'Get your first game going and see your students engaged like never before!' })
                ]
            }),
            (0, f.jsx)(l.default, {
                to: k.REGISTER_BASE,
    ...
    const _t = m.default.div.attrs({ className: 'maxWidth flex flex-column vc' })(n || (n = r`
  background: #0a2540;
  color: ${ 0 };
  padding: 100px 30px;
`), i.default.White), _u = m.default.div(o || (o = r`
  max-width: 770px;
  text-align: center;
`)), _v = m.default.div(p || (p = r`
  font-size: 48px;
  font-weight: ${ 0 };
  @media (max-width: 580px) {
    font-size: 36px;
  }
`), j.FontWeights.Bold), _w = m.default.div(q || (q = r`
  font-size: 22px;
  margin-top: -5px;
  margin-bottom: 20px;
  color: #adbdcc;

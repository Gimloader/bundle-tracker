...
const Lt = {
    ...
    w = e => {
        ...
        return s.jsx(z, {
            ...
            children: i.map(o => s.jsx(z.Option, {
                value: o.value,
                name: o.name,
                style: a ? {
                    fontFamily: o.value

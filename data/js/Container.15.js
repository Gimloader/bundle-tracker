...
c.register('.....', function (d, e) {
    ...
    let C, D, E, F = G => G;
    const G = h.default.div.attrs({ className: 'maxAll flex-column' })(C || (C = F``)), H = h.default.div(D || (D = F`
  flex: 1;
  display: flex;
  font-family: ${ 0 };
`), k.Fonts.SFPro), I = h.default.div.attrs({
            id: 'mainContainer',
...
`), i.default.Snow);
    var _J = () => {
        ...
        const U = (() => {
            ...
            return (0, l.isStudent)() && V.push({
                id: 'home',
                label: 'Home',
                icon: (0, f.jsx)(y.default, { name: 'fas fa-home' }),
                path: x.HOME,
                otherMatchingPaths: [x.DASHBOARD]
            }), V.push({
                id: 'kits',
                label: 'Kits',
                icon: (0, f.jsx)(y.default, { name: 'fas fa-box-open' }),
                path: x.KITS,
                ...
                id: 'reports',
                label: 'Reports',
                icon: (0, f.jsx)(y.default, { name: 'fas fa-analytics' }),
                path: x.REPORTS
            }, {
                id: 'assignments',
                label: 'Assignments',
                path: x.ASSIGNMENTS,
                icon: (0, f.jsx)(y.default, { name: 'fas fa-file-alt' })
            }, {
                id: 'classes',
                label: 'Classes',
                path: x.CLASSES,
                icon: (0, f.jsx)(y.default, { name: 'fas fa-users-class' })
            }), (0, l.isStudent)() && V.push({
                id: 'join-game',
                label: 'Join Game',
                path: x.JOIN,
                target: '_blank',
                icon: (0, f.jsx)(y.default, { name: 'fas fa-gamepad' })
            }), V;
        })();
        return (0, f.jsxs)(f.Fragment, {
            children: [
                ...
                (0, f.jsxs)(G, {
                    children: [
                        (0, f.jsxs)(H, {
                            ...
                            children: [
                                (0, f.jsx)(l.Title, { title: 'Dashboard' }),
                                (0, f.jsxs)(I, {
                                    style: { flex: 1 },
                                    ref: R,
                                    children: [
                ...
                T.type === s.PlanIds.proPass ? (0, f.jsx)(r.default, { onVisibleChange: Q }) : null
            ]
        });
    };
}), c.register('.....', function (d, e) {
    ...
    let s;
    const t = j.default.div.attrs({ className: 'flex-column' })(s || (s = (u => u)`
  color: ${ 0 };
  flex: 1;
`), k.default.Black);
    let u;
    ...
    var _w = () => {
        const {pathname: x} = (0, o.useLocation)(), y = g.useMemo(() => x ? (0, n.matchPath)({ path: p.REPORTS }, x) ? u.reports : (0, n.matchPath)({ path: p.ASSIGNMENTS }, x) ? u.assignments : (0, n.matchPath)({ path: p.CLASSES }, x) ? u.classes : (0, n.matchPath)({ path: p.HOME }, x) ? u.hub : (0, n.matchPath)({ path: p.KITS }, x) || (0, n.matchPath)({ path: p.KITS_SELECTION }, x) ? u.kits : (0, q.isStudent)() ? u.hub : u.kits : u.kits, [x]), z = g.useMemo(() => {
                switch (y) {
                case u.reports:
    ...
    var _w = () => {
        ...
        const {
                data: C,
                isLoading: D
            } = (0, p.default)(), {id: E} = (0, r.useParams)(), F = (0, s.IsEducator)() && (null === (x = (0, l.getUser)()) || void 0 === x ? void 0 : x.schoolId) && 'school' === E;
        var G;
        const H = null !== (G = null === (y = null == C || null === (z = C.folders) || void 0 === z ? void 0 : z.find(I => I._id === E)) || void 0 === y ? void 0 : y._id) && void 0 !== G ? G : '', I = Math.abs(b(t)((0, l.dateFromObjectId)((0, l.getUser)()._id)).diff(b(t)(), 'days'));
        if (D)
            return null;
        const J = () => {
                var K;
                return (null == C || null === (K = C.games) || void 0 === K ? void 0 : K.length) ? (0, f.jsx)(h.default, {
                    kits: null == C ? void 0 : C.games,
                    folders: null == C ? void 0 : C.folders,
                    selectedFolder: H
                }) : (0, f.jsx)(j.default, {
                    image: 'kit',
                    title: 'Kits',
            ...
            }, K = (null == C ? void 0 : C.folders.length) || (null === (A = (0, l.getUser)()) || void 0 === A ? void 0 : A.schoolId);
        return K || (null == C || null === (B = C.games) || void 0 === B ? void 0 : B.length) ? (0, f.jsx)(o.default, {
            header: (0, f.jsxs)('div', {
                className: 'maxWidth',
                children: [
                    (0, f.jsx)(i.default, {
                        title: 'Kits',
                        customUnderTitleComponent: K ? (0, f.jsx)('div', {
                            style: { marginTop: 13 },
                            children: (0, f.jsx)(q.default, {
                                schoolLibraryScreenOpen: F,
                                openSchoolLibraryScreen: () => {
                                    (0, m.NavigateTo)('/kits/school');
                                },
                                folders: null !== (_L = null == C ? void 0 : C.folders) && void 0 !== _L ? _L : [],
                                selectedFolder: H
                            })
                        }) : null,
                    ...
                    I > 7 && (0, s.IsEducator)() ? (0, f.jsx)(u.default, {}) : null
                ]
            }),
            children: (0, f.jsx)(g.Suspense, {
                fallback: null,
                children: F ? (0, f.jsx)(v, {}) : J()
            })
        }) : J();
        var _L;
    };
    ...
    var _k = l => {
        var m;
        const n = [], o = [], p = null === (m = l.folders) || void 0 === m ? void 0 : m.find(q => q._id === l.selectedFolder);
        l.kits.forEach(q => {
            if (l.selectedFolder) {
                if (!p)
                    return;
        ...
        return (0, f.jsxs)(f.Fragment, {
            children: [
                (0, f.jsx)(j.Title, { title: null !== (r = null == p ? void 0 : p.title) && void 0 !== r ? r : 'Kits' }),
                !q.length && l.selectedFolder ? (0, f.jsxs)('div', {
                    className: 'maxAll flex-center flex-column',
                    children: [
                        (0, f.jsx)('div', {
                            style: { fontSize: 62 },
                            children: (0, f.jsx)(i.default, { name: 'fas fa-folder-open' })
                        }),
                        (0, f.jsx)('div', {
                            style: { fontSize: 16 },
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = c('.....'), x = c('.....'), y = c('.....'), z = c('.....'), A = c('.....'), B = c('.....'), C = c('.....'), D = c('.....'), E = c('.....'), F = c('.....'), G = c('.....'), H = c('.....'), I = c('.....'), J = c('.....'), K = c('.....'), L = c('.....'), M = c('.....'), N = c('.....'), O = c('.....'), P = c('.....');
    let Q, R, S, T, U, V, W, X, Y, Z = $ => $;
    const _$ = 80, _ab = w.default.div(Q || (Q = Z`
  width: 100%;
  display: flex;
...
`)), _db = w.default.div(T || (T = Z`
  ...
  display: flex;
  align-items: center;
`), y.FontWeights.Bold), eb = w.default.div(U || (U = Z`
  max-width: 100%;
  overflow: hidden;
  white-space: nowrap;
...
`));
    var _jb = (0, z.observer)(kb => {
        const {
                kits: lb,
                navigation: mb
            } = g.useContext(F.default), [nb, ob, pb] = (0, A.useBoolean)(!1), [qb, rb, sb] = (0, A.useBoolean)(!1), [tb, ub] = g.useState(E.IExperiencePickerMode.liveGame), [vb, wb] = g.useState(null), {game: xb} = kb, yb = g.useMemo(() => xb.createdAt ? `Created ${ b(J)(xb.createdAt).fromNow() }` : '', [
                xb.editCount,
                xb.updatedAt,
                xb.createdAt
                ...
                zb('copy') || (!(0, P.IsEducator)() || (0, A.isUpgraded)() ? (0, A.copyKit)({
                    ...
                    onFailure: () => (0, M.throwError)({ title: 'Error copying kit' })
                }) : wb({
                    id: 'self-copy',
                ...
                (0, A.request)({
                    ...
                    error: Ib => {
                        (0, A.throwMessageError)({
                            e: Ib,
                            default: { title: 'There was an error removing this Kit from this folder.' }
                        });
                    }
                });
            }, Ib = () => {
                    ...
                    onOk: () => {
                        (0, A.request)({
                            ...
                            error: Jb => (0, A.throwMessageError)({
                                e: Jb,
                                default: { title: 'There was an error deleting this kit' }
                            })
                        });
                    }
                });
                                    ...
                                    children: [
                                        ...
                                        (0, f.jsx)(ib, {
                                            children: (0, f.jsx)(s.default, {
                                                overlay: (() => {
                                                    const {isArchived: Jb} = xb;
                                                    return (0, f.jsxs)(t.default, {
                                                        children: [
                                                            (0, f.jsxs)(t.default.Item, {
                                                                onClick: Ab,
                                                                children: [
                                                                    (0, f.jsx)(n.default, { style: { marginRight: 7 } }),
                                                                    'Open'
                                                                ]
                                                            }, 'open'),
                                                            (0, f.jsxs)(t.default.Item, {
                                                                onClick: Bb,
                                                                children: [
                                                                    (0, f.jsx)(j.default, { style: { marginRight: 7 } }),
                                                                    'Edit'
                                                                ]
                                                            }, 'edit'),
                                                            (0, f.jsxs)(t.default.Item, {
                                                            ...
                                                            kb.folderId ? null : (0, f.jsxs)(t.default.Item, {
                                                                onClick: Db,
                                                                children: [
                                                                    (0, f.jsx)(m.default, { style: { marginRight: 7 } }),
                                                                    'Add to Folder'
                                                                ]
                                                            }, 'folder'),
                                                            ...
                                                            Jb ? (0, f.jsxs)(t.default.Item, {
                                                                onClick: Ib,
                                                                children: [
                                                                    (0, f.jsx)(i.default, { style: { marginRight: 7 } }),
                                                                    'Delete'
                                                                ]
                                                            }, 'delete') : null,
                                                            (0, f.jsxs)(t.default.Item, {
                                                                onClick: Jb ? Gb : Fb,
                                                                children: [
                                                                    (0, f.jsx)(l.default, { style: { marginRight: 7 } }),
...
`), n => n.size, n => n.size, n => n.customRightMargin ? n.customRightMargin : 0, n => n.showBorder && `border: solid ${ j.default.Black } 1px;`);
            ...
            children: u.folders.map(y => (0, f.jsxs)(_v, {
                onClick: () => {
                    return f = y._id, void (v || (w(), (0, q.request)({
                        ...
                        success: () => {
                            u.close(), (0, r.invalidateKits)(), l.default.success({ content: 'Kit added to folder!' });
                        },
                        error: z => {
                            (0, q.throwMessageError)({
                                e: z,
                                default: { title: 'Error adding kit to folder' }
                            });
                        },
                        both: x
                    })));
                ...
                children: [
                    (0, f.jsx)('div', {
                        style: { marginRight: 8 },
                        children: (0, f.jsx)(p.default, { name: 'fas fa-folder' })
                    }),
                    (0, f.jsx)('div', { children: y.name })
                ]
            }, y._id))
        });
    };
        ...
        const D = B.length < 2, E = () => {
                D || y || (z(), (0, q.request)({
                    ...
                    error: F => {
                        (0, q.throwMessageError)({
                            e: F,
                            default: { title: 'Error creating folder' }
                        }), A();
                    }
                }));
            };
    ...
    const _v = o.default.div.attrs({ className: 'flex vc' })(s || (s = (w => w)`
  padding: 12px 20px;
  border-radius: 6px;
...
`));
    ...
    var g = c('.....');
    const _h = {
        title: (0, f.jsx)(f.Fragment, { children: 'Create folders with Pro' }),
        description: (0, f.jsxs)(f.Fragment, {
            children: [
                'Upgrade to ',
                g.COMPANY_NAME,
    ...
    const z = A => {
            ...
            return (0, f.jsx)(t.default, {
                ...
                children: (0, f.jsxs)(_G, {
                    ...
                    children: [
                        (0, f.jsx)('span', {
                            style: { marginRight: 6 },
                            children: (0, f.jsx)(p.default, { name: B.icon })
                        }),
                        B.label
                    ]
                })
                ...
                children: (0, f.jsxs)(_G, {
                    ...
                    children: [
                        ...
                        C.selected ? (0, f.jsx)(i.default, {
                            ...
                            children: (0, f.jsx)(_H, { children: (0, f.jsx)(p.default, { name: 'far fa-ellipsis-h' }) })
                        }) : null,
                        (0, f.jsx)(_C, {
                            open: G,
                            close: I,
                ...
                E || (F(), (0, r.request)({
                    ...
                    error: L => {
                        (0, r.throwMessageError)({
                            e: L,
                            default: { title: 'Error renaming folder' }
                        });
                    }
                }));
            };
            ...
            return (0, f.jsx)(k.default, {
                        ...
                        onClick: () => {
                            G(), (0, r.request)({
                                ...
                                error: I => {
                                    (0, r.throwMessageError)({
                                        e: I,
                                        default: { title: 'Error deleting folder' }
                                    });
                                },
                                both: H
                            });
                ...
                children: (0, f.jsx)(m.default.Text, { children: 'Are you sure you want to delete this folder? The kits within the folder will not be deleted.' })
            });
        };
    var _E = F => {
        var G;
        const H = !(0, r.isStudent)() && (null === (G = (0, r.getUser)()) || void 0 === G ? void 0 : G.schoolId), I = J => J === F.selectedFolder && !F.schoolLibraryScreenOpen;
        return (0, f.jsx)(_F, {
            children: (0, f.jsxs)(l.default, {
                ...
                children: [
                    ...
                    F.folders.sort((J, K) => J.title.localeCompare(K.title)).map(J => (0, f.jsx)(B, {
                        ...
                        selected: I(J._id),
                        path: `${ s.KITS }/${ J._id }`,
                        icon: (0, f.jsx)(p.default, { name: 'fas fa-folder' })
                    }, `folder-${ J._id }`))
                ]
            })
        });
...
`)), _G = n.default.div.attrs({ className: 'flex-center' })(w || (w = y`
  background: ${ 0 };
  color: ${ 0 };
  font-size: 15px;
  padding: 4px 14px;
...
`), H => H.background, H => H.color, H => H.hoverBackgroundColor), _H = n.default.div(x || (x = y`
  margin-left: 12px;
...
`));
    ...
    let p;
    const q = 'teacher-appreciation-promo', r = '2025';
    var _s = () => {
        const [t, u] = g.useState(localStorage.getItem(q) !== r);
        return t ? (0, f.jsx)(_t, {
            children: (0, f.jsx)(h.default, {
                className: 'maxWidth',
                to: i.TEACHER_APPRECIATION,
                ...
                children: (0, f.jsxs)('div', {
                    style: {
                        ...
                        padding: 20,
                        borderRadius: 6,
                        background: j.default.BackgroundPurple,
                        position: 'relative',
                        overflow: 'hidden'
                    },
                    className: 'maxWidth flex between vc light-shadow',
                    children: [
                        (0, f.jsx)('img', {
                            src: '/assets/map/characters/spine/preview/exam.png',
                            style: {
                                width: 80,
                                position: 'absolute',
                                left: 2,
                        ...
                        (0, f.jsx)('div', {
                            ...
                            children: 'Free Gim for Teacher Appreciation Week!'
                        }),
                        (0, f.jsx)('div', {
                            children: (0, f.jsx)(n.default, {
                                ...
                                children: (0, f.jsx)(m.default, {
                                    onClick: v => {
                                        v.preventDefault(), v.stopPropagation(), u(!1), localStorage.setItem(q, r);
                                    },
                                    icon: (0, f.jsx)(o.default, {}),
                                    type: 'dashed',
                                    shape: 'circle'
    ...
    const _t = l.default.div.attrs({ className: 'maxWidth' })(p || (p = (u => u)`
...
`), p => p.color, k.IMAGE_SIZE, k.IMAGE_SIZE);
                ...
                children: (0, f.jsx)(h.default, {
                    ...
                    children: (0, f.jsx)(k.Content, {
                        children: (0, f.jsxs)(k.LeftSide, {
                            children: [
                                (0, f.jsx)(o, { color: r.color }),
                                (0, f.jsxs)(k.KitInfo, {
                                    children: [
                                        (0, f.jsx)(k.KitTitle, { children: r.name }),
                                        (0, f.jsx)(k.KitDescription, { children: r.memberCount + ' ' + (0, l.plural)('member', r.memberCount) })
                                    ]
                                })
                            ]
                        })
    ...
    var _m = () => {
        ...
        return b(g).useEffect(() => {
            ...
            children: [
                (0, f.jsx)(i.default, { groups: p.map(r => r._id) }),
                (0, f.jsx)(j.default, {}),
                (0, f.jsx)(l.default, {}),
                (0, f.jsx)(k.default, {
                    groups: p,
    ...
    c('.....');
    var g = c('.....'), h = c('.....');
    var _i = j => (0, f.jsx)(h.default, { children: (0, f.jsx)(g.default, { groups: j.groups }) });
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _r;
    });
        ...
        return g.useEffect(() => {
            ...
            children: (0, f.jsxs)(_s, {
                children: [
                    (0, f.jsxs)('div', {
                        children: [
                            (0, f.jsx)(_t, { children: 'Join your teacher\'s live game!' }),
                            (0, f.jsx)(_u, { children: t })
                        ]
                    }),
                    (0, f.jsx)('div', {
                        style: { marginLeft: 20 },
    ...
    const _s = h.default.div.attrs({ className: 'flex vc wrap' })(n || (n = q`
  justify-content: space-between;
    ...
    var _j = k => (0, f.jsxs)(_k, {
        ...
        children: [
            (0, f.jsx)('div', {
                ...
                children: (0, f.jsx)('i', { className: k.icon })
            }),
            (0, f.jsx)('span', { children: k.text })
        ]
    });
...
`), g.default.White, g.default.Black, l => l.customWidth || 350, g.default.BorderGray, g.default.Black);
    ...
    var f = c('.....'), g = c('.....');
    let h;
    var _i = f.default.div.attrs({ className: 'maxWidth' })(h || (h = (j => j)`
  color: ${ 0 };
`), g.default.Black);
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
    ...
    var _w = () => {
        ...
        return g.useEffect(() => {
            ...
            children: [
                (0, f.jsx)(_x, { children: 'Assignments' }),
                (0, f.jsxs)('div', {
                ...
                x ? (0, f.jsx)('div', {
                    ...
                    style: { marginTop: 20 },
                    children: (0, f.jsx)(o.default, { size: 'large' })
  ...
  line-height: 38px;
  font-weight: ${ 0 };
`), j.FontWeights.UltraBold), _y = i.default.div.attrs({ className: 'flex vc' })(r || (r = t`
  padding-left: 15px;
  padding-right: 15px;
  border-radius: 15px;
  border-style: solid;
...
`), z => z.selected ? '#1a237e' : k.default.White, z => z.selected ? k.default.White : k.default.Black, z => z.selected ? '#1a237e' : k.default.BorderGray, z => !z.selected && '\n  &:hover {\n    background: #fafafa;\n  }\n  ');
        ...
        return (0, f.jsxs)(i.Container, {
            children: [
                (0, f.jsxs)(i.TopContainer, {
                    children: [
                        (0, f.jsx)(i.Color, { style: { background: n.groupColor } }),
                ...
                (0, f.jsx)(k.default, {
                    ...
                    children: (0, f.jsx)(h.default, {
                        ...
                        children: (0, f.jsxs)(i.CardContainer, {
                            children: [
                                (0, f.jsx)(i.IconContainer, { children: (0, f.jsx)('i', { className: 'fal fa-file-alt' }) }),
                                (0, f.jsxs)(i.RightSide, {
                                    children: [
                                        (0, f.jsxs)(i.DetailsSection, {
                                            children: [
                                                (0, f.jsx)(i.Title, { children: n.title }),
                                                o ? (0, f.jsx)(i.Description, { children: o }) : null
                                            ]
                                        }),
                                        (0, f.jsx)(i.Status, {
    ...
    const _u = h.default.div.attrs({ className: 'flex maxWidth flex-column' })(i || (i = t`
  align-items: flex-start;
  margin-bottom: 15px;
  &:last-of-type {
    margin-bottom: 0px;
  }
`)), _v = h.default.div.attrs({ className: 'flex vc' })(j || (j = t`
  border-style: solid;
  border-width: 1px;
  border-color: ${ 0 };
...
`), f.default.BorderGray), _w = h.default.div(k || (k = t`
  height: 14px;
  width: 14px;
  border-radius: 50%;
`)), _x = h.default.div(l || (l = t`
  ...
  font-size: 14px;
  line-height: 14px;
`)), _y = h.default.div.attrs({ className: 'flex maxWidth vc' })(m || (m = t`
  color: ${ 0 };
`), f.default.Black), _z = h.default.div.attrs({ className: 'flex maxWidth vc' })(n || (n = t`
  margin-left: 25px;
  justify-content: space-between;
...
`)), _C = h.default.div(q || (q = t`
  font-size: 20px;
  font-weight: ${ 0 };
`), g.FontWeights.Bold), _D = h.default.div(r || (r = t`
  color: rgba(0, 0, 0, 0.8);
  font-size: 15px;
  margin-top: 6px;
...
`));
    ...
    var _p = q => {
        ...
        return (0, f.jsxs)(h.default, {
            style: { marginTop: 30 },
            children: [
                (0, f.jsx)(_q, { children: 'Classes' }),
                q.loading ? (0, f.jsx)('div', {
                    className: 'maxWidth flex hc',
                    style: { marginTop: 20 },
                    children: (0, f.jsx)(m.default, { size: 'large' })
...
`), j.FontWeights.UltraBold);
    ...
    const _w = l.default.div.attrs({ className: 'flex maxWidth vc between' })(q || (q = u`
  color: ${ 0 };
`), m.default.Black), _x = l.default.div(r || (r = u`
  margin-left: 25px;
`)), _y = l.default.div(s || (s = u`
  font-size: 20px;
  line-height: 20px;
  font-weight: ${ 0 };
`), n.FontWeights.Bold), _z = l.default.div(t || (t = u`
  color: rgba(0, 0, 0, 0.8);
  font-size: 15px;
  line-height: 15px;
  margin-top: 6px;
`));
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = (g = c('.....'), c('.....')), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = c('.....'), x = c('.....');
    let y;
    const z = [
            {
                title: 'Kit',
            ...
            },
            {
                ...
                dataIndex: 'accuracy',
                key: 'report-accuracy',
                render: A => (0, f.jsx)(t.ReportProgressAccuracyMeter, { percent: A })
            },
            {
                title: 'Participants',
                dataIndex: 'groups',
            ...
            var D;
            const E = Math.max(1, null !== (D = Number(B.get('page'))) && void 0 !== D ? D : 1), [F, G] = g.useState(0), H = (0, g.useRef)(null), [I, J, K] = (0, k.useBoolean)(!1), {
                    data: L,
                    isLoading: M,
                    isError: N,
                    isFetching: O
            ...
            const P = L ? (0, f.jsx)(p.ReportPagination, {
                ...
                current: E,
                onPageChange: Q => {
                    (0, k.isUpgraded)() ? C({ page: Q }) : J();
                }
            }) : null;
            return (0, f.jsxs)(f.Fragment, {
                children: [
                    (0, f.jsx)(k.Title, { title: 'Reports' }),
        ...
        }, _B = o.default.div.attrs({ className: 'maxWidth flex' })(y || (y = (C => C)`
  flex: 1;
`));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
...
`));
            ...
            children: [
                (0, f.jsxs)(_p, {
                    children: [
                        ...
                        !(0, l.isUpgraded)() && (0, f.jsx)(j.default, { openUpgradeModal: p.openUpgradeModal })
                    ]
                }),
                (0, f.jsx)(m.default, {})
            ]
    ...
    const _p = i.default.div.attrs({ className: 'maxWidth' })(n || (n = (q => q)`
  position: sticky;
  left: 0;
  right: 0;
  bottom: 0;
...
`), g.default.Black, h.Fonts.SFPro);
        ...
        g.useEffect(() => {
            (() => {
                if (!localStorage.getItem(n))
                    return !0;
                const s = localStorage.getItem(n), t = Number(s);
                if (!t || isNaN(t))
                    return !0;
                const u = b(i).unix(t);
                ...
                (0, f.jsx)(h.Text, {
                    children: (() => {
                        if ((0, l.getFreePlanType)() === l.FreePlanType.limitedGames) {
                            ...
                            return t <= 0 ? (0, f.jsx)(f.Fragment, { children: 'You are out of hosted games for this month' }) : (0, f.jsxs)(f.Fragment, {
                                children: [
                                    'You can host',
                                    ' ',
                                    (0, f.jsxs)(h.Bold, {
    ...
    var _u = v => {
        const [w, x] = j.useState(0), [y, z] = j.useState(''), A = () => {
                ...
                if (!B && !B.freeTrial)
                    return;
                const C = b(n).duration(b(n)(B.freeTrial.freeTrialExpiration).diff(b(n)())), D = C.asDays(), E = C.asHours(), F = C.asMinutes(), G = C.asSeconds();
                if (D >= 1) {
                    let H = D;
        ...
        return j.useEffect(() => {
            ...
            children: [
                (0, f.jsxs)(_w, {
                    children: [
                        'Your trial of ',
                        (0, f.jsx)(_x, { children: 'Gimkit Pro' }),
                        ' ends in',
                        ' ',
                        (0, f.jsxs)(_x, {
                            children: [
    ...
    const _v = k.default.div.attrs({ className: 'maxWidth flex vc' })(o || (o = s`
  background: ${ 0 };
  padding: 15px 20px;
  color: ${ 0 };
  justify-content: space-between;
...
`), w => w.background, g.default.White), _w = k.default.div(p || (p = s`
  font-size: 18px;
`)), _x = k.default.span(q || (q = s`
  font-weight: ${ 0 };
`), h.FontWeights.Bold), _y = (0, k.default)(i.default)(r || (r = s`
  background: ${ 0 };
  color: ${ 0 };
  font-size: 15px;
  border-radius: 50px;
...
`), z => z.background, g.default.White, g.default.White, z => z.background, g.default.White);
                ...
                children: [
                    ...
                    (0, f.jsxs)('div', {
                        ...
                        children: [
                            ...
                            (0, f.jsx)('br', {}),
                            (0, f.jsx)('br', {}),
                            (0, f.jsx)('b', { children: '- Josh Feinsilber' }),
                            ', creator of Gimkit'
                        ]
                    })
                ]
    ...
    var _j = k => (() => {
        ...
        if ((0, g.getUrlVariable)('from'))
            return !0;
        const l = (0, g.getUser)(), m = (0, g.dateFromId)(l._id);
        return b(h)().diff(b(h)(m), 'days') < 3;
    })() ? null : (0, f.jsx)(i.default, { allowAutoOpen: !0 });
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _o;
    });
    ...
    const _p = l.default.div.attrs({ className: 'maxWidth' })(n || (n = (q => q)`
  font-family: ${ 0 };
  color: ${ 0 };
`), i.Fonts.SFPro, h.default.Black);
    ...
    var _q = r => {
        ...
        return (0, f.jsxs)(_r, {
            children: [
                s.image ? (0, f.jsx)(_t, { src: `/client/img/dashboard/onboarding/${ s.image }.svg` }, s.image) : (0, f.jsx)(_s, {}),
                (0, f.jsx)(_u, { children: s.title }),
                (0, f.jsx)(_v, { children: s.content }),
                (0, f.jsx)(j.default, {
    ...
    const _r = h.default.div.attrs({ className: 'flex-center flex-column maxWidth' })(k || (k = p``)), _s = h.default.div(l || (l = p`
  height: 80px;
  width: 80px;
...
`)), _u = h.default.div(n || (n = p`
  ...
  font-weight: ${ 0 };
  margin-top: 20px;
`), g.FontWeights.Bold), _v = h.default.div(o || (o = p`
  font-size: 18px;
  margin-top: 15px;
  margin-bottom: 25px;
`));
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....');
    var _k = l => {
        const m = g.useMemo(() => l.currentStage === j.default.length - 1, [l.currentStage]), n = g.useCallback(() => {
...
`)), _y = l.default.div.attrs({ className: 'maxWidth' })(s || (s = u`
  color: ${ 0 };
  font-family: ${ 0 };
`), m.default.Black, n.Fonts.SFPro), _z = l.default.div(t || (t = u`
  z-index: 999;

...
`), h.default.Black);
    ...
    var _l = m => (0, f.jsxs)(g.AntCard, {
        children: [
            ...
            (0, f.jsx)(g.Description, {
                children: m.isRenewal ? `Upload your purchase order to instantly renew your group's ${ j.COMPANY_NAME } Pro access and get your invoice!` : `Get your group license up and running today! Upload your purchase order to get your group access to ${ j.COMPANY_NAME } Pro!`
            }),
            (0, f.jsxs)(h.default, {
                onClick: () => {
    ...
    const _f = g => 'https://www.gimkit.com/quote/' + g,
        _g = h => '/quote-printable/' + h;
}), c.register('.....', function(d, e) {
    a(d.exports, 'default', function() {
        return _m;
    });
    ...
    var _j = k => (0, f.jsxs)(g.AntCard, {
        children: [
            ...
            (0, f.jsx)(g.Description, {
                children: k.isRenewal ? 'We\'re here to help! Let us know if you have any questions about your group license renewal.' : 'Let us know if you have any questions about your group quote!'
            }),
            (0, f.jsxs)(h.default, {
    ...
    var _l = m => (0, f.jsxs)(g.AntCard, {
        children: [
            ...
            (0, f.jsx)(g.Description, {
                children: m.isRenewal ? `Use a credit card to renew your group's ${ j.COMPANY_NAME } Pro license!` : `Pay with credit card to get your group access to ${ j.COMPANY_NAME } Pro!`
            }),
            (0, f.jsxs)(h.default, {
                onClick: () => {
                    (0, i.requireAuthentication)(() => {

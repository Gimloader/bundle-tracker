...
`), i.default.White, u => u.selected ? '#269900' : 'rgba(0,0,0,0.2)'),
...
`));
    ...
    const _h = (i, j) => {
        ...
        if (!l)
            return !1;
        const m = l.minimumRoleLevel,
            n = l.maximumRoleLevel;
    ...
    var _n = o => {
        const {
            deviceId: p,
            deviceOption: q
        } = o, [r, s] = g.useState((0, h.GetRemovingDeviceTotalMemoryCost)({
            deviceId: p
        }));
        return g.useEffect(() => (0, i.ReactionToMultipleProps)([
            ...
            s((0, h.GetRemovingDeviceTotalMemoryCost)({
                deviceId: p
            }));
        }, {
            fireImmediately: !0
        }), [p]), (0, f.jsxs)(k.default.Text, {
            italic: !0,
            children: [
    ...
    var f = c('.....');
    const _g = h => Array.from(f.default.world.wires.wires.keys()).filter(i => i.startsWith(h)).map(i => f.default.world.wires.wires.get(i)),
        _h = i => Array.from(f.default.world.wires.wires.keys()).filter(j => j.endsWith(i)).map(j => f.default.world.wires.wires.get(j)),
        _i = j => !(!_g(j).length && !_h(j).length);
}), c.register('.....', function(d, e) {
    a(d.exports, 'default', function() {
        return _f;
    });
    ...
    var _u = (0, r.observer)(v => {
        ...
        const C = () => {
                const D = null == z ? void 0 : z.trim(),
                    E = (0, s.default)().worldManager.devices.getDeviceById(v.deviceId);
                E && ((0, t.default)({
...
`));
    ...
    var _F = G => {
        const {
            memorySystem: H
        } = (0, s.default)(), [I, J] = g.useState((0, w.CanAddCodeGrid)(G.deviceId)), [K, L, M] = (0, t.useBoolean)(!1), [N, O] = g.useState(''), P = g.useRef(null);
        g.useEffect(() => (0, u.ReactionToMultipleProps)([
            ...
            fireImmediately: !0
        }), [G.deviceId]), g.useEffect(() => {
            var Q;
            null == P || null === (Q = P.current) || void 0 === Q || Q.focus();
        }, [K]);
        const Q = g.useMemo(() => (0, z.default)(A.default.channel), []),
            R = (0, x.GetCodeGridMessage)({
                reason: I.reason
            });
        return (0, f.jsxs)(_G, {
            children: [
...
`));
    ...
    const p = (q, r) => {
            ...
            const {
                getPrefixCls: D
            } = i.useContext(j.ConfigContext), E = D('select', s);
    ...
    var _F = (0, q.observer)(G => {
        const {
            deviceId: H
        } = G, I = Array.from(G.codeGrids), J = (0, m.default)();
        return g.useEffect(() => {
...
`)),
  ...
  flex-shrink: 0;
`), I => I.selected ? '#269900' : 'rgba(255,255,255,0.14)'),
...
`), r.Fonts.FugazOne);
    ...
    const _h = i => {
        ...
        const m = k.minimumRoleLevel,
            n = k.maximumRoleLevel;
        return (0, g.IsRoleLevelBetween)(m, n);
    };
}), c.register('.....', function(d, e) {

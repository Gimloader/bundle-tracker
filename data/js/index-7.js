...
var Wt = {
    ...
    Tt = function(t, n) {
        return i.createElement(ot, ae({}, t, {
            ref: n,
            icon: Wt
        }))
    },
...
function de(e) {
    var t = String(e);
    if (Ee(e)) {
        if (e > Number.MAX_SAFE_INTEGER) return String($e() ? BigInt(e).toString() : Number.MAX_SAFE_INTEGER);
        if (e < Number.MIN_SAFE_INTEGER) return String($e() ? BigInt(e).toString() : Number.MIN_SAFE_INTEGER);
        t = e.toFixed(z(t))
    }
    return U(t).fullStr
}
...
var Lt = function() {
        function e(t) {
            if (Le(this, e), y(this, "origin", ""), y(this, "negative", void 0), y(this, "integer", void 0), y(this, "decimal", void 0), y(this, "decimalLen", void 0), y(this, "empty", void 0), y(this, "nan", void 0), ze(t)) {
                this.empty = !0;
                return
            }
            ...
            var n = t;
            if (Ee(n) && (n = Number(n)), n = typeof n == "string" ? n : de(n), we(n)) {
                var r = U(n);
        ...
        return Ge(e, [{
            ...
            value: function(n, r, a) {
                var o = Math.max(this.getDecimalStr().length, n.getDecimalStr().length),
                    ...
                    b = c.negativeStr,
                    S = c.trimStr,
                    N = "".concat(b).concat(S.padStart(m + 1, "0"));
                return new e("".concat(N.slice(0, -m), ".").concat(N.slice(-m)))
            }
        }, {
            key: "add",
            value: function(n) {
    ...
    Pt = function() {
        function e(t) {
            if (Le(this, e), y(this, "origin", ""), y(this, "number", void 0), y(this, "empty", void 0), ze(t)) {
                this.empty = !0;
                return
            }
...
function le(e, t, n) {
    ...
    if (n >= 0) {
        var c = Number(f[n]);
        if (c >= 5 && !r) {
            var b = M(e).add("".concat(o, "0.").concat("0".repeat(n)).concat(10 - c));
            return le(b.toString(), t, n, r)
        }
        return n === 0 ? m : "".concat(m).concat(t).concat(f.padEnd(n, "0").slice(0, n))
    }
    ...
    function a() {
        if (e && n.current && t) try {
            var o = e.value,
                ...
                m = v.start,
                c = o.length;
            if (o.startsWith(f)) c = f.length;
            else if (o.endsWith(g)) c = o.length - n.current.afterTxt.length;
            else {
                var b = f[m - 1],
                    S = o.indexOf(b, m - 1);
                S !== -1 && (c = S + 1)
            ...
            st(!1, "Something warning of cursor restore. Please fire issue about this: ".concat(N.message))
        }
    }
    return [r, a]
}
...
function Xt(e) {
    ...
    var c = function() {
        ...
        b = function(R, d) {
            R.preventDefault(), c(), m.current(d);

            function O() {
                m.current(d), f.current = setTimeout(O, qt)
            }
            f.current = setTimeout(O, Kt)
        };
    ...
    var N = "".concat(t, "-handler"),
        D = T(N, "".concat(N, "-up"), y({}, "".concat(N, "-up-disabled"), a)),
        x = T(N, "".concat(N, "-down"), y({}, "".concat(N, "-down-disabled"), o)),
        $ = function() {
...
function ke(e) {
    var t = typeof e == "number" ? de(e) : U(e).fullStr,
        n = t.includes(".");
...
var Jt = ["prefixCls", "className", "style", "min", "max", "step", "defaultValue", "value", "disabled", "readOnly", "upHandler", "downHandler", "keyboard", "changeOnWheel", "controls", "classNames", "stringMode", "parser", "formatter", "precision", "decimalSeparator", "onChange", "onInput", "onPressEnter", "onStep", "changeOnBlur", "domRef"],
    Qt = ["disabled", "style", "prefixCls", "value", "prefix", "suffix", "addonBefore", "addonAfter", "className", "classNames"],
    je = function(t, n) {
    ...
    Zt = i.forwardRef(function(e, t) {
        ...
        function te(u, s) {
            Ce(xe(u.isInvalidate() ? u.toString(!1) : u.toString(!s), s))
        }
        var Y = i.useMemo(function() {
            ...
            Qe = Yt(),
            Me = function u(s) {
                if (Ye(), he.current = s, Ce(s), !H.current) {
                    var p = ve(s),
                        l = M(p);
                    l.isNaN() || ue(l, !0)
                }
                V == null || V(s), Qe(function() {
                    var F = s;
            ...
            et = function() {
                H.current = !1, Me(G.current.value)
            },
            tt = function(s) {
                Me(s.target.value)
            },
            ...
            rt = function(s) {
                var p = s.key,
                    l = s.shiftKey;
                _.current = !0, K.current = l, p === "Enter" && (H.current || (_.current = !1), Ae(!1), k == null || k(s)), x !== !1 && !H.current && ["Up", "ArrowUp", "Down", "ArrowDown"].includes(p) && (Se(p === "Up" || p === "ArrowUp"), s.preventDefault())
            },
            at = function() {
        ...
        i.useEffect(function() {
            if (I && q) {
                var u = function(l) {
                        Se(l.deltaY < 0), l.preventDefault()
                    },
                    s = G.current;
                if (s) return s.addEventListener("wheel", u, {
                        passive: !1
                    }),
                    function() {
                        return s.removeEventListener("wheel", u)
                    }
            }
        });
        var it = function() {
            Q && Ae(!1), Z(!1), _.current = !1
        };
        return Ie(function() {
            ...
            ref: fe,
            className: T(n, r, y(y(y(y(y({}, "".concat(n, "-focused"), q), "".concat(n, "-disabled"), b), "".concat(n, "-readonly"), S), "".concat(n, "-not-a-number"), h.isNaN()), "".concat(n, "-out-of-range"), !h.isInvalidate() && !be(h))),
            style: a,
            onFocus: function() {
                Z(!0)
            },
...
const tn = e => {
        ...
        return Object.assign(Object.assign({}, Ct(e)), {
            controlWidth: 90,
            handleWidth: r,
            ...
            filledHandleBg: new ft(e.colorFillSecondary).onBackground(e.colorBgContainer).toHexString(),
        ...
        return [{
            [t]: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, ye(e)), He(e)), {
                ...
                "&-lg": {
                    ...
                    borderRadius: B,
                    [`input${t}-input`]: {
                        height: W(f).sub(W(n).mul(2)).equal(),
                        padding: `${C(S)} ${C(N)}`
                    }
                },
                "&-sm": {
                    ...
                    borderRadius: w,
                    [`input${t}-input`]: {
                        height: W(g).sub(W(n).mul(2)).equal(),
                        padding: `${C(b)} ${C(c)}`
                    }
                },
                "&-out-of-range": {
...
const Ue = i.forwardRef((e, t) => {
        const {
            getPrefixCls: n,
            direction: r
        } = i.useContext(ht), a = i.useRef(null);
        ...
        let k = i.createElement(Gt, {
            ...
            j = i.createElement(wt, {
                className: `${d}-handler-down-inner`
            });
        const W = typeof I == "boolean" ? I : void 0;
        ...
        const {
            ...
            isFormItemInput: me,
            feedbackIcon: ie
        } = i.useContext(Nt), G = jt(fe, $), L = It(h => {
            var X;
            return (X = f ?? P) !== null && X !== void 0 ? X : h
        }), oe = i.useContext(yt), q = g ?? oe, [Z, _] = $t("inputNumber", E, D), H = Q && i.createElement(i.Fragment, null, ie), K = T({
            [`${d}-lg`]: L === "large",
            [`${d}-sm`]: L === "small",
            [`${d}-rtl`]: r === "rtl",
            [`${d}-in-form-item`]: me
            ...
            classNames: {
                ...
                affixWrapper: T({
                    [`${d}-affix-wrapper-sm`]: L === "small",
                    [`${d}-affix-wrapper-lg`]: L === "large",
                ...
                groupWrapper: T({
                    [`${d}-group-wrapper-sm`]: L === "small",
                    [`${d}-group-wrapper-lg`]: L === "large",
                    [`${d}-group-wrapper-rtl`]: r === "rtl",
                    [`${d}-group-wrapper-${Z}`]: _
                }, Fe(`${d}-group-wrapper`, G, Q), w)
            }
        }, R));
        return A(se)
    }),
...
sn._InternalPanelDoNotUseOrYouWillBeFired = un;
export {
    sn as T
};
        ...
        super(Z), this.particles = [], this.isCharacterInZone = !1, this.onUpdate = i => {
            ...
            for (let r = 0; r < o; r++) {
                ...
                a.view.setScale(m), this.particles.push({
                    particle: a,
                    baseX: a.view.x - this.x + this.options.width / 2,
                    baseY: a.view.y - this.y + this.options.height / 2,
                    baseSpeed: m * (Math.random() * .75 + .25)
                })
            }
        }, this.onSyncedData = i => {
            const e = y();
            ...
            d() && this.particles.forEach(t => {
                ...
                const o = 50,
                    ...
                    a = i + this.options.width / 2,
                    m = this.y - this.options.height / 2,
                    f = this.y + this.options.height / 2;
                let h = 1;

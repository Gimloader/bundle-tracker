...
const m = () => {
        ...
        return d.characters.characters.forEach((t, o) => {
            E() !== t.id && t.name !== void 0 && t.isActive && t.type === B.player && e.push({
                id: t.id,
                name: t.name,
                selected: t.id === d.gui.selectedPlayerId
            })
        }), e.sort((t, o) => t.name.localeCompare(o.name, "en", {
            sensitivity: "base"
        })), e
    },
    z = e => {
        if (!S()) return;
        let t = d.characters.characters.get(e);
    ...
    R = e => {
        const t = () => {
                O(e.selectedPlayer.id)
            },
            o = () => {
                z(e.selectedPlayer.id), e.close()
            };
        return r.jsxs(U, {
            children: [r.jsx(q, {
                children: e.selectedPlayer.name
            }), r.jsxs(D, {
                children: [r.jsx(h, {
                    type: "danger",
                    onClick: t,
                    ariaLabel: "Remove From Game",
                    children: "Remove From Game"
                }), S() ? r.jsx(h, {
                    style: {
                        marginLeft: 10
                    },
    ...
    ft = C(() => {
        ...
        const x = n.useMemo(() => t ? .3 : .2, [t]),
            v = () => i.length ? c ? r.jsxs(r.Fragment, {
                ...
                children: "No other players have joined this game."
            });
        return r.jsxs(X, {
            children: [r.jsx(Y, {
                initial: l.out,

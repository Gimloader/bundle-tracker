...
c.register('.....', function (d, e) {
    ...
    let w, x, y = z => z;
    const z = 'Error fetching subscription info. Try refreshing the page. If you continue to see this error, please contact support.';
    var _A = () => {
        const [B, C] = h.useState(!0), [D, E] = h.useState(''), [F, G] = h.useState(''), [H, I] = h.useState(''), [J, K] = h.useState(!1);
        h.useEffect(() => {
            (0, u.default)({});
        }, []), h.useEffect(() => {
            const L = (0, s.getUrlVariable)('session_id');
            if (L)
                (0, s.verifyStripe)({
                    sessionId: L,
                    onSuccess: M => {
                        (0, s.request)({
                            url: `/api/bulk/complete/${ M.subscriptionId }`,
                            success: N => {
                                E(N.paymentMethod), G(N.receiptUrl), I(N.invoiceUrl), K(N.renewal), C(!1);
                            },
                            error: N => (0, t.throwError)({ title: z })
                        });
                    },
                    onError: M => (0, t.throwError)({ title: z }),
                    onBoth: () => C(!1)
                });
            else {
                const M = (0, s.getUrlVariable)('subscriptionId');
                (0, s.request)({
                    url: `/api/bulk/complete/${ M }`,
                    success: N => {
                        E(N.paymentMethod), G(N.receiptUrl), I(N.invoiceUrl), K(N.renewal), C(!1);
                    },
                    error: N => (0, s.throwMessageError)({
                        e: N,
                        default: { title: z }
                    })
                });
        ...
        return (0, g.jsxs)(g.Fragment, {
            children: [
                (0, g.jsx)(s.Title, { title: 'Group License Complete' }),
                (0, g.jsxs)(_B, {
                    ...
                    children: [
                        ...
                        (0, g.jsx)(_C, {
                            children: B ? (0, g.jsx)('div', {
                                ...
                                children: [
                                    (0, g.jsx)(l.default, { isRenewal: J }),
                                    (0, g.jsx)(n.default, {}),
                                    'creditCard' === D && (0, g.jsx)(p.default, { receiptLink: F }),
                                    'purchaseOrder' === D && (0, g.jsx)(m.default, { invoiceLink: H }),
                                    (0, g.jsx)('div', { style: { height: 10 } }),
                                    (0, g.jsx)(q.default, { isRenewal: J }),
                                    (0, g.jsx)(n.default, {}),
                                    (0, g.jsx)(r.default, {})
                                ]
                            })
  ...
  padding: 20px;
  min-height: 900px;
`), j.default.Snow, j.default.Black, k.Fonts.SFPro), _C = i.default.div(x || (x = y`
  width: 100%;
  max-width: 550px;
`));
}), c.register('.....', function (d, e) {
    ...
    var _m = n => (0, f.jsxs)('div', {
        ...
        children: [
            ...
            (0, f.jsx)(_n, { children: 'Woohoo!' }),
            (0, f.jsx)(_o, { children: n.isRenewal ? 'Your group license renewal is complete!' : 'Your group license is ready to go!' })
        ]
    });
    const _n = g.default.h1(j || (j = l`
  color: ${ 0 };
  font-weight: ${ 0 };
  font-size: 50px;
`), h.default.Black, i.FontWeights.UltraBold), _o = g.default.p(k || (k = l`
  margin-top: -41px;
  font-size: 18px;
`));
}), c.register('.....', function (d, e) {
    ...
    var _k = l => (0, f.jsxs)(f.Fragment, {
        children: [
            (0, f.jsxs)(g.AntCard, {
                children: [
                    (0, f.jsx)(g.Header, { children: 'Invoice' }),
                    (0, f.jsx)(g.Description, { children: 'Click the button below to print out your invoice. A copy of this invoice has also been sent to your email.' }),
                    (0, f.jsx)(h.default, {
                        style: { marginTop: 5 },
                        href: l.invoiceLink,
                        target: '_blank',
            ...
            (0, f.jsxs)(g.AntCard, {
                children: [
                    (0, f.jsx)(g.Header, { children: 'Payment Information' }),
                    (0, f.jsxs)(g.Description, {
                        children: [
                            (0, f.jsx)('div', {
                                style: { marginTop: 3 },
                            ...
                            (0, f.jsx)('br', {}),
                            (0, f.jsx)('div', { children: (0, f.jsx)('b', { children: 'Gimkit, Inc' }) }),
                            (0, f.jsx)('div', { children: j.COMPANY_TOP_ADDRESS }),
                            (0, f.jsx)('div', { children: j.COMPANY_BOTTOM_ADDRESS }),
                            (0, f.jsx)(i.default, {}),
                            (0, f.jsx)('div', { children: 'With the check, please include a copy of the invoice. All Gimkit invoices on Purchase Orders have NET45 Terms.' })
                        ]
                    })
                ]
            })
    ...
    c('.....');
    var g = c('.....'), h = c('.....');
    var _i = j => (0, f.jsx)(f.Fragment, {
        children: (0, f.jsxs)(g.AntCard, {
            children: [
                (0, f.jsx)(g.Header, { children: 'Receipt' }),
                (0, f.jsx)(g.Description, { children: 'Click the button below to print out your receipt A copy of this receipt has also been sent to your email.' }),
                (0, f.jsx)(h.default, {
                    style: { marginTop: 5 },
                    href: j.receiptLink,
                    target: '_blank',
    ...
    var _k = l => {
        const {isRenewal: m} = l;
        return (0, f.jsxs)(g.AntCard, {
            children: [
                (0, f.jsx)(g.Header, { children: m ? 'Renewal Complete!' : 'Get Started!' }),
                (0, f.jsx)(g.Description, { children: m ? 'Your new group license is active! All of your teachers have been imported over from your expiring group. Click the button below to manage your new group license!' : `Your group license is active! Click the button below to invite your teachers to join your license and gain ${ j.COMPANY_NAME } Pro access!` }),
                (0, f.jsx)(h.default, {
                    href: i.GROUP_DASHBOARD,
                    type: 'primary',
                    style: { marginTop: 5 },
                    block: !0,
    ...
    var _p = () => (0, f.jsxs)(_q, {
        className: 'flex vc flex-column',
        children: [
            (0, f.jsx)(_r, { children: '\uD83D\uDCDA Resources' }),
            (0, f.jsx)(_s, { children: 'Take a look at the resources below to help you use your group license!' }),
            o.map(q => (0, f.jsx)('div', {
                style: {
                    fontSize: 16,
                    marginBottom: 5
            ...
            (0, f.jsx)(j.default, {}),
            (0, f.jsx)(_r, { children: '\uD83D\uDC4B Need Help?' }),
            (0, f.jsx)('div', { style: { height: 5 } }),
            (0, f.jsxs)(_s, {
                children: [
                    'Just email us at',
                    ' ',
  ...
  text-align: center;
`)), _r = g.default.h2(l || (l = n`
  font-size: 32px;
  font-weight: ${ 0 };
  color: ${ 0 };
`), i.FontWeights.UltraBold, h.default.Black), _s = g.default.p(m || (m = n`
  font-size: 17px;
  margin-top: -25px;
`));
}), c.register('.....', function (d, e) {

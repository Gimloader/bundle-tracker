        ...
        h.useEffect(() => {
            ...
            if (L)
                (0, s.verifyStripe)({
                    ...
                    onSuccess: L => {
                        (0, s.request)({
                            ...
                            success: L => {
                                E(L.paymentMethod), G(L.receiptUrl), I(L.invoiceUrl), K(L.renewal), C(!1);
                            },
                            error: L => (0, t.throwError)({
                                title: z
                            })
                        });
                    },
                    onError: L => (0, t.throwError)({
                        title: z
                    }),
                    onBoth: () => C(!1)
                });
                ...
                (0, s.request)({
                    ...
                    success: M => {
                        E(M.paymentMethod), G(M.receiptUrl), I(M.invoiceUrl), K(M.renewal), C(!1);
                    },
                    error: M => (0, s.throwMessageError)({
                        e: M,
                        default: {
                            title: z
                        }
                        ...
                        (0, g.jsx)(_C, {
                            children: B ? (0, g.jsx)('div', {
                                ...
                                children: [
                                    ...
                                    (0, g.jsx)(n.default, {}),
                                    'creditCard' === D && (0, g.jsx)(p.default, {
                                        receiptLink: F
                                    }),
                                    'purchaseOrder' === D && (0, g.jsx)(m.default, {
                                        invoiceLink: H
                                    }),
                                    (0, g.jsx)('div', {
                                        style: {
...
`), j.default.Snow, j.default.Black, k.Fonts.SFPro),
        _C = i.default.div(x || (x = y`
  width: 100%;
  max-width: 550px;
`));
}), c.register('xFSvl', function(d, e) {
    a(d.exports, 'default', function() {
        return _m;
    });
    var f = c('gRbUn');
    ...
    var _m = a => (0, f.jsxs)('div', {
        ...
        children: [
            ...
            (0, f.jsx)(_o, {
                children: a.isRenewal ? 'Your group license renewal is complete!' : 'Your group license is ready to go!'
            })
        ]
    });
...
`), h.default.Black, i.FontWeights.UltraBold),
        _o = g.default.p(k || (k = l`
  margin-top: -41px;
  font-size: 18px;
`));
}), c.register('OWIxl', function(d, e) {
    a(d.exports, 'default', function() {
        return _k;
    });
    var f = c('gRbUn');
                ...
                children: [
                    ...
                    (0, f.jsxs)(g.Description, {
                        children: [
                            ...
                            (0, f.jsx)('div', {
                                children: j.COMPANY_TOP_ADDRESS
                            }),
                            (0, f.jsx)('div', {
                                children: j.COMPANY_BOTTOM_ADDRESS
                            }),
                            (0, f.jsx)(i.default, {}),
                            (0, f.jsx)('div', {
...
`)),
  ...
  font-weight: ${ 0 };
  color: ${ 0 };
`), i.FontWeights.UltraBold, h.default.Black),
        _s = g.default.p(m || (m = n`
  font-size: 17px;
  margin-top: -25px;
`));

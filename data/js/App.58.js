...
a.register('o+uzb', function(b, c) {
    ...
    var e = a('0hzx+'),
        ...
        t = a('RJjEi');
    let u, v, w = _z => _z;
    const x = 'Error fetching subscription info. Try refreshing the page. If you continue to see this error, please contact support.';
    var _y = () => {
        const [_z, A] = f.useState(!0), [B, C] = f.useState(''), [D, E] = f.useState(''), [F, G] = f.useState(''), [H, I] = f.useState(!1);
        f.useEffect(() => {
            (0, s.default)({});
        }, []), f.useEffect(() => {
            const J = (0, q.getUrlVariable)('session_id');
            if (J)
                (0, q.verifyStripe)({
                    sessionId: J,
                    onSuccess: J => {
                        (0, q.request)({
                            url: `/api/bulk/complete/${ J.subscriptionId }`,
                            success: J => {
                                C(J.paymentMethod), E(J.receiptUrl), G(J.invoiceUrl), I(J.renewal), A(!1);
                            },
                            error: J => (0, r.throwError)({
                                title: x
                            })
                        });
                    },
                    onError: J => (0, r.throwError)({
                        title: x
                    }),
                    onBoth: () => A(!1)
                });
            else {
                const K = (0, q.getUrlVariable)('subscriptionId');
                (0, q.request)({
                    url: `/api/bulk/complete/${ K }`,
                    success: K => {
                        C(K.paymentMethod), E(K.receiptUrl), G(K.invoiceUrl), I(K.renewal), A(!1);
                    },
                    error: K => (0, q.throwMessageError)({
                        e: K,
                        default: {
                            title: x
                        }
                        ...
                        (0, e.jsx)(_A, {
                            children: _z ? (0, e.jsx)('div', {
                                ...
                                children: [
                                    ...
                                    (0, e.jsx)(l.default, {}),
                                    'creditCard' === B && (0, e.jsx)(n.default, {
                                        receiptLink: D
                                    }),
                                    'purchaseOrder' === B && (0, e.jsx)(k.default, {
                                        invoiceLink: F
                                    }),
                                    (0, e.jsx)('div', {
                                        style: {
...
`), h.default.Snow, h.default.Black, i.Fonts.SFPro),
        _A = g.default.div(v || (v = w`
  width: 100%;
  max-width: 550px;
`));
}), a.register('8/9rc', function(b, c) {
    ...
    var _k = _h => (0, d.jsxs)('div', {
        ...
        children: [
            ...
            (0, d.jsx)(_m, {
                children: _h.isRenewal ? 'Your group license renewal is complete!' : 'Your group license is ready to go!'
            })
        ]
    });
    const _l = e.default.h1(h || (h = j`
  color: ${ 0 };
  font-weight: ${ 0 };
  font-size: 50px;
`), f.default.Black, g.FontWeights.UltraBold),
        _m = e.default.p(i || (i = j`
  margin-top: -41px;
  font-size: 18px;
`));
}), a.register('DoQeN', function(b, c) {
    _h(b.exports, 'default', function() {
        return _i;
    });
    var d = a('0hzx+');
                ...
                children: [
                    ...
                    (0, d.jsxs)(e.Description, {
                        children: [
                            ...
                            (0, d.jsx)('div', {
                                children: h.COMPANY_TOP_ADDRESS
                            }),
                            (0, d.jsx)('div', {
                                children: h.COMPANY_BOTTOM_ADDRESS
                            }),
                            (0, d.jsx)(g.default, {}),
                            (0, d.jsx)('div', {
    ...
    var e = a('FHZOB'),
        f = a('ulE4q');
    var _g = _h => (0, d.jsx)(d.Fragment, {
        children: (0, d.jsxs)(e.AntCard, {
            children: [
                (0, d.jsx)(e.Header, {
                    children: 'Receipt'
                }),
    ...
    var _i = _h => {
        ...
        return (0, d.jsxs)(e.AntCard, {
            children: [
                (0, d.jsx)(e.Header, {
                    children: j ? 'Renewal Complete!' : 'Get Started!'
                }),
                (0, d.jsx)(e.Description, {
                    children: j ? 'Your new group license is active! All of your teachers have been imported over from your expiring group. Click the button below to manage your new group license!' : `Your group license is active! Click the button below to invite your teachers to join your license and gain ${ h.COMPANY_NAME } Pro access!`
                }),
                (0, d.jsx)(f.default, {
                    href: g.GROUP_DASHBOARD,
                    type: 'primary',
                    style: {
                        marginTop: 5
                    },
  ...
  text-align: center;
`)),
        _p = e.default.h2(j || (j = l`
  font-size: 32px;
  font-weight: ${ 0 };
  color: ${ 0 };
`), g.FontWeights.UltraBold, f.default.Black),
        _q = e.default.p(k || (k = l`
  font-size: 17px;
  margin-top: -25px;
`));

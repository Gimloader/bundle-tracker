...
function Dr() {
    if (st) return j;
    st = 1, Object.defineProperty(j, "__esModule", {
        value: !0
    }), j.useThrottledEffect = void 0;
    var o = Br();
    ...
    var d = j.useThrottledEffect = function(u, a) {
    ...
    bn = N.forwardRef((o, n) => {
        const [d, s] = N.useState(""), u = N.useRef(!1), a = N.useRef(!1), l = N.useRef(null), c = N.useRef(null), h = N.useRef([]), t = N.useRef(-1), r = N.useRef({
            ...
            const {
                ...
                color: I,
                width: kr
            } = m, P = c.current, H = l.current;
            if (P.beginPath(), P.moveTo(B, S), P.lineTo(q, T), P.strokeStyle = I, P.lineWidth = kr, P.stroke(), P.closePath(), b && o.emitLine) {
                const Er = m;
                m.xStart /= H.clientWidth, m.yStart /= H.clientHeight, m.xEnd /= H.clientWidth, m.yEnd /= H.clientHeight, m.width /= (H.clientWidth + H.clientHeight) / 2, o.emitLine(Er)
            }
        }, w = () => {
            const m = c.current,
                b = l.current;
            h.current = [...h.current, m.getImageData(0, 0, b.width, b.height)], t.current = t.current + 1, F()
        }, F = () => {
            const m = l.current;
            o.onLatestImage && (m != null && m.toDataURL) && o.onLatestImage(m.toDataURL("image/jpeg"))
        }, A = () => {
            const m = c.current,
                b = l.current;
            m.clearRect(0, 0, b.width, b.height), m.fillStyle = "white", m.fillRect(0, 0, b.width, b.height), w()
        }, R = () => {
            t.current <= 0 ? A() : (t.current = t.current - 1, h.current = [...h.current.slice(0, h.current.length - 1)], c.current.putImageData(h.current[t.current], 0, 0), F())
        }, k = m => {
            const b = l.current,
                B = m;
            m.xStart *= b.clientWidth, m.yStart *= b.clientHeight, m.xEnd *= b.clientWidth, m.yEnd *= b.clientHeight, m.width *= (b.clientWidth + b.clientHeight) / 2, y(B, !1)
        }, E = m => {
            const b = c.current,
                B = l.current,
                S = new Image;
            S.onload = () => {
                b.drawImage(S, 0, 0, B.width / D(), B.height / D())
            }, S.src = m
        };
        return Ir(() => {
            const m = l.current,
            ...
            m.width = S.width * D(), m.height = S.height * D(), b.scale(D(), D()), b.lineCap = "round", b.lineJoin = "round", h.current = [], t.current = -1, E(B)
            ...
            m.width = B.width * D(), m.height = B.height * D();
            const S = m.getContext("2d");
            S.scale(D(), D()), S.fillStyle = "white", S.fillRect(0, 0, m.width, m.height), S.lineCap = "round", S.lineJoin = "round", c.current = S, o.initialImage && E(o.initialImage);
            const q = b.getContext("2d");
            p.current = q, document.addEventListener("mousedown", g), document.addEventListener("mouseup", C)
        }, []), N.useEffect(() => {
            const m = f.current,
                b = p.current;
            if (!m || !b) return;
            const B = o.strokeWidth;
            m.width = B, m.height = B, b.clearRect(0, 0, m.width, m.height), b.beginPath(), b.arc(m.width / 2, m.height / 2, B / 2, 0, 2 * Math.PI), b.fillStyle = o.color, b.fill();
            const S = m.toDataURL("image");
            s(S)
        ...
        function s(t) {
            ...
            function e() {
                if (e.enabled) {
                    ...
                    for (var g = new Array(arguments.length), C = 0; C < g.length; C++) g[C] = arguments[C];
                    g[0] = n.coerce(g[0]), typeof g[0] != "string" && g.unshift("%O");
                    var x = 0;
                    g[0] = g[0].replace(/%([a-zA-Z%])/g, function(_, y) {
                        if (_ === "%%") return _;
                        x++;
                        var w = n.formatters[y];
                        if (typeof w == "function") {
                            var F = g[x];
                            _ = w.call(i, F), g.splice(x, 1), x--
                        }
                        return _
                    }), n.formatArgs.call(i, g);
                    var v = e.log || n.log || console.log.bind(console);
                    v.apply(i, g)
                }
            }
...
function de() {
    return ut || (ut = 1, (function(o, n) {
        ...
        function c() {
            ...
            return !t && typeof z < "u" && "env" in z && (t = d.DEBUG), t
        }
        n.enable(c());
...
function Jr() {
    return lt || (lt = 1, (function(o, n) {
        n = o.exports = s.debug = s.default = s, n.coerce = h, n.disable = l, n.enable = a, n.enabled = c, n.humanize = jr(), n.instances = [], n.names = [], n.skips = [], n.formatters = {};
...
function zr() {
    ...
    V.deconstructPacket = function(c) {
        var h = [],
            t = c.data,
            r = c;
    ...
    V.reconstructPacket = function(c, h) {
    ...
    return V.removeBlobs = function(c, h) {
        function t(i, f, p) {
            if (!i) return i;
            if (s && i instanceof Blob || u && i instanceof File) {
                ...
                for (var C = 0; C < i.length; C++) t(i[C], C, i);
            else if (typeof i == "object" && !n(i))
                for (var x in i) t(i[x], x, i)
        }
        var r = 0,
            e = c;
        t(e), r || h(e)
...
function et() {
    return mt || (mt = 1, (function(o) {
        ...
        l.prototype.encode = function(v, _) {
            if (n("encoding packet %j", v), o.BINARY_EVENT === v.type || o.BINARY_ACK === v.type) r(v, _);
            else {
                var y = h(v);
                _([y])
            }
        ...
        function h(v) {
            var _ = "" + v.type;
            if ((o.BINARY_EVENT === v.type || o.BINARY_ACK === v.type) && (_ += v.attachments + "-"), v.nsp && v.nsp !== "/" && (_ += v.nsp + ","), v.id != null && (_ += v.id), v.data != null) {
                var y = t(v.data);
                if (y !== !1) _ += y;
                else return c
            }
            return n("encoded %j as %s", v, _), _
        }
        ...
        function e(v) {
            this.reconstructor = null, v = v || {}, this.opts = {
                maxAttachments: v.maxAttachments || 10
            }
        }
        d(e.prototype), e.prototype.add = function(v) {
            var _;
            if (typeof v == "string") {
                if (this.reconstructor) throw new Error("got plaintext data when reconstructing a packet");
                _ = f(v, this.opts.maxAttachments), o.BINARY_EVENT === _.type || o.BINARY_ACK === _.type ? (this.reconstructor = new g(_), this.reconstructor.reconPack.attachments === 0 && this.emit("decoded", _)) : this.emit("decoded", _)
            } else if (a(v) || v.base64)
                if (this.reconstructor) _ = this.reconstructor.takeBinaryData(v), _ && (this.reconstructor = null, this.emit("decoded", _));
        ...
        function i(v, _) {
            switch (v) {
                ...
                case 1:
                    return _ === void 0;
                case 4:
                    return typeof _ == "string" || typeof _ == "object";
                case 2:
                case 5:
                    return u(_) && (typeof _[0] == "string" || typeof _[0] == "number");
                case 3:
                case 6:
                    return u(_)
            }
        ...
        function f(v, _) {
            ...
            if (o.types[w.type] == null) return C("unknown packet type " + w.type);
            if (o.BINARY_EVENT === w.type || o.BINARY_ACK === w.type) {
                for (var F = y + 1; v.charAt(++y) !== "-" && y != v.length;);
                var A = v.substring(F, y);
                if (A != Number(A) || v.charAt(y) !== "-") throw new Error("Illegal attachments");
                var R = Number(A);
                if (!x(R) || R < 0) throw new Error("Illegal attachments");
                if (R > _) throw new Error("too many attachments");
                w.attachments = R
            }
            if (v.charAt(y + 1) === "/") {
                for (var F = y + 1; ++y;) {
                    var k = v.charAt(y);
                    if (k === "," || y === v.length) break
                }
                w.nsp = v.substring(F, y)
            } else w.nsp = "/";
            var E = v.charAt(y + 1);
            if (E !== "" && Number(E) == E) {
                for (var F = y + 1; ++y;) {
                ...
                w.id = Number(v.substring(F, y + 1))
            }
            if (v.charAt(++y)) {
                var m = p(v.substr(y));
                if (i(w.type, m)) w.data = m;
                else throw new Error("invalid payload")
            }
            return n("decoded %s as %j", v, w), w
        }
        ...
        g.prototype.takeBinaryData = function(v) {
            if (this.buffers.push(v), this.buffers.length === this.reconPack.attachments) {
                var _ = s.reconstructPacket(this.reconPack, this.buffers);
                return this.finishedReconstruction(), _
            }
            return null
        ...
        var x = Number.isInteger || function(v) {
...
function Zr() {
    ...
    function n(f) {
        for (var p = [], g = 0, C = f.length, x, v; g < C;) x = f.charCodeAt(g++), x >= 55296 && x <= 56319 && g < C ? (v = f.charCodeAt(g++), (v & 64512) == 56320 ? p.push(((x & 1023) << 10) + (v & 1023) + 65536) : (p.push(x), g--)) : p.push(x);
        return p
    }

    function d(f) {
        for (var p = f.length, g = -1, C, x = ""; ++g < p;) C = f[g], C > 65535 && (C -= 65536, x += o(C >>> 10 & 1023 | 55296), C = 56320 | C & 1023), x += o(C);
        return x
    }
    ...
    function l(f, p) {
        p = p || {};
        for (var g = p.strict !== !1, C = n(f), x = C.length, v = -1, _, y = ""; ++v < x;) _ = C[v], y += a(_, g);
        return y
    }
    ...
    function h(f) {
        ...
        if ((p & 224) == 192) {
            if (g = c(), v = (p & 31) << 6 | g, v >= 128) return v;
            throw Error("Invalid continuation byte")
        }
        if ((p & 240) == 224) {
            if (g = c(), C = c(), v = (p & 15) << 12 | g << 6 | C, v >= 2048) return s(v, f) ? v : 65533;
            throw Error("Invalid continuation byte")
        }
        if ((p & 248) == 240 && (g = c(), C = c(), x = c(), v = (p & 7) << 18 | g << 12 | C << 6 | x, v >= 65536 && v <= 1114111)) return v;
...
function X() {
    return St || (St = 1, (function(o) {
        ...
        var r = o.packets = {
            ...
            f = $r();
        o.encodePacket = function(y, w, F, A) {
            typeof w == "function" && (A = w, w = !1), typeof F == "function" && (A = F, F = null);
            var R = y.data === void 0 ? void 0 : y.data.buffer || y.data;
            if (typeof ArrayBuffer < "u" && R instanceof ArrayBuffer) return g(y, w, A);
            if (typeof f < "u" && R instanceof f) return x(y, w, A);
            if (R && R.base64) return p(y, A);
            var k = r[y.type];
            return y.data !== void 0 && (k += F ? a.encode(String(y.data), {
                strict: !1
            }) : String(y.data)), A("" + k)
        };

        function p(y, w) {
            var F = "b" + o.packets[y.type] + y.data.data;
            return w(F)
        }

        function g(y, w, F) {
            if (!w) return o.encodeBase64Packet(y, F);
            var A = y.data,
                R = new Uint8Array(A),
                k = new Uint8Array(1 + A.byteLength);
            k[0] = r[y.type];
            for (var E = 0; E < R.length; E++) k[E + 1] = R[E];
            return F(k.buffer)
        }
        ...
        function x(y, w, F) {
            ...
            A[0] = r[y.type];
            var R = new f([A.buffer, y.data]);
            return F(R)
        }
        o.encodeBase64Packet = function(y, w) {
            var F = "b" + o.packets[y.type];
            if (typeof f < "u" && y.data instanceof f) {
                var A = new FileReader;
                return A.onload = function() {
                    var b = A.result.split(",")[1];
                    w(F + b)
                }, A.readAsDataURL(y.data)
            }
            var R;
            try {
                R = String.fromCharCode.apply(null, new Uint8Array(y.data))
            } catch {
                for (var k = new Uint8Array(y.data), E = new Array(k.length), m = 0; m < k.length; m++) E[m] = k[m];
                R = String.fromCharCode.apply(null, E)
            }
            return F += btoa(R), w(F)
        }, o.decodePacket = function(y, w, F) {
            if (y === void 0) return i;
            if (typeof y == "string") {
                if (y.charAt(0) === "b") return o.decodeBase64Packet(y.substr(1), w);
                if (F && (y = v(y), y === !1)) return i;
                var R = y.charAt(0);
                return Number(R) != R || !e[R] ? i : y.length > 1 ? {
                    type: e[R],
                    data: y.substring(1)
                } : {
                    type: e[R]
            ...
            var A = new Uint8Array(y),
                R = A[0],
                k = s(y, 1);
            return f && w === "blob" && (k = new f([k])), {
                type: e[R],
                data: k
            }
        };
        ...
        o.decodeBase64Packet = function(y, w) {
            var F = e[y.charAt(0)];
            if (!l) return {
                type: F,
                data: {
            ...
            var A = l.decode(y.substr(1));
            return w === "blob" && f && (A = new f([A])), {
                type: F,
                data: A
            }
        }, o.encodePayload = function(y, w, F) {
            typeof w == "function" && (F = w, w = null);
            var A = d(y);
            if (w && A) return f && !t ? o.encodePayloadAsBlob(y, F) : o.encodePayloadAsArrayBuffer(y, F);
            if (!y.length) return F("0:");
            ...
            function k(E, m) {
                o.encodePacket(E, A ? w : !1, !1, function(b) {
                    m(null, R(b))
                })
            }
            _(y, k, function(E, m) {
        ...
        function _(y, w, F) {
            for (var A = new Array(y.length), R = u(y.length, F), k = function(m, b, B) {
                    w(b, function(S, q) {
                        A[m] = q, B(S, A)
                    })
                }, E = 0; E < y.length; E++) k(E, y[E], R)
        }
        o.decodePayload = function(y, w, F) {
            if (typeof y != "string") return o.decodePayloadAsBinary(y, w, F);
            typeof w == "function" && (F = w, w = null);
            var A;
            if (y === "") return F(i, 0, 1);
            for (var R = "", k, E, m = 0, b = y.length; m < b; m++) {
                var B = y.charAt(m);
                if (B !== ":") {
                    R += B;
                    continue
                }
                if (R === "" || R != (k = Number(R)) || (E = y.substr(m + 1, k), R != E.length)) return F(i, 0, 1);
                if (E.length) {
                    if (A = o.decodePacket(E, w, !1), i.type === A.type && i.data === A.data) return F(i, 0, 1);
                    var S = F(A, m + k, b);
                    if (S === !1) return
                }
                m += k, R = ""
            ...
            if (R !== "") return F(i, 0, 1)
        }, o.encodePayloadAsArrayBuffer = function(y, w) {
            if (!y.length) return w(new ArrayBuffer(0));

            function F(A, R) {
                o.encodePacket(A, !0, !0, function(k) {
                    return R(null, k)
                })
            }
            _(y, F, function(A, R) {
                var k = R.reduce(function(b, B) {
                        var S;
                        return typeof B == "string" ? S = B.length : S = B.byteLength, b + S.toString().length + S + 2
                    }, 0),
                    E = new Uint8Array(k),
                    m = 0;
                return R.forEach(function(b) {
                    var B = typeof b == "string",
                        S = b;
                    if (B) {
                        for (var I = new Uint8Array(b.length), q = 0; q < b.length; q++) I[q] = b.charCodeAt(q);
                        S = I.buffer
                    }
                    B ? E[m++] = 0 : E[m++] = 1;
                    for (var T = S.byteLength.toString(), q = 0; q < T.length; q++) E[m++] = parseInt(T[q]);
                    E[m++] = 255;
                    for (var I = new Uint8Array(S), q = 0; q < I.length; q++) E[m++] = I[q]
                }), w(E.buffer)
            })
        }, o.encodePayloadAsBlob = function(y, w) {
            function F(A, R) {
                o.encodePacket(A, !0, !0, function(k) {
                    var E = new Uint8Array(1);
                    if (E[0] = 1, typeof k == "string") {
                        for (var m = new Uint8Array(k.length), b = 0; b < k.length; b++) m[b] = k.charCodeAt(b);
                        k = m.buffer, E[0] = 0
                    }
                    for (var B = k instanceof ArrayBuffer ? k.byteLength : k.size, S = B.toString(), q = new Uint8Array(S.length + 1), b = 0; b < S.length; b++) q[b] = parseInt(S[b]);
                    if (q[S.length] = 255, f) {
                        var T = new f([E.buffer, q.buffer, k]);
                        R(null, T)
                    }
                })
            }
        ...
        }, o.decodePayloadAsBinary = function(y, w, F) {
            typeof w == "function" && (F = w, w = null);
            for (var A = y, R = []; A.byteLength > 0;) {
                for (var k = new Uint8Array(A), E = k[0] === 0, m = "", b = 1; k[b] !== 255; b++) {
                    if (m.length > 310) return F(i, 0, 1);
                    m += k[b]
                }
                A = s(A, 2 + m.length), m = parseInt(m);
                var B = s(A, 0, m);
                if (E) try {
                    ...
                    B = "";
                    for (var b = 0; b < S.length; b++) B += String.fromCharCode(S[b])
                }
                R.push(B), A = s(A, m)
            }
            var q = R.length;
            R.forEach(function(T, I) {
                F(o.decodePacket(T, w, !0), I, q)
            })
        }
    })(Ee)), Ee
}
...
function ge() {
    return Ot || (Ot = 1, Pe = function(o, n) {
        var d = function() {};
...
function rn() {
    ...
    s(c, n), c.prototype.supportsBinary = !0, c.prototype.request = function(e) {
        ...
        var f = typeof e != "string" && e !== void 0,
            ...
            g = this;
        p.on("success", i), p.on("error", function(C) {
    ...
    return n(c, o), c.prototype.supportsBinary = !1, c.prototype.doClose = function() {
        ...
        function C() {
            if (r.iframe) try {
                ...
                r.onError("jsonp polling iframe removal error", v)
            }
            try {
                var x = '<iframe src="javascript:0" name="' + r.iframeId + '">';
...
function sn() {
    ...
    return s(t, o), t.prototype.name = "websocket", t.prototype.supportsBinary = !0, t.prototype.doOpen = function() {
        ...
        var e = this;
        this.writable = !1;
        for (var i = r.length, f = 0, p = i; f < p; f++)(function(C) {
            n.encodePacket(C, e.supportsBinary, function(x) {
                if (!e.usingBrowserWebSocket) {
                    var v = {};
                    if (C.options && (v.compress = C.options.compress), e.perMessageDeflate) {
                        var _ = typeof x == "string" ? L.byteLength(x) : x.length;
                        _ < e.perMessageDeflate.threshold && (v.compress = !1)
                    }
                }
                try {
                    e.usingBrowserWebSocket ? e.ws.send(x) : e.ws.send(x, v)
                } catch {
        ...
        typeof this.ws < "u" && (this.ws.onerror = function() {}, this.ws.close())
...
function on() {
    ...
    c.priorWebsocketSuccess = !1, n(c.prototype), c.protocol = u.protocol, c.Socket = c, c.Transport = nt(), c.transports = Jt(), c.parser = X(), c.prototype.createTransport = function(t) {
    ...
    return c.prototype.open = function() {
        ...
        function f() {
            if (i.onlyBinaryUpgrades) {
                var y = !this.supportsBinary && i.transport.supportsBinary;
                e = e || y
            }
            e || (d('probe transport "%s" opened', t), r.send([{
                type: "ping",
                data: "probe"
            }]), r.once("packet", function(w) {
                if (!e)
                    if (w.type === "pong" && w.data === "probe") {
                        ...
                        c.priorWebsocketSuccess = r.name === "websocket", d('pausing current transport "%s"', i.transport.name), i.transport.pause(function() {
                            e || i.readyState !== "closed" && (d("changing transport and sending upgrade packet"), _(), i.setTransport(r), r.send([{
                                type: "upgrade"
        ...
        function p() {
            e || (e = !0, _(), r.close(), r = null)
        }

        function g(y) {
            var w = new Error("probe error: " + y);
            w.transport = r.name, p(), d('probe transport "%s" failed because of error: %s', t, y), i.emit("upgradeError", w)
        }
        ...
        function v(y) {
            r && y.name !== r.name && (d('"%s" works - aborting "%s"', y.name, r.name), p())
        }

        function _() {
            r.removeListener("open", f), r.removeListener("error", g), r.removeListener("close", C), i.removeListener("close", x), i.removeListener("upgrading", v)
        }
        r.once("open", f), r.once("error", g), r.once("close", C), this.once("close", x), this.once("upgrading", v), r.open()
...
function an() {
    return Xt || (Xt = 1, ee.exports = on(), ee.exports.parser = X()), ee.exports
}
var ze = {
        exports: {}
    },
        ...
        s(i.prototype), i.prototype.subEvents = function() {
            ...
            return function() {
                if (!g) {
                    g = !0;
                    var C = u(arguments);
                    c("sending ack %j", C), p.packet({
                        type: t(C) ? d.BINARY_ACK : d.ACK,
                        id: f,
                        data: C
                    })
                }
...
function $t() {
    ...
    return r.prototype.emitAll = function() {
        ...
        var g = u(f, "open", function() {
            ...
            C = u(f, "error", function(_) {
                if (l("connect_error"), p.cleanup(), p.readyState = "closed", p.emitAll("connect_error", _), e) {
        ...
        if (this._timeout !== !1) {
            var x = this._timeout;
            l("connect attempt will timeout after %d", x), x === 0 && g.destroy();
            var v = setTimeout(function() {
                l("connect attempt timed out after %d", x), g.destroy(), f.close(), f.emit("error", "timeout"), p.emitAll("connect_timeout", x)
            }, x);
            this.subs.push({
                destroy: function() {
                    clearTimeout(v)
        ...
        return this.subs.push(g), this.subs.push(C), this
    ...
    return er || (er = 1, (function(o, n) {
        ...
        function c(h, t) {
            ...
            var r = d(h),
                ...
                C;
            return g ? (a("ignoring socket cache for %s", e), C = u(e, t)) : (l[i] || (a("new io instance for %s", e), l[i] = u(e, t)), C = l[i]), r.query && !t.query && (t.query = r.query), C.socket(r.path, t)
        }
        n.protocol = s.protocol, n.connect = c, n.Manager = $t(), n.Socket = _r()
...
function hn() {
    ...
    function d(u, a, l) {
        ...
        if (c === "object") {
            ...
            var g = [],
                C = "",
                x = Object.keys(l);
            for (h = 0, t = x.length; h < t; h++) C = x[h], typeof l[C] != "function" && g.push(C);
            ...
            for (h = 0; h < i; h++) C = g[h], f += d(u, a, C), f += d(u, a, l[C]);
            return f
        }
    ...
    function s(u) {
        ...
        for (var f, p = 0, g = 0, C = 0, x = a.length; C < x; C++)
            if (t.setUint8(e + C, a[C]), C + 1 === i) {
                if (f = l[r], p = f._length, g = e + i, f._bin)
                    for (var v = new Uint8Array(f._bin), _ = 0; _ < p; _++) t.setUint8(g + _, v[_]);
...
function Rr() {
    if (ur) return W;
    ur = 1;
    var o = W && W.__importDefault || function(a) {

...
d.register('.....', function (e, f) {
    ...
    d('.....');
    var h = d('.....');
    var _i = j => (0, g.jsx)(g.Fragment, { children: (0, g.jsx)(h.default, { ...j }) });
}), d.register('.....', function (e, f) {
    ...
    const _v = w => {
            ...
            return y;
        }, _w = (x, y, z) => 1 === y ? x : z || x + 's', _x = y => y.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ','), _y = z => {
            if (_cb()) {
        ...
        }, _B = C => C === i.upgradeNames.moneyPerQuestion ? 'moneyPerQuestion' : C === i.upgradeNames.streakBonus ? 'streakBonus' : C === i.upgradeNames.multiplier ? 'multiplier' : 'insurance', _C = (D, E) => {
            const {
                type: F,
                blockSound: G
            } = E;
        ...
        }, _D = E => E ? E.charAt(0).toUpperCase() + E.slice(1) : '', _E = F => _D(F), _F = G => {
            let H = '';
            ...
            r.BOSS_BATTLE
        ].includes(l.default.gameOptions.specialGameType[0]), _J = (K, L) => {
            const M = l.default.navigation.attackModal;
            _W(n.default.powerupAttack, {
                name: M.powerup,
                target: K
            });
        }, _K = L => L.replace('#', _I() ? 'team' : 'player'), _L = () => l.default.questions.eqt ? (0, s.DecryptData)(l.default.questions.eqt) : [], _M = () => _eb();
    function _N(O) {
        return '/assets/play/' + O;
    }
    const _O = P => P.displayName ? P.displayName : P.name, _P = Q => Q * l.default.upgrades.upgradePricingDiscount, _Q = () => {
        ...
        }, _S = () => _W(n.default.requestPlayerDefendingHomebase), _T = () => {
            let U = !1;
            ...
            Z && Z.send(X, Y);
        }, _X = () => l.default.gameOptions.specialGameType.includes(k.THANOS), _Y = () => l.default.gameOptions.specialGameType.includes(k.SHOP_QR_SCAN), _Z = () => l.default.gameOptions.specialGameType.includes(r.BOSS_BATTLE), _$ = () => l.default.gameOptions.specialGameType.includes(k.HIDDEN), _ab = () => l.default.gameOptions.specialGameType.includes(k.LAVA), _bb = () => l.default.gameOptions.specialGameType.includes(k.IMPOSTER), _cb = () => l.default.gameOptions.specialGameType.includes(k.DRAW), _db = () => l.default.gameOptions.specialGameType.includes(k.COMEBACK), _eb = () => l.default.gameOptions.specialGameType.includes(k.PARDY), _fb = () => l.default.gameOptions.specialGameType.includes(r.HUMAN_ZOMBIE_DEFENDING_HOMEBASE), _gb = hb => {
            let ib = hb.trim();
            return ib = ib.replace(/[\u2018\u2019]/g, '\'').replace(/[\u201C\u201D]/g, '"'), ib = ib.toLowerCase(), ib;
        }, _hb = () => _bb() ? 'Mission Control' : 'Shop', _ib = () => _cb() ? p.DRAW_MODE_FONT : q.default.mainFontName;
}), d.register('.....', function (e, f) {
    var g, h;
    ...
    var i = function (j) {
        ...
        }(d('.....')), j = _s(d('.....')), k = _s(d('.....')), l = _s(d('.....')), m = _s(d('.....')), n = _s(d('.....')), o = d('.....'), p = d('.....'), q = _s(d('.....')), r = d('.....');
    function _s(t) {
    ...
    var v = function (w) {
        ...
        function z() {
            for (var A, B = arguments.length, C = new Array(B), D = 0; D < B; D++)
                z[D] = arguments[D];
            return (A = w.call.apply(w, [this].concat(z)) || this).state = { toast: [] }, A.toastKey = 1, A.collection = {}, A.isToastActive = function (E) {
        ...
        return E.componentDidMount = function () {
            ...
            var I = this, J = this.props.closeButton;
            ...
            'function' == typeof G.onOpen && (L.onOpen = G.onOpen), 'function' == typeof G.onClose && (L.onClose = G.onClose), (0, i.isValidElement)(F) && 'string' != typeof F.type && 'number' != typeof F.type ? F = (0, i.cloneElement)(F, { closeToast: K }) : 'function' == typeof F && (F = F({ closeToast: K })), this.collection = u({}, this.collection, ((H = {})[J] = {
                position: L.position,
                options: L,
                content: F
            }, H)), this.setState({
            ...
            var F = this, G = {}, H = this.props, I = H.className, J = H.style;
            return (H.newestOnTop ? Object.keys(this.collection).reverse() : Object.keys(this.collection)).forEach(function (K) {
                var L = F.collection[K], M = L.position, N = L.options, O = L.content;
                ...
                var L = 1 === G[K].length && null === G[K][0], M = {
                        className: (0, k.default)('Toastify__toast-container', 'Toastify__toast-container--' + K, { 'Toastify__toast-container--rtl': F.props.rtl }, F.parseClassName(I)),
                        style: L ? u({}, J, { pointerEvents: 'none' }) : u({}, J)
                    };
                return i.default.createElement(l.default, u({}, M, { key: 'container-' + K }), G[K]);
            });
        }, E.render = function () {
            return i.default.createElement('div', { className: 'Toastify' }, this.renderToast());
        }, z;
    }(i.Component);
    v.propTypes = {
    ...
    var i = function (j) {
            ...
            return k.default = j, k;
        }(d('.....')), j = _o(d('.....')), k = _o(d('.....')), l = _o(d('.....')), m = d('.....'), n = d('.....');
    function _o(p) {
    ...
    var s = function () {
            ...
            function x() {
                ...
                return (y = u.call.apply(u, [this].concat(x)) || this).state = {
                    ...
                    y.props.autoClose && y.setState({ isRunning: !1 });
                }, y.playToast = function () {
                    y.props.autoClose && y.setState({ isRunning: !0 });
                    ...
                    if (y.flag.canDrag) {
                        if (y.flag.canDrag = !1, Math.abs(y.drag.deltaX) > y.drag.removalDistance)
                            return void y.setState({ preventExitTransition: !0 }, y.props.closeToast);
                    ...
                    var C = y.ref.getBoundingClientRect(), D = C.top, E = C.bottom, F = C.left, G = C.right;
            ...
            return C.componentDidMount = function () {
                ...
                var D = this, E = this.props, F = E.closeButton, G = E.children, H = E.autoClose, I = E.pauseOnHover, J = E.closeOnClick, K = E.type, L = E.hideProgressBar, M = E.closeToast, N = E.transition, O = E.position, P = E.onExited, Q = E.className, R = E.bodyClassName, S = E.progressClassName, T = E.progressStyle, U = E.updateId, V = E.role, W = E.progress, X = E.isProgressDone, Y = E.rtl, Z = { className: (0, k.default)('Toastify__toast', 'Toastify__toast--' + K, { 'Toastify__toast--rtl': Y }, Q) };
                ...
                }), i.default.createElement('div', p({}, this.props.in && { role: V }, { className: (0, k.default)('Toastify__toast-body', R) }), G), F && F, (H || $) && i.default.createElement(l.default, p({}, U && !$ ? { key: 'pb-' + U } : {}, {
                    rtl: Y,
                    delay: H,
    ...
    var i = _n(d('.....')), j = _n(d('.....')), k = _n(d('.....')), l = d('.....'), m = d('.....');
    function _n(o) {
    ...
    function p(q) {
        var r, s = q.delay, t = q.isRunning, u = q.closeToast, v = q.type, w = q.hide, x = q.className, y = q.style, z = q.controlledProgress, A = q.progress, B = q.isProgressDone, C = q.rtl, D = o({}, y, {
                animationDuration: s + 'ms',
                animationPlayState: t ? 'running' : 'paused',
                opacity: w ? 0 : 1,
                transform: z ? 'scaleX(' + _n + ')' : null
            }), E = (0, k.default)('Toastify__progress-bar', z ? 'Toastify__progress-bar--controlled' : 'Toastify__progress-bar--animated', 'Toastify__progress-bar--' + v, { 'Toastify__progress-bar--rtl': C }, x), F = ((r = {})[z && p ? 'onTransitionEnd' : 'onAnimationEnd'] = z && !p ? null : u, r);
    ...
    function l(m) {
        var n = m.closeToast, o = m.type, p = m.ariaLabel;
    ...
    }, l.defaultProps = { ariaLabel: 'close' }, h = l;
}), d.register('.....', function (e, f) {
    var g, h, i, j;
    ...
    var k, l = (k = d('.....')) && k.__esModule ? k : { default: k };
    var m = (0, l.default)({
    ...
    a(e.exports), b(e.exports, '__esModule', function () {
        ...
        var j = i.enter, k = i.exit, l = i.duration, m = void 0 === l ? 750 : l, n = i.appendPosition, o = void 0 !== n && n;
        return function (p) {
            var q, r, s = p.children, t = p.position, u = p.preventExitTransition, v = function (w, x) {
                    if (null == w)
                        return {};
    ...
    var i, j = (i = d('.....')) && i.__esModule ? i : { default: i }, k = d('.....');
    function l() {
        ...
        update: function (u, v) {
            setTimeout(function () {
                if (m && void 0 !== m.collection[u]) {
                    var w = m.collection[u], x = w.options, y = w.content, z = l({}, x, v, { toastId: v.toastId || u });
    ...
    var g = d('.....'), h = d('.....');
    const _i = new (0, g.Howl)({ src: [(0, h.getAssetPath)('correct.mp3')] }), _j = new (0, g.Howl)({ src: [(0, h.getAssetPath)('incorrect.mp3')] }), _k = new (0, g.Howl)({ src: [(0, h.getAssetPath)('click.wav')] }), _l = new (0, g.Howl)({ src: [(0, h.getAssetPath)('click2.wav')] }), _m = new (0, g.Howl)({ src: [(0, h.getAssetPath)('applyTheme.wav')] }), _n = new (0, g.Howl)({ src: [(0, h.getAssetPath)('successClick.wav')] }), _o = new (0, g.Howl)({ src: [(0, h.getAssetPath)('woosh.wav')] }), _p = (new (0, g.Howl)({ src: [(0, h.getAssetPath)('splash.wav')] }), new (0, g.Howl)({ src: [(0, h.getAssetPath)('done.wav')] })), _q = new (0, g.Howl)({
            src: [(0, h.getAssetPath)('celebrate.mp3')],
            volume: 0.5
        }), _r = new (0, g.Howl)({ src: [(0, h.getAssetPath)('error.wav')] }), _s = new (0, g.Howl)({ src: [(0, h.getAssetPath)('success.wav')] }), _t = new (0, g.Howl)({ src: [(0, h.getAssetPath)('alert.wav')] }), _u = new (0, g.Howl)({ src: [(0, h.getAssetPath)('clap.wav')] }), _v = new (0, g.Howl)({ src: [(0, h.getAssetPath)('pop.mp3')] }), _w = new (0, g.Howl)({ src: [(0, h.getAssetPath)('freeze.mp3')] }), _x = new (0, g.Howl)({ src: [(0, h.getAssetPath)('stone.mp3')] }), _y = new (0, g.Howl)({
            src: [(0, h.getAssetPath)('drain.mp3')],
            volume: 0.7
        }), _z = new (0, g.Howl)({ src: [(0, h.getAssetPath)('pieSlice.mp3')] }), _A = new (0, g.Howl)({
            src: [(0, h.getAssetPath)('spark.mp3')],
            volume: 0.4
        }), _B = new (0, g.Howl)({ src: [(0, h.getAssetPath)('bounce.wav')] });
}), d.register('.....', function (e, f) {
    ...
    const g = 'THANOS', _h = 'HIDDEN', _i = 'SHOP_QR_SCAN', _j = 'DEFENDING_HOMEBASE', _k = 'LAVA', _l = 'IMPOSTER', _m = 'DRAW', _n = 'COMEBACK', _o = 'PARDY';
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return d;
    });
    ...
    const g = 'CLASSIC', _h = 'TEAMS', _i = 'THANOS', _j = 'BOSS_BATTLE', _k = 'HUMAN_ZOMBIE_DEFENDING_HOMEBASE', _l = 'LAVA', _m = 'IMPOSTER', _n = 'DRAW', _o = 'PARDY';
}), d.register('.....', function (e, f) {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    const j = d('.....').themes.filter(k => 'Default' === k.name)[0], _k = {
            background: '#311B92',
    ...
    var _r = (0, o.observer)(s => {
        const {theme: t} = l.useContext(p.default);
        return (0, g.jsx)(i.default, {
            theme: q,
            children: (0, g.jsx)(m.ThemeProvider, {
                theme: (0, n.toJS)(t.theme),
                children: (0, g.jsx)(g.Fragment, { children: (0, g.jsx)(j.default, { ...s }) })
            })
        });
    });
}), d.register('.....', function (e, f) {
    ...
    var i = d('.....'), j = d('.....'), k = d('.....');
    var _l = function (m) {
        var n = m.children, o = m.theme, p = (0, j.default)(), q = c(h).useMemo(function () {
        ...
        return c(h).createElement(i.default.Provider, { value: q }, n);
    };
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _i;
  ...
  overflow: hidden;
  color: ${ 0 };
`), u.default.Black), A = k.default.div(w || (w = y`
  width: 100%;
  height: 100%;
  display: flex;
  flex-flow: column;
  ...
  overflow: hidden;
`), l.default.name, B => B.blurred && 'filter: blur(5px);'), B = k.default.div(x || (x = y`
  height: 0px;
  width: 0px;
  .toast-body {
    font-family: ${ 0 };
...
`), l.default.name);
    var _C = (0, j.observer)(D => {
        const {ui: E} = h.useContext(t.default);
        return (0, g.jsxs)(g.Fragment, {
            children: [
                ...
                (0, g.jsx)(B, { children: (0, g.jsx)(i.ToastContainer, { bodyClassName: 'toast-body' }) }),
                (0, g.jsx)(q.default, {}),
                (0, g.jsx)(r.default, {}),
                (0, g.jsx)(s.default, {}),
                (0, g.jsx)(o.default, {})
  ...
  flex: 0 1 auto;
  color: ${ 0 };
`), k.default.White), G = q.default.div(A || (A = C`
  height: ${ 0 }px;
  background: #4252af;
  position: static;
  display: flex;
  ...
  box-shadow: ${ 0 };
  z-index: 1;
`), 63, l.default.basic), H = q.default.div(B || (B = C`
  width: 100%;
  display: flex;
  align-items: center;
`));
    var _I = (0, o.observer)(() => {
        const {
                ...
                navigation: L,
                powerups: M,
                questions: {lockedViewingCorrectAnswer: N}
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = i.forwardRef(function (p, q) {
            var r = p.edge, s = void 0 !== r && r, t = p.children, u = p.classes, v = p.className, w = p.color, x = void 0 === w ? 'default' : w, y = p.disabled, z = void 0 !== y && y, A = p.disableFocusRipple, B = void 0 !== A && A, C = p.size, D = void 0 === C ? 'medium' : C, E = (0, h.default)(p, [
                    'edge',
                    'children',
                    'classes',
                    'className',
            ...
            return i.createElement(m.default, (0, g.default)({
                ...
                disabled: z,
                ref: q
            }, E), i.createElement('span', { className: u.label }, t));
            ...
            return {
                root: {
                    ...
                    transition: q.transitions.create('background-color', { duration: q.transitions.duration.shortest }),
                    '&:hover': {
        ...
        }, { name: 'MuiIconButton' })(o);
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z' }), 'Menu');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _j;
    });
    ...
    function _j(k, l) {
        var m = c(h).memo(c(h).forwardRef(function (n, o) {
            return c(h).createElement(i.default, (0, g.default)({ ref: o }, n), k);
        }));
    ...
    var g = { basic: '0px 4px 33px -6px rgba(0, 0, 0, 0.46)' };
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _t;
    });
    ...
    let s = class extends q.Component {
        render() {
            return this.props.navigation.currentRoute === m.default.upgrade ? (0, i.jsx)(r, { goBack: this.goBack }) : null;
        }
        constructor(...e) {
    ...
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z' }), 'ArrowBack');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _r;
    });
    ...
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M17 20c-.29 0-.56-.06-.76-.15-.71-.37-1.21-.88-1.71-2.38-.51-1.56-1.47-2.29-2.39-3-.79-.61-1.61-1.24-2.32-2.53C9.29 10.98 9 9.93 9 9c0-2.8 2.2-5 5-5s5 2.2 5 5h2c0-3.93-3.07-7-7-7S7 5.07 7 9c0 1.26.38 2.65 1.07 3.9.91 1.65 1.98 2.48 2.85 3.15.81.62 1.39 1.07 1.71 2.05.6 1.82 1.37 2.84 2.73 3.55.51.23 1.07.35 1.64.35 2.21 0 4-1.79 4-4h-2c0 1.1-.9 2-2 2zM7.64 2.64L6.22 1.22C4.23 3.21 3 5.96 3 9s1.23 5.79 3.22 7.78l1.41-1.41C6.01 13.74 5 11.49 5 9s1.01-4.74 2.64-6.36zM11.5 9c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5-1.12-2.5-2.5-2.5-2.5 1.12-2.5 2.5z' }), 'Hearing');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    ...
    var h = g(d('.....')), i = (0, g(d('.....')).default)(h.default.createElement('path', { d: 'M15 7.5V2H9v5.5l3 3 3-3zM7.5 9H2v6h5.5l3-3-3-3zM9 16.5V22h6v-5.5l-3-3-3 3zM16.5 9l-3 3 3 3H22V9h-5.5z' }), 'Games');
    e.exports.default = i;
}), d.register('.....', function (e, f) {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....');
    d('.....');
    var q = d('.....'), r = d('.....'), s = d('.....'), t = d('.....'), u = d('.....'), v = d('.....');
    let w, x, y, z, A = B => B;
    const _B = 'fas fa-link', C = u.default.div(w || (w = A`
  margin-top: 7px;
  margin-bottom: 7px;
  width: 100%;
  background: ${ 0 };
  ...
  align-items: center;
  font-family: ${ 0 };
`), D => D.backgroundColor, D => D.customBorderRadius || 3, D => D.textColor, o.default.basic, () => (0, r.mainFontName)()), D = u.default.div(x || (x = A`
  display: flex;
  align-items: center;
  flex: 1;
`)), E = u.default.div(y || (y = A`
  ...
  background: ${ 0 };
  color: ${ 0 };
`), F => F.backgroundColor, F => F.textColor), F = u.default.div(z || (z = A`
  font-weight: normal;
  font-size: 15px;
`)), G = H => {
            let I = '';
    ...
    let H = class extends t.Component {
        render() {
            const I = this.props, J = this.getIcon();
            ...
            if (K) {
                ...
                M || (M.name = 'Default');
                let N = n.default.White, O = n.default.Black;
                    ...
                    children: [
                            ...
                            children: [
                                (0, i.jsx)(E, {
                                    ...
                                    children: (0, i.jsx)(m.default, {
                                        paddingHorizontal: 7,
                                        paddingVertical: 7,
                                        text: J ? (0, i.jsx)(k.default, { name: J }) : I.position.toString()
                                    })
                                }),
                                (0, i.jsx)('div', {
                        ...
                        this.props.usePowerupAction && (0, i.jsx)('div', {
                            ...
                            children: (0, i.jsx)(j.default, {
                                ...
                                label: (0, i.jsx)(l.default, { text: this.getUseButtonText() }),
                                size: 'small',
                                onClick: this.attack
                            })
                        })
                    ...
                    (0, i.jsxs)(D, {
                        children: [
                            ...
                            (0, i.jsxs)('div', {
                                ...
                                children: [
                                    (0, i.jsx)('div', { children: this.state.showingBalance ? (0, r.getMoney)(N.balance) : (0, i.jsx)(l.default, { text: (0, r.getTeamName)(N.id) }) }),
                                    (0, i.jsx)(F, { children: G(N) })
                                ]
                            })
                        ]
                    }),
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { showingBalance: !1 }), (0, g.default)(this, 'canUsePowerup', () => {
                ...
                ((0, r.inThanosMode)() || !(0, r.inHiddenMode)() && ((0, r.inTeamMode)() || this.props.gameValues.gameStatus !== v.GameStatus.gameplay)) && this.setState({ showingBalance: !this.state.showingBalance });
            });
        }
    };
    H = (0, h.__decorate)([
    ...
    let l = class extends i.Component {
        componentDidUpdate(m) {
            m.text !== this.props.text && (this.setState({ text: this.props.text }), this.onTranslate());
        }
        componentDidMount() {
            this.onTranslate();
        }
        onTranslate() {
            if ('en' !== this.props.gameOptions.language && !this.props.text.includes(this.props.disableIfContains))
                return this.props.translations[this.props.text] ? this.setState({ text: this.props.translations[this.props.text] }) : void this.requestTranslation().then(m => {
                    this.props.translations[this.props.text] = m, this.setState({ text: m });
                }).catch();
        }
        render() {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { text: this.props.text }), (0, g.default)(this, 'buildString', () => {
                                        ...
                                        if (z.action !== m.default.defendingHomebaseResults) {
                                            ...
                                            if (z.action !== m.default.lavaResults) {
                                                if (z.action !== m.default.successModalInfo)
                                                    ...
                                                    new (0, o.Howl)({ src: [(0, i.getAssetPath)(y.sound)] }).play();
                                                }
                                            } else
    ...
    var _m = (n, o) => {
        ...
        if (p === j.default.theme) {
            const r = q, s = h.default.theme.availableThemes.filter(t => t && t.name && t.name === r)[0];
            if (!s)
                return;
    ...
    d('.....');
    var h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....');
    const l = () => k.default && k.default.powerups && k.default.powerups.screenAttack && k.default.powerups.screenAttack.powerupName ? k.default.powerups.screenAttack.powerupName : '', _m = () => {
            const n = l();
  ...
  color: ${ 0 };
  margin-right: 5px;
`), q => q.colors.background, q => q.colors.text), _q = r => (0, h.jsx)(i.default, {
            placement: 'right',
            title: r.name ? (0, h.jsx)('div', {
                style: { fontSize: 15 },
                children: (0, h.jsx)(k.default, { text: r.name + ' active' })
            }) : null,
            children: (0, h.jsx)(p, {
                colors: r.color,
                children: (0, h.jsx)(j.default, { name: r.icon })
            })
        });
    ...
    let s, t, u, v = w => w, w = class extends j.Component {
            render() {
                if ((0, q.inImposterMode)() || (0, q.inPardyMode)())
                    return null;
                const {balance: x} = this.props, y = this.canShow(), z = (0, p.default)({
                ...
                return (0, i.jsx)(_y, {
                    animate: { height: y ? 'auto' : 0 },
                    transition: { duration: 0.3 },
                    children: (0, i.jsx)(_z, {
                        children: (0, i.jsx)(_A, {
                            initial: { x: 20 },
                            animate: { x: this.state.xValue ? 20 - this.state.xValue : 20 },
                            transition: {
                                ease: 'anticipate',
                                duration: 0.6
                            },
            ...
            constructor(...e) {
                super(...e), (0, g.default)(this, 'state', { xValue: 0 }), (0, g.default)(this, 'changeX', x => this.setState({ xValue: x })), (0, g.default)(this, 'findUpgradeValue', x => {
...
`));
    ...
    let l, m, n, o = p => p;
    var _p = q => {
        const r = h.useRef(), s = `bonus-item-index-${ q.index }`;
        return h.useEffect(() => {
            if (q.selected) {
            ...
            children: [
                (0, g.jsxs)(_q, {
                    ...
                    ref: r,
                    children: [
                        (0, g.jsx)(_r, { children: q.index }),
                        (0, g.jsx)(_s, { children: (0, k.getMoney)(q.amount) })
                    ]
                }),
...
`));
    ...
    var g = d('.....');
    Object.defineProperty(e.exports, '__esModule', { value: !0 }), e.exports.default = void 0;
    var h = g(d('.....')), i = (0, g(d('.....')).default)(h.default.createElement('path', { d: 'M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z' }), 'Description');
    e.exports.default = i;
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _D;
    });
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = d('.....'), t = d('.....'), u = d('.....'), v = d('.....'), w = d('.....'), x = d('.....'), y = d('.....'), z = d('.....'), A = d('.....'), B = d('.....'), C = d('.....');
    var _D = (0, u.observer)(() => {
        var E;
        const {
                navigation: F,
                user: G,
                questions: {lockedViewingCorrectAnswer: H}
                            ...
                            (0, g.jsx)('div', {
                                ...
                                children: F.settingsOpen ? (0, g.jsx)(i.default, {
                                    ...
                                    children: (0, g.jsxs)(j.default, {
                                        children: [
                                            (0, g.jsx)(l.default, { primary: (0, g.jsx)(q.default, { text: 'Read to Me' }) }),
                                            (0, g.jsx)(z.default, {
                                            ...
                                            children: [
                                                ...
                                                (0, g.jsx)(p.default, {
                                                    ...
                                                    children: (0, g.jsxs)(j.default, {
                                                        button: !0,
                                                        children: [
                                                            (0, g.jsx)(k.default, { children: (0, g.jsx)(n.default, {}) }),
                                                            (0, g.jsx)(l.default, { primary: (0, g.jsx)(q.default, { text: 'Questions' }) })
                                                        ]
                                                    })
                                                }),
                                                !(0, t.blockShopping)() && (0, g.jsx)(p.default, {
                                                    ...
                                                    children: (0, g.jsxs)(j.default, {
                                                        button: !0,
                                                        children: [
                                                            (0, g.jsx)(k.default, { children: (0, t.inImposterMode)() ? (0, g.jsx)(m.default, {}) : (0, g.jsx)(o.default, {}) }),
                                                            (0, g.jsx)(l.default, { primary: (0, g.jsx)(q.default, { text: (0, t.shopName)() }) })
                                                        ]
                                                    })
                                                })
                                            ]
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = {
            left: 'right',
            right: 'left',
            top: 'down',
            bottom: 'up'
    ...
    var t = {
            ...
            var x = v.anchor, y = void 0 === x ? 'left' : x, z = v.BackdropProps, A = v.children, B = v.classes, C = v.className, D = v.elevation, E = void 0 === D ? 16 : D, F = v.ModalProps, G = (F = void 0 === F ? {} : F).BackdropProps, H = (0, h.default)(F, ['BackdropProps']), I = v.onClose, J = v.open, K = void 0 !== J && J, L = v.PaperProps, M = void 0 === L ? {} : L, N = v.SlideProps, O = v.TransitionComponent, P = void 0 === O ? n.default : O, Q = v.transitionDuration, R = void 0 === Q ? t : Q, S = v.variant, T = void 0 === S ? 'temporary' : S, U = (0, h.default)(v, [
                    'anchor',
                    'BackdropProps',
                    'children',
                    'classes',
            ...
            var X = function (Y, Z) {
                ...
                }(V, y), Y = i.createElement(o.default, (0, g.default)({
                    elevation: 'temporary' === T ? E : 0,
                    square: !0
                }, M, { className: (0, j.default)(B.paper, B['paperAnchor'.concat((0, p.default)(X))], M.className, 'temporary' !== T && B['paperAnchorDocked'.concat((0, p.default)(X))]) }), A);
            if ('permanent' === T)
            ...
            return 'persistent' === T ? i.createElement('div', (0, g.default)({
                ...
                BackdropProps: (0, g.default)({}, z, G, { transitionDuration: R }),
            ...
            return {
                ...
                paperAnchorDockedLeft: { borderRight: '1px solid '.concat(w.palette.divider) },
                paperAnchorDockedTop: { borderBottom: '1px solid '.concat(w.palette.divider) },
                paperAnchorDockedRight: { borderLeft: '1px solid '.concat(w.palette.divider) },
                paperAnchorDockedBottom: { borderTop: '1px solid '.concat(w.palette.divider) },
                modal: {}
            };
        }, {
            name: 'MuiDrawer',
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....');
    d('.....');
    var k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = d('.....'), t = d('.....'), u = d('.....');
    var v = new (0, s.default)(), _w = i.forwardRef(function (x, y) {
            var z = (0, l.default)(), A = (0, k.default)({
                    name: 'MuiModal',
                    props: (0, h.default)({}, x),
                    theme: z
                }), B = A.BackdropComponent, C = void 0 === B ? u.default : B, D = A.BackdropProps, E = A.children, F = A.closeAfterTransition, G = void 0 !== F && F, H = A.container, I = A.disableAutoFocus, J = void 0 !== I && I, K = A.disableBackdropClick, L = void 0 !== K && K, M = A.disableEnforceFocus, N = void 0 !== M && M, O = A.disableEscapeKeyDown, P = void 0 !== O && O, Q = A.disablePortal, R = void 0 !== Q && Q, S = A.disableRestoreFocus, T = void 0 !== S && S, U = A.disableScrollLock, V = void 0 !== U && U, W = A.hideBackdrop, X = void 0 !== W && W, Y = A.keepMounted, Z = void 0 !== Y && Y, $ = A.manager, ab = void 0 === $ ? v : $, bb = A.onBackdropClick, cb = A.onClose, db = A.onEscapeKeyDown, eb = A.onRendered, fb = A.open, gb = (0, g.default)(A, [
                    'BackdropComponent',
                    'BackdropProps',
                    'children',
                    ...
                    'onRendered',
                    'open'
                ]), hb = i.useState(!0), ib = hb[0], jb = hb[1], kb = i.useRef({}), lb = i.useRef(null), mb = i.useRef(null), nb = (0, p.default)(mb, y), ob = function (pb) {
                    ...
                    ab.mount(qb(), { disableScrollLock: V }), mb.current.scrollTop = 0;
            ...
            return void 0 === E.props.tabIndex && (xb.tabIndex = E.props.tabIndex || '-1'), ob && (xb.onEnter = (0, o.default)(function () {
                ...
                role: 'presentation'
            }, gb, { style: (0, h.default)({}, wb.root, !fb && ib ? wb.hidden : {}, gb.style) }), X ? null : i.createElement(C, (0, h.default)({
                open: fb,
                onClick: function (yb) {
    ...
    function o(p, q, r) {
        var s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : [], t = arguments.length > 4 ? arguments[4] : void 0, u = [
                q,
                r
            ].concat((0, i.default)(s)), v = [
                'TEMPLATE',
                'SCRIPT',
                'STYLE'
            ];
    ...
    function v(w, x) {
        ...
        if (!x.disableScrollLock) {
            ...
            var D = B.parentElement, E = 'HTML' === _m.nodeName && 'scroll' === window.getComputedStyle(_m)['overflow-y'] ? _m : B;
            z.push({
    ...
    var i = d('.....'), j = d('.....');
    var _k = function (l) {
        var m = l.children, n = l.disableAutoFocus, o = void 0 !== n && n, p = l.disableEnforceFocus, q = void 0 !== p && p, r = l.disableRestoreFocus, s = void 0 !== r && r, t = l.getDoc, u = l.isEnabled, v = l.open, w = g.useRef(), x = g.useRef(null), y = g.useRef(null), z = g.useRef(), A = g.useRef(null), B = g.useCallback(function (C) {
                A.current = h.findDOMNode(C);
            }, []), C = (0, j.default)(m.ref, B), D = g.useRef();
        ...
        }), g.cloneElement(m, { ref: C }), g.createElement('div', {
            tabIndex: 0,
            ref: y,
    ...
    var j = {
            ...
            var n = l.invisible, o = void 0 !== n && n, p = l.open, q = (0, h.default)(l, [
                    'invisible',
                    'open'
                ]);
            return p ? i.createElement('div', (0, g.default)({
                'aria-hidden': !0,
                ref: m
            }, q, { style: (0, g.default)({}, j.root, o ? j.invisible : {}, q.style) })) : null;
        });
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _n;
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = i.forwardRef(function (n, o) {
            var p = n.children, q = n.classes, r = n.className, s = n.invisible, t = void 0 !== s && s, u = n.open, v = n.transitionDuration, w = n.TransitionComponent, x = void 0 === w ? l.default : w, y = (0, h.default)(n, [
                    'children',
                    'classes',
                    'className',
                    'invisible',
    ...
    var k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = {
            ...
            var u = s.children, v = s.disableStrictModeCompat, w = void 0 !== v && v, x = s.in, y = s.onEnter, z = s.onEntered, A = s.onEntering, B = s.onExit, C = s.onExited, D = s.onExiting, E = s.style, F = s.TransitionComponent, G = void 0 === F ? k.default : F, H = s.timeout, I = void 0 === H ? q : H, J = (0, i.default)(s, [
                    'children',
                    ...
                    'TransitionComponent',
                    'timeout'
                ]), K = (0, m.default)(), L = K.unstable_strictMode && !w, M = j.useRef(null), N = (0, o.default)(u.ref, t), O = (0, o.default)(L ? M : void 0, N), P = function (Q) {
                    return function (R, S) {
                        if (Q) {
                            var T = L ? [
                                    M.current,
                                    ...
                                    R,
                                    S
                                ], U = (0, h.default)(T, 2), V = U[0], W = U[1];
                            void 0 === W ? Q(V) : Q(V, W);
                        }
                    };
                }, Q = P(A), R = P(function (S, T) {
                    (0, n.reflow)(S);
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....');
    function q(r, s) {
        var t = function (u, v) {
    ...
    var s = {
            ...
            var w = u.children, x = u.direction, y = void 0 === x ? 'down' : x, z = u.in, A = u.onEnter, B = u.onEntered, C = u.onEntering, D = u.onExit, E = u.onExited, F = u.onExiting, G = u.style, H = u.timeout, I = void 0 === H ? s : H, J = u.TransitionComponent, K = void 0 === J ? l.default : J, L = (0, h.default)(u, [
                    'children',
                    'direction',
                    'in',
                    'onEnter',
                    ...
                    'timeout',
                    'TransitionComponent'
                ]), M = (0, n.default)(), N = i.useRef(null), O = i.useCallback(function (P) {
                    N.current = j.findDOMNode(P);
                }, []), P = (0, m.default)(w.ref, O), Q = (0, m.default)(P, v), R = function (S) {
                    return function (T) {
                    ...
                    U.style.webkitTransition = M.transitions.create('-webkit-transform', (0, g.default)({}, W, { easing: M.transitions.easing.easeOut })), U.style.transition = M.transitions.create('transform', (0, g.default)({}, W, { easing: M.transitions.easing.easeOut })), U.style.webkitTransform = 'none', U.style.transform = 'none', C && C(U, V);
                }), U = R(B), V = R(F), W = R(function (X) {
                    var Y = (0, p.getTransitionProps)({
                        timeout: I,
                        style: G
                    }, { mode: 'exit' });
                    X.style.webkitTransition = M.transitions.create('-webkit-transform', (0, g.default)({}, Y, { easing: M.transitions.easing.sharp })), X.style.transition = M.transitions.create('transform', (0, g.default)({}, Y, { easing: M.transitions.easing.sharp })), q(y, X), D && D(X);
                }), X = R(function (Y) {
            ...
            return i.useEffect(function () {
                if (!z && 'down' !== y && 'right' !== y) {
                    ...
                    return window.addEventListener('resize', Z), function () {
                ...
                return i.cloneElement(w, (0, g.default)({
                    ref: Q,
                    style: (0, g.default)({ visibility: 'exited' !== Z || z ? void 0 : 'hidden' }, G, w.props.style)
                }, $));
            });
        });
}), d.register('.....', function (e, f) {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    d('.....');
    var j = d('.....'), k = d('.....'), l = i.forwardRef(function (m, n) {
            var o = m.classes, p = m.className, q = m.component, r = void 0 === q ? 'div' : q, s = m.square, t = void 0 !== s && s, u = m.elevation, v = void 0 === u ? 1 : u, w = m.variant, x = void 0 === w ? 'elevation' : w, y = (0, g.default)(m, [
                    'classes',
                    'className',
                    'component',
                    'square',
            ...
            return n.shadows.forEach(function (p, q) {
                o['elevation'.concat(q)] = { boxShadow: p };
            }), (0, h.default)({
                root: {
                ...
                rounded: { borderRadius: n.shape.borderRadius },
                outlined: { border: '1px solid '.concat(n.palette.divider) }
            }, o);
        }, { name: 'MuiPaper' })(l);
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
    ...
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = i.forwardRef(function (n, o) {
            var p = n.children, q = n.classes, r = n.className, s = n.component, t = void 0 === s ? 'ul' : s, u = n.dense, v = void 0 !== u && u, w = n.disablePadding, x = void 0 !== w && w, y = n.subheader, z = (0, h.default)(n, [
                    'children',
                    'classes',
                    'className',
                    'component',
            ...
            return i.createElement(l.default.Provider, { value: A }, i.createElement(t, (0, g.default)({
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = 'undefined' == typeof window ? i.useEffect : i.useLayoutEffect, r = i.forwardRef(function (s, t) {
            var u = s.alignItems, v = void 0 === u ? 'center' : u, w = s.autoFocus, x = void 0 !== w && w, y = s.button, z = void 0 !== y && y, A = s.children, B = s.classes, C = s.className, D = s.component, E = s.ContainerComponent, F = void 0 === E ? 'li' : E, G = s.ContainerProps, H = (G = void 0 === G ? {} : G).className, I = (0, h.default)(G, ['className']), J = s.dense, K = void 0 !== J && J, L = s.disabled, M = void 0 !== L && L, N = s.disableGutters, O = void 0 !== N && N, P = s.divider, Q = void 0 !== P && P, R = s.focusVisibleClassName, S = s.selected, T = void 0 !== S && S, U = (0, h.default)(s, [
                    'alignItems',
                    'autoFocus',
                    'button',
                    'children',
            ...
            var Y = i.Children.toArray(A), Z = Y.length && (0, m.default)(Y[Y.length - 1], ['ListItemSecondaryAction']), $ = i.useCallback(function (ab) {
                    X.current = p.findDOMNode(ab);
                }, []), ab = (0, n.default)($, t), bb = (0, g.default)({
            ...
            return z && (bb.component = D || 'div', bb.focusVisibleClassName = (0, j.default)(B.focusVisible, R), cb = l.default), Z ? (cb = bb.component || D ? cb : 'div', 'li' === F && ('li' === cb ? cb = 'div' : 'li' === bb.component && (bb.component = 'div')), i.createElement(o.default.Provider, { value: W }, i.createElement(F, (0, g.default)({
                className: (0, j.default)(B.container, H),
                ref: ab
            }, I), i.createElement(cb, bb, Y), Y.pop()))) : i.createElement(o.default.Provider, { value: W }, i.createElement(cb, (0, g.default)({ ref: ab }, bb), Y));
            ...
            return {
                root: {
                    ...
                    paddingTop: 8,
                    paddingBottom: 8,
                    '&$focusVisible': { backgroundColor: t.palette.action.selected },
                    '&$selected, &$selected:hover': { backgroundColor: t.palette.action.selected },
    ...
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = i.forwardRef(function (n, o) {
            var p = n.classes, q = n.className, r = (0, h.default)(n, [
                    'classes',
                    'className'
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = i.forwardRef(function (o, p) {
            var q = o.children, r = o.classes, s = o.className, t = o.disableTypography, u = void 0 !== t && t, v = o.inset, w = void 0 !== v && v, x = o.primary, y = o.primaryTypographyProps, z = o.secondary, A = o.secondaryTypographyProps, B = (0, h.default)(o, [
                    'children',
                    'classes',
                    'className',
                    'disableTypography',
                ...
                ]), C = i.useContext(m.default).dense, D = null != x ? x : q;
    ...
    var j = d('.....'), k = d('.....'), l = d('.....'), m = {
            ...
            var q = o.align, r = void 0 === q ? 'inherit' : q, s = o.classes, t = o.className, u = o.color, v = void 0 === u ? 'initial' : u, w = o.component, x = o.display, y = void 0 === x ? 'initial' : x, z = o.gutterBottom, A = void 0 !== z && z, B = o.noWrap, C = void 0 !== B && B, D = o.paragraph, E = void 0 !== D && D, F = o.variant, G = void 0 === F ? 'body1' : F, H = o.variantMapping, I = void 0 === H ? m : H, J = (0, h.default)(o, [
                    'align',
                    'classes',
                    'className',
                    'color',
            ...
            return {
                ...
                colorInherit: { color: 'inherit' },
                colorPrimary: { color: p.palette.primary.main },
                colorSecondary: { color: p.palette.secondary.main },
                colorTextPrimary: { color: p.palette.text.primary },
                colorTextSecondary: { color: p.palette.text.secondary },
                colorError: { color: p.palette.error.main },
                displayInline: { display: 'inline' },
                displayBlock: { display: 'block' }
            };
        }, { name: 'MuiTypography' })(n);
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M7 3v9c0 .55.45 1 1 1h2v7.15c0 .51.67.69.93.25l5.19-8.9c.39-.67-.09-1.5-.86-1.5H13l2.49-6.65c.25-.65-.23-1.35-.93-1.35H8c-.55 0-1 .45-1 1z' }), 'FlashOnRounded');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z' }), 'QuestionAnswer');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M16 6V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H2v13c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6h-6zm-6-2h4v2h-4V4zM9 18V9l7.5 4L9 18z' }), 'Shop');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _i;
    });
                ...
                children: (0, h.jsxs)('div', {
                    ...
                    children: [
                        (0, h.jsx)('div', {
                            ...
                            children: (0, h.jsx)(i.default, { name: j.LINK_ICON })
                        }),
                        (0, h.jsxs)('div', {
                            style: { fontWeight: 'bold' },
                            children: [
                                (0, h.jsx)(_v, { children: (0, h.jsx)(k.default, { text: 'Link Active' }) }),
                                (0, h.jsx)(_w, { children: this.props.powerups.linkPartnerName })
                            ]
                        })
                    ]
                })
...
`), g.default.name);
  ...
  align-items: center;
  font-family: ${ 0 };
`), n.default.name), z = s.default.div(u || (u = x`
  font-size: 38px;
  margin-left: 5px;
  font-weight: 900;
`)), A = s.default.div(v || (v = x`
  ...
  justify-content: center;
  align-items: center;
`), B => B.backgroundColor, B => B.textColor), B = s.default.div(w || (w = x`
  font-size: 19px;
  opacity: 0.8;
  margin-bottom: 7px;
  font-family: ${ 0 };
                    ...
                    (0, i.jsxs)(y, {
                        children: [
                            (0, i.jsx)(A, {
                                ...
                                children: (0, i.jsx)(j.default, { name: D.icon })
                            }),
                            (0, i.jsx)(z, { children: (0, i.jsx)(m.default, { text: (0, p.getPowerupName)(D) }) })
                        ]
                    }),
                    (0, i.jsx)(B, { children: (0, i.jsx)(m.default, { text: E ? (0, p.getPowerupDescription)(D.description) : 'This powerup is disabled while shield is active' }) }),
                    E && (0, i.jsx)(k.default, {
                        usePowerupAction: !0,
...
`), p.default.name), w = m.default.div(t || (t = u`
  background: ${ 0 };
  border-radius: 4px;
  box-shadow: ${ 0 };
...
`), o.default.White, q.default.basic, x => x.fullScreen ? '\n  height: 100%;\n  width: 100%;\n  ' : `\n  max-width: ${ x.customMaxWidth ? x.customMaxWidth : '540px' };\n  ${ x.customWidth ? 'width: ' + x.customWidth + ';' : null }\n  max-height: 79vh;\n  margin: 20px;\n  `, x => x.customPadding || '18px'), x = y => y.stopPropagation();
    let y = class extends j.Component {
        ...
        componentDidUpdate(z, A) {
            this.state.exiting && !A.exiting && setTimeout(() => this.setState({ exiting: !1 }), 500);
        }
        render() {
            const {
                    close: z,
                    gameValues: {gameStatus: A}
                } = this.props, {
                    open: B,
                    exiting: C
                } = this.state;
            ...
            if (A === n.GameStatus.results)
                return null;
            const D = C ? 'fadeOut' : 'fadeIn', E = C ? 'zoomOut' : 'zoomIn';
    ...
    let n = class extends l.Component {
        render() {
            ...
            return o.length < 1 ? null : (0, i.jsxs)(l.Fragment, {
                children: [
                    (0, i.jsx)(j.default, {}),
                    (0, i.jsx)('div', { style: { height: 5 } }),
                    o.map(p => (0, i.jsx)(m.default, { powerup: p }, p.name))
                ]
            });
        }
        constructor(...e) {
    ...
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = i.forwardRef(function (n, o) {
            var p = n.absolute, q = void 0 !== p && p, r = n.classes, s = n.className, t = n.component, u = void 0 === t ? 'hr' : t, v = n.flexItem, w = void 0 !== v && v, x = n.light, y = void 0 !== x && x, z = n.orientation, A = void 0 === z ? 'horizontal' : z, B = n.role, C = void 0 === B ? 'hr' !== u ? 'separator' : void 0 : B, D = n.variant, E = void 0 === D ? 'fullWidth' : D, F = (0, h.default)(n, [
                    'absolute',
                    'classes',
                    'className',
                    'component',
            ...
            return {
                ...
                inset: { marginLeft: 72 },
                light: { backgroundColor: (0, l.fade)(o.palette.divider, 0.08) },
                middle: {
  ...
  padding-bottom: 5px;
  height: 52px;
`), n.default.name), C = t.default.div(w || (w = z`
  display: flex;
  align-items: center;
`)), D = t.default.div(x || (x = z`
  ...
  justify-content: center;
  align-items: center;
`), E => E.colors.background, E => E.colors.text), E = t.default.div(y || (y = z`
  font-size: 18px;
  font-weight: bold;
  margin-left: 7px;
`));
                        ...
                        (0, i.jsxs)(C, {
                            children: [
                                (0, i.jsx)(j.default, {
                                    title: (0, i.jsx)('div', {
                                        style: { fontSize: 15 },
                                        children: (0, i.jsx)(m.default, { text: (0, o.getPowerupDescription)(G.description) })
                                    }),
                                    children: (0, i.jsx)(D, {
                                        colors: G.color,
                                        children: (0, i.jsx)(l.default, { name: G.icon })
                                    })
                                }),
                                (0, i.jsx)(E, { children: (0, i.jsx)(m.default, { text: (0, o.getPowerupName)(G) }) })
                            ]
                        }),
                        (0, i.jsx)(k.default, {
                            onClick: this.activatePowerup,
                            label: (0, i.jsx)(m.default, { text: 'Use' }),
    ...
    var _s = t => (0, g.jsxs)(_t, {
        children: [
            (0, g.jsxs)(_u, {
                children: [
                    (0, g.jsx)(_v, { children: t.playerName }),
                    t.teamName && (0, g.jsx)(_w, { children: t.teamName })
                ]
            }),
            (0, g.jsx)(_x, {
                children: (0, g.jsx)(l.default, {
                    style: { color: 'rgba(117, 117, 117, 1.0)' },
    ...
    const _t = h.default.div.attrs({ className: 'maxWidth flex vc between' })(m || (m = r`
  font-family: ${ 0 };
  flex-shrink: 0;
  padding: 12px 16px;
  padding-right: 5px;
  background-color: #f2f2f2;
`), k.mainFontName), _u = h.default.div.attrs({ className: 'flex flex-column hc' })(n || (n = r`
...
`));
    ...
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M21 11H6.83l3.58-3.59L9 6l-6 6 6 6 1.41-1.41L6.83 13H21z' }), 'KeyboardBackspace');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', {
    ...
    var _v = (0, j.observer)(() => {
        const {pardy: w} = k.useContext(i.default), x = w.powers.find(y => y.id === w.power);
        return x ? (0, g.jsx)(_w, {
            children: (0, g.jsxs)(_x, {
                children: [
                    (0, g.jsx)(_y, {
                        style: { backgroundColor: x.background },
                        children: (0, g.jsx)(_z, { src: x.image })
                    }),
                    (0, g.jsxs)(_A, {
                        children: [
                            (0, g.jsx)(_B, { children: x.name }),
                            (0, g.jsx)(_C, { children: x.description })
                        ]
                    })
                ]
            })
    ...
    const _w = l.default.div.attrs({ className: 'maxWidth' })(n || (n = u`
  font-family: ${ 0 };
  padding: 15px;
`), m.mainFontName), _x = l.default.div.attrs({ className: 'maxWidth light-shadow' })(o || (o = u`
  border-style: solid;
  border-color: rgba(0, 0, 0, 0.2);
  border-width: 0px;
  border-radius: 5px;
  overflow: hidden;
`)), _y = l.default.div.attrs({ className: 'maxWidth flex-center' })(p || (p = u`
  height: 80px;
`)), _z = l.default.img(q || (q = u`
  height: 40px;
  filter: drop-shadow(2px 2px 2px #222);
`)), _A = l.default.div.attrs({ className: 'maxWidth flex-center flex-column' })(r || (r = u`
  background: ${ 0 };
  padding: 20px 15px;
  text-align: center;
`), h.default.Snow), _B = l.default.div(s || (s = u`
  font-weight: bold;
  font-size: 22px;
  margin-bottom: 2px;
                    ...
                    children: (0, i.jsxs)(n.LeaderboardContainer, {
                        ...
                        children: [
                            ...
                            (0, i.jsx)(p.default, {
                                ...
                                message: (0, i.jsx)(q.default, { text: 'Tip' }),
                                description: (0, i.jsx)(q.default, { text: 'Pay attention to the Investigation Log for more clues.' }),
                                showIcon: !0
                            })
                        ]
                    })
    ...
    let p = class extends j.Component {
        ...
        render() {
            return this.props.imposter.me ? (0, i.jsx)(o, {
                ...
                onBlur: this.onBlur,
                autoSize: { minRows: this.props.minRows || 4 }
            }) : null;
        }
        constructor(...e) {
    ...
    let t = class extends l.Component {
        render() {
            return this.props.gameOptions.type !== n.GameType.live ? null : (0, i.jsx)(_s, {
                ...
                children: (0, i.jsx)(_v, { children: (0, i.jsx)(o.default, {}) })
            });
        }
        constructor(...e) {
...
`));
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = d('.....'), t = d('.....'), u = d('.....'), v = d('.....'), w = d('.....'), x = d('.....'), y = d('.....'), z = d('.....'), A = d('.....'), B = d('.....'), C = d('.....'), D = d('.....'), E = d('.....'), F = d('.....'), G = d('.....'), H = d('.....'), I = d('.....'), J = d('.....'), K = d('.....');
    let L;
    const M = [k.default.questions], N = () => (0, J.sample)('abcdefghijklmnopqrstuvwxyz'.split('')), O = N(), P = N(), _Q = n.default.div.withConfig({ displayName: `sc-${ O + P }` }).attrs({ className: 'maxAll flex-column' })(L || (L = (R => R)`
  flex: 1 1 auto;
  min-height: 0;
  background: ${ 0 };
  overflow-x: hidden;
  overflow-y: hidden;
`), R => R.customBackground || R.theme.defaultBackground), R = {
            width: '100%',
            height: '100%'
        }, S = T => {
            ...
            return null;
        }, T = () => v.default.navigation.canChangeRoute = !1, U = () => v.default.navigation.canChangeRoute = !0, V = W => {
    ...
    var _W = (0, u.observer)(X => {
        ...
        return l.useEffect(() => {
            ...
            children: [
                (0, g.jsx)(V, { currentRoute: Z.currentRoute }),
                (0, g.jsx)(r.default, {}),
                (0, g.jsx)(F.default, {}),
                (0, g.jsx)(x.default, {}),
                (0, g.jsx)(z.default, {}),
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = (m = d('.....'), d('.....')), o = d('.....'), p = d('.....');
    let q, r, s = t => t;
    const _t = 600, u = l.default.div(q || (q = s`
  height: 100%;
  width: 100%;
  overflow-y: scroll;
  display: flex;
  ...
  background: ${ 0 };
  -webkit-overflow-scrolling: touch;
`), m.backgroundCanvasColor), v = l.default.div(r || (r = s`
  width: 90%;
  max-width: ${ 0 }px;
  min-height: 100%;
`), _t);
    ...
    let y = class extends k.Component {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { screen: w.information }), (0, g.default)(this, 'switchToDrawing', () => {
                this.setState({ screen: w.drawing });
            }), (0, g.default)(this, 'getContent', () => this.state.screen === w.information ? (0, i.jsx)(u, {
                onClick: this.switchToDrawing,
                children: (0, i.jsxs)(v, {
                    children: [
                        (0, i.jsx)('div', { style: { height: 20 } }),
                        (0, i.jsx)(n.default, {}),
                        this.props.gameValues.news.map(z => (0, i.jsx)(o.default, { item: z }, z.description)),
                        (0, i.jsx)('div', { style: { height: 20 } })
                    ]
                })
            }) : (0, i.jsx)(m.default, {}));
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....');
    let p;
    const q = 'gimkit-draw-canvas', _r = () => (0, m.inImposterMode)() ? '#313639' : (0, m.inLavaMode)() ? '#263238' : (0, m.inPardyMode)() ? '#525380' : '#4caf50', _s = () => (0, m.inImposterMode)() ? l.default.White : (0, m.inLavaMode)() || (0, m.inPardyMode)() ? '#ffeb3b' : '#424242', _t = () => (0, m.inImposterMode)() ? '#ffee58' : (0, m.inThanosMode)() ? '#5e35b1' : (0, m.inLavaMode)() ? '#ff6f00' : (0, m.inPardyMode)() ? '#99f6a9' : '#e1f5fe', u = k.default.div(p || (p = (v => v)`
  height: 100%;
  width: 100%;
  background: ${ 0 };
`), _r);
    class v extends i.Component {
        componentDidMount() {
            this.onResize(), window.addEventListener('resize', this.onResize), document.addEventListener('touchmove', this.onTouch, { passive: !1 });
        }
        componentWillUnmount() {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', {
                ...
                const w = document.getElementById(q).clientHeight, x = document.getElementById(q).clientWidth;
                this.setState({
                    height: w,
                    width: x
                });
    ...
    var g, h, i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = Object.assign || function (p) {
            for (var q = 1; q < arguments.length; q++) {
                var r = arguments[q];
                for (var s in r)
                    Object.prototype.hasOwnProperty.call(r, s) && (p[s] = r[s]);
    ...
    var q = {
            ...
            function v(w) {
                ...
                return x.componentWillUnmount = function () {
                    ...
                    var A = JSON.parse(y), B = A.lines, C = A.width, D = A.height;
                    ...
                    if (x.clear(), C === x.props.canvasWidth && D === x.props.canvasHeight)
                        ...
                        var E = x.props.canvasWidth / C, F = x.props.canvasHeight / D, G = (E + F) / 2;
                        x.simulateDrawingLines({
                    ...
                    var z = y.lines, A = y.immediate, B = 0, C = A ? 0 : x.props.loadTimeOffset;
                    z.forEach(function (D) {
                        var E = D.points, F = D.brushColor, G = D.brushRadius;
                        if (A)
                            return x.drawPoints({
                                points: E,
                                brushColor: F,
                    ...
                    var z = x.getPointerPos(y), A = z.x, B = z.y;
                    y.touches && y.touches.length > 0 && x.lazy.update({
                        x: A,
                        y: B
                    }, { both: !0 }), x.handlePointerMove(A, B);
                    ...
                    var A = x.getSaveData(), B = y, C = Array.isArray(B), D = 0;
                    for (B = C ? B : B[Symbol.iterator]();;) {
                        ...
                        var F = E.contentRect, G = F.width, H = F.height;
                        x.setCanvasSize(x.canvas.interface, G, H), x.setCanvasSize(x.canvas.drawing, G, H), x.setCanvasSize(x.canvas.temp, G, H), x.setCanvasSize(x.canvas.grid, G, H), x.drawGrid(x.ctx.grid), x.drawImage(), x.loop({ once: !0 });
                    }
                    x.loadSaveData(A, !0);
                }, x.setCanvasSize = function (y, z, A) {
                    y.width = z, y.height = A, y.style.width = z, y.style.height = A;
                }, x.getPointerPos = function (y) {
                    var z = x.canvas.interface.getBoundingClientRect(), A = y.clientX, B = y.clientY;
                    ...
                    var z = y.points, A = y.brushColor, B = y.brushRadius;
                    ...
                    var y = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, z = y.brushColor, A = y.brushRadius;
                    if (!(x.points.length < 2)) {
                        ...
                        var B = x.canvas.temp.width, C = x.canvas.temp.height;
                    ...
                    var y = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, z = y.once, A = void 0 !== z && z;
                    if (x.mouseHasMoved || x.valuesChanged) {
                        var B = x.lazy.getPointerCoordinates(), C = x.lazy.getBrushCoordinates();
            ...
            return function (x, y) {
                ...
                this.lazy = new (0, k.LazyBrush)({
                    ...
                    var y = window.innerWidth / 2, z = window.innerHeight / 2;
                    x.lazy.update({
                        x: y - x.chainLength / 4,
                        y: z
                    }, { both: !0 }), x.lazy.update({
                        x: y + x.chainLength / 4,
                        y: z
                    }, { both: !1 }), x.mouseHasMoved = !0, x.valuesChanged = !0, x.clear(), x.props.saveData && x.loadSaveData(x.props.saveData);
                }, 100);
                ...
                return c(i).createElement('div', {
                    ...
                    var z = y.name, A = y.zIndex, B = 'interface' === z;
    ...
    Object.defineProperty(e.exports, '__esModule', { value: !0 }), e.exports.LazyPoint = e.exports.Point = e.exports.LazyBrush = void 0;
    var g = _j(d('.....')), h = _j(d('.....')), i = _j(d('.....'));
    function _j(k) {
    ...
    var g, h = function () {
        ...
        }(), i = d('.....'), j = (g = i) && g.__esModule ? g : { default: g };
    function k(l, m) {
        if (!(l instanceof m))
            throw new TypeError('Cannot call a class as a function');
    }
    var l = function () {
        function m() {
            var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, o = n.radius, p = void 0 === o ? 30 : o, q = n.enabled, r = void 0 === q || q, s = n.initialPoint, t = void 0 === s ? {
                    x: 0,
                    y: 0
                } : s;
        ...
        return q(m, [
            ...
            },
            {
                key: 'update',
                value: function (u) {
                    var v = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, w = v.both, x = void 0 !== w && w;
    ...
    Object.defineProperty(e.exports, '__esModule', { value: !0 }), e.exports.Point = e.exports.Catenary = void 0;
    var g = _i(d('.....')), h = _i(d('.....'));
    function _i(j) {
    ...
    var l = function () {
        function m() {
            var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, o = n.segments, p = void 0 === o ? 50 : o, q = n.iterationLimit, r = void 0 === q ? 100 : q;
        ...
        return q(m, [
            {
                ...
                value: function (s, t, u, v) {
                    ...
                    var w = this.p1.x > this.p2.x, x = w ? this.p2 : this.p1, y = w ? this.p1 : this.p2, z = [], A = !0;
                    if (x.getDistanceTo(y) < v)
                        if (y.x - x.x > 0.01) {
                            var B = y.x - x.x, C = y.y - x.y, D = -this.getCatenaryParameter(B, C, v, this.iterationLimit), E = 0.5 * (D * Math.log((v + C) / (v - C)) - B), F = D * Math.cosh(E / D), G = x.x - E, H = x.y - F;
                            z = this.getCurve(D, x, y, G, H, this.segments), A = !1;
                        } else {
                            var I = 0.5 * (x.x + y.x), J = 0.5 * (x.y + y.y + v);
                            z = [
                                [
                                    x.x,
                                    x.y
            ...
            },
            {
                ...
                value: function (s, t, u, v, w, x) {
                    for (var y = [
                        ...
                        var C = t.x + z * (B + 0.5) / A, D = s * Math.cosh((C - v) / s) + w;
                        y.push(C, D);
                    }
            ...
            },
            {
                key: 'drawCurve',
                value: function (s, t) {
                    var u = 0.5 * s.length - 1, v = s[2], w = s[3], x = [];
                    t.moveTo(s[0], s[1]);
                    for (var y = 2; y < u; y++) {
                        var z = s[2 * y], A = s[2 * y + 1], B = 0.5 * (z + v), C = 0.5 * (A + w);
                        x.push([
                            v,
                            w,
                            B,
    ...
    function g() {
        var h = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, i = h.ctx, j = h.img, k = h.x, l = h.y, m = h.w, n = h.h, o = h.offsetX, p = h.offsetY;
        ...
        var q, r, s, t, u = j.width, v = j.height, w = Math.min(m / u, n / v), x = u * w, y = v * w, z = 1;
...
`)), t = l.default.div(p || (p = r`
  ...
  align-items: center;
  background-color: ${ 0 };
`), j.default.DisabledGray, j.default.White), u = l.default.div(q || (q = r`
  cursor: pointer;
  font-size: 35px;
  background: ${ 0 };
  color: ${ 0 };
  padding: 5px;
  border-radius: 6px;
`), v => v.enabled ? '#E0E0E0' : 'transparent', v => v.customColor ? v.customColor : j.default.Black), v = {
  ...
  color: ${ 0 };
  font-weight: 900;
`), k.default.basic, () => (0, l.darken)(0.3, (0, n.backgroundCanvasColor)()), j.default.White), x = m.default.div(q || (q = v`
  font-size: 37px;
  margin-bottom: 4px;
`)), y = m.default.div(r || (r = v`
  ...
  border-style: solid;
  border-width: 2px;
`), k.default.basic), z = m.default.div(s || (s = v`
  height: 100%;
  display: flex;
  justify-content: center;
  flex-direction: column;
...
`)), C = D => (0, g.jsxs)(y, {
            children: [
                (0, g.jsx)('div', {
                    ...
                    children: (0, g.jsx)(h.default, { name: D.icon })
                }),
                (0, g.jsx)('div', {
                    style: { marginLeft: 15 },
                    children: (0, g.jsx)(i.default, { text: D.message })
                })
            ]
        });
    var _D = () => (0, g.jsxs)(w, {
        children: [
            (0, g.jsx)(x, { children: (0, g.jsx)(i.default, { text: (0, o.inImposterMode)() ? 'Ready for liftoff?' : 'Get ready...' }) }),
            ...
            (0, g.jsxs)(z, {
                children: [
                    (0, g.jsx)(A, { children: (0, g.jsx)(i.default, { text: 'You can draw while you\'re waiting!' }) }),
                    (0, g.jsx)(B, { children: (0, g.jsx)(i.default, { text: 'Click/tap here to draw!' }) })
                ]
            })
        ]
    });
    ...
    var _r = s => {
        ...
        return (0, g.jsxs)(_s, {
            ...
            children: [
                ...
                w && (0, g.jsx)(_u, { dangerouslySetInnerHTML: { __html: w } })
            ]
        });
    };
  ...
  text-align: center;
  font-family: ${ 0 };
`), () => m.ITEM_MAX_WIDTH, k.default.basic, i.default.White, j.default.mainFontName), _t = l.default.div(o || (o = q`
  font-size: 28px;
  font-weight: bold;
...
`), j.default.name);
    ...
    var r = i.forwardRef(function (s, t) {
            var u = s.avatar, v = s.classes, w = s.className, x = s.clickable, y = s.color, z = void 0 === y ? 'default' : y, A = s.component, B = s.deleteIcon, C = s.disabled, D = void 0 !== C && C, E = s.icon, F = s.label, G = s.onClick, H = s.onDelete, I = s.onKeyDown, J = s.onKeyUp, K = s.size, L = void 0 === K ? 'medium' : K, M = s.variant, N = void 0 === M ? 'default' : M, O = (0, h.default)(s, [
                    'avatar',
                    'classes',
                    'className',
                    'clickable',
                    ...
                    'size',
                    'variant'
                ]), P = i.useRef(null), Q = (0, n.default)(P, t), R = function (S) {
                    S.stopPropagation(), H && H(S);
                }, S = !(!1 === x || !G) || x, T = 'small' === L, U = A || (S ? p.default : 'div'), V = U === p.default ? { component: 'div' } : {}, W = null;
            if (H) {
            ...
            var Y = null;
            u && i.isValidElement(u) && (Y = i.cloneElement(u, { className: (0, j.default)(v.avatar, u.props.className, T && v.avatarSmall, 'default' !== z && v['avatarColor'.concat((0, o.default)(z))]) }));
            var Z = null;
            return E && i.isValidElement(E) && (Z = i.cloneElement(E, { className: (0, j.default)(v.icon, E.props.className, T && v.iconSmall, 'default' !== z && v['iconColor'.concat((0, o.default)(z))]) })), i.createElement(U, (0, g.default)({
                ...
                ref: Q
            }, V, O), Y || Z, i.createElement('span', { className: (0, j.default)(v.label, T && v.labelSmall) }, F), W);
        }), _s = (0, l.default)(function (t) {
            var u = 'light' === t.palette.type ? t.palette.grey[300] : t.palette.grey[700], v = (0, m.fade)(t.palette.text.primary, 0.26);
            return {
                root: {
                ...
                clickable: {
                    ...
                    WebkitTapHighlightColor: 'transparent',
                    cursor: 'pointer',
                    '&:hover, &:focus': { backgroundColor: (0, m.emphasize)(u, 0.08) },
                    '&:active': { boxShadow: t.shadows[1] }
                },
                clickableColorPrimary: { '&:hover, &:focus': { backgroundColor: (0, m.emphasize)(t.palette.primary.main, 0.08) } },
                clickableColorSecondary: { '&:hover, &:focus': { backgroundColor: (0, m.emphasize)(t.palette.secondary.main, 0.08) } },
                deletable: { '&:focus': { backgroundColor: (0, m.emphasize)(u, 0.08) } },
                deletableColorPrimary: { '&:focus': { backgroundColor: (0, m.emphasize)(t.palette.primary.main, 0.2) } },
                deletableColorSecondary: { '&:focus': { backgroundColor: (0, m.emphasize)(t.palette.secondary.main, 0.2) } },
                outlined: {
                    backgroundColor: 'transparent',
                    border: '1px solid '.concat('light' === t.palette.type ? 'rgba(0, 0, 0, 0.23)' : 'rgba(255, 255, 255, 0.23)'),
                    '$clickable&:hover, $clickable&:focus, $deletable&:focus': { backgroundColor: (0, m.fade)(t.palette.text.primary, t.palette.action.hoverOpacity) },
                    '& $avatar': { marginLeft: 4 },
                ...
                outlinedPrimary: {
                    ...
                    '$clickable&:hover, $clickable&:focus, $deletable&:focus': { backgroundColor: (0, m.fade)(t.palette.primary.main, t.palette.action.hoverOpacity) }
                },
                outlinedSecondary: {
                    color: t.palette.secondary.main,
                    border: '1px solid '.concat(t.palette.secondary.main),
                    '$clickable&:hover, $clickable&:focus, $deletable&:focus': { backgroundColor: (0, m.fade)(t.palette.secondary.main, t.palette.action.hoverOpacity) }
                },
                avatar: {},
                avatarSmall: {},
                avatarColorPrimary: {},
                ...
                deleteIconColorPrimary: {
                    ...
                    '&:hover, &:active': { color: t.palette.primary.contrastText }
                },
                deleteIconColorSecondary: {
                    color: (0, m.fade)(t.palette.secondary.contrastText, 0.7),
                    '&:hover, &:active': { color: t.palette.secondary.contrastText }
                },
                deleteIconOutlinedColorPrimary: {
                    color: (0, m.fade)(t.palette.primary.main, 0.7),
                    '&:hover, &:active': { color: t.palette.primary.main }
                },
                deleteIconOutlinedColorSecondary: {
                    color: (0, m.fade)(t.palette.secondary.main, 0.7),
                    '&:hover, &:active': { color: t.palette.secondary.main }
                }
            };
        }, { name: 'MuiChip' })(r);
}), d.register('.....', function (e, f) {
    ...
    var g = d('.....'), _h = (0, d('.....').default)(g.createElement('path', { d: 'M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z' }), 'Cancel');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _j;
    });
    ...
    let o = class extends m.Component {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { hasCalledStart: !1 });
        }
    };
    o = (0, h.__decorate)([
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = d('.....'), t = d('.....'), u = d('.....'), v = d('.....'), w = d('.....'), x = d('.....'), y = d('.....');
    d('.....');
    var z = d('.....');
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'changeShopTab', B => {
                ...
                return (0, r.inQrScanMode)() ? (0, i.jsx)(w.default, {}) : (0, r.inImposterMode)() ? (0, i.jsx)(y.default, {}) : (0, i.jsxs)(i.Fragment, {
                    children: [
                        (e = this.props.navigation.currentShopTab, e === u.ShopTab.upgrades ? (0, i.jsx)(o.default, {}) : e === u.ShopTab.powerups ? (0, i.jsx)(m.default, {}) : e === u.ShopTab.defendingHomebase ? (0, i.jsx)(v.default, {}) : e === u.ShopTab.lava ? (0, i.jsx)(x.default, {}) : e === u.ShopTab.powerupsNonMusic ? (0, i.jsx)(m.default, { hidePowerup: B => !(!B.category || !B.category.includes(z.PowerupCategory.specialSound)) }) : e === u.ShopTab.powerupsMusic ? (0, i.jsx)(m.default, { hidePowerup: B => !B.category || !B.category.includes(z.PowerupCategory.specialSound) }) : (0, i.jsx)(n.default, {})),
                        (0, i.jsx)(l.default, {
...
`));
    ...
    d('.....'), d('.....');
    var j = d('.....'), k = d('.....'), l = i.forwardRef(function (m, n) {
            var o = m.children, p = m.classes, q = m.className, r = m.component, s = void 0 === r ? 'div' : r, t = m.onChange, u = m.showLabels, v = void 0 !== u && u, w = m.value, x = (0, h.default)(m, [
                    'children',
                    'classes',
                    'className',
                    'component',
    ...
    d('.....');
    var j = d('.....'), k = d('.....'), l = d('.....'), m = i.forwardRef(function (n, o) {
            var p = n.classes, q = n.className, r = n.icon, s = n.label, t = n.onChange, u = n.onClick, v = n.selected, w = n.showLabel, x = n.value, y = (0, h.default)(n, [
                    'classes',
                    'className',
                    'icon',
                    'label',
            ...
            }, y), i.createElement('span', { className: p.wrapper }, r, i.createElement('span', { className: (0, j.default)(p.label, v ? p.selected : !w && p.iconOnly) }, s)));
        }), _n = (0, k.default)(function (o) {
            return {
                root: {
                ...
                label: {
                    ...
                    '&$selected': { fontSize: o.typography.pxToRem(14) }
                }
            };
        }, { name: 'MuiBottomNavigationAction' })(m);
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z' }), 'Build');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M18 4V3c0-.55-.45-1-1-1H5c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1h12c.55 0 1-.45 1-1V6h1v4H9v11c0 .55.45 1 1 1h2c.55 0 1-.45 1-1v-9h8V4h-3z' }), 'FormatPaint');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z' }), 'Home');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z' }), 'MusicNote');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M16.01 7L16 3h-2v4h-4V3H8v4h-.01C7 6.99 6 7.99 6 8.99v5.49L9.5 18v3h5v-3l3.5-3.51v-5.5c0-1-1-2-1.99-1.99z' }), 'Power');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _h;
    });
    var g = d('.....'), _h = (0, d('.....').default)(c(g).createElement('path', { d: 'M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z' }), 'TrendingUp');
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _F;
    });
...
`)), C = p.default.div(u || (u = x`
  ...
  flex-direction: column;
`)), D = p.default.img.attrs({ src: (0, m.getAssetPath)('treasure.svg') })(v || (v = x`
  width: 50%;
  max-width: 250px;
  max-height: 25vh;
  cursor: pointer;
`));
    let E = class extends o.Component {
        render() {
            return (0, i.jsx)(z, { children: this.renderScreens() });
        }
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', {
                ...
                const {currentScreen: F} = this.state;
                let G = null;
                ...
                children: [
                    (0, i.jsx)(B, { children: (0, i.jsx)(j.default, { text: 'Open The Treasure Chest To Unlock Your Powerups!' }) }),
                    (0, i.jsx)(D, {
                ...
                this.props.navigation.powerupRNGAnimationDone = !0, this.setState({ showTreasureChest: !1 }, () => setTimeout(() => this.setState({ currentScreen: w.powerups }, () => setTimeout(() => this.props.navigation.visitedPowerupSection = !0, 500)), 1000));
            }), (0, g.default)(this, 'openModal', () => this.setState({ showPowerupsHelperModal: !0 })), (0, g.default)(this, 'closeAndReturnToQuestions', () => {
                this.closeModal(), setTimeout(() => (0, m.changeRoute)(l.default.questions), 510);
            }), (0, g.default)(this, 'closeModal', () => {
                this.setState({ showPowerupsHelperModal: !1 });
            });
        }
    };
    E = (0, h.__decorate)([
  ...
  display: flex;
  flex-direction: column;
`), n.default.basic, 5), C = u.default.div(w || (w = A`
  width: 100%;
  min-height: 80px;
  padding: 10px;
  box-sizing: border-box;
  ...
  flex-grow: 1;
  flex-direction: column;
`), D => D.colors.background, D => D.colors.text, 5, 5), D = u.default.div(x || (x = A`
  display: flex;
  padding: 12px;
  justify-content: space-between;
...
`));
    let G = class extends t.Component {
        render() {
            const {powerup: H} = this.props, I = this.getButtonDetails();
            return (0, i.jsxs)(B, {
                children: [
                    (0, i.jsxs)(C, {
                        colors: H.color,
                        children: [
                            (0, i.jsx)(l.default, { name: H.icon }),
                                ...
                                children: [
                                    (0, i.jsx)(E, {
                                        children: (0, i.jsx)('div', {
                                            style: { marginRight: 5 },
                                            children: (0, i.jsx)(m.default, { text: (0, r.getPowerupName)(H) })
                                        })
                                    }),
                                    (0, i.jsx)(F, { children: (0, i.jsx)(m.default, { text: (0, r.getPowerupDescription)(H.description) }) })
                                ]
                            }),
                            (0, i.jsx)(k.default, {
                                type: I.type,
  ...
  flex-direction: column;
  font-family: ${ 0 };
`), k.default.name), u = o.default.div(q || (q = s`
  font-weight: bold;
  font-size: 29px;
    ...
    class w extends n.Component {
        render() {
            return (0, g.jsx)(i.default, {
                ...
                children: (0, g.jsxs)(t, {
                    children: [
                        (0, g.jsx)(u, { children: (0, g.jsx)(j.default, { text: 'Powerup Purchased!' }) }),
                        (0, g.jsx)(v, { children: (0, g.jsx)(j.default, { text: 'Activate your powerup via the tray menu' }) }),
                        (0, g.jsx)('img', {
                        ...
                        (0, g.jsx)(h.default, {
                            ...
                            label: (0, g.jsx)(j.default, { text: 'Got It' })
                        })
                    ]
                })
            });
...
`));
    let r = class extends k.Component {
        render() {
            const {
                theme: {availableThemes: s}
            } = this.props;
            return (0, h.jsx)(_p, { children: (0, h.jsx)(q, { children: s.slice().sort((t, u) => t.cost - u.cost).filter(t => !this.props.theme.disabledThemes.includes(t.name)).map(t => (0, h.jsx)(i.default, { specifiedTheme: t }, t.name)) }) });
        }
    };
    r = (0, g.__decorate)([
        (0, j.inject)('theme'),
  ...
  margin: 10px;
  box-shadow: ${ 0 };
`), 5, l.default.basic), C = t.default.div(v || (v = A`
  width: 100%;
  height: 100px;
  display: flex;
`)), D = t.default.div(w || (w = A`
  ...
  border-top-right-radius: ${ 0 }px;
  background: ${ 0 };
`), E => 0 === E.index ? 5 : 0, E => 3 === E.index ? 5 : 0, E => E.color), E = t.default.div(x || (x = A`
...
`));
    let H = class extends r.Component {
        render() {
            const I = this.getButtonDetails(), J = this.props.specifiedTheme;
            return (0, i.jsxs)(B, {
                children: [
                    (0, i.jsx)(C, {
                    ...
                    (0, i.jsxs)(E, {
                        children: [
                            (0, i.jsxs)('div', {
                                style: { marginRight: 10 },
                                children: [
                                    (0, i.jsx)(G, { children: J.name }),
                                    (0, i.jsx)(F, { children: (0, i.jsx)(k.default, { text: J.description }) })
                                ]
                            }),
                            (0, i.jsx)(j.default, {
                                onClick: I.onClick,
            ...
            super(...e), (0, g.default)(this, 'getButtonDetails', () => {
                if (this.ownsTheme())
                    return this.canApplyTheme() ? {
                        type: 'secondary',
                        text: (0, i.jsx)(k.default, { text: 'Apply' }),
                        onClick: () => {
                        ...
                        type: 'disabled',
                        text: (0, i.jsx)(k.default, { text: 'Applied' })
                    };
...
`), k.default.White, k.default.Black, l.default.basic, x => x.breakpoint), x = s.default.div(u || (u = v`
  margin-left: 10px;
  margin-top: 7px;
  margin-bottom: 7px;
  margin-right: 12px;
                    ...
                    (0, i.jsxs)(x, {
                        ...
                        children: [
                            (0, i.jsx)('div', {
                                ...
                                children: (0, i.jsx)(j.default, { text: this.props.title })
                            }),
                            (0, i.jsx)('div', { children: (0, i.jsx)(j.default, { text: this.props.description }) })
                        ]
                    })
                ]
            });
    ...
    class _m extends j.Component {
        ...
        render() {
            return (0, h.jsx)(l, {
                ...
                index: this.props.index,
                children: (0, h.jsx)(i.default, { name: this.props.name })
            });
        }
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { screenWidth: 0 }), (0, g.default)(this, 'updateWidth', () => {
                    ...
                    children: (0, i.jsxs)(_v, {
                        children: [
                            ...
                            this.props.upgrades.homebaseUpgades.map(u => {
                                const v = this.getCost(u.baseCost, u.percentageCost), w = this.props.balance.balance >= v;
                                return (0, i.jsx)(r.default, {
                                    ...
                                    onClick: () => {
                                        w && ((0, l.send)(j.default.upgradeDefendingHomebase, { id: u.id }), (0, l.changeRoute)(k.default.questions));
                                    }
                                }, u.id);
                            }),
                            (0, i.jsx)('div', {
...
`));
            ...
            return v ? (0, h.jsxs)(_w, {
                children: [
                    (0, h.jsx)(_x, {
                        ...
                        children: (0, h.jsx)(j.default, { name: v.icon })
                    }),
                    (0, h.jsxs)('div', {
                        style: {
                            padding: 23,
                        ...
                        children: [
                            (0, h.jsx)('div', {
                                ...
                                children: (0, h.jsx)(k.default, { text: v.name })
                            }),
                            (0, h.jsxs)('div', {
                                style: {
                                    fontSize: 23,
                            ...
                            (0, h.jsxs)('div', {
                                children: [
                                    (0, h.jsx)(k.default, { text: 'Losing' }),
                                    ' ',
                                    (0, h.jsx)('b', { children: (0, n.numberWithCommas)((b = v.healthDecreasePerTick, Math.round(10 * b) / 10)) }),
                                    ' ',
                                    (0, h.jsx)(k.default, { text: 'health per second' })
                                ]
                            })
                        ]
                    })
  ...
  border-radius: ${ 0 }px;
  box-shadow: ${ 0 };
`), 5, m.default.basic), _x = q.default.div(s || (s = t`
  width: 100%;
  min-height: 120px;
  padding: 10px;
  box-sizing: border-box;
...
`), y => y.colors.background, y => y.colors.text, 5, 5);
            ...
            return (0, g.jsxs)(_u, {
                ...
                children: [
                    (0, g.jsx)(_v, {
                        ...
                        children: (0, g.jsx)(i.default, { name: t.icon })
                    }),
                    (0, g.jsxs)('div', {
                        style: {
                            padding: 23,
                            ...
                            (0, g.jsxs)('div', {
                                ...
                                children: [
                                    ...
                                    (0, g.jsx)('div', {
                                        ...
                                        children: (0, g.jsx)(j.default, { text: t.name })
                                    }),
                                    (0, g.jsx)('div', { children: (0, g.jsx)(j.default, { text: t.description }) })
                                ]
                            }),
                            (0, g.jsx)('div', {
                                children: (0, g.jsx)(h.default, {
  ...
  border-radius: ${ 0 }px;
  box-shadow: ${ 0 };
`), 5, l.default.basic), _v = o.default.div(q || (q = r`
  width: 100%;
  min-height: 80px;
  padding: 10px;
  box-sizing: border-box;
...
`), j.default.White), y = r.default.div(v || (v = w`
  font-size: 26px;
  font-weight: bold;
  margin-bottom: 9px;
`));
    let z = class extends o.Component {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', {
                ...
                children: [
                    (0, i.jsx)(y, { children: 'Find a KitCode to scan!' }),
                    (0, i.jsx)(c(p), {
    ...
    e.exports = (h = g = function (t) {
        ...
        return function (w, x) {
            ...
            },
            {
                ...
                value: function (w) {
                    var x = p(this.props, w, s), y = !0, z = !1, A = void 0;
                    try {
            ...
            },
            {
                key: 'initiate',
                value: function () {
                    var w = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.props, x = w.onError, y = w.facingMode, z = /firefox/i.test(navigator.userAgent), A = {};
                    ...
                    var B = {};
                    A.facingMode && (B.facingMode = { ideal: y }), A.frameRate && (B.frameRate = {
                        ideal: 25,
                        min: 10
                    });
                    var C = A.facingMode || z ? Promise.resolve(w.constraints || B) : o(y).then(function (D) {
                        return Object.assign({}, { deviceId: D }, w.constraints);
                    });
                    C.then(function (D) {
                        return navigator.mediaDevices.getUserMedia({ video: D });
            ...
            },
            {
                key: 'handleVideo',
                value: function (w) {
                    var x = this.els.preview, y = this.props.facingMode;
                    if (!x)
            ...
            },
            {
                key: 'handleLoadStart',
                value: function () {
                    var w = this.props, x = w.delay, y = w.onLoad, z = this.state, A = z.mirrorVideo, B = z.streamLabel, C = this.els.preview;
            ...
            },
            {
                key: 'check',
                value: function () {
                    var w = this.props, x = w.legacyMode, y = w.resolution, z = w.delay, A = this.els, B = A.preview, C = A.canvas, D = A.img, E = Math.floor(x ? D.naturalWidth : B.videoWidth), F = Math.floor(x ? D.naturalHeight : B.videoHeight), G = 0, H = 0;
                    if (x) {
                        var I = y / (E > F ? E : F);
            ...
            },
            {
                ...
                value: function (w) {
                    var x = this.props, y = x.onScan, z = x.legacyMode, A = x.delay;
            ...
            },
            {
                key: 'render',
                value: function () {
                    var w = this.props, x = w.style, y = w.className, z = w.onImageLoad, A = w.legacyMode, B = w.showViewFinder, C = (w.facingMode, { display: 'none' }), D = {
                            top: 0,
                            left: 0,
                            display: 'block',
                            position: 'absolute',
            ...
            return new Promise(function (l, m) {
                ...
                n.then(function (o) {
                    ...
                    if (p.length < 1)
                        ...
                        var q = i(j), r = p.filter(function (s) {
                                var t = s.label;
                                return q.test(t);
                            });
                        l(k(r, p, j));
    ...
    g.prototype = new Error(), e.exports = { NoVideoInputDevicesError: g };
}), d.register('.....', function (e, f) {
    ...
    (0, d('.....').adapterFactory)({ window: 'undefined' == typeof window ? void 0 : window });
}), d.register('.....', function (e, f) {
    b(e.exports, 'adapterFactory', function () {
        return _m;
    });
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....');
    function _m({window: n} = {}, o = {
        shimChrome: !0,
        shimFirefox: !0,
        shimEdge: !0,
        shimSafari: !0
    }) {
        const p = g.log, q = g.detectBrowser(n), r = {
                browserDetails: q,
                commonShim: l,
    ...
    function _k(l, m, n) {
        if (!l.RTCPeerConnection)
            return;
        const o = l.RTCPeerConnection.prototype, p = g.addEventListener;
    ...
    function _w(x) {
        return v(x) ? Object.keys(x).reduce(function (y, z) {
            const A = v(x[z]), B = A ? _w(x[z]) : x[z], C = A && !Object.keys(B).length;
            return void 0 === B || C ? y : Object.assign(y, { [z]: B });
        }, {}) : x;
    }
    function x(y, z, A) {
    ...
    function _y(z, A, B) {
        const C = B ? 'outbound-rtp' : 'inbound-rtp', D = new Map();
        if (null === A)
            return h;
        const E = [];
        return z.forEach(F => {
            ...
            j.RTCPeerConnection.prototype.setRemoteDescription = function () {
                return this._ontrackpoly || (this._ontrackpoly = l => {
                    l.stream.addEventListener('addtrack', m => {
                        let n;
                        n = j.RTCPeerConnection.prototype.getReceivers ? this.getReceivers().find(o => o.track && o.track.id === m.track.id) : { track: m.track };
                        const o = new Event('track');
                        o.track = m.track, o.receiver = n, o.transceiver = { receiver: n }, o.streams = [l.stream], this.dispatchEvent(o);
                    }), l.stream.getTracks().forEach(m => {
                        let n;
                        n = j.RTCPeerConnection.prototype.getReceivers ? this.getReceivers().find(o => o.track && o.track.id === m.id) : { track: m };
                        const o = new Event('track');
                        o.track = m, o.receiver = n, o.transceiver = { receiver: n }, o.streams = [l.stream], this.dispatchEvent(o);
                    });
                }, this.addEventListener('addstream', this._ontrackpoly)), k.apply(this, arguments);
            };
        } else
            g.wrapPeerConnectionEvent(j, 'track', l => (l.transceiver || Object.defineProperty(l, 'transceiver', { value: { receiver: l.receiver } }), l));
    }
    function _k(l) {
    ...
    function _D(E) {
        ...
        function J(K, L) {
            ...
            return Object.keys(K._reverseStreams || []).forEach(N => {
                const O = K._reverseStreams[N], P = K._streams[O.id];
        ...
        function K(L, M) {
            ...
            return Object.keys(L._reverseStreams || []).forEach(O => {
                const P = L._reverseStreams[O], Q = L._streams[P.id];
        ...
        E.RTCPeerConnection.prototype.removeStream = function (L) {
            ...
            const M = E.RTCPeerConnection.prototype[L], N = {
                    [L]() {
                        const O = arguments;
    ...
    function _K(L) {
        ...
        M.version < 53 && [
            ...
            const P = L.RTCPeerConnection.prototype[O], Q = {
                    [O]() {
    ...
    function _i(j) {
        ...
        if (!k.mediaDevices)
            return;
        const l = g.detectBrowser(j), m = function (n) {
                ...
                return Object.keys(n).forEach(p => {
                    if ('require' === p || 'advanced' === p || 'mediaSource' === p)
                        return;
                    const q = 'object' == typeof n[p] ? n[p] : { ideal: n[p] };
                    ...
                    if (r && ('user' === r.exact || 'environment' === r.exact || 'user' === r.ideal || 'environment' === r.ideal) && (!q.mediaDevices.getSupportedConstraints || !q.mediaDevices.getSupportedConstraints().facingMode || s)) {
                        ...
                        if (delete o.video.facingMode, 'environment' === r.exact || 'environment' === r.ideal ? t = [
                            ...
                            return q.mediaDevices.enumerateDevices().then(u => {
                                ...
                                return !v && u.length && t.includes('back') && (v = u[u.length - 1]), v && (o.video.deviceId = r.exact ? { exact: v.deviceId } : { ideal: v.deviceId }), o.video = m(o.video), h('chrome: ' + JSON.stringify(o)), p(o);
                            });
                    }
                    o.video = m(o.video);
                }
    ...
    function g(h, i) {
        h.navigator.mediaDevices && 'getDisplayMedia' in h.navigator.mediaDevices || h.navigator.mediaDevices && ('function' == typeof i ? h.navigator.mediaDevices.getDisplayMedia = function (j) {
            return i(j).then(k => {
                const l = j.video && j.video.width, m = j.video && j.video.height, n = j.video && j.video.frameRate;
                return j.video = {
                    mandatory: {
    ...
    function l(m, n) {
        var o = {
                ...
                var v = p(r.parameters.apt, t), w = p(s.parameters.apt, u);
    ...
    e.exports = function (u, v) {
        function w(x, y) {
            y.addTrack(x), y.dispatchEvent(new u.MediaStreamTrackEvent('addtrack', { track: x }));
        }
        function x(y, z, A, B) {
            var C = new Event('track');
            C.track = z, C.receiver = A, C.transceiver = { receiver: A }, C.streams = B, u.setTimeout(function () {
        ...
        Object.defineProperty(z.prototype, 'localDescription', {
            ...
            var C = this.transceivers.length > 0, D = {
                    track: null,
                    iceGatherer: null,
                    iceTransport: null,
                    dtlsTransport: null,
            ...
            var C = this, D = this.transceivers[B].iceGatherer;
            if (!D.onlocalcandidate) {
                ...
                this.transceivers[B].bufferedCandidateEvents = null, D.removeEventListener('localcandidate', this.transceivers[B].bufferCandidates), D.onlocalcandidate = function (F) {
                    if (!(C.usingBundle && B > 0)) {
                        ...
                        var H = F.candidate, I = !H || 0 === Object.keys(H).length;
                        if (I)
            ...
            var A = this, B = new u.RTCIceTransport(null);
            ...
            if ('offer' === A.type)
                ...
                B.forEach(function (F, G) {
                    var H = D.transceivers[G], I = H.iceGatherer, J = H.iceTransport, K = H.dtlsTransport, L = H.localCapabilities, M = H.remoteCapabilities;
                    if (!(v.isRejected(F) && 0 === v.matchPrefix(F, 'a=bundle-only').length) && !H.rejected) {
                        var N = v.getIceParameters(F, C), O = v.getDtlsParameters(F, C);
            ...
            var D = [], E = v.splitSections(A.sdp), F = E.shift(), G = v.matchPrefix(F, 'a=ice-lite').length > 0, H = v.matchPrefix(F, 'a=group:BUNDLE ').length > 0;
            B.usingBundle = H;
            ...
            return B.canTrickleIceCandidates = !!I && I.substr(14).split(' ').indexOf('trickle') >= 0, E.forEach(function (J, K) {
                var L = v.splitLines(J), M = v.getKind(J), N = v.isRejected(J) && 0 === v.matchPrefix(J, 'a=bundle-only').length, O = L[0].substr(2).split(' ')[2], P = v.getDirection(J, F), Q = v.parseMsid(J), R = v.getMid(J) || v.generateIdentifier();
                if (N || 'application' === M && ('DTLS/SCTP' === O || 'UDP/DTLS/SCTP' === O))
                    ...
                    var db = v.parseRtcpParameters(J), eb = v.matchPrefix(J, 'a=end-of-candidates', F).length > 0, fb = v.matchPrefix(J, 'a=candidate:').map(function (gb) {
                    ...
                    if (('offer' === A.type || 'answer' === A.type) && !N && H && K > 0 && B.transceivers[K] && (B._disposeIceAndDtlsTransports(K), B.transceivers[K].iceGatherer = B.transceivers[0].iceGatherer, B.transceivers[K].iceTransport = B.transceivers[0].iceTransport, B.transceivers[K].dtlsTransport = B.transceivers[0].dtlsTransport, B.transceivers[K].rtpSender && B.transceivers[K].rtpSender.setTransport(B.transceivers[0].dtlsTransport), B.transceivers[K].rtpReceiver && B.transceivers[K].rtpReceiver.setTransport(B.transceivers[0].dtlsTransport)), 'offer' !== A.type || N) {
                        ...
                        (S = B.transceivers[K] || B._createTransceiver(M)).mid = R, S.iceGatherer || (S.iceGatherer = B._createIceGatherer(K, H)), fb.length && 'new' === S.iceTransport.state && (!eb || H && 0 !== K ? fb.forEach(function (gb) {
                            ...
                            return 'rtx' !== gb.name;
                        })), X = S.sendEncodingParameters || [{ ssrc: 1001 * (2 * K + 2) }];
                        var gb, hb = !1;
                        if ('sendrecv' === P || 'sendonly' === P) {
                            ...
                            S.rtpReceiver && S.rtpReceiver.track && (S.associatedRemoteMediaStreams.forEach(function (ib) {
                                ...
                                jb && function (kb, lb) {
                                    lb.removeTrack(kb), lb.dispatchEvent(new u.MediaStreamTrackEvent('removetrack', { track: kb }));
                                }(jb, ib);
            ...
            var B = A.transceivers.filter(function (C) {
                    return 'audio' === C.kind;
                }).length, C = A.transceivers.filter(function (D) {
                    return 'video' === D.kind;
                }).length, D = arguments[0];
            if (D) {
            ...
            A.transceivers.forEach(function (F, G) {
                var H = F.track, I = F.kind, J = F.mid || v.generateIdentifier();
                ...
                var L = F.sendEncodingParameters || [{ ssrc: 1001 * (2 * G + 1) }];
                H && v >= 15019 && 'video' === I && !L[0].rtx && (L[0].rtx = { ssrc: L[0].ssrc + 1 }), F.wantReceive && (F.rtpReceiver = new u.RTCRtpReceiver(F.dtlsTransport, I)), F.localCapabilities = K, F.sendEncodingParameters = L;
            ...
            A.transceivers.forEach(function (D, E) {
                if (!(E + 1 > C)) {
                    ...
                    var F;
                    if (D.stream)
                        'audio' === D.kind ? F = D.stream.getAudioTracks()[0] : 'video' === D.kind && (F = D.stream.getVideoTracks()[0]), F && v >= 15019 && 'video' === D.kind && !D.sendEncodingParameters[0].rtx && (D.sendEncodingParameters[0].rtx = { ssrc: D.sendEncodingParameters[0].ssrc + 1 });
    ...
    g.localCName = g.generateIdentifier(), g.splitLines = function (h) {
        ...
        var i = h.substr(9).split(' '), j = { payloadType: parseInt(i.shift(), 10) };
        ...
        var i = h.indexOf(' '), j = { ssrc: parseInt(h.substr(7, i - 7), 10) }, k = h.indexOf(':', i);
        ...
        var j = g.matchPrefix(h + i, 'a=ice-ufrag:')[0], k = g.matchPrefix(h + i, 'a=ice-pwd:')[0];
        return j && k ? {
        ...
        for (var i = {
            ...
            var l = j[k], m = g.matchPrefix(h, 'a=rtpmap:' + l + ' ')[0];
            if (m) {
                var n = g.parseRtpMap(m), o = g.matchPrefix(h, 'a=fmtp:' + l + ' ');
        ...
        var i, j = [], k = g.parseRtpParameters(h), l = -1 !== k.fecMechanisms.indexOf('RED'), m = -1 !== k.fecMechanisms.indexOf('ULPFEC'), n = g.matchPrefix(h, 'a=ssrc:').map(function (o) {
                return g.parseSsrcMedia(o);
            }).filter(function (o) {
                return 'cname' === o.attribute;
            }), o = n.length > 0 && n[0].ssrc, p = g.matchPrefix(h, 'a=ssrc-group:FID').map(function (q) {
        ...
        p.length > 0 && p[0].length > 1 && p[0][0] === o && (i = p[0][1]), k.codecs.forEach(function (q) {
            if ('RTX' === q.name.toUpperCase() && q.parameters.apt) {
                ...
                o && i && (r.rtx = { ssrc: i }), j.push(r), l && ((r = JSON.parse(JSON.stringify(r))).fec = {
                    ssrc: o,
                    mechanism: m ? 'red+ulpfec' : 'red'
                }, j.push(r));
            }
        }), 0 === j.length && o && j.push({ ssrc: o });
        ...
        var i = {}, j = g.matchPrefix(h, 'a=ssrc:').map(function (k) {
        ...
        var i, j = g.parseMLine(h), k = g.matchPrefix(h, 'a=max-message-size:');
    ...
    function g(h) {
        const i = h && h.navigator, j = i.mediaDevices.getUserMedia.bind(i.mediaDevices);
        i.mediaDevices.getUserMedia = function (k) {
            return j(k).catch(l => Promise.reject(function (m) {
                return {
                    name: { PermissionDeniedError: 'NotAllowedError' }[m.name] || m.name,
                    message: m.message,
    ...
    function _i(j) {
        ...
        if (!j.RTCPeerConnection && j.mozRTCPeerConnection && (j.RTCPeerConnection = j.mozRTCPeerConnection), k.version < 53 && [
                ...
                const m = j.RTCPeerConnection.prototype[l], n = {
                        [l]() {
                ...
                if (l.version < 53 && !p)
                    try {
                        ...
                        if ('TypeError' !== l.name)
                            throw l;
                        r.forEach((s, t) => {
                            r.set(t, Object.assign({}, s, { type: m[s.type] || s.type }));
                        });
                    }
                return r;
            }).then(p, q);
    ...
    function _u(v) {
        ...
        w && (v.RTCPeerConnection.prototype.addTransceiver = function () {
            ...
            const x = arguments[1], y = x && 'sendEncodings' in x;
            ...
            if (y) {
                const {sender: A} = z, B = A.getParameters();
    ...
    var g = d('.....');
    function _h(i) {
        const j = g.detectBrowser(i), k = i && i.navigator, l = i && i.MediaStreamTrack;
    ...
    function g(h, i) {
        h.navigator.mediaDevices && 'getDisplayMedia' in h.navigator.mediaDevices || h.navigator.mediaDevices && (h.navigator.mediaDevices.getDisplayMedia = function (j) {
            ...
            return !0 === j.video ? j.video = { mediaSource: i } : j.video.mediaSource = i, k.navigator.mediaDevices.getUserMedia(j);
        });
    }
    b(e.exports, 'shimGetDisplayMedia', function () {
        return g;
    ...
    function _l(m) {
        if ('object' != typeof m || !m.RTCPeerConnection)
            return;
        const n = m.RTCPeerConnection.prototype, o = n.createOffer, p = n.createAnswer, q = n.setLocalDescription, r = n.setRemoteDescription, s = n.addIceCandidate;
        n.createOffer = function (t, u) {
            const v = arguments.length >= 2 ? arguments[2] : arguments[0], w = o.apply(this, [v]);
            return u ? (w.then(t, u), Promise.resolve()) : w;
        }, n.createAnswer = function (t, u) {
            const v = arguments.length >= 2 ? arguments[2] : arguments[0], w = p.apply(this, [v]);
            return u ? (w.then(t, u), Promise.resolve()) : w;
        };
    ...
    function _s(t) {
        ...
        if (u.mediaDevices && u.mediaDevices.getUserMedia) {
            const v = u.mediaDevices, w = t.getUserMedia.bind(t);
    ...
    function _w(x) {
        return x && void 0 !== x.video ? Object.assign({}, x, { video: q.compactObject(x.video) }) : x;
    }
    function _x(y) {
        ...
        y.RTCPeerConnection = function (A, B) {
            ...
            return new C(A, B);
        }, y.RTCPeerConnection.prototype = z.prototype, 'generateCertificate' in z && Object.defineProperty(y.RTCPeerConnection, 'generateCertificate', { get: () => z.generateCertificate });
    }
    function _z(A) {
    ...
    function _i(j) {
        ...
        j.RTCIceCandidate = function (l) {
            if ('object' == typeof l && l.candidate && 0 === l.candidate.indexOf('a=') && ((l = JSON.parse(JSON.stringify(l))).candidate = l.candidate.substr(2)), l.candidate && l.candidate.length) {
                const m = new k(l), n = c(g).parseCandidate(l.candidate), o = Object.assign(m, n);
    ...
    function _k(l) {
        ...
        l.RTCPeerConnection.prototype.setRemoteDescription = function () {
            ...
            if (n(arguments[0])) {
                const t = o(arguments[0]), u = _i(t), v = _k(arguments[0], t);
                let w;
                w = 0 === u && 0 === v ? Number.POSITIVE_INFINITY : 0 === u || 0 === v ? Math.max(u, v) : Math.min(u, v);
                const x = {};
                Object.defineProperty(x, 'maxMessageSize', { get: () => w }), this._sctp = x;
            }
    ...
    function r(s) {
        ...
        function t(u, v) {
            const w = u.send;
            u.send = function () {
                const x = arguments[0], y = x.length || x.size || x.byteLength;
    ...
    let s, t = class extends k.Component {
            ...
            constructor(...e) {
                super(...e), (0, g.default)(this, 'canAffordUpgrade', u => {
                    ...
                    this.canAffordUpgrade(u) && ((0, p.send)(q.default.lavaPurchasePiece, { type: u }), (0, p.changeRoute)(r.default.questions));
                });
            }
        };
    t = (0, h.__decorate)([
...
`));
            ...
            return this.props.entities.lava ? (0, h.jsxs)(o.Container, {
                children: [
                    (0, h.jsx)(o.IconContainer, {
                        ...
                        children: (0, h.jsx)(i.default, { name: 'fas fa-wrench fa-flip-horizontal' })
                    }),
                    (0, h.jsxs)('div', {
                        style: {
                            padding: 23,
                        ...
                        children: [
                            (0, h.jsx)('div', {
                                ...
                                children: (0, h.jsx)(j.default, { text: 'Build' })
                            }),
                            (0, h.jsx)(p.default, {
                                style: {
                                    marginBottom: 15,
                            ...
                            (0, h.jsxs)('div', {
                                ...
                                children: [
                                    (0, h.jsxs)('b', {
                                        children: [
                                            (0, h.jsx)(j.default, { text: 'Building Height' }),
                                            ':'
                                        ]
                                    }),
                                    ' ',
                                    ...
                                    ' ',
                                    (0, h.jsx)(j.default, { text: (0, q.plural)('block', this.props.entities.lava.buildHeight) }),
                                    (0, h.jsx)('br', {}),
                                    (0, h.jsxs)('b', {
                                        children: [
                                            (0, h.jsx)(j.default, { text: 'Lava Height' }),
                                            ':'
                                        ]
                                    }),
                                    ' ',
                                    ...
                                    ' ',
                                    (0, h.jsx)(j.default, { text: (0, q.plural)('block', this.props.entities.lava.lavaHeight) })
                                ]
                            })
                        ]
                    })
    ...
    let y = class extends l.Component {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'isItemNotAvailable', z => !(0 !== this.props.imposter.investigationsLeft || !x.includes(z)) || !(z !== j.ImposterShopItemId.blendIn || !this.props.imposter.me || !this.props.imposter.me.blendingIn)), (0, g.default)(this, 'canPurchaseItem', z => !this.isItemNotAvailable(z) && this.canAffordItem(z)), (0, g.default)(this, 'canAffordItem', z => {
                ...
                (0, t.send)(u.default.imposter.purchase, { item: z }), z !== j.ImposterShopItemId.meeting && (0, t.changeRoute)(v.default.questions);
            });
        }
    };
    y = (0, h.__decorate)([
    ...
    const _z = () => (0, i.jsx)(_B, { children: (0, i.jsx)(s.default, { text: 'Not Available' }) });
    var _A = y;
            ...
            return (0, h.jsxs)(n.Container, {
                ...
                children: [
                    (0, h.jsx)(n.IconContainer, {
                        ...
                        children: (0, h.jsx)(i.default, { name: 'far fa-space-station-moon-alt' })
                    }),
                    (0, h.jsxs)('div', {
                        style: {
                            padding: 23,
                        ...
                        children: [
                            (0, h.jsx)('div', {
                                ...
                                children: (0, h.jsx)(j.default, { text: 'Mission Control' })
                            }),
                            (0, h.jsx)(o.default, {
                                style: {
                                    marginBottom: 15,
                            ...
                            (0, h.jsxs)('div', {
                                ...
                                children: [
                                    (0, h.jsxs)('b', {
                                        children: [
                                            (0, h.jsx)(j.default, { text: 'Investigations Left' }),
                                            ':'
                                        ]
                                    }),
                                    ' ',
                                    ...
                                    !w && (0, h.jsxs)(h.Fragment, {
                                        children: [
                                            (0, h.jsxs)('b', {
                                                children: [
                                                    (0, h.jsx)(j.default, { text: 'Impostors Left' }),
                                                    ':'
                                                ]
                                            }),
                                            ' ',
                                    ...
                                    (0, h.jsxs)('b', {
                                        children: [
                                            (0, h.jsx)(j.default, { text: 'Meetings Left' }),
                                            ':'
                                        ]
                                    }),
                                    ' ',
...
`), j.default.BackgroundGray);
    let t = class extends q.Component {
        render() {
            const u = this.props.upgrades.upgrades.filter(v => v.name === this.props.upgrades.currentlySelectedUpgrade)[0], v = this.props.upgrades.upgradeLevelTabs[(0, o.upgradeNameToKey)(this.props.upgrades.currentlySelectedUpgrade)];
            return (0, i.jsxs)(s, {
                children: [
                    (0, i.jsx)(k.default, { onPurchase: this.markAsPurchased }),
                    (0, i.jsx)(m.default, {
                        levels: u.levels,
                        active: v
                    }),
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { purchased: !1 }), (0, g.default)(this, 'closeModal', u => {
                this.setState({ purchased: !1 }, () => u ? setTimeout(() => (0, o.changeRoute)(n.default.questions), 300) : null);
            }), (0, g.default)(this, 'markAsPurchased', () => this.setState({ purchased: !0 }));
        }
    };
    t = (0, h.__decorate)([
        (0, p.inject)('upgrades'),
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = d('.....');
    let t, u, v, w, x, y = z => z;
    const z = '4px', A = s.default.div(t || (t = y`
  height: 60%;
  width: 100%;
  display: flex;
  justify-content: center;
...
`)), B = s.default.div(u || (u = y`
  ...
  background: ${ 0 };
  color: ${ 0 };
`), z, m.default.basic, C => C.theme.question.background, C => C.theme.question.text), C = s.default.div(v || (v = y`
  height: 20%;
  border-top-left-radius: ${ 0 };
  border-top-right-radius: ${ 0 };
  width: 100%;
  background: rgba(0, 0, 0, 0.4);
`), z, z), D = s.default.div(w || (w = y`
  height: 50%;
  width: 100%;
...
`), F => F.disabled ? l.default.DisabledGray : 'rgba(255,255,255,0.2)', F => F.disabled ? 'not-allowed' : 'pointer', l.default.White, z, z, F => F.disabled ? l.default.DisabledGray : 'rgba(255,255,255,0.25)');
    let F = class extends r.Component {
                    ...
                    children: [
                        (0, i.jsx)(C, {
                            children: (0, i.jsx)(k.default, {
                                ...
                                max: 40,
                                text: (0, i.jsx)(j.default, { text: this.getTitle() })
                            })
                        }),
                        (0, i.jsx)(D, {
                            children: (0, i.jsx)(k.default, {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'canPurchase', () => this.ownedLevel() < this.currentlySelectedLevel() && this.getPrice() <= this.props.balance.balance), (0, g.default)(this, 'currentlySelectedLevel', () => this.props.upgrades.upgradeLevelTabs[(0, p.upgradeNameToKey)(this.currentUpgrade().name)]), (0, g.default)(this, 'ownedLevel', () => this.props.upgrades.upgradeLevels[(0, p.upgradeNameToKey)(this.currentUpgrade().name)]), (0, g.default)(this, 'currentUpgrade', () => this.props.upgrades.upgrades.filter(G => G.name === this.props.upgrades.currentlySelectedUpgrade)[0]), (0, g.default)(this, 'getTitle', () => {
                ...
                const G = this.currentUpgrade(), H = this.getLevel().value;
                ...
                const G = this.currentUpgrade(), H = this.currentlySelectedLevel();
  ...
  z-index: ${ 0 };
  display: ${ 0 };
`), D => D.open ? 0 : -1, D => D.visible ? 'flex' : 'none'), D = u.default.div(w || (w = A`
  background: ${ 0 };
  font-family: ${ 0 };
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
`), m.default.White, n.default.name), E = u.default.div(x || (x = A`
  display: flex;
  justify-content: center;
  align-items: center;
...
`));
    let H = class extends s.Component {
        componentDidUpdate(I) {
            this.props.open && !I.open && (p.celebrate.play(), setTimeout(() => this.setState({ showConfetti: !0 }), 1000));
        }
        componentDidMount() {
                    ...
                    (0, i.jsx)(k.default, {
                        ...
                        children: (0, i.jsxs)(D, {
                            children: [
                                ...
                                (0, i.jsxs)(F, {
                                    children: [
                                        (0, i.jsx)(l.default, { text: 'Purchased' }),
                                        '!'
                                    ]
                                }),
                                (0, i.jsx)(G, { children: (0, i.jsx)(l.default, { text: this.getDescription() }) }),
                                (0, i.jsx)('div', {
                                    style: { marginTop: 10 },
                                    children: (0, i.jsx)(j.default, {
                                        onClick: this.closeWithMovingForward,
                                        type: 'primary',
                                        label: (0, i.jsx)(l.default, { text: 'Continue to Questions' })
                                    })
                                })
                            ]
                        })
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { showConfetti: !1 }), (0, g.default)(this, 'upgradeName', () => this.props.upgrades.currentlySelectedUpgrade), (0, g.default)(this, 'upgradeDetails', () => {
                    ...
                    text: (0, h.jsxs)(_u, {
                        children: [
                            (0, h.jsx)('div', {
                                ...
                                children: (0, h.jsx)(i.default, { name: 'fas fa-circle' })
                            }),
                            (0, h.jsx)('div', { children: (0, h.jsx)(j.default, { text: 'Level ' + this.props.level }) })
                        ]
                    })
                })
            });
...
`), u => u.chosen ? '#28004c' : '#0D0019', l.default.White), _u = n.default.div(p || (p = q`
  display: flex;
  justify-content: center;
  align-items: center;
...
`));
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = d('.....');
    let t, u, v = w => w;
    const w = m.default.div.attrs({ className: 'scroll-y' })(t || (t = v`
  height: 100%;
  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
    url(${ 0 }) repeat 0 0;
  box-sizing: border-box;
  ...
  align-items: center;
  font-family: ${ 0 };
`), (0, j.getAssetPath)('background.png'), () => (0, j.mainFontName)()), x = m.default.div(u || (u = v`
  padding-top: 15px;
  padding-bottom: 15px;
  display: flex;
  justify-content: center;
...
`), y => y.animationDelay), y = z => {
            const A = (B, C) => (Math.pow(10, C) + ~~B).toString().substring(1), B = z % 60;
    ...
    var _z = (0, k.observer)(() => {
        ...
        return (0, j.inBossBattleMode)() && (D = 11), (0, j.inZombiesVsHumansMode)() && (D = 17), (0, j.inPardyMode)() && (D = 16), A && (D = 13), (0, g.jsx)(w, {
            children: (0, g.jsxs)(x, {
                ...
                animationDelay: D,
                children: [
                    (0, g.jsx)(p.default, { customText: A ? '\uD83C\uDF0B Game Over!' : (0, j.inZombiesVsHumansMode)() ? (0, j.defendingHomebaseResultsInfo)().text : null }),
                    ...
                    A ? (0, g.jsxs)(g.Fragment, {
                        children: [
                            (0, g.jsx)(o.default, {
                                ...
                                tagline: (0, g.jsx)(i.default, { text: 'Lava Survival Time' })
                            }),
                            (0, g.jsx)(o.default, {
                                amount: `${ (0, j.numberWithCommas)(A.buildHeight) } ${ (0, q.plural)('block', A.buildHeight) }`,
                                tagline: (0, g.jsx)(i.default, { text: 'Building Height' })
                            }),
                            (0, g.jsx)(o.default, {
                                amount: `${ (0, j.numberWithCommas)(A.buildPieces) } ${ (0, q.plural)('piece', A.buildPieces) }`,
                                tagline: (0, g.jsx)(i.default, { text: 'Building Pieces' })
                            })
                        ]
                    }) : null,
                    (0, g.jsx)(o.default, {
                        amount: (0, j.getMoney)(B.balance),
                        tagline: (0, g.jsx)(i.default, { text: (0, j.inDrawMode)() ? 'Final Score' : 'Final Balance' })
                    }),
                    !(0, j.inDrawMode)() && (0, g.jsxs)(g.Fragment, {
                        children: [
                            (0, g.jsx)(o.default, {
                                ...
                                tagline: (0, g.jsx)(i.default, { text: 'Questions Answered Correctly' })
                            }),
                            (0, g.jsx)(o.default, {
                                customColor: '#DD2C00',
                                amount: (0, j.numberWithCommas)(C.questionsAnsweredIncorrectly),
                                tagline: (0, g.jsx)(i.default, { text: 'Questions Answered Incorrectly' })
                            })
                        ]
                    }),
                    !(0, j.inZombiesVsHumansMode)() && !A && (0, g.jsx)(h.default, { showSelf: !0 })
                ]
            })
        });
    });
...
`), m.default.basic, l.default.White, u => u.theme.question.background, u => u.theme.question.text);
    let u = class extends r.Component {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { clapCount: 0 }), (0, g.default)(this, 'onClap', () => {
                const v = this.props.powerups.activePowerups.includes(o.PowerupNames.clapMultiplier) ? 10 : 1;
                (0, k.getClapSound)().play(), (0, p.send)(n.default.clap, { amount: v }), this.setState({ clapCount: this.state.clapCount + v });
            });
        }
    };
    u = (0, h.__decorate)([
  ...
  align-items: center;
  flex-direction: column;
`), i.default.White), p = j.default.div(l || (l = n`
  font-size: 20px;
...
`), i.default.White, j.default.basic);
    var _t = (0, l.observer)(u => {
        const [v, w] = m.useState(!1), {user: x} = m.useContext(p.default);
        return m.useEffect(() => {
            setTimeout(() => {
                w(!0);
            }, 7100);
    ...
    var _A = (0, m.observer)(() => {
        const {imposter: B} = n.useContext(q.default), C = B.impostersLeft >= 1, D = (0, p.DecryptData)(B.epl) || [];
        return n.useEffect(() => {
            ...
            children: (0, g.jsxs)(_C, {
                children: [
                    ...
                    (0, g.jsxs)(_E, {
                        children: [
                            (0, g.jsx)(_F, { style: { background: C ? '#d32f2f' : '#4caf50' } }),
                            (0, g.jsx)(_G, { children: (0, g.jsx)(_H, { src: (0, j.getAssetPath)(C ? 'astronaut2.svg' : 'astronaut.svg') }) })
                        ]
                    }),
                    (0, g.jsxs)(_I, {
                        children: [
    ...
    const _B = o.default.div.attrs({ className: 'flex hc maxWidth maxHeight scroll-y' })(r || (r = z`
  background: ${ 0 };
  color: ${ 0 };
  align-items: flex-start;
`), h.default.Black, h.default.White), _C = o.default.div.attrs({ className: 'flex flex-column vc animated fadeIn' })(s || (s = z`
  ...
  width: 80%;
  max-width: 500px;
`)), _D = o.default.div.attrs({ className: 'maxWidth' })(t || (t = z`
  height: 77px;
  font-weight: 700;
`)), _E = o.default.div(u || (u = z`
  ...
  margin-top: 50px;
  margin-bottom: 75px;
`)), _F = o.default.div.attrs({ className: 'maxWidth maxHeight animated pulse infinite' })(v || (v = z`
  border-radius: 50%;
  animation-duration: 2.5s;
  filter: blur(50px);
`)), _G = o.default.div.attrs({ className: 'flex maxWidth hc vc' })(w || (w = z`
  position: absolute;
  top: 0;
  left: 0;
  bottom: 0;
...
`), w => w.background);
    let w = class extends n.Component {
        ...
        render() {
            const {user: x} = this.props, y = x.team && x.team.meta && x.team.meta.isBoss;
            return (0, h.jsx)(v, {
                ...
                children: (0, h.jsx)(u, {
                    children: x.team ? (0, h.jsxs)(h.Fragment, {
                        children: [
                            ...
                            (0, h.jsx)(q.Title, { children: (0, h.jsx)(j.default, { text: (0, k.capitalizeFirstLetter)(x.team.id) }) }),
                            (0, h.jsx)(q.Details, { children: y ? (0, h.jsx)(j.default, { text: 'You\'re the boss. Ready to face the challengers?' }) : (0, k.inZombiesVsHumansMode)() ? (0, h.jsx)(j.default, { text: 'Get ready for battle!' }) : (0, h.jsx)(j.default, { text: 'Go find the rest of your team!' }) })
                        ]
                    }) : (0, h.jsx)(i.default, {})
                })
            });
...
`), h.default.basic, i.default.White);
    ...
    var _p = (0, i.observer)(() => {
        ...
        const x = y => (0, m.inImposterMode)() ? `${ y <= 0 ? '-' : '+' }${ (0, m.numberWithCommas)(Math.round(Math.abs(y))) }` : `${ y > 0 ? '+' : '' }${ (0, m.getMoney)(y) }`, y = () => {
    ...
    const v = w => new Promise(x => setTimeout(x, w)), w = n.default.div(o || (o = u`
  position: absolute;
  top: 0;
  bottom: 0;
  right: 0;
  left: 0;
  background: ${ 0 };
`), j.default.Black), x = n.default.div(p || (p = u`
  background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
url("${ 0 }");
  ...
  height: 100%;
  width: 100%;
`), y => y.backgroundImage, j.default.White), y = n.default.div(q || (q = u`
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
...
`));
    let C = class extends l.Component {
        ...
        render() {
            ...
            return (0, i.jsx)(w, {
                children: (0, i.jsx)(x, {
                    ...
                    children: (0, i.jsxs)(y, {
                        children: [
                            (0, i.jsx)(z, { children: (0, m.getTitle)() }),
                            (0, i.jsxs)(A, {
                                children: [
                                    (0, m.getVerb)(),
                                    ' by ',
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { secondsPassed: 0 }), (0, g.default)(this, 'mounted', !1), (0, g.default)(this, 'beginCountdown', async () => {
                for (let D = 0; D < 15; D++)
                    await v(1000), this.addSecond();
                this.mounted && this.setState({ secondsPassed: 0 });
            }), (0, g.default)(this, 'addSecond', () => {
                this.mounted && this.setState({ secondsPassed: this.state.secondsPassed + 1 });
...
`), j.default.Black, j.default.White), z = p.default.div(s || (s = u`
  display: flex;
  justify-content: center;
  align-items: center;
  flex-direction: column;
...
`));
    ...
    let E = class extends o.Component {
        componentDidMount() {
            (0, m.toggleDrawer)(!1, !0), setTimeout(() => this.setState({ showStones: !0 }), 1200), setTimeout(() => this.setState({ stage: B.waiting }), 11400);
            const F = this.props.gameValues.thanosValues.showAt, G = setInterval(() => {
                    const H = Math.round((F - Date.now()) / 1000);
                    if (H <= 0)
                        return this.setState({ stage: B.resultsShowing }), setTimeout(() => this.setState({ stage: B.result }), 4000 * (this.props.gameValues.thanosValues.saved.length + this.props.gameValues.thanosValues.snapped.length)), void clearInterval(G);
                    this.setState({ secondsLeft: H });
                }, 200);
        }
        render() {
            return (0, i.jsx)(y, { children: (0, i.jsx)(z, { children: this.getContent() }) });
        }
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', {
                stage: B.winner,
                ...
                const {thanosValues: F} = this.props.gameValues;
                    ...
                    children: (0, i.jsxs)(A, {
                        ...
                        children: [
                            ...
                            (0, i.jsxs)(q.motion.div, {
                                ...
                                variants: v,
                                children: [
                                    (0, i.jsx)(x, { color: '#f4511e' }),
                                    (0, i.jsx)(x, { color: '#388e3c' }),
                                    (0, i.jsx)(x, { color: '#1976d2' }),
                                    (0, i.jsx)(x, { color: '#ffcc80' }),
                                    (0, i.jsx)(x, { color: '#d32f2f' }),
                                    (0, i.jsx)(x, { color: '#4527a0' })
                                ]
                            })
                        ]
                    })
        ...
        render() {
            return (0, i.jsx)(o.BackgroundContainer, {
                children: (0, i.jsxs)(n.Card, {
                    children: [
                        (0, i.jsx)(n.Title, { children: (0, i.jsx)(k.default, { text: this.props.gameValues.nonDismissMessage.title }) }),
                        (0, i.jsx)(n.Details, { children: (0, i.jsx)(k.default, { text: this.props.gameValues.nonDismissMessage.message }) }),
                        (0, i.jsx)(j.default, {
...
`), i.default.Black);
    ...
    let l = class extends j.Component {
        render() {
            return (0, h.jsx)(k.default, { isSnowing: this.props.ui.snowing });
        }
    };
    l = (0, g.__decorate)([
        (0, i.inject)('ui'),
    ...
    class k extends i.Component {
        componentDidUpdate(l) {
            this.state.hasShown || !l.isSnowing && this.props.isSnowing && (this.setState({ hasShown: !0 }), (0, j.default)());
        }
        render() {
        ...
        constructor(...e) {
            super(...e), (0, g.default)(this, 'state', { hasShown: !1 });
        }
    }
    var _l = k;
}), d.register('.....', function (e, f) {
    ...
    var g = d('.....'), h = d('.....');
    function _i() {
        var j = !0, k = document.getElementById('snow-canv');
        if (k) {
    ...
    let s, t = class extends o.Component {
            render() {
                return (0, i.jsx)(_v, { children: this.getContent() });
            }
            constructor(...e) {
                super(...e), (0, g.default)(this, 'getContent', () => {
                    const {status: u} = this.props.imposter;
                    return u === m.ImposterStatus.discussion || u === m.ImposterStatus.voting ? (0, i.jsx)(q.default, {}) : u === m.ImposterStatus.votingResult ? (0, i.jsx)(r.default, { text: 'Look at your captain\'s screen for voting results.' }) : u === m.ImposterStatus.intro ? (0, i.jsx)(r.default, { text: 'Look at your captain\'s screen for instructions.' }) : (u == m.ImposterStatus.questions && (0, l.changeRoute)(k.default.questions), null);
                });
            }
        };
    t = (0, h.__decorate)([
...
`), j.default.White);
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), s = d('.....'), t = d('.....');
    let u, v, w, x = y => y, y = class extends o.Component {
            render() {
                return (0, i.jsx)(_A, {
                    children: (0, i.jsx)(_B, {
    ...
    var _z = y;
    const _A = p.default.div.attrs({ className: 'maxWidth maxHeight flex hc' })(u || (u = x``)), _B = p.default.div.attrs({ className: 'scroll-y' })(v || (v = x`
  flex: 1;
...
`), l.default.White, l.default.Black);
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....');
    let o, p, q, r, s = t => t, t = class extends m.Component {
            render() {
                return (0, i.jsxs)(_v, {
                    children: [
                        (0, i.jsx)(_w, { src: this.getImage() }),
                        (0, i.jsx)(_x, { children: this.getTitle() }),
                        (0, i.jsx)(_y, { children: this.getDescription() })
                    ]
                });
            }
            constructor(...e) {
    ...
    var _u = t;
    const _v = n.default.div.attrs({ className: 'maxWidth flex flex-column vc' })(o || (o = s``)), _w = n.default.img(p || (p = s`
  max-width: 150px;
  margin-top: 15px;
...
`));
    ...
    var _s = (0, l.observer)(t => {
        const {imposter: u} = m.useContext(p.default);
        m.useEffect(() => {
            (0, j.send)(i.default.imposter.requestPeople);
        }, []);
        const {
    ...
    const _t = n.default.div.attrs({ className: 'maxWidth' })(r || (r = (u => u)``));
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _q;
    });
    ...
    var _q = r => (0, g.jsxs)(_r, {
        children: [
            (0, g.jsxs)(_s, {
                children: [
                    (0, g.jsx)(_t, {
                        style: { color: r.nameColor || j.default.Black },
                        children: r.name
                    }),
                    r.description && (0, g.jsx)(_u, { children: r.description })
                ]
            }),
            r.button && (0, g.jsx)(_v, {
                children: (0, g.jsx)(i.default, {
    ...
    const _r = h.default.div.attrs({ className: 'flex vc light-shadow' })(k || (k = p`
  margin-top: 10px;
  margin-bottom: 10px;
  box-sizing: border-box;
  text-align: left;
  ...
  max-width: 100%;
  overflow: hidden;
`)), _s = h.default.div(l || (l = p``)), _t = h.default.div(m || (m = p`
  font-size: 22px;
  font-weight: 500;
...
`));
    ...
    let r = class extends p.Component {
        render() {
            const {me: s} = this.props.imposter;
            return s && s.currentVote ? (0, i.jsx)(j.default, {
                ...
                children: [
                    (0, i.jsx)('div', {
                        ...
                        className: 'maxWidth',
                        children: (0, i.jsx)(k.default, { children: '\uD83D\uDC69‍\uD83D\uDE80 People' })
                    }),
                    (0, i.jsx)(q.default, {
                        showAction: !0,
                        actionText: 'Vote',
    ...
    var i = d('.....');
    let j, k, l = m => m;
    var _m = n => (0, g.jsx)(_n, { children: (0, g.jsx)(_o, { children: (0, g.jsx)(h.default, { text: n.text }) }) });
    const _n = i.default.div.attrs({ className: 'flex hc vc maxWidth maxHeight' })(j || (j = l``)), _o = i.default.div(k || (k = l`
...
`));
    ...
    var _r = (0, n.observer)(() => {
        ...
        return (0, g.jsx)(_s, { children: s === p.DrawStatus.drawing ? (0, g.jsx)(i.default, {}) : (0, g.jsx)(l.default, {}) });
    });
    const _s = j.default.div.attrs({ className: 'maxWidth maxHeight' })(q || (q = (t => t)`
  font-family: ${ 0 };
  color: ${ 0 };
...
`), () => (0, m.mainFontName)(), k.default.Black);
    ...
    var _u = (0, m.observer)(() => {
        var v;
        const {draw: w} = h.useContext(n.default), x = h.useRef(), [y, z] = h.useState(l.colors[0]), [A, B] = h.useState(l.sizes[1]), [C, D] = h.useState(), E = (null == w || null === (v = w.me) || void 0 === v ? void 0 : v.role) === o.DrawRole.drawer, F = h.useMemo(() => w.round.drawingBase64, []);
        h.useEffect(() => {
        ...
        const G = h.useCallback(H => {
            ...
            }, [E]), I = h.useMemo(() => w.round.secondsLeft ? `${ w.round.secondsLeft } ${ (0, p.plural)('second', w.round.secondsLeft) } left...` : 'Time\'s up!', [w.round.secondsLeft]), J = !(!E || !w.round.secondsLeft), _K = () => {
    ...
    const _v = i.default.div.attrs({ className: 'maxWidth maxHeight flex' })(s || (s = (w => w)`
  align-items: stretch;
    ...
    const x = y => {
        ...
        return (0, g.jsx)(g.Fragment, {
            children: (0, g.jsx)('span', {
                children: z.map((A, B) => {
                    const C = `letter-${ B }`;
                    return ' ' !== A || y.noTimeLeft ? (0, g.jsx)(i.Fragment, { children: A }, C) : (0, g.jsx)(i.Fragment, { children: '\xA0\xA0\xA0' }, C);
                })
            })
        });
    };
    var _y = z => {
        const A = i.useRef(null), [B, C] = (0, l.default)(A), D = (0, n.useWindowWidth)(), E = Math.min(B / 4, C / 3), F = 4 * E, G = 3 * E, H = D < m.MOBILE_BREAKPOINT ? z.timeText : z.isDrawer ? 'You\'re drawing...' : null, I = z.isDrawer ? null : (0, g.jsxs)('span', {
                children: [
                    'Drawer: ',
                    (0, g.jsx)('b', { children: z.drawerName })
                ]
            });
        return (0, g.jsx)(_z, {
...
`), () => m.MOBILE_BREAKPOINT), _A = j.default.div.attrs({ className: 'maxWidth maxHeight flex flex-column vc' })(q || (q = w`
  padding: 20px;
  max-height: 100%;
  overflow: hidden;
  @media (max-width: ${ 0 }px) {
...
`), () => m.MOBILE_BREAKPOINT), _B = j.default.div.attrs({ className: 'flex flex-column vc' })(r || (r = w`
  margin-bottom: 10px;
  @media (max-width: ${ 0 }px) {
    margin-bottom: 7px;
  }
`), () => m.MOBILE_BREAKPOINT), _C = j.default.div(s || (s = w`
  font-size: 23px;
  @media (max-width: ${ 0 }px) {
    font-size: 18px;
  }
`), () => m.MOBILE_BREAKPOINT), _D = j.default.div(t || (t = w`
  font-size: 41px;
  font-weight: ${ 0 };
  @media (max-width: ${ 0 }px) {
    font-size: 32px;
  }
`), o.FontWeights.Bold, () => m.MOBILE_BREAKPOINT), _E = j.default.div.attrs({ className: 'flex hc vc maxWidth' })(u || (u = w`
  flex: 1;
  overflow: hidden;
...
`), j => void 0 !== j.borderWidth ? j.borderWidth : 3, g.default.Black);
    ...
    var g = d('.....'), h = d('.....');
    const i = {}, j = 'undefined' == typeof window ? null : window, k = () => [
    ...
    const _i = (j, k = 100, l = !1) => {
            const m = (0, h.default)(j), n = g.useRef(), o = [
                    k,
                    l,
                    m
                ];
    ...
    var _i = function (j, k, l, m) {
        const n = g.useRef(l), o = g.useRef(m);
        (0, h.default)(() => {
    ...
    const _n = h.default.div.attrs({ className: 'scroll-y flex flex-column' })(l || (l = (o => o)`
  flex-shrink: 0;
  width: 400px;
  height: 100%;
        ...
        children: [
            (0, g.jsxs)(_z, {
                children: [
                    ...
                    (0, g.jsx)(_A, { children: 'Brush Size' }),
                    (0, g.jsx)(_B, {
                    ...
                    (0, g.jsxs)(_B, {
                        children: [
                            (0, g.jsxs)(_E, {
                                ...
                                children: [
                                    (0, g.jsx)(_F, { className: 'fas fa-undo' }),
                                    ' Undo'
                                ]
                            }),
                            (0, g.jsxs)(_E, {
                                ...
                                children: [
                                    (0, g.jsx)(_F, { className: 'far fa-trash' }),
                                    ' Clear'
                                ]
                            }),
                            (0, g.jsxs)(_E, {
                                ...
                                children: [
                                    (0, g.jsx)(_F, { className: z.hidingTerm ? 'fas fa-eye' : 'fas fa-eye-slash' }),
                                    ' ',
            ...
            (0, g.jsx)(_G, { children: z.timeText })
        ]
    });
...
`)), _A = k.default.div(n || (n = u`
  font-weight: ${ 0 };
  font-size: 34px;
`), h.FontWeights.Bold), _B = k.default.div.attrs({ className: 'flex maxWidth wrap' })(o || (o = u`
  margin-top: 5px;
  margin-bottom: 15px;
...
`), D => D.color, D => D.selected ? 4 : 2, D => D.selected ? v : i.default.Black), _D = k.default.div.attrs({ className: 'flex hc vc' })(q || (q = u`
  height: 60px;
  width: 70px;
  margin-right: 7px;
  margin-bottom: 7px;
...
`), E => E.selected ? 4 : 2, E => E.selected ? v : i.default.Black), _E = k.default.div.attrs({ className: 'flex hc vc' })(r || (r = u`
  padding: 10px 20px;
  font-size: 20px;
  margin-right: 7px;
  margin-bottom: 7px;
...
`), i.default.Black), _F = k.default.i(s || (s = u`
  margin-right: 10px;
...
`), () => l.MOBILE_BREAKPOINT);
    ...
    var _y = (0, p.observer)(z => {
        const A = j.useRef(null), [B, C] = j.useState(''), {
                gameOptions: {modeOptions: D}
        ...
        const E = j.useMemo(() => {
            ...
            }, G = !z.secondsLeft, H = z.guessedCorrectly ? 'You guessed correctly!' : G ? 'Time\'s up!' : 'Type your guess here!', I = z.guessedCorrectly || G;
        return (0, g.jsxs)(_z, {
            children: [
                (0, g.jsx)(_A, { children: z.timeText }),
                (0, g.jsxs)(_B, {
                    children: [
                        (0, g.jsx)(n.default, {}),
                        (0, g.jsxs)(_C, {
    ...
    const _z = k.default.div.attrs({ className: 'flex flex-column' })(s || (s = x`
  flex: 1;
  overflow: hidden;
...
`), () => r.MOBILE_BREAKPOINT), _B = k.default.div.attrs({ className: 'flex flex-column' })(u || (u = x`
  flex: 1;
  padding: 0px 20px;
  overflow: hidden;
`)), _C = k.default.div(v || (v = x`
  padding-bottom: 20px;
`)), _D = k.default.div.attrs({ className: 'flex' })(w || (w = x``));
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _r;
    });
        ...
        return (0, g.jsxs)('div', {
            ...
            children: [
                ...
                t && (0, g.jsx)('span', {
                    ...
                    children: u ? (0, g.jsx)(m.default, { text: t }) : t
                })
            ]
        });
    };
    var _r = (0, j.observer)(() => {
        const s = h.useRef(null), [t, u] = h.useState([]), {draw: v} = h.useContext(i.default), w = (0, n.debounce)(x => {
                u(y => [
                    ...y,
                    x
                ]);
        ...
        return h.useEffect(() => {
            ...
            ref: s,
            children: (0, n.takeRight)(t, 60).map(x => (0, g.jsx)(q, { item: x }, `guess-item-${ x.id }`))
        });
    });
    const _s = o.default.div.attrs({ className: 'flex flex-column' })(p || (p = (t => t)`
  flex: 1;
  overflow: hidden;
...
`));
    ...
    let q;
    var _r = (0, n.observer)(() => {
        const {draw: s} = h.useContext(o.default);
        return (0, g.jsxs)(_s, {
            children: [
                (0, g.jsx)(i.default, {}),
    ...
    const _s = j.default.div.attrs({ className: 'maxWidth maxHeight flex flex-column' })(q || (q = (t => t)``));
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _o;
    });
    ...
    let n;
    var _o = (0, k.observer)(() => {
        const {balance: p} = l.useContext(j.default);
        return (0, g.jsx)(_p, { children: (0, i.getMoney)(p.balance) });
    });
    const _p = m.default.div.attrs({ className: 'maxWidth flex' })(n || (n = (q => q)`
  padding: 10px 20px;
  background: #4252af;
  color: ${ 0 };
  justify-content: flex-end;
...
`), h.default.White);
    ...
    var i = d('.....');
    let j;
    var _k = () => (0, g.jsx)(_l, { children: (0, g.jsx)(h.default, { text: 'Waiting for round to begin...' }) });
    const _l = i.default.div.attrs({ className: 'flex hc vc' })(j || (j = (m => m)`
  flex: 1;
  text-align: center;
  font-size: 38px;
  padding: 40px;
`));
    ...
    var _y = (0, o.observer)(() => {
        ...
        return (0, g.jsx)(_z, {
            children: (0, g.jsx)('div', {
                ...
                children: (0, g.jsxs)(_A, {
                    children: [
                        (0, g.jsx)(_B, { children: (0, g.jsx)(m.default, { text: 'You are this round\'s drawer!' }) }),
                        (0, g.jsx)(_C, { children: (0, g.jsx)(m.default, { text: 'Which term do you want to draw?' }) }),
                        (0, g.jsx)(h.default, {}),
                        (0, g.jsx)('div', { style: { height: 7 } }),
                        z.map(A => (0, g.jsx)(_D, {
                            onClick: () => {
    ...
    const _z = q.default.div.attrs({ className: 'flex flex-column vc scroll-y' })(s || (s = x`
  flex: 1;
  padding: 40px 0px;
`)), _A = (0, q.default)(r.HandDrawnDiv).attrs({ className: 'animated fadeInDown' })(t || (t = x`
  width: 700px;
  max-width: 90%;
  padding: 35px;
  background: ${ 0 };
`), j.default.White), _B = q.default.div(u || (u = x`
  font-size: 22px;
  color: #1b5e20;
`)), _C = q.default.div(v || (v = x`
  font-size: 32px;
  font-weight: ${ 0 };
`), i.FontWeights.Bold), _D = (0, q.default)(r.HandDrawnDiv).attrs({ className: 'maxWidth' })(w || (w = x`
  padding: 10px 20px;
...
`));
    ...
    var _x = y => {
        const z = y.additions.reduce(w, 0) || 0, A = z > 0;
        return (0, g.jsx)(_y, {
            className: 'flex',
            correct: A,
            children: (0, g.jsx)(_z, {
                children: (0, g.jsxs)(_A, {
                    children: [
                        (0, g.jsx)(_B, { children: y.isDrawer && A ? (0, g.jsx)(m.default, { text: 'Nice work!' }) : `+ ${ (0, n.getMoney)(z) }` }),
                        (0, g.jsx)(_C, {
                                ...
                                children: y.additions.map(B => {
                                    return (0, g.jsxs)(_D, {
                                        children: [
                                            ...
                                            ' ',
                                            (z = B.type, A = B.metadata, z === l.PointAdditionType.correct ? (0, g.jsx)(m.default, { text: 'for correct guess' }) : z === l.PointAdditionType.firstGuess ? (0, g.jsx)(m.default, { text: 'for correct first guess' }) : z === l.PointAdditionType.speed ? (0, g.jsx)(m.default, { text: 'for speed' }) : z === l.PointAdditionType.goodDrawer && A && 'number' == typeof A ? `for ${ A } ${ (0, n.plural)('person', A, 'people') } guessing your drawing correctly!` : '')
                                        ]
                                    }, B.type);
                                    var C, D;
                                })
                            }) : (0, g.jsx)(g.Fragment, { children: (0, g.jsx)(_D, { children: (0, g.jsx)(m.default, { text: y.isDrawer ? 'You tried your best!' : (0, i.sample)(v) }) }) })
                        })
                    ]
                })
            })
    ...
    const _y = j.default.div.attrs({ className: 'scroll-y' })(o || (o = u`
  flex: 1;
  background: ${ 0 };
  color: ${ 0 };
`), z => z.correct ? 'rgba(56, 142, 60, 0.85)' : 'rgba(123, 31, 162, 0.85)', h.default.White), _z = j.default.div(p || (p = u`
  margin: auto;
`)), _A = j.default.div.attrs({ className: 'flex flex-column vc' })(q || (q = u`
  margin: 40px;
  @media (max-width: ${ 0 }px) {
    margin: 30px;
  }
`), () => k.MOBILE_BREAKPOINT), _B = j.default.div(r || (r = u`
  font-size: 70px;
  margin-bottom: 10px;
  font-weight: bold;
  text-align: center;
...
`), () => k.MOBILE_BREAKPOINT), _C = j.default.div(s || (s = u``)), _D = j.default.div(t || (t = u`
  font-size: 26px;
  @media (max-width: ${ 0 }px) {
    font-size: 22px;
  }
`), () => k.MOBILE_BREAKPOINT);
    ...
    let w;
    var _x = (0, s.observer)(() => {
        const {pardy: y} = i.useContext(t.default);
        return (0, g.jsx)(_y, {
            children: (() => {
    ...
    const _y = j.default.div.attrs({ className: 'maxAll' })(w || (w = (z => z)`
...
`), k.FontWeights.Light, l.default.background, h.default.White);
    ...
    d('.....');
    var h = d('.....');
    var _i = () => (0, g.jsx)(h.default, { message: 'Waiting for round to begin...' });
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _n;
    });
    ...
    var _n = o => (0, g.jsx)(_o, {
        children: (0, g.jsxs)(_p, {
            children: [
                ...
                (0, g.jsx)(_q, { children: o.message })
            ]
        })
    });
    const _o = i.default.div.attrs({ className: 'maxAll flex-center' })(j || (j = m``)), _p = i.default.div.attrs({ className: 'flex-center flex-column' })(k || (k = m`
...
`), h.FontWeights.Normal, 650), _q = i.default.div(l || (l = m`
  margin-top: 25px;
  font-size: 32px;
  @media (max-width: ${ 0 }px) {
    font-size: 20px;
...
`), 650);
    ...
    d('.....');
    var h = d('.....');
    var _i = () => (0, g.jsx)(h.default, { message: 'Get ready to answer!' });
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
        return _z;
    });
        ...
        return (0, g.jsxs)(g.Fragment, {
            children: [
                (0, g.jsx)(_A, {
                    ...
                    style: { background: F ? p.default.answerResponseCorrect : p.default.answerResponseIncorrect },
                    children: (0, g.jsxs)(_B, {
                        ...
                        children: [
                            (0, g.jsx)(_C, { className: F ? 'fal fa-check-circle' : 'fal fa-times-circle' }),
                            (0, g.jsx)(_D, { children: (0, g.jsx)(o.default, { text: (F ? 'Correct' : 'Incorrect') + '!' }) }),
                            (0, g.jsx)(_E, { children: F ? H : I }),
                            (0, g.jsx)('div', { style: { height: 60 } }),
                            (0, g.jsx)(n.default, {
                                reasons: G,
                                onReasonsAnimatedIn: () => {
                                    F && E(!0);
    ...
    const _A = (0, k.default)(l.motion.div).attrs({ className: 'maxAll scroll-y' })(t || (t = y``)), _B = (0, k.default)(l.motion.div).attrs({ className: 'maxWidth flex-center flex-column' })(u || (u = y`
  min-height: 100%;
  padding: 40px 20px;
  text-align: center;
`)), _C = k.default.i(v || (v = y`
  color: ${ 0 };
  font-size: 144px;
`), h.default.White), _D = k.default.div(w || (w = y`
  font-weight: ${ 0 };
  font-size: 64px;
  margin-top: 10px;
`), i.FontWeights.Normal), _E = k.default.div(x || (x = y`
  font-size: 22px;
`));
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
    ...
    const _n = h.default.div.attrs({ className: 'maxWidth maxHeight' })(j || (j = (o => o)`
  position: absolute;
  top: 0;
  left: 0;
  pointer-events: none;
`));
    ...
    var _n = o => (0, g.jsx)(_o, {
        ...
        children: o.reasons.map(p => (0, g.jsx)(_p, { children: p }, p))
    });
    const _o = (0, j.default)(i.motion.div).attrs({
        ...
        })(k || (k = m``)), _p = (0, j.default)(i.motion.div).attrs({
            className: 'maxWidth',
            variants: {
                hidden: {
                    opacity: 0,
...
`), h.default.White);
    ...
    var _v = w => (0, g.jsxs)(g.Fragment, {
        children: [
            (0, g.jsx)(_w, {
                initial: { background: l.default.background },
                animate: { background: l.default.questionBackground },
                transition: {
                    duration: 1.2,
                    ease: 'easeOut'
                },
    ...
    const _w = (0, i.default)(k.motion.div).attrs({ className: 'maxAll' })(p || (p = t``)), _x = (0, i.default)(k.motion.div).attrs({ className: 'maxAll' })(q || (q = t`
  font-family: ${ 0 };
  overflow: hidden;
  color: ${ 0 };
`), j.default.mainFontName, m.default.Black), _y = i.default.div.attrs({ className: 'maxAll flex-center animated fadeIn' })(r || (r = t`
  position: absolute;
  top: 0;
  left: 0;
  background: rgba(0, 0, 0, 0.5);
`)), _z = i.default.div.attrs({ className: 'medium-shadow animated jackInTheBox' })(s || (s = t`
  background: ${ 0 };
  color: ${ 0 };
  width: 80%;
  max-width: 700px;
...
`), l.default.questionBackground, m.default.White, n.FontWeights.Normal);
    ...
    const D = 700;
    var _E = (0, r.observer)(() => {
        const {pardy: F} = s.useContext(p.default), [G, H] = s.useState(0), [I, J] = s.useState(!1), K = F.maxBet, L = () => {
                if (!G)
                    return;
        ...
        return (0, g.jsx)(m.default, {
            children: (0, g.jsx)(_F, {
                ...
                animate: { background: I ? u.default.background : 'rgba(0,0,0,0)' },
                transition: { duration: 0.7 },
                children: (0, g.jsx)(_G, {
                    children: (0, g.jsxs)(_H, {
                        ...
                        children: [
                            (0, g.jsx)(_I, { children: 'The Finale' }),
                            (0, g.jsx)(_J, { children: 'Place Your Bet!' }),
                            (0, g.jsxs)('div', {
                            ...
                            (0, g.jsx)(i.default, { style: { margin: '40px 0px' } }),
                            (0, g.jsxs)(_K, {
                                children: [
                                    (0, g.jsxs)(_L, {
                                        children: [
    ...
    const _F = (0, t.default)(q.motion.div).attrs({ className: 'maxAll scroll-y' })(v || (v = C``)), _G = t.default.div.attrs({ className: 'maxWidth flex-center' })(w || (w = C`
  min-height: 100%;
  padding: 30px 0px;
`)), _H = (0, t.default)(q.motion.div).attrs({ className: 'flex-column flex-center medium-shadow' })(x || (x = C`
  background: rgba(255, 255, 255, 0.1);
  color: ${ 0 };
  padding: 60px 70px;
  border-radius: 5px;
...
`), k.default.White, k.default.Black, D), _I = t.default.div(y || (y = C`
...
`), k.default.Black, l.FontWeights.UltraBold, D), _J = t.default.div(z || (z = C`
  font-size: 28px;
  margin-bottom: 30px;
  font-weight: ${ 0 };
  @media (max-width: ${ 0 }px) {
...
`), l.FontWeights.Normal, D), _K = t.default.div.attrs({ className: 'flex maxWidth vc between' })(A || (A = C`
  @media (max-width: ${ 0 }px) {
    flex-direction: column;
  }
`), D), _L = t.default.div(B || (B = C`
  font-size: 18px;
  @media (max-width: ${ 0 }px) {
    margin-bottom: 10px;
  }
`), D);
            ...
            children: (0, g.jsxs)(_v, {
                children: [
                    ...
                    (0, g.jsxs)(_x, {
                        children: [
                            'Your bet of ',
                            (0, g.jsx)('b', { children: (0, i.getMoney)(u) }),
                            ' is in!'
                        ]
                    })
                ]
    ...
    const _u = n.default.div.attrs({ className: 'maxAll flex-center' })(o || (o = s``)), _v = (0, n.default)(l.motion.div).attrs({
...
`));
    ...
    var _z = (0, m.observer)(() => {
        ...
        return (0, g.jsxs)(_A, {
            initial: { background: p.default.questionBackground },
            animate: { background: p.default.background },
            transition: { duration: 1.3 },
            children: [
                (0, g.jsxs)(_B, {
                    children: [
                        (0, g.jsx)(_C, {}),
                        (0, g.jsx)(_D, { children: 'Answer locked in!' }),
                        (0, g.jsx)(_E, { children: C })
                    ]
                }),
                (0, g.jsx)(_F, {
                    children: (0, g.jsx)(_G, {
    ...
    const _A = (0, o.default)(k.motion.div).attrs({ className: 'maxAll flex-center' })(q || (q = x``)), _B = o.default.div.attrs({ className: 'flex-center flex-column animated jackInTheBox' })(r || (r = x`
...
`), h.FontWeights.Normal, y), _E = o.default.div(u || (u = x`
  font-size: 22px;
  margin-top: 10px;
  @media (max-width: ${ 0 }px) {
    font-size: 14px;
...
`), y), _F = o.default.div.attrs({ className: 'maxAll flex hc' })(v || (v = x`
  position: absolute;
  top: 0;
  left: 0;
  align-items: flex-end;
...
`), y);
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....');
    d('.....');
    var s = d('.....'), t = d('.....'), u = d('.....'), v = d('.....'), w = d('.....'), x = d('.....'), y = d('.....');
    let z, A, B, C, D, E, F, G, H = I => I;
    const I = 800, J = 700, K = L => (0, g.jsx)(_U, {
            background: L.color,
            onClick: L.select,
            children: L.num
        }), L = M => {
            const N = new (0, w.Howl)({ src: [(0, m.getAssetPath)('numberSwitch.mp3')] }), O = new (0, w.Howl)({ src: [(0, m.getAssetPath)('numberLogo.mp3')] }), P = new (0, w.Howl)({ src: [(0, m.getAssetPath)('numberSuccess.mp3')] }), Q = new (0, w.Howl)({ src: [(0, m.getAssetPath)('numberError.mp3')] }), [R] = h.useState((0, p.shuffle)(Array.from(Array(9).keys()).map(S => S + 1))), [S, T] = h.useState(1), [U, V] = h.useState(!1), [W, X] = h.useState(!1);
            h.useEffect(() => {
            ...
            return (0, g.jsx)(_N, {
                children: (0, g.jsx)(_O, {
                    ...
                    children: (0, g.jsxs)(_P, {
                        ...
                        children: [
                            (0, g.jsx)(_Q, {}),
                            (0, g.jsx)(_R, { children: (0, g.jsx)(x.default, { text: 'Outnumbered' }) }),
                            (0, g.jsxs)(_S, {
                                children: [
                                    'by ',
                                    M.name,
    ...
    const _N = i.default.div.attrs({ className: 'maxWidth maxHeight' })(z || (z = H`
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
  z-index: 9;
`)), _O = (0, i.default)(j.motion.div).attrs({ className: 'maxWidth maxHeight flex hc vc' })(A || (A = H`
  background: rgba(0, 0, 0, 0.35);
`)), _P = (0, i.default)(j.motion.div).attrs({ className: 'flex flex-column hc vc' })(B || (B = H`
  padding: 60px;
  color: ${ 0 };
  background: ${ 0 };
  border-radius: 5px;
...
`), k.default.Black, k.default.White, l.default.basic, I, J), _Q = i.default.img.attrs({
...
`), n.FontWeights.Bold, t.default.mainFontName, I, J), _S = i.default.div(E || (E = H`
  font-size: 21px;
  @media (max-width: ${ 0 }px),
    (max-height: ${ 0 }px) {
    font-size: 18px;
...
`), I, J), _T = i.default.div(F || (F = H`
  ...
  grid-template-areas:
    ...
    '. . .'
    '. . .';
`)), _U = i.default.div.attrs({ className: 'flex hc vc' })(G || (G = H`
  width: 90px;
  height: 75px;
...
`), n.FontWeights.Bold, V => V.background);
    ...
    const y = [
            ...
            return (0, g.jsx)(i.default, {
                ...
                customMaxWidth: '95%',
                customPadding: '0px',
                customStyle: { border: `3px solid ${ l.default.White }` },
                children: (0, g.jsxs)(_B, {
                    children: [
                        (0, g.jsxs)(_C, {
                            children: [
                                (0, g.jsx)(_D, { children: 'Pick Your' }),
                                (0, g.jsx)(_E, { children: 'Power!' })
                            ]
                        }),
                        (0, g.jsx)(n.default, { style: { margin: '30px 0px' } }),
    ...
    var _A = (0, p.observer)(() => {
        const {
            gameOptions: {specialGameType: B}
        } = h.useContext(q.default);
        return B && B.includes(r.PARDY) ? (0, g.jsx)(z, {}) : null;
    });
    const _B = j.default.div.attrs({ className: 'maxWidth' })(t || (t = x`
  padding: 40px;
  background: ${ 0 };
  color: ${ 0 };
  font-family: 'Londrina Solid', cursive;
  font-weight: ${ 0 };
`), m.default.background, l.default.White, k.FontWeights.Light), _C = j.default.div.attrs({ className: 'maxWidth flex-column flex-center' })(u || (u = x`
  text-transform: uppercase;
  line-height: 1;
  text-shadow: 0px 3px 3px ${ 0 };
`), l.default.Black), _D = j.default.div(v || (v = x`
  font-size: 42px;
...
`), k.FontWeights.Bold);
    ...
    var _u = v => (0, g.jsxs)(_v, {
        children: [
            (0, g.jsx)(_w, {
                ...
                children: (0, g.jsx)(_x, { src: v.image })
            }),
            (0, g.jsxs)(_y, {
                children: [
                    (0, g.jsx)(_z, { children: v.name }),
                    (0, g.jsx)(_A, { children: v.description }),
                    (0, g.jsx)(l.default, {
                        type: 'primary',
                        style: { width: 250 },
                        size: 'small',
    ...
    const _v = m.default.div.attrs({ className: 'maxWidth medium-shadow' })(n || (n = t`
  border-radius: 5px;
  overflow: hidden;
  margin-bottom: 20px;
  ...
  background: ${ 0 };
  text-align: center;
`), h.default.Black, h.default.White), _w = m.default.div.attrs({ className: 'maxWidth flex-center' })(o || (o = t`
  height: 80px;
`)), _x = m.default.img(p || (p = t`
  height: 42px;
  filter: drop-shadow(2px 2px 2px #222);
`)), _y = m.default.div.attrs({ className: 'maxWidth flex-column flex-center' })(q || (q = t`
  padding: 20px;
  background: #f5f5f5;
`)), _z = m.default.div(r || (r = t`
  font-weight: ${ 0 };
  font-size: 34px;
`), i.FontWeights.Normal), _A = m.default.div(s || (s = t`
  font-size: 18px;
  margin-bottom: 15px;
`));
}), d.register('.....', function (e, f) {
    ...
    var _k = l => {
        ...
        const p = new (0, g.Client)(m ? m.serverUrl : n.serverUrl, {
                ...
                console.log({ connectionError: r }), l.onConnectError && l.onConnectError(r), l.disposeOnError && o(), h.default.engine.connectionError = !0, h.default.engine.attemptingToConnect = !1;
            });
        p.onConnect.add(() => {
            ...
            r.onJoinAttempt.add(() => {
                ...
                console.log({ roomJoinError: s }), l.onRoomJoinError && l.onRoomJoinError(s), h.default.engine.roomError = s, h.default.engine.errorJoiningRoom = !0, h.default.engine.attemptingToJoinRoom = !1;
            });
    ...
    var g = d('.....');
    var _h = i => {
        let j = 'Error joining game', k = '', l = 'string' == typeof i ? i : i.type;
        if ('MAX_PLAYERS' === l) {
            let {message: m} = i;
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....');
    let o, p, q, r = s => s, s = class extends m.Component {
            render() {
            ...
            constructor(...e) {
                super(...e), (0, g.default)(this, 'close', () => this.props.ui.showingSuccessModal = !1), (0, g.default)(this, 'getContent', () => {
                    const {successModalInfo: t} = this.props.ui;
                    if (!t || !t.title)
                        return null;
                    const {textOptions: u} = t, {
                            icon: v,
                            background: w,
                            color: x,
                            title: y,
                    ...
                    return (0, i.jsxs)('div', {
                        ...
                        children: [
                            (0, i.jsx)(_u, {
                                ...
                                children: (0, i.jsx)('i', { className: v })
                            }),
                            (0, i.jsx)(_v, { children: y }),
                            (0, i.jsx)(_w, {
                                style: {
...
`));
                ...
                children: [
                    (0, i.jsxs)(_I, {
                        ...
                        children: [
                            ...
                            (0, i.jsxs)(_K, {
                                children: [
                                    (0, i.jsx)(_L, { children: (0, i.jsx)(p.default, { text: G.name }) }),
                                    (0, i.jsx)(_M, { children: (0, i.jsx)(p.default, { text: G.description }) })
                                ]
                            })
                        ]
                    }),
    ...
    let F = class extends s.Component {
        render() {
            if (!this.props.imposter.me)
                return null;
            const {imposter: G} = this.props, H = G.currentShopItemModalVisible;
    ...
    var _G = F;
    const _H = t.default.div.attrs({ className: 'maxWidth flex flex-column' })(v || (v = C`
  font-family: 'Space Grotesk', monospace;
`)), _I = t.default.div(w || (w = C`
  height: 170px;
  padding: 20px;
`)), _J = t.default.div.attrs({ className: 'flex maxWidth vc hc' })(x || (x = C`
  height: 60px;
...
`)), _M = t.default.div(A || (A = C`
  font-size: 14px;
`)), _N = t.default.div.attrs({ className: 'maxWidth' })(B || (B = C`
  padding: 20px;
`));
}), d.register('.....', function (e, f) {
    b(e.exports, 'default', function () {
    ...
    const D = (0, n.observer)(() => {
        const [E, F] = o.useState(A.intro), {imposter: G} = o.useContext(r.default), H = () => {
        ...
        return (0, g.jsx)(k.default, {
            ...
            children: (0, g.jsx)(_F, {
                children: E === A.intro ? (0, g.jsxs)(g.Fragment, {
                    children: [
                        (0, g.jsx)(_G, { children: (0, g.jsx)(l.default, { text: 'Welcome aboard.' }) }),
                        (0, g.jsx)(_H, {}),
                        (0, g.jsx)(_I, { children: (0, g.jsx)(l.default, { text: 'Make sure nobody can see your screen, and then click to view your\n            role!' }) }),
                        (0, g.jsx)(j.default, {
                            style: { width: '100%' },
                            size: 'medium',
                            type: 'primary',
                            onClick: I,
                            label: (0, g.jsx)(l.default, { text: 'View Role' })
                        })
                    ]
                }) : (0, g.jsxs)(g.Fragment, {
                    children: [
                        (0, g.jsx)(_J, { children: (0, g.jsx)(l.default, { text: 'You are ' + (J() ? 'an' : 'a') }) }),
                        (0, g.jsx)(_K, { children: (0, g.jsx)(l.default, { text: J() ? 'Impostor' : 'Crewmate' }) }),
                        (0, g.jsx)(_L, { children: K().map(M => (0, g.jsx)(_M, { children: (0, g.jsx)(l.default, { text: M }) }, M)) }),
                        (0, g.jsx)(j.default, {
                            style: { marginTop: 5 },
                            size: 'medium',
                            type: 'primary',
                            onClick: H,
                            label: (0, g.jsx)(l.default, { text: 'Close' })
                        })
                    ]
                })
            })
    ...
    var _E = (0, n.observer)(() => {
        const {imposter: F} = o.useContext(r.default);
        return F.me ? (0, g.jsx)(D, {}) : null;
    });
    const _F = p.default.div.attrs({ className: 'maxWidth flex flex-column hc vc' })(s || (s = B`
  background: ${ 0 };
  color: ${ 0 };
  padding: 40px;
  font-family: 'Space Grotesk', monospace;
  text-align: center;
`), h.default.Black, h.default.White), _G = p.default.div(t || (t = B`
  font-weight: 900;
  font-size: 40px;
  margin-bottom: 16px;
`)), _H = p.default.img.attrs({ src: (0, i.getAssetPath)('space-ship.svg') })(u || (u = B`
  height: 125px;
...
`)), _K = p.default.div(x || (x = B`
  ...
  font-size: 40px;
  margin-bottom: 20px;
`)), _L = p.default.ul.attrs({ className: 'maxWidth' })(y || (y = B`
  font-size: 16px;
  text-align: left;
...
`));
    ...
    const g = h => {
            ...
            if (!j || !j.length || j.length < 2)
                return null;
            const k = j[j.length - 2], l = j[j.length - 1];
            return k && l && k.startsWith('v') ? `${ k }/${ l }` : null;
        }, _i = 'media.gimkit.com', _j = 'res.cloudinary.com', _k = 'gimkit-production', _l = [
            _i,
            _j
        ];
}), d.register('.....', function (e, f) {
    ...
    var _j = k => (0, g.jsx)(h.Suspense, {
        ...
        children: (0, g.jsx)(i, { latex: k.latex })
    });
}), d.register('.....', function (e, f) {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....');
    function _k(l) {
        const m = (0, j.useConstant)(() => (0, h.motionValue)(l)), {isStatic: n} = (0, g.useContext)(i.MotionConfigContext);
        if (n) {

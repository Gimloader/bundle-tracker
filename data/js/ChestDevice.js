    ...
    class m extends h.default {
        constructor(n) {
            super(n), (0, f.default)(this, 'animateOpen', () => {
                ...
                'open' === o && (this.state.open ? this.animateOpen() : this.animateClose()), 'active' === o && (this.state.active ? this.activate() : this.deactivate()), this.updateInteractiveZones();
            }), this.open = this.parts.add.sprite({
                ...i.OpenAsset,
                onReady: o => {
                    o.view.setScale(0.5), o.view.alpha = this.state.active && this.state.open ? 1 : 0;
                }
            }), this.openFlash = this.parts.add.sprite({
                ...i.OpenAsset,
                onReady: o => {
                    o.view.setScale(0.5), o.view.tint = 16777215, o.view.tintFill = !0, o.view.alpha = 0;
                }
            }), this.closed = this.parts.add.sprite({
                ...i.ClosedAsset,
                onReady: o => {
                    o.view.setScale(0.5), o.view.alpha = this.state.active && !this.state.open ? 1 : 0, this.isPreview && (0, k.InPreGamePhase)() && (o.view.alpha = 1);
                }

...
`,
    ...
    Xt = e => {
        ...
        d.useEffect(() => {
            ...
            const y = ht(Math.min(1, (b - j.pack.delay) / j.pack.duration));
            y === 1 && f(), r.set(y);
...
function M(e, t, n, r) {
    return r === void 0 && (r = {}), fr(e, t, n, r), hr(e, t, n, r), r
}
...
var Cr = function(t) {
        return t === void 0 && (t = {}), {
            plugins: [wt(), cr(t.observable), mr(), Ct(), gr(), jt(), vr(), kt(), It(t.defaultUnit), wr(), St(), Pt()]
        }
    },
...
var J = {},
    Dr = function(t, n) {
        ...
        var r = n,
            ...
            u = o && o.context || Te,
            f = function(g) {
                return typeof t == "function" && (g || d.useContext(u)) || J
            },
            m = {};
        return function(g) {
            var b = d.useRef(!0),
                ...
                C = I[1];
            he(y.isSSR)(function() {
                p && C && !b.current && Rr(g, p, C)
            }, [g]), he(y.isSSR)(function() {
                return p && fe({
                        index: i,
                        context: y,
                        sheet: p,
    ...
    function o(c) {
        ...
        return function(u, f) {
            if (u = n(u), f = f == null ? 0 : i(t(f), 292), f && a(u)) {
                var m = (r(u) + "e").split("e"),
                    h = l(m[0] + "e" + (+m[1] + f));
                return m = (r(h) + "e").split("e"), +(m[0] + "e" + (+m[1] - f))
            }
            return l(u)
        }
    }
...
var te = function(e, t, n, r, a) {
    ...
    Vr = function(e, t, n, r, a) {
        ...
        return i = {}, i["&#confetti-particle-".concat(a)] = {
            animation: "$x-axis-".concat(a, " ").concat(l, "ms forwards cubic-bezier(").concat(m, ", ").concat(h, ", ").concat(g, ", ").concat(b, ")"),
            "& > div": {
    ...
    Zr = function(e) {
        ...
        return Dr(x(x(x({}, Ur), Hr(t.map(function(l) {
            return l.degree
        }), r, a)), {
            container: {
                width: 0,
...
`,
    gn = e => {
        ...
        const i = d.useMemo(() => {
                const c = e.items[r],
                    l = e.packData.cosmetics.find(h => h.id === c.cosmeticId),
                    u = e.packData.items.reduce((h, g) => h + g.count, 0),
                    m = e.packData.items.find(h => h.cosmeticId === c.cosmeticId).count / u * 100;
                return {
                    item: c,
                    cosmetic: l,
                    percentage: m
...
`,
    yn = e => {
        ...
        return ne(() => {
            ...
            children: [i ? s.jsx(Xt, {
                ...
                onExit: a
            }) : null, t === "result" ? s.jsx(an, {}) : null, t === "result" ? s.jsx(gn, {
                items: e.items,
                packData: e.packData,
                close: e.close
            }) : null]
    ...
    Xn = e => {
        ...
        if (h) {
            const b = (g = h == null ? void 0 : h.message) == null ? void 0 : g.text;
            return s.jsx(ce, {
                className: "maxAll",

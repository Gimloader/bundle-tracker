...
c.register('.....', function (d, e) {
    ...
    var A;
    let B;
    (A = y || (y = {})).error = 'ERROR', A.waiting = 'WAITING', A.in = 'IN', A.owner = 'OWNER', (B || (B = {})).notTeacher = 'NOT_TEACHER';
    var _C = () => {
        const [D, E] = h.useState(!0), [F, G] = h.useState(null), [H, I] = h.useState(!1), J = (0, p.useParams)().id;
        let K = (0, n.getUrlVariable)('redirect');
        if (K) {
            const L = decodeURIComponent(K);
            (0, t.IsURLFromUs)(D) || (K = null);
        }
        h.useEffect(() => {
            if (!(0, n.isLoggedIn)())
                return K ? void (window.location.href = `/join-class?class=${ J }&location=${ encodeURIComponent(window.location.pathname + window.location.search + window.location.hash) }`) : void (window.location.href = `/join-class?class=${ J }`);
            (0, n.request)({
                url: '/api/v1/groups/request-access',
                method: 'post',
                data: { group: J },
                success: M => {
                    M && M.result && M.result.response && M.result.response === y.in && M.result.existing && K ? window.location.href = decodeURIComponent(K) : (G(M), E(!1));
                },
                error: M => {
                    ...
                    }), E(!1), (0, s.NavigateTo)(r.DASHBOARD);
                }
            });
        }, []);
        const M = () => {
            H || l.default.confirm({
                ...
                content: (0, g.jsxs)('div', {
                    style: { color: j.default.Black },
                    children: [
                        (0, g.jsxs)('div', {
                            children: [
                                (0, g.jsx)('b', { children: 'Students' }),
                ...
                onOk: () => {
                    I(!0), (0, n.request)({
                        ...
                        success: () => {
                            l.default.destroyAll(), (0, q.default)({}), l.default.success({
        ...
        return (0, g.jsxs)(_D, {
            children: [
                (0, g.jsx)(u.default, { includeSpacer: !0 }),
                (0, g.jsx)(_E, {
                    children: (() => {
                        if (!(0, n.isLoggedIn)())
                            return null;
                        if (D)
                            return (0, g.jsxs)(g.Fragment, {
                                children: [
                                    (0, g.jsx)(n.Title, { title: 'Class' }),
                                    (0, g.jsx)(m.default, { size: 'large' })
                                ]
                            });
                        if (!F)
                            return null;
                        const {group: N} = F, O = (() => {
                                const {result: P} = F;
                                return P.response === y.error ? P.reason && P.reason === B.notTeacher ? {
                                    icon: 'fas fa-chalkboard-teacher',
                                    iconColor: '#311b92',
                                    response: (0, g.jsx)('span', { children: 'It looks like you created an account as a teacher. Only students can join classes. Switch to a student to join this class.' }),
                                    bottomResponse: (0, g.jsx)(k.default, {
                                        size: 'large',
                                        block: !0,
                                        style: { marginTop: 30 },
                                        type: 'primary',
                                    ...
                                    iconColor: '#43a047',
                                    response: 'You\'re in the right place! Once your students visit this link, they\'ll ' + (N.autoAccept ? 'be part of your class!' : 'request to join your class!')
                                } : {
                                    icon: 'fas fa-check',
                                    iconColor: '#43a047',
                                    response: 'You\'re now part of this class! That means you can access live games and assignments from your teacher.',
                                    bottomResponse: K ? (0, g.jsx)(k.default, {
                                        size: 'large',
                                        block: !0,
                                        style: { marginTop: 30 },
                                        type: 'primary',
                                        href: decodeURIComponent(K),
                                        children: 'Go Back'
                                    }) : null
                                };
                            })();
                        return (0, g.jsxs)(g.Fragment, {
                            children: [
                                (0, g.jsx)(n.Title, { title: N.name }),
                                (0, g.jsx)(o.default, {
                                    groupName: N.name,
                                    groupColor: N.color,
                                    groupCreator: N.creator,
                                    icon: O.icon,
                                    iconColor: O.iconColor,
                                    response: O.response,
                                    bottomResponse: O.bottomResponse
                                })
                            ]
                        });
                    })()
    ...
    const _D = i.default.div.attrs({ className: 'maxWidth flex-column' })(w || (w = z`
  background: ${ 0 };
  flex: 1;
`), j.default.Snow), _E = (0, i.default)(v.Centered)(x || (x = z`
  flex: 1;
`));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
    ...
    var _t = u => {
        ...
        return (0, f.jsx)(_u, {
            children: (0, f.jsxs)(_v, {
                children: [
                    (0, f.jsx)(_w, { style: { background: w } }),
                    (0, f.jsx)(_x, { children: v }),
                    (0, f.jsx)(_y, { children: x }),
                    (0, f.jsxs)(_z, {
                        children: [
                            (0, f.jsxs)(_A, {
                                children: [
                                    ...
                                    (0, f.jsx)('div', { children: (0, f.jsx)(_C, { children: A }) })
                                ]
                            }),
                            B || null
                        ]
    ...
    const _u = g.default.div.attrs({ className: 'flex hc' })(j || (j = s`
  background: ${ 0 };
  color: ${ 0 };
  align-items: flex-start;
  font-family: ${ 0 };
  flex: 1;
`), h.default.Snow, h.default.Black, i.Fonts.SFPro), _v = g.default.div.attrs({ className: 'flex flex-column hc vc' })(k || (k = s`
  max-width: 700px;
  width: 90%;
  margin-top: 50px;
  margin-bottom: 50px;
`)), _w = g.default.div.attrs({ className: 'light-shadow' })(l || (l = s`
  height: 115px;
  width: 115px;
  border-radius: 8px;
`)), _x = g.default.div(m || (m = s`
  margin-top: 10px;
  text-align: center;
  font-size: 50px;
  font-weight: ${ 0 };
`), i.FontWeights.UltraBold), _y = g.default.div(n || (n = s`
  font-size: 22px;
  margin-top: -4px;
  color: rgba(0, 0, 0, 0.7);
`)), _z = g.default.div.attrs({ className: 'maxWidth' })(o || (o = s`
  background: ${ 0 };
  padding: 30px;
  border-radius: 7px;
  border-style: solid;
  ...
  border-color: ${ 0 };
  margin-top: 25px;
`), h.default.White, h.default.BorderGray), _A = g.default.div.attrs({ className: 'flex maxWidth vc' })(p || (p = s``)), _B = g.default.i(q || (q = s`
  font-size: 40px;
`)), _C = g.default.div(r || (r = s`
  margin-left: 30px;
  font-size: 18px;
`));
}), c.register('.....', function (d, e) {
    ...
    a(d.exports, 'IsURLFromUs', function () {
        return _f;
    });
    const _f = g => g.startsWith(window.location.origin) || g.startsWith('/');
}), c.register('.....', function (d, e) {

    ...
    var _l = a => {
        ...
        (0, e.verifyStripe)({
            ...
            onSuccess: (0, e.isLoggedIn)() ? () => {
                const m = (0, e.isUpgraded)();
                (0, h.default)({
                    onSuccess: () => {
                        var n;
                        m || (0, k.AnalyticsTrackEvent)({
                            event: 'upgrade',
                            properties: {
                                plan: null === (n = (0, e.getUser)()) || void 0 === n ? void 0 : n.type,
                                source: 'individual'
                            },
                            forcePostHog: !0

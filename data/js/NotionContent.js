...
d.register('.....', function (e, f) {
    ...
    var _o = p => {
        ...
        return (0, h.jsxs)('div', {
            className: 'maxWidth',
            children: [
                (0, h.jsx)('base', { target: '_blank' }),
                (0, h.jsx)(_p, {
                    children: s ? (0, h.jsx)(j.NotionRenderer, { blockMap: s }) : p.hideSkeleton ? null : (0, h.jsx)(m.default, {
                        active: !0,
                        title: !1,
                        paragraph: { rows: 9 }
                    })
    ...
    var i = [
            ...
            var l = k.block, m = k.mapImageUrl, n = l.value, o = l.value.type;
            if (!i.includes(o))
                return null;
            var p = n.format, q = null != p ? p : {}, r = q.display_source, s = void 0 === r ? void 0 : r, t = q.block_aspect_ratio, u = void 0 === t ? void 0 : t, v = q.block_height, w = void 0 === v ? 1 : v, x = q.block_width, y = u || w / (void 0 === x ? 1 : x);
            ...
            if ('image' === l.value.type) {
                var z, A = m(n.properties.source[0][0], l), B = null === (z = n.properties.caption) || void 0 === z ? void 0 : z[0][0];
            ...
            var m = l.code, n = l.language, o = void 0 === n ? 'javascript' : n, p = o.toLowerCase(), q = h.languages[p] || h.languages.javascript, r = 'language-' + o.toLowerCase();
            return (0, g.createElement)('pre', { className: 'notion-code ' + r }, (0, g.createElement)('code', {
                className: r,
                dangerouslySetInnerHTML: { __html: (0, h.highlight)(m, q, o) }
            }));
        }, l = function () {
            ...
            var s, t, u, v = r.block, w = r.className, x = r.big, y = r.mapImageUrl;
            if ('page' !== (u = v.value).type && 'callout' !== u.type)
                return null;
            var z = null === (s = v.value.format) || void 0 === s ? void 0 : s.page_icon, A = null === (t = v.value.properties) || void 0 === t ? void 0 : t.title;
            ...
            var t = s.blockMap, u = s.mapPageUrl, v = s.mapImageUrl, w = Object.keys(t)[0];
            if (!w)
                return null;
            for (var x = [], y = w;;) {
                var z, A, B = t[y];
                if (!B || !B.value)
                    break;
                var C = null === (z = B.value.properties) || void 0 === z ? void 0 : z.title[0][0], D = null === (A = B.value.format) || void 0 === A ? void 0 : A.page_icon;
                if (!C && !D)
                    break;
                x.push({
                    block: B,
            ...
            return x.reverse(), (0, g.createElement)('header', { className: 'notion-page-header' }, (0, g.createElement)('div', { className: 'notion-nav-breadcrumbs' }, x.map(function (F, G) {
                return (0, g.createElement)(g.Fragment, { key: F.pageId }, (0, g.createElement)('a', {
                    ...
                    block: F.block,
                    mapImageUrl: v
                }), F.title && (0, g.createElement)('span', { className: 'notion-nav-title' }, F.title)), G < x.length - 1 && (0, g.createElement)('span', { className: 'notion-nav-spacer' }, '/'));
            })));
        }, s = function (t) {
            var u = t.block, v = t.children, w = t.level, x = t.fullPage, y = t.hideHeader, z = t.blockMap, A = t.mapPageUrl, B = t.mapImageUrl, C = t.customBlockComponents, D = t.customDecoratorComponents, E = null == u ? void 0 : u.value, F = function () {
                                ...
                                return null == T ? void 0 : T.map(function (U, V) {
                                    ...
                                    return X ? X.reduceRight(function (Y, Z) {
                                        var $ = function () {
                                                ...
                                                case 'b':
                                                    return (0, g.createElement)('b', { key: V }, Y);
                                                case 'i':
                                                    return (0, g.createElement)('em', { key: V }, Y);
                                                case 's':
                                                    return (0, g.createElement)('s', { key: V }, Y);
                                                case 'a':
                                                ...
                                                default:
                                                    return (0, g.createElement)(g.Fragment, { key: V }, Y);
                                                }
                                            }, ab = null == S ? void 0 : S[Z[0]];
                                        if (ab) {
                                            var bb = Z[1] ? { decoratorValue: Z[1] } : {};
                                            return (0, g.createElement)(ab, Object.assign({ key: V }, bb, { renderComponent: $ }), W);
                                        }
                                        return $();
                                    }, (0, g.createElement)(g.Fragment, null, W)) : (0, g.createElement)(g.Fragment, { key: V }, W);
                                });
                            };
                        }(D);
                    ...
                    case 'page':
                        if (0 === w) {
                            if (x) {
                                if (!E.properties)
                                    return null;
                                var S = E.format || {}, T = S.page_icon, U = S.page_cover, V = S.page_cover_position, W = S.page_full_width, X = S.page_small_text, Y = 100 * (1 - (V || 0.5));
                                return (0, g.createElement)('div', { className: 'notion' }, !y && (0, g.createElement)(r, {
                                    blockMap: z,
                                    mapPageUrl: A,
                                    mapImageUrl: B
                                ...
                                }), (0, g.createElement)('main', { className: l('notion-page', !U && 'notion-page-offset', W && 'notion-full-width', X && 'notion-small-text') }, T && (0, g.createElement)(q, {
                                    className: U ? 'notion-page-icon-offset' : void 0,
                                    block: u,
                                    big: !0,
                                    mapImageUrl: B
                                }), (0, g.createElement)('div', { className: 'notion-title' }, R(E.properties.title)), v));
                            }
                            return (0, g.createElement)('main', { className: 'notion' }, v);
                        }
                        return E.properties ? (0, g.createElement)('a', {
                            className: 'notion-page-link',
                            href: A(E.id)
                        }, E.format && (0, g.createElement)('div', { className: 'notion-page-icon' }, (0, g.createElement)(q, {
                            block: u,
                            mapImageUrl: B
                        })), (0, g.createElement)('div', { className: 'notion-page-text' }, R(E.properties.title))) : null;
                    case 'header':
                        return E.properties ? (0, g.createElement)('h1', { className: 'notion-h1' }, R(E.properties.title)) : null;
                    case 'sub_header':
                        return E.properties ? (0, g.createElement)('h2', { className: 'notion-h2' }, R(E.properties.title)) : null;
                    case 'sub_sub_header':
                        return E.properties ? (0, g.createElement)('h3', { className: 'notion-h3' }, R(E.properties.title)) : null;
                    case 'divider':
                        return (0, g.createElement)('hr', { className: 'notion-hr' });
                    case 'text':
                        if (!E.properties)
                            return (0, g.createElement)('div', { className: 'notion-blank' }, '\xA0');
                        var Z = null === (G = E.format) || void 0 === G ? void 0 : G.block_color;
                        return (0, g.createElement)('p', { className: l('notion-text', Z && 'notion-' + Z) }, R(E.properties.title));
                    case 'bulleted_list':
                    case 'numbered_list':
                        var $ = function (ab, bb) {
                                return 'bulleted_list' === E.type ? (0, g.createElement)('ul', { className: 'notion-list notion-list-disc' }, ab) : (0, g.createElement)('ol', {
                                    start: bb,
                        ...
                        var bb = u.value.type !== z[u.value.parent_id].value.type, cb = n(E.id, z);
                        return bb ? $(ab, cb) : ab;
                    case 'image':
                    case 'embed':
                    case 'figma':
                    case 'video':
                        ...
                        return (0, g.createElement)('figure', {
                            ...
                            style: void 0 !== db.format ? { width: db.format.block_width } : void 0
                        }, (0, g.createElement)(j, {
                            block: u,
                            mapImageUrl: B
                        }), db.properties.caption && (0, g.createElement)('figcaption', { className: 'notion-image-caption' }, R(db.properties.caption)));
                    case 'code':
                        if (E.properties.title) {
                            var eb = E.properties.title[0][0], fb = E.properties.language[0][0];
                        ...
                        break;
                    case 'column_list':
                        return (0, g.createElement)('div', { className: 'notion-row' }, v);
                    case 'column':
                        var gb = E.format.column_ratio, hb = 'calc((100% - ' + 46 * (Number((1 / gb).toFixed(0)) - 1) + 'px) * ' + gb + ')';
                    ...
                    case 'quote':
                        return E.properties ? (0, g.createElement)('blockquote', { className: 'notion-quote' }, R(E.properties.title)) : null;
                    case 'collection_view':
                        if (!u)
                            return null;
                        var ib = null == u || null === (H = u.collection) || void 0 === H ? void 0 : H.types[0];
                        return (0, g.createElement)('div', null, (0, g.createElement)('h3', { className: 'notion-h3' }, R(null === (I = u.collection) || void 0 === I ? void 0 : I.title)), 'table' === (null == ib ? void 0 : ib.type) && (0, g.createElement)('div', {
                            style: {
                                maxWidth: '100%',
                                marginTop: 5
                            }
                        }, (0, g.createElement)('table', { className: 'notion-table' }, (0, g.createElement)('thead', null, (0, g.createElement)('tr', { className: 'notion-tr' }, null === (J = ib.format) || void 0 === J || null === (K = J.table_properties) || void 0 === K ? void 0 : K.filter(function (jb) {
                            return jb.visible;
                        }).map(function (jb, kb) {
                            var lb, mb;
                        ...
                        })))), 'gallery' === (null == ib ? void 0 : ib.type) && (0, g.createElement)('div', { className: 'notion-gallery' }, null === (M = u.collection) || void 0 === M ? void 0 : M.data.map(function (jb, kb) {
                            var lb, mb;
                            return (0, g.createElement)('div', {
                                key: 'col-' + kb,
                                className: 'notion-gallery-card'
                            }, (0, g.createElement)('div', { className: 'notion-gallery-content' }, null === (lb = ib.format) || void 0 === lb || null === (mb = lb.gallery_properties) || void 0 === mb ? void 0 : mb.filter(function (nb) {
                                return nb.visible;
                            }).map(function (nb, ob) {
                                var pb;
                    ...
                    case 'callout':
                        return (0, g.createElement)('div', { className: l('notion-callout', E.format.block_color && 'notion-' + E.format.block_color, E.format.block_color && 'notion-' + E.format.block_color + '_co') }, (0, g.createElement)('div', null, (0, g.createElement)(q, {
                            block: u,
                            mapImageUrl: B
                        })), (0, g.createElement)('div', { className: 'notion-callout-text' }, R(E.properties.title)));
                    case 'bookmark':
                        var jb = E.properties.link, kb = null !== (N = E.properties.title) && void 0 !== N ? N : jb, lb = E.properties.description, mb = null === (O = E.format) || void 0 === O ? void 0 : O.block_color, nb = null === (P = E.format) || void 0 === P ? void 0 : P.bookmark_icon, ob = null === (Q = E.format) || void 0 === Q ? void 0 : Q.bookmark_cover;
                        return (0, g.createElement)('div', { className: 'notion-row' }, (0, g.createElement)('a', {
                            target: '_blank',
                            rel: 'noopener noreferrer',
                            className: l('notion-bookmark', mb && 'notion-' + mb),
                            href: jb[0][0]
                        }, (0, g.createElement)('div', null, (0, g.createElement)('div', { className: 'notion-bookmark-title' }, R(kb)), lb && (0, g.createElement)('div', { className: 'notion-bookmark-description' }, R(lb)), (0, g.createElement)('div', { className: 'notion-bookmark-link' }, nb && (0, g.createElement)('img', {
                            src: nb,
                            alt: m(kb)
                        }), (0, g.createElement)('div', null, R(jb)))), ob && (0, g.createElement)('div', { className: 'notion-bookmark-image' }, (0, g.createElement)('img', {
                            src: ob,
                            alt: m(kb)
                        }))));
                    case 'toggle':
                        return (0, g.createElement)('details', { className: 'notion-toggle' }, (0, g.createElement)('summary', null, R(E.properties.title)), (0, g.createElement)('div', null, v));
                    default:
            ...
            var v, w, x = u.level, y = void 0 === x ? 0 : x, z = u.currentId, A = u.mapPageUrl, B = void 0 === A ? p : A, C = u.mapImageUrl, D = void 0 === C ? o : C, E = function (F, G) {
                    if (null == F)
                        return {};
                    ...
                    'mapPageUrl',
                    'mapImageUrl'
                ]), F = E.blockMap, G = z || Object.keys(F)[0], H = F[G];
    ...
    var g = function (h) {
        var i = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, j = 0, k = {}, l = {
                ...
                util: {
                    ...
                    objId: function (m) {
                        return m.__id || Object.defineProperty(m, '__id', { value: ++j }), m.__id;
                    },
                ...
                highlightElement: function (m, n, o) {
                    var p = l.util.getLanguage(m), q = l.languages[p];
                ...
                tokenize: function (m, n) {
                    ...
                    var q = new _Q();
                    return _T(q, q.head, m), _q(m, q, n, q.head, 0), function (r) {
                        var s = [], t = r.head.next;
                        for (; t !== r.tail;)
            ...
            for (var x in t)
                if (t.hasOwnProperty(x) && t[x]) {
                    ...
                    for (var z = 0; z < y.length; ++z) {
                        if (w && w.cause == x + ',' + z)
                            return;
                        var A = y[z], B = A.inside, C = !!A.lookbehind, D = !!A.greedy, E = A.alias;
                            ...
                            if (!(J instanceof _m)) {
                                ...
                                if (D) {
                                    if (!(K = n(G, I, r, C)) || K.index >= r.length)
                                        break;
                                    var M = K.index, N = K.index + K[0].length, O = I;
                                    ...
                                    continue;
                                M = K.index;
                                var Q = K[0], R = J.slice(0, M), S = J.slice(M + Q.length), T = I + J.length;
        ...
        if (R.Prism = ab, _m.stringify = function R(Z, $) {
            ...
            return R.addEventListener ? (ab.disableWorkerMessageHandler || R.addEventListener('message', function (Z) {
                var $ = JSON.parse(Z.data), ab = $.language, bb = $.code, cb = $.immediateClose;
    ...
    e.exports && (e.exports = g), void 0 !== c && (c.Prism = g), g.languages.markup = {
    ...
    }), g.languages.html = g.languages.markup, g.languages.mathml = g.languages.markup, g.languages.svg = g.languages.markup, g.languages.xml = g.languages.extend('markup', {}), g.languages.ssml = g.languages.xml, g.languages.atom = g.languages.xml, g.languages.rss = g.languages.xml, function (h) {
        var i = /(?:"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"|'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n])*')/;
        h.languages.css = {
            comment: /\/\*[\s\S]*?\*\//,
            atrule: {
    ...
    }), g.languages.markup && (g.languages.markup.tag.addInlined('script', 'javascript'), g.languages.markup.tag.addAttribute(/on(?:abort|blur|change|click|composition(?:end|start|update)|dblclick|error|focus(?:in|out)?|key(?:down|up)|load|mouse(?:down|enter|leave|move|out|over|up)|reset|resize|scroll|select|slotchange|submit|unload|wheel)/.source, 'javascript')), g.languages.js = g.languages.javascript, function () {
        if (void 0 !== g && 'undefined' != typeof document) {
            ...
            var h = {
                    ...
                    h: 'c',
                    tex: 'latex'
                }, i = 'data-src-status', j = 'loading', k = 'loaded', l = 'pre[data-src]:not([' + i + '="' + k + '"]):not([' + i + '="' + j + '"])';
            g.hooks.add('before-highlightall', function (m) {
                ...
                if (n.matches(l)) {
                    ...
                    var p = n.getAttribute('data-src'), q = m.language;
                    if ('none' === q) {
                        var r = (/\.(\w+)$/.exec(p) || [
                            ,
                            'none'
                    ...
                    s && s.loadLanguages(q), function (t, u, v) {
                        ...
                        if (u) {
                            var v = t.split(/\r\n?|\n/g), w = u[0], x = null == u[1] ? v.length : u[1];
    ...
    !function (g) {
        var h = g.util.clone(g.languages.javascript), i = /(?:\s|\/\/.*(?!.)|\/\*(?:[^*]|\*(?!\/))\*\/)/.source, j = /(?:\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])*\})/.source, k = /(?:\{<S>*\.{3}(?:[^{}]|<BRACES>)*\})/.source;
        function l(m, n) {

...
const $e = le(y.forwardRef((e, t) => {
        const {
            memorySystem: r
        } = Y(), [o, l] = y.useState(e.gridJSON), i = y.useRef(), c = y.useRef(), [m] = se(ie([N.messageBroadcaster, N.playerProximityMessageBroadcaster]), d => {
        ...
        return s.jsxs(s.Fragment, {
            children: [s.jsxs(de, {
                ...
                children: s.jsxs(P.Text, {
                    ...
                    children: [Z(e.blockCount), "/", Z(t.limits.blocksPerCodeGrid), " ", q.blocklyBlock.plural, " placed"]
                })
            })]
        })
    },
...
`,
    ...
    Wr = le(e => {
        ...
        } = Y(), [l, i, c] = ee(!1), [m, k, f] = ee(!1), [a, b] = y.useState(void 0), [h, n] = y.useState(0), [u, w] = y.useState(void 0), [d, v] = y.useState(void 0), B = y.useRef(), z = () => {
            var S;
            (S = r.get(e.deviceId)) != null && S.items.has(t.currentlyEditedGridId) || (Re.error(`This ${q.grid.singular} was deleted!`), e.close())
        }, {
            start: D,
            clear: F

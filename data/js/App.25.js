...
d.register('.....', function (e, f) {
    ...
    var _r = s => {
        const {secondary: t} = (0, i.useParams)(), [u, v] = q.useState([]);
        var w;
        ...
        if (z || C)
            return (0, h.jsx)(n.Centered, {
                className: 'maxAll',
                children: (0, h.jsx)(o.default, { style: { color: p.default.White } })
            });
        if (E) {
            var F;
        ...
        return u.length ? (0, h.jsxs)(h.Fragment, {
            children: [
                G.pageMode ? null : (0, h.jsx)('div', { style: { height: 650 } }),
    ...
    const _A = B => {
            ...
            (0, v.useDidMount)(() => {
                (0, t.preloadSound)({ path: (0, u.default)('cosmos/drumroll.mp3') }), (0, t.preloadSound)({ path: (0, u.default)('cosmos/packPurchased.mp3') }), (0, t.preloadSound)({ path: (0, u.default)('cosmos/packOpen1.mp3') }), (0, t.preloadSound)({ path: (0, u.default)('cosmos/packOpen2.mp3') });
            });
            return (0, g.jsxs)(g.Fragment, {
                children: [
                    B.pageMode ? (0, g.jsx)(o.Title, { title: G.name }) : null,
                        ...
                        children: (0, g.jsxs)(_B, {
                            children: [
                                (0, g.jsxs)(n.default, {
                                    ...
                                    children: [
                                        (0, g.jsx)(k.Image, { packId: B.packId }),
                                        (0, g.jsxs)(_C, {
                                            children: [
                                                (0, g.jsx)(k.Title, { title: G.name }),
        ...
        }, _B = j.default.div.attrs({ className: 'flex-center flex-column' })(x || (x = z`
  padding-top: 20px;
  font-family: ${ 0 };
  text-transform: uppercase;
  flex: 1;
`), h.Fonts.FugazOne), _C = j.default.div.attrs({ className: 'flex-center flex-column' })(y || (y = z``));
}), d.register('.....', function (e, f) {
    ...
    const _n = o => {
        ...
        }, _o = p => (0, g.jsx)(_p, { children: p.title }), _p = l.default.div(m || (m = (q => q)`
  font-size: 40px;
  font-family: ${ 0 };
  margin-bottom: 10px;
`), h.Fonts.FugazOne);
  ...
  color: ${ 0 } !important;
`), p.default.White), _y = h.default.div.attrs({ className: 'medium-shadow' })(r || (r = v`
  background: ${ 0 };
  ...
  position: relative;
  cursor: pointer;
`), z => z.background, j.Fonts.FugazOne, () => 280), _z = h.default.div.attrs({ className: 'maxWidth flex-center flex-column' })(s || (s = v`
...
`), C => C.hovering ? 0 : 3, C => C.hovering ? 1.02 : 0.98, C => C.hovering ? 1.2 : 1, C => C.imageUrl);
    ...
    const _o = p => {
        ...
        }, _p = h.default.div.attrs({ className: 'flex vc' })(n || (n = (q => q)`
  text-transform: uppercase;
  font-size: 16px;
  line-height: 1;
  font-family: ${ 0 };
`), k.Fonts.FugazOne);
    ...
    let s, t, u, v, w, x = y => y;
    const y = 116, z = A => {
            const [B, C, D] = (0, q.useBoolean)(!1), {data: E} = (0, o.default)(), {cosmetic: F} = A, G = E && E.ownedCosmetics.some(H => H.cosmetic.id === F.id);
            return (0, g.jsxs)(g.Fragment, {
                children: [
                    (0, g.jsxs)(_C, {
                        children: [
            ...
            const C = b(m).useMemo(() => B.items.map(D => {
                const E = B.cosmetics.find(F => F.id === D.cosmeticId), F = B.items.reduce((G, H) => G + H.count, 0);
                return {
                    cosmetic: E,
        ...
        }, _B = h.default.div.attrs({ className: 'maxWidth' })(s || (s = x`
  ...
  border-radius: 8px;
`), y), _C = h.default.div(t || (t = x`
  width: ${ 0 }px;
`), y), _D = h.default.div.attrs({ className: 'flex-center maxAll' })(u || (u = x`
  cursor: pointer;
...
`), l.Fonts.FugazOne);
    ...
    let t, u, v = w => w;
    const _w = x => {
            const y = (0, l.useMotionValue)(0), z = (0, l.useMotionValue)(0), A = (0, l.useMotionValue)(0), B = (0, m.useTransform)(A, C => `invert(${ C / 2 }) brightness(${ C + 1 })`), C = h.useRef(null), [D, E] = (0, o.useBoolean)(!1), F = h.useRef(!1), G = () => {
            ...
            h.useEffect(() => {
                ...
                1 === I && G(), A.set(I);
                const J = n.ResultAnimation.pack.intensity * I, K = Math.sin(H / 35) * J;
                y.set(K);
                const L = 2 * K;
                z.set(L);
            });
            const H = h.useMemo(() => D ? {
                    ...
                    opacity: 0
                } : { scale: n.ResultAnimation.pack.scale }, [D]), I = h.useMemo(() => D ? {
        ...
        }, _x = p.default.div.attrs({ className: 'maxAll flex-center animated fadeIn' })(t || (t = v`
  position: absolute;
  top: 0;
  left: 0;
...
`));
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    function _j(k) {
        const l = (0, h.useRef)(0), {isStatic: m} = (0, h.useContext)(i.MotionConfigContext);
        (0, h.useEffect)(() => {
            if (m)
                return;
            const n = ({
    ...
    var g = d('.....');
    function _h(...a) {
        const i = !Array.isArray(a[0]), j = i ? 0 : -1, k = a[0 + j], l = a[1 + j], m = a[2 + j], n = a[3 + j], o = (0, g.interpolate)(_h, m, {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....');
    function _j(k, l) {
        const m = (0, g.useMotionValue)(l()), n = () => m.set(l());
        return n(), (0, i.useIsomorphicLayoutEffect)(() => {
            const o = () => h.sync.update(n, !1, !0), p = k.map(q => q.on('change', o));
            return () => {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = function () {
    ...
    var o = function (p, q, r, s, t) {
            ...
            return n(n({}, u), ((x = {})['@keyframes rotation-'.concat(w)] = {
                ...
                '100%': { transform: 'rotate3d('.concat(v.join(), ', 360deg)') }
            }, x));
        }, {}), u = function (v, w, x, y, z) {
            var A, B = Math.round(600 * Math.random() + 200), C = Math.round(Math.random() * (s.length - 1)), D = w - Math.round(1000 * Math.random()), E = Math.random() < 0.1, F = function (G) {
                    return !b(m)(s[G], r) && q();
                }(C), G = E ? b(l)(0.25 * Math.random(), 2) : 0, H = -1 * G, I = G, J = b(l)(Math.abs(o(Math.abs(p(v.degree, 90) - 180), 0, 180, -1, 1)), 4), K = b(l)(0.5 * Math.random(), 4), L = b(l)(Math.random() * x * (q() ? 1 : -1), 4), M = b(l)(Math.max(o(Math.abs(v.degree - 180), 0, 180, x, -x), 0), 4);
            ...
            var x = w.particles, y = w.duration, z = w.height, A = w.width, B = w.force, C = w.particleSize, D = x.reduce(function (E, F, G) {
                    return n(n({}, E), u(F, y, B, C, G));
                }, {});
            return (0, k.createUseStyles)(n(n(n({}, t), function (E, F, G) {
                var H = 'string' == typeof F ? F : ''.concat(F, 'px'), I = E.reduce(function (J, K, L) {
                        var M, N = o(Math.abs(p(K, 90) - 180), 0, 180, -G / 2, G / 2);
                        return n(n({}, J), ((M = {})['@keyframes x-axis-'.concat(L)] = { to: { transform: 'translateX('.concat(N, 'px)') } }, M));
                    }, {});
                return n({ '@keyframes y-axis': { to: { transform: 'translateY('.concat(H, ')') } } }, I);
            }(x.map(function (E) {
                return E.degree;
            }), z, A)), {
                container: {
    ...
    function _x(y) {
        var z = y.particleCount, A = void 0 === z ? 100 : z, B = y.duration, C = void 0 === B ? 2200 : B, D = y.colors, E = void 0 === D ? w : D, F = y.particleSize, G = void 0 === F ? 12 : F, H = y.force, I = void 0 === H ? 0.5 : H, J = y.height, K = void 0 === J ? '120vh' : J, L = y.width, M = void 0 === L ? 1000 : L, N = y.zIndex, O = y.onComplete, P = function (Q, R) {
                var S = {};
                for (var T in Q)
                ...
                'zIndex',
                'onComplete'
            ]), Q = h.useState(), R = Q[0], S = Q[1], T = function (U, V) {
                var W = 360 / U;
                ...
                if (W) {
                    var X = W.getBoundingClientRect(), Y = X.top, Z = X.left;
                    S({
                        top: Y,
                        left: Z
                    });
        ...
        return h.useEffect(function () {
            ...
            children: R && (0, j.createPortal)((0, g.jsx)('div', n({ className: U.screen }, N ? { style: { zIndex: N } } : null, {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = /^[-+]0x[0-9a-f]+$/i, k = /^0b[01]+$/i, l = /^0o[0-7]+$/i, m = parseInt;
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = (d('.....'), d('.....')), k = (j = d('.....'), d('.....')), l = d('.....'), m = (l = d('.....'), d('.....')), n = (d('.....'), d('.....'), d('.....')), o = Number.MIN_SAFE_INTEGER || -1000000000, p = function () {
            return o++;
        }, q = (0, i.createContext)({
            classNamePrefix: '',
            disableStylesGeneration: !1,
            isSSR: !k.default
        }), r = new Map(), s = function (t, u) {
            var v = t.managers;
            if (v)
            ...
            var v = u.sheet, w = u.context, x = u.index, y = u.theme;
            v && (s(w, x).manage(y), w.registry && w.registry.add(v));
        }, u = (0, l.create)((0, m.default)()), v = new WeakMap(), w = function (x) {
            return v.get(x);
        };
    var x = function (y) {
            if (!y.context.disableStylesGeneration) {
                var z = s(y.context, y.index), A = z.get(y.theme);
                if (A)
                    return A;
                var B = y.context.jss || u, C = function (D) {
                        var E = D.styles;
                        return 'function' != typeof E ? E : E(D.theme);
                    }(y), D = (0, l.getDynamicStyles)(C), E = B.createStyleSheet(C, function (F, G) {
                        var H;
    ...
    var A = {}, _B = function (C, D) {
            void 0 === D && (D = {});
            var E = D, F = E.index, G = void 0 === F ? p() : F, H = E.theming, I = E.name, J = (0, h.default)(E, [
                    'index',
                    'theming',
                    'name'
                ]), K = H && H.context || j.ThemeContext, L = {};
            return function (M) {
                var N = (0, i.useRef)(!0), O = (0, i.useContext)(q), P = function (Q) {
                        return 'function' == typeof C && (Q || (0, i.useContext)(K)) || A;
                    }(M && M.theme), Q = (0, i.useMemo)(function () {
                        var R = x({
                            context: O,
                            styles: C,
                            name: I,
        ...
        var n = function (o) {
            ...
            function r() {
                ...
                return i(k(k(s = o.call.apply(o, [this].concat(r)) || this)), 'cachedTheme', void 0), i(k(k(s)), 'lastOuterTheme', void 0), i(k(k(s)), 'lastTheme', void 0), i(k(k(s)), 'renderProvider', function (w) {
                    ...
                    return b(g).createElement(m.Provider, { value: s.getTheme(w) }, x);
                }), s;
            }
    ...
    Object.defineProperty(e.exports, '__esModule', { value: !0 }), e.exports.default = function (g) {
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = {}.constructor;
    function o(p) {
    ...
    function _r(s, t, u) {
        void 0 === s && (s = 'unnamed');
        var v = u.jss, w = o(t), x = v.plugins.onCreateRule(s, w, u);
        return x || (s[0], null);
    }
    var v = function (w, x) {
    ...
    function B(C, D, E) {
        ...
        if (!D)
            return F;
        var G = E.indent, H = void 0 === G ? 0 : G, I = D.fallbacks;
        !1 === E.format && (H = -1 / 0);
        var J = x(E), K = J.linebreak, L = J.space;
        if (C && H++, I)
            if (Array.isArray(I))
    ...
    var R = /([[\].#*$><+~=|^:(),"'`\s])/g, S = 'undefined' != typeof CSS && CSS.escape, T = function (U) {
            return S ? S(U) : U.replace(R, '\\$1');
        }, U = function () {
            function V(W, X, Y) {
                this.type = 'style', this.isProcessed = !1;
                var Z = Y.sheet, $ = Y.Renderer;
            ...
            return V.prototype.prop = function (Y, Z, $) {
                ...
                var cb = null == bb || !1 === bb, db = Y in this.style;
                if (cb && !db && !ab)
                    return this;
                var eb = cb && db;
            ...
            function X(Y, Z, $) {
                ...
                var bb = $.selector, cb = $.scoped, db = $.sheet, eb = $.generateId;
            ...
            return cb.applyTo = function (db) {
                ...
                var eb = this.options.sheet, fb = !!eb && eb.options.link ? (0, ab.default)({}, db, { allowEmpty: !0 }) : db;
                return B(this.selectorText, this.style, fb);
                    ...
                    set: function (db) {
                        if (db !== this.selectorText) {
                            ...
                            var eb = this.renderer, fb = this.renderable;
                            if (fb && eb)
            ...
            function $(ab, bb, cb) {
                ...
                var db = ab.match(Y);
                for (var eb in (this.at = db ? db[1] : 'unknown', this.query = cb.name || '@' + this.at, this.options = cb, this.rules = new _vb((0, G.default)({}, cb, { parent: this })), bb))
            ...
            indent: 1,
            children: !0
        }, cb = /@keyframes\s+([\w-]+)/, db = function () {
            function eb(fb, gb, hb) {
                this.type = 'keyframes', this.at = '@keyframes', this.isProcessed = !1;
                var ib = fb.match(cb);
                ib && ib[1] ? this.name = ib[1] : this.name = 'noname', this.key = this.type + '-' + this.name, this.options = hb;
                var jb = hb.scoped, kb = hb.sheet, lb = hb.generateId;
                for (var mb in (this.id = !1 === jb ? this.name : T(lb(this, kb)), this.rules = new _vb((0, G.default)({}, hb, { parent: this })), gb))
                    this.rules.add(mb, gb[mb], (0, G.default)({}, hb, { parent: this }));
                this.rules.process();
            }
            ...
            return (0, K.default)(lb, kb), lb.prototype.toString = function (mb) {
                var nb = this.options.sheet, ob = !!nb && nb.options.link ? (0, G.default)({}, mb, { allowEmpty: !0 }) : mb;
            ...
            return xb.add = function (yb, zb, Ab) {
                var Bb = this.options, Cb = Bb.parent, Db = Bb.sheet, Eb = Bb.jss, Fb = Bb.Renderer, Gb = Bb.generateId, Hb = Bb.scoped, Ib = (0, G.default)({
                ...
                var Bb = this.get(yb), Cb = this.index.indexOf(Bb);
                Bb && this.remove(Bb);
                var Db = Ab;
                return -1 !== Cb && (Db = (0, G.default)({}, Ab, { index: Cb })), this.add(yb, zb, Db);
            }, xb.get = function (yb) {
                return this.map[yb];
                ...
                void 0 === Ab && (Ab = tb);
                var Bb = this.options, Cb = Bb.jss.plugins, Db = Bb.sheet;
            ...
            return Ab.add = function (Bb) {
                var Cb = this.registry, Db = Bb.options.index;
                if (-1 === Cb.indexOf(Bb))
        ...
        }())(), zb = 'undefined' != typeof globalThis ? globalThis : 'undefined' != typeof window && window.Math === Math ? window : 'undefined' != typeof self && self.Math === Math ? self : Function('return this')(), Ab = '2f1acc6c3a606b082e5eef5e54414ffb';
    null == zb[Ab] && (zb[Ab] = 0);
    var Bb = zb[Ab]++, _Cb = function (Db) {
            void 0 === Db && (Db = {});
            var Eb = 0;
            ...
            try {
                ...
                if (Array.isArray(Ib) && (Jb = _w(Ib)), Gb.attributeStyleMap)
                    ...
                    var Kb = Jb ? Jb.indexOf('!important') : -1, Lb = Kb > -1 ? Jb.substr(0, Kb - 1) : Jb;
    ...
    var Ob = Db(function () {
            ...
            function Sb(Tb) {
                ...
                var Ub, Vb = this.sheet ? this.sheet.options : {}, Wb = Vb.media, Xb = Vb.meta, Yb = Vb.element;
            ...
            return Zb.attach = function () {
                ...
                if (void 0 === bc && (bc = this.element.sheet), $b.rules) {
                    ...
                    if ('conditional' === $b.type || 'keyframes' === $b.type) {
                        var ec = Qb(bc, ac);
                        if (!1 === (dc = Pb(bc, cc.toString({ children: !1 }), ec)))
                            return !1;
                ...
                if (!fc)
                    return !1;
                var gc = Qb(bc, ac), hc = Pb(bc, fc, gc);
                ...
                var ac = this.element.sheet, bc = this.indexOf($b);
            ...
            function Ub(Vb) {
                this.id = Sb++, this.version = '10.10.0', this.plugins = new xb(), this.options = {
                    ...
                    plugins: []
                }, this.generateId = _Cb({ minify: !1 });
                for (var Wb = 0; Wb < sb.length; Wb++)
                    this.plugins.use(sb[Wb], { queue: 'internal' });
                this.setup(Vb);
            }
            var Wb = Ub.prototype;
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = d('.....'), l = d('.....'), m = d('.....'), n = d('.....'), o = d('.....'), p = d('.....'), q = d('.....'), r = d('.....'), _s = function (t) {
            return void 0 === t && (t = {}), {
                plugins: [
                    (0, g.default)(),
    ...
    var g = d('.....'), h = Date.now(), i = 'fnValues' + h, j = 'fnStyle' + ++h, _k = function () {
            return {
    ...
    var g = d('.....'), h = d('.....'), i = function (j) {
            ...
            return {
                ...
                onProcessRule: function (l) {
                    if (!l || 'style' === l.type) {
                        var m = l, n = m.style, o = function (p) {
                                var q = n[p];
                                if (!i(q))
                                    return 'continue';
            ...
            'string' == typeof i.style && (i.style = function (j) {
                for (var k = {}, l = j.split(g), m = 0; m < l.length; m++) {
                    ...
                    if (n) {
                        var o = n.indexOf(':');
                        if (-1 !== o) {
                            var p = n.substr(0, o).trim(), q = n.substr(o + 1).trim();
                            k[p] = q;
                        }
                    }
                }
    ...
    var _i = function () {
        return { onProcessRule: h };
    };
}), d.register('.....', function (e, f) {
    a(e.exports, 'default', function () {
        return _r;
    });
    var g = d('.....'), h = d('.....'), i = '@global', j = '@global ', k = function () {
            function l(m, n, o) {
                for (var p in (this.type = 'global', this.at = i, this.isProcessed = !1, this.key = m, this.options = o, this.rules = new (0, h.RuleList)((0, g.default)({}, o, { parent: this })), n))
            ...
            function m(n, o, p) {
                ...
                this.rule = p.jss.createRule(q, o, (0, g.default)({}, p, { parent: this }));
            }
        ...
        return {
            ...
            onProcessRule: function (s, t) {
                'style' === s.type && t && (function (u, v) {
                    var w = u.options, x = u.style, y = x ? x[i] : null;
                    if (y) {
                        for (var z in y)
                            v.addRule(z, y[z], (0, s.default)({}, w, { selector: n(z, u.selector) }));
                        delete x[i];
                    }
                }(s, t), function (u, v) {
                    var w = u.options, x = u.style;
                    for (var y in x)
                        if ('@' === y[0] && y.substr(0, i.length) === i) {
                            var z = n(y.substr(i.length), u.selector);
                            v.addRule(z, x[y], (0, s.default)({}, w, { selector: z })), delete x[y];
                        }
                }(s, t));
            }
        };
    ...
    var _k = function () {
        ...
        function u(v, w, x) {
            if (x)
                return (0, r.default)({}, x, { index: x.index + 1 });
        ...
        return {
            onProcessStyle: function (x, y, z) {
                if ('style' !== y.type)
                    return x;
                var A, B, C = y, D = C.options.parent;
                for (var E in x) {
                    var F = -1 !== E.indexOf('&'), G = '@' === E[0];
                    if (F || G) {
                        if (A = u(C, D, A), F) {
                            var H = m(E, C.selector);
                            B || (B = l(D, z)), H = H.replace(s, B);
                            var I = C.key + '-' + E;
                            'replaceRule' in D ? D.replaceRule(I, x[E], (0, r.default)({}, A, { selector: H })) : D.addRule(I, x[E], (0, r.default)({}, A, { selector: H }));
                        } else
                            G && D.addRule(E, {}, A).addRule(C.key, x[E], { selector: C.selector });
                        delete x[E];
                    }
                }
                return x;
    ...
    var g = d('.....'), h = g.hasCSSTOMSupport && CSS ? CSS.px : 'px', i = g.hasCSSTOMSupport && CSS ? CSS.ms : 'ms', j = g.hasCSSTOMSupport && CSS ? CSS.percent : '%';
    function k(l) {
        var m = /(-[a-z])/g, n = function (o) {
        ...
        function j(k) {
            for (var l in k) {
                ...
                if ('fallbacks' === l && Array.isArray(m))
                    ...
                    var n = !1, o = (0, g.supportedProperty)(l);
                    o && o !== l && (n = !0);
                    var p = !1, q = (0, g.supportedValue)(o, (0, h.toCssValue)(m));
    ...
    function g(h, i) {
        ...
        if (!h || !i)
            return !1;
        var j = Object.keys(h), k = Object.keys(i), l = j.length;
        if (g.length !== l)
            return !1;
        for (var m = 0; m < l; m++) {
            var n = j[m];
    ...
    var g = d('.....'), h = d('.....'), i = (0, g.create)((0, h.default)()), j = function (k) {
            void 0 === k && (k = i);
            var l, m = new Map(), n = 0, o = function () {
                    return (!l || l.rules.index.length > 10000) && (l = k.createStyleSheet().attach()), l;
                };
            function p() {
                var q = arguments, r = JSON.stringify(q), s = m.get(r);
                if (p)
                    return p.className;
                var t = [];
                for (var u in q) {
                ...
                delete x.label;
                var D = 0 === y.length ? 'css' : y.join('-'), E = D + '-' + n++;
                o().addRule(E, x);
                var F = o().classes[E], G = {
                        style: x,
                        labels: y,
    ...
    var g = d('.....'), h = d('.....'), i = d('.....'), j = d('.....'), k = g.isFinite, l = Math.min;
    e.exports = function (m) {
        var n = Math[m];
        return function (o, p) {
            if (o = i(o), (p = null == p ? 0 : l(h(p), 292)) && k(o)) {
                var q = (j(o) + 'e').split('e'), r = n(q[0] + 'e' + (+q[1] + p));
    ...
    const _v = w => {
            ...
            const B = h.useMemo(() => {
                const C = w.items[z], D = w.packData.cosmetics.find(E => E.id === C.cosmeticId), E = w.packData.items.reduce((F, G) => F + G.count, 0), F = w.packData.items.find(G => G.cosmeticId === C.cosmeticId).count / E * 100;
                return {
                    item: C,
                    cosmetic: D,
                    percentage: F
            ...
            return x ? (0, g.jsxs)(g.Fragment, {
                children: [
                    (0, g.jsx)(_x, { rarity: B.cosmetic.rarity }),
            ...
            const y = (0, p.rarityToColor)(x.rarity), z = h.useRef(null), A = h.useMemo(() => y, []);
            return h.useEffect(() => {
        ...
        }, _x = y => (0, i.createPortal)((0, g.jsx)(w, { ...y }), document.getElementById(j.CosmosElementIds.container)), _y = k.default.div.attrs({ className: 'maxAll animated fadeIn' })(u || (u = (z => z)`
  @property --c {
    syntax: '<color>';
    inherits: false;
    initial-value: ${ 0 };
...
`), z => z.defaultColor);
    ...
    const _y = z => {
            ...
            return (0, g.jsxs)(_z, {
                ...
                children: [
                    ...
                    B ? (0, g.jsx)(_B, { children: (0, g.jsx)(_C, { children: 'New!' }) }) : null,
                    (0, g.jsx)(_D, {
                        style: { background: (0, i.rarityToBackground)(A.rarity) },
                        children: (0, g.jsx)(_F, {
                            src: (0, n.default)({
                                id: A.id,
                                type: A.type
        ...
        }, _z = (0, h.default)(l.motion.div).attrs({ className: 'maxAll flex-center scroll-y flex-column' })(p || (p = x`
  ...
  text-align: center;
  will-change: transform;
`), j.Fonts.FugazOne), _A = h.default.div(q || (q = x`
  font-size: 12px;
  opacity: 0.75;
...
`)), _C = h.default.div(s || (s = x`
  margin-top: 2px;
`)), _D = h.default.div.attrs({ className: 'flex-center' })(t || (t = x`
  height: 230px;
  width: 230px;
  border-radius: 8px;
  border: 4px solid white;
...
`));
    ...
    var _j = k => (0, g.useQuery)([
        i,
        k
    ], () => (0, h.requestAsPromise)({ url: '/api/cosmos/pack/details/' + k }));
}), d.register('.....', function (e, f) {

    ...
    var _K = L => {
        ...
        const {
            ...
            if (!(null == O ? void 0 : O.ownedCosmetics))
                return [];
            const db = T.toLowerCase(),
                eb = O.ownedCosmetics.filter(fb => {
                    var gb, hb;
...
`));
    ...
    var _t = u => {
        const v = i.useRef(null),
            ...
            x = i.useMemo(() => {
                const y = w - 1,
                    z = Math.floor((y - _u.gapBetweenItems) / (_u.itemWidth + _u.gapBetweenItems));
                if (z < 2)
                    return y;
            ...
            children: [
                ...
                (0, g.jsx)(n.default, {
                    ...
                    callToAction: y => {
                        ...
                        const z = void 0 !== y.editStyles && '{}' !== JSON.stringify(y.editStyles) && JSON.stringify(y.editStyles) !== JSON.stringify(s.editStyles),
                            A = s.selected ? z ? 'Update' : 'Selected' : 'Select';
                        return {
                            text: A,
                            ariaLabel: A,
    ...
    function _j(k, l) {
        ...
        (0, g.useEffect)(function() {
            if ('undefined' != typeof window)
                return window.addEventListener('storage', q),
                    function() {

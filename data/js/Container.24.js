...
c.register('.....', function(d, e) {
    ...
    function C(D, E, F) {
        ...
        if (!H || !H[u]) {
            var I = D[E],
                J = _H(D, E, H ? H.enumerable : void 0, G, I);
    ...
    function _ab(bb, cb) {
        var db = l('reactProp_' + cb + '_valueHolder'),
            eb = l('reactProp_' + cb + '_atomHolder');
    ...
    function _hb(ib) {
        var jb = ib.children,
            ...
            lb = a(O).useContext(gb),
            mb = a(O).useRef(eb({}, lb, kb)).current;
        return a(O).createElement(gb.Provider, {
            value: mb
        }, jb);
    }
...
}), c.register('.....', function(d, e) {}), c.register('.....', function(d, e) {

...
c.register('.....', function (d, e) {
    ...
    var g = c('.....');
    c('.....');
    var h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....');
    let t, u, v = w => w;
    const w = [
    ...
    var _x = () => (0, g.jsxs)(g.Fragment, {
        children: [
            (0, g.jsx)(h.Title, { title: 'Group Pricing' }),
            (0, g.jsxs)(_y, {
                children: [
                    (0, g.jsx)(s.default, { includeSpacer: !0 }),
                    (0, g.jsxs)(_z, {
                        style: { maxWidth: 700 },
                        children: [
                            (0, g.jsx)(l.default, {}),
                            (0, g.jsx)(i.default, {}),
                            (0, g.jsx)('div', { style: { height: 20 } }),
                            (0, g.jsx)(m.default, {
                                features: w.map(y => ({
                                    good: !0,
                                    text: y
    ...
    const _y = p.default.div.attrs({ className: 'flex-column vc maxWidth' })(t || (t = v`
  background: ${ 0 };
  font-family: ${ 0 };
  color: ${ 0 };
`), q.default.Snow, r.Fonts.SFPro, q.default.Black), _z = p.default.div(u || (u = v`
  width: 90%;
  max-width: 1000px;
`));
}), c.register('.....', function (d, e) {
    ...
    var _m = () => (0, f.jsx)(i.default, {
        ...
        children: l.map(n => (0, f.jsx)(_n, { children: n }, n))
    });
    const _n = g.default.div(k || (k = (o => o)`
  font-size: 23px;
  font-weight: ${ 0 };
`), h.FontWeights.Bold);
}), c.register('.....', function (d, e) {
...
`), o => o.background || '#101da5', g.default.White, h.Fonts.SFPro);
    var _o = p => {
        const q = 'large' == p.size, r = {
                imageHeight: q ? 14 : 10,
                planNameFontSize: q ? 48 : 30,
                planNameMarginTop: q ? 5 : 7,
                planNameLineHeight: q ? '35px' : '17px',
                priceFontSize: q ? 37 : 24,
                priceDescriptionFontSize: q ? 11 : 9,
                priceDescriptionMarginTop: q ? -9 : -7
            }, s = (0, i.isLoggedIn)() && p.plan.id ? l.CHECKOUT : p.plan.link;
                            ...
                            children: [
                                ...
                                (0, f.jsx)('div', {
                                    style: {
                                        ...
                                        fontSize: r.planNameFontSize,
                                        marginTop: r.planNameMarginTop,
                                        lineHeight: r.planNameLineHeight
                                    },
                        ...
                        (0, f.jsxs)('div', {
                            ...
                            children: [
                                (0, f.jsx)('div', {
                                    ...
                                    children: p.plan.price
                                }),
                                p.plan.description && (0, f.jsx)('div', {
                                    style: {
                                        fontSize: r.priceDescriptionFontSize,
                                        opacity: 0.7,
                                        marginTop: r.priceDescriptionMarginTop
                                    },
                                    children: p.plan.description
                                })
                            ]
                        })
                    ]
    ...
    const i = j => (0, f.jsxs)('div', {
        ...
        children: [
            ...
            (0, f.jsx)('div', { children: j.text })
        ]
    });
    var _j = k => (0, f.jsx)(_k, {
        className: 'flex maxWidth wrap vc hc',
        children: k.features.map(l => (0, f.jsx)(i, {
            good: l.good,
            text: l.text
        }, `feat-${ l.good }-${ l.text }`))
    });
    const _k = g.default.div(h || (h = (l => l)`
  text-align: left;
  font-size: 17px;
`));
}), c.register('.....', function (d, e) {

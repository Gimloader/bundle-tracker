...
`), o.default.Snow, p.Fonts.SFPro, o.default.Black),
        x = n.default.div(s || (s = t`
  width: 90%;
  max-width: 1000px;
`));
}), c.register('nw1xG', function(b, p) {
    a(b.exports, 'default', function() {
        return k;
    });
    var d = c('8kSQZ');
    ...
    var k = () => (0, d.jsx)(g.default, {
        style: {
            color: h.default.Black,
            textAlign: 'left'
        },
        children: j.map(a => (0, d.jsx)(l, {
            children: a
        }, a))
    });
    const l = e.default.div(i || (i = (a => a)`
  font-size: 23px;
  font-weight: ${ 0 };
`), f.FontWeights.Bold);
}), c.register('S27Iu', function(b, p) {
    a(b.exports, 'default', function() {
        return m;
    });
    var d = c('8kSQZ');
...
`), a => a.background || '#101da5', e.default.White, f.Fonts.SFPro);
    var m = a => {
        const n = 'large' == a.size,
            o = {
                imageHeight: n ? 14 : 10,
            ...
            p = (0, g.isLoggedIn)() && a.plan.id ? j.CHECKOUT : a.plan.link;
                    ...
                    children: [
                        ...
                        (0, d.jsxs)('div', {
                            ...
                            children: [
                                ...
                                a.plan.description && (0, d.jsx)('div', {
                                    style: {
...
}), c.register('Plys5', function(b, j) {
    a(b.exports, 'DepartmentGroup', function() {
        return h;
    }), a(b.exports, 'SchoolGroup', function() {
        return i;
    });
    var d = c('8kSQZ');
    c('uPP4W');
    ...
    var h = a => (0, d.jsx)(i, {
        ...
        children: a.features.map(a => (0, d.jsx)(g, {
            good: a.good,
            text: a.text
        }, `feat-${ a.good }-${ a.text }`))
    });
    const i = e.default.div(f || (f = (a => a)`
  text-align: left;
  font-size: 17px;
`));
}), c.register('gMoe4', function(b, j) {
    a(b.exports, 'default', function() {
        return i;
    });
    var d = c('8kSQZ');

...
a.register('PUDCL', function(b, c) {
  ...
  font-family: ${ 0 };
  color: ${ 0 };
`), o.default.Snow, p.Fonts.SFPro, o.default.Black),
        _x = n.default.div(s || (s = t`
  width: 90%;
  max-width: 1000px;
`));
}), a.register('3iQNj', function(b, c) {
    _h(b.exports, 'default', function() {
        return _k;
    });
    var d = a('0hzx+');
    ...
    var _k = () => (0, d.jsx)(g.default, {
        style: {
            color: h.default.Black,
            textAlign: 'left'
        },
        children: j.map(_h => (0, d.jsx)(_l, {
            children: _h
        }, _h))
    });
    const _l = e.default.div(i || (i = (_h => _h)`
  font-size: 23px;
  font-weight: ${ 0 };
`), f.FontWeights.Bold);
}), a.register('Mw5KE', function(b, c) {
    _h(b.exports, 'default', function() {
        return _m;
    });
    var d = a('0hzx+');
    ...
    var e = a('sHRDd'),
        ...
        j = a('gs4MT');
    let k;
    const l = h.default.div(k || (k = (_h => _h)`
  background: ${ 0 };
  width: 100%;
  padding: 20px;
  border-radius: 5px;
...
`), _h => _h.background || '#101da5', e.default.White, f.Fonts.SFPro);
    var _m = _h => {
        const n = 'large' == _h.size,
            o = {
                imageHeight: n ? 14 : 10,
                planNameFontSize: n ? 48 : 30,
                planNameMarginTop: n ? 5 : 7,
                planNameLineHeight: n ? '35px' : '17px',
                priceFontSize: n ? 37 : 24,
                priceDescriptionFontSize: n ? 11 : 9,
                priceDescriptionMarginTop: n ? -9 : -7
            },
            p = (0, g.isLoggedIn)() && _h.plan.id ? j.CHECKOUT : _h.plan.link;
                            ...
                            children: [
                                ...
                                (0, d.jsx)('div', {
                                    style: {
                                        ...
                                        fontSize: o.planNameFontSize,
                                        marginTop: o.planNameMarginTop,
                                        lineHeight: o.planNameLineHeight
                                    },
                                    children: _h.plan.name
                                })
                            ]
                        }),
                        (0, d.jsxs)('div', {
                            ...
                            children: [
                                (0, d.jsx)('div', {
                                    style: {
                                        fontSize: o.priceFontSize,
                                        fontWeight: f.FontWeights.UltraBold
                                    },
                                    children: _h.plan.price
                                }),
                                _h.plan.description && (0, d.jsx)('div', {
                                    style: {
                                        fontSize: o.priceDescriptionFontSize,
                                        opacity: 0.7,
                                        marginTop: o.priceDescriptionMarginTop
                                    },
                                    children: _h.plan.description
                                })
                            ]
                        })
                    ]
...
}), a.register('E2XrA', function(b, c) {
    _h(b.exports, 'DepartmentGroup', function() {
        return _h;
    }), _h(b.exports, 'SchoolGroup', function() {
        return _i;
    });
    var d = a('0hzx+');
    a('LEQ5w');
    var e = a('b5kvC'),
        f = a('gs4MT'),
        g = a('nCi40');
    g.PlanIds.basic, e.FontWeights.Bold, g.PlanIds.pro, g.PlanIds.pro, g.PlanIds.proPass, g.PlanIds.proPass, f.GROUP_PRICING;
    const _h = {
            name: 'Department',
            price: '$650',
    ...
    var _h = _h => (0, d.jsx)(_i, {
        ...
        children: _h.features.map(_h => (0, d.jsx)(g, {
            good: _h.good,
            text: _h.text
        }, `feat-${ _h.good }-${ _h.text }`))
    });
    const _i = e.default.div(f || (f = (_h => _h)`
  text-align: left;
  font-size: 17px;
`));
}), a.register('YJKxs', function(b, c) {
    _h(b.exports, 'default', function() {
        return _i;
    });
    var d = a('0hzx+');

...
const mt = t => {
        ...
        } = t, a = `${e}-notice`, i = new w("antNotificationFadeIn", {
            "0%": {
        ...
        }), s = new w("antNotificationTopFadeIn", {
            "0%": {
                top: -n,
                opacity: 0
            },
        ...
        }), r = new w("antNotificationBottomFadeIn", {
            "0%": {
        ...
        }), c = new w("antNotificationLeftFadeIn", {
            "0%": {
                transform: "translate3d(-100%, 0, 0)",
                opacity: 0
            },
    ...
    D = t => {
        ...
        return {
            ...
            [d]: {
                padding: O,
                width: x,
                maxWidth: `calc(100vw - ${E(t.calc(y).mul(2).equal())})`,
                overflow: "hidden",
                lineHeight: m,
                wordWrap: "break-word"
            },
    ...
    St = t => {
        const {
            ...
            motionDurationMid: a,
            motionEaseInOut: i
        } = t, s = `${e}-notice`, r = new w("antNotificationFadeOut", {
            "0%": {
    ...
    k = t => {
        ...
        return Y(t, {
            ...
            notificationPadding: `${E(t.paddingMD)} ${E(t.paddingContentHorizontalLG)}`,
    ...
    Ot = tt(["Notification", "PurePanel"], t => {
        const e = `${t.componentCls}-notice`,
            o = k(t);
        return {
            [`${e}-pure-panel`]: Object.assign(Object.assign({}, D(o)), {
                width: o.width,
                maxWidth: `calc(100vw - ${E(t.calc(o.notificationMarginEdge).mul(2).equal())})`,
                margin: 0
            })
        }
    }, G);
...
const B = 24,
    ...
    Lt = f.forwardRef((t, e) => {
        ...
        return f.useImperativeHandle(e, () => Object.assign(Object.assign({}, d), {
            prefixCls: m,
            notification: g
        })), N
    });
...
function V(t) {
    ...
    }, []), f.createElement(Lt, Object.assign({
...
function z() {
    const {
        ...
        showProgress: i,
        pauseOnHover: s
    } = j, r = (t == null ? void 0 : t()) || document.body;
    return {
        getContainer: () => r,
        rtl: e,
        maxCount: o,
...
const At = t => {
    ...
    kt = Gt;
Dt.forEach(t => {
    kt[t] = e => U(Object.assign(Object.assign({}, e), {
        type: t
    }))
});
export {

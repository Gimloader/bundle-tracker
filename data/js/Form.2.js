...
c.register('.....', function(d, e) {
    ...
    const _t = `__LIST_IGNORE_${ Date.now() }__`,
        u = (v, w) => {
            ...
            const eb = (fb, gb, hb) => {
                ...
                fb = gb => {
                    ...
                    ib.forEach(kb => {
                        ...
                        if (hb[lb].parsedFile)
                            ...
                            let ob;
                            try {
                                ob = new File([nb], nb.name, {
                                    type: nb.type
                                });
                            } catch (kb) {
                                ob = new Blob([nb], {
                                    type: nb.type
                                }), ob.name = nb.name, ob.lastModifiedDate = new Date(), ob.lastModified = new Date().getTime();
                            }
                            ob.uid = kb.uid, mb = ob;
                        }
                        eb(mb, jb);
                ...
                jb = kb => {
                    ...
                    Promise.resolve('function' == typeof z ? z(kb) : z).then(mb => {
                        ...
                        ob && (lb = Object.assign(Object.assign({}, kb), {
                            status: 'removed'
                        }), null == $ || $.forEach(pb => {
            ...
            if ('drag' === O) {
                ...
                return pb(j.createElement('span', {
                    className: b(g)(`${ nb }-wrapper`, sb, N, qb)
                }, j.createElement('div', {
                    className: tb,
                    onDrop: kb,
                    onDragOver: kb,
                    ...
                    className: `${ nb }-drag-container`
                }, P))), rb()));
            }
            const ub = b(g)(nb, `${ nb }-select`, {
                    [`${ nb }-disabled`]: Z
                }),
                vb = (_wb = P ? void 0 : {
                    display: 'none'
    ...
    var n = function(o) {
        ...
        return (0, h.default)(q, [{
            ...
            },
            {
                key: 'render',
                value: function() {
                    return s(k).createElement(l.default, (0, u.default)({}, this.props, {
                ...
                },
                {
                    ...
                    value: function() {
                        var G, H = this.props,
                            ...
                            Q = H.children,
                            R = H.directory,
                            S = H.openFileDialogOnClick,
                            T = H.onMouseEnter,
                            U = H.onMouseLeave,
                            V = H.capture,
                            W = (0, h.default)(H, x),
                            X = b(r)((G = {}, (0, F.default)(G, J, !0), (0, F.default)(G, ''.concat(J, '-disabled'), L), (0, F.default)(G, K, K), G)),
                            Y = R ? {
                                directory: 'directory',
    ...
    function h(i) {
        ...
        i.data && Object.keys(i.data).forEach(function(l) {
            ...
            return j.status < 200 || j.status >= 300 ? i.onError(function(l, m) {
                var n = 'cannot '.concat(l.method, ' ').concat(l.action, ' ').concat(m.status, '\''),
                    o = new Error(n);
    ...
    const u = (v, w) => {
        ...
        const U = (V, W) => {
            ...
            X = Y => {
                if (D)
                    return D(Y, x);
                const Z = 'uploading' === Y.status,
                    $ = E && E(Y) ? m.createElement(j.default, null) : m.createElement(g.default, null);
            ...
            Y = (Z, $, ab, bb) => {
                ...
                if ((0, r.isValidElement)(Z)) {
                    ...
                    return m.createElement(n.default, Object.assign({}, cb, {
                        icon: db
                    }));
                }
        ...
        const {
            getPrefixCls: Z
        } = m.useContext(o.ConfigContext), $ = Z('upload', F), ab = Z(), bb = b(k)({
            [`${ $ }-list`]: !0,
            [`${ $ }-list-${ x }`]: !0
        ...
        return 'picture-card' !== x && 'picture-circle' !== x && (db = Object.assign(Object.assign({}, eb), db)), m.createElement('div', {
            className: bb
        }, m.createElement(l.CSSMotionList, Object.assign({}, db, {
            component: !1
        }), fb => {
            let {
                key: gb,
            ...
            return (0, r.cloneElement)(O, ib => ({
                ...
                style: Object.assign(Object.assign(Object.assign({}, hb), {
                    pointerEvents: gb ? 'none' : void 0
                }), ib.style)
            }));
        }));
    };
    ...
    function _m(n, o) {
        const p = void 0 !== n.uid ? 'uid' : 'name',
            q = o.filter(r => r[p] !== n[p]);
        return q.length === o.length ? null : q;
    }
    const p = q => 0 === q.indexOf('image/'),
        _q = r => {
            if (r.type && !r.thumbUrl)
                return p(r.type);
            const s = r.thumbUrl || r.url || '',
                t = function() {
                    let u = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '';
                    const v = u.split('/'),
                        w = v[v.length - 1].split(/#|\?/)[0];
                    return (/\.[^./\\]*$/.exec(w) || [''])[0];
                }(s);
    ...
    var _o = k.forwardRef((p, q) => {
        ...
        const Z = b(i)(`${ r }-list-item`, `${ r }-list-item-${ P }`),
            $ = 'string' == typeof w.linkProps ? JSON.parse(w.linkProps) : w.linkProps,
            ab = E ? A(('function' == typeof H ? H(w) : H) || k.createElement(f.default, null), () => L(w), r, u.removeFile) : null,
            bb = F && 'done' === P ? A(('function' == typeof I ? I(w) : I) || k.createElement(g.default, null), () => K(w), r, u.downloadFile) : null,
            cb = 'picture-card' !== v && 'picture-circle' !== v && k.createElement('span', {
                key: 'download-delete',
                className: b(i)(`${ r }-list-item-actions`, {
                    picture: 'picture' === v
                })
            }, bb, ab),
            db = b(i)(`${ r }-list-item-name`),
            eb = w.url ? [
            ...
            fb = D ? k.createElement('a', {
                ...
                onClick: gb => J(w, gb),
                title: u.previewFile
            }, 'function' == typeof G ? G(w) : G || k.createElement(h.default, null)) : null,
            gb = ('picture-card' === v || 'picture-circle' === v) && 'uploading' !== P && k.createElement('span', {
            ...
            ib = hb(),
            jb = k.createElement('div', {
                className: Z
            }, V, eb, gb, R && k.createElement(j.default, {
                motionName: `${ ib }-fade`,
                visible: 'uploading' === P,
                motionDeadline: 2000
            }, kb => {
                ...
                return k.createElement('div', {
                    className: b(i)(`${ r }-list-item-progress`, lb)
                }, mb);
            })),
            kb = w.response && 'string' == typeof w.response ? w.response : (null === (M = w.error) || void 0 === M ? void 0 : M.statusText) || (null === (N = w.error) || void 0 === N ? void 0 : N.message) || u.uploadError,
            lb = 'error' === P ? k.createElement(n.default, {
                title: kb,
                ...
                [`\n      ${ k }-wrapper${ k }-picture-card-wrapper,\n      ${ k }-wrapper${ k }-picture-circle-wrapper\n    `]: Object.assign(Object.assign({}, (0, g.clearFix)()), {
                    ...
                    [`${ o }${ o }-picture-card, ${ o }${ o }-picture-circle`]: {
                        ...
                        [`${ p }-uploading`]: {
                            ...
                            [`&::before, ${ l }-eye, ${ l }-download, ${ l }-delete`]: {
                                display: 'none'
                            }
                        },
                        [`${ p }-progress`]: {

                    ...
                    children: (0, h.jsx)(l.ResponsiveContainer, {
                        ...
                        children: (0, h.jsxs)(j.BarChart, {
                            ...
                            children: [
                                ...
                                (0, h.jsx)(m.Tooltip, {
                                    formatter: K => (0, q.numberWithCommas)(K) + '%'
                                }),
                                (0, h.jsx)(i.Bar, {
                                    dataKey: 'Percentage',
...
`));
    ...
    var _U = function(V) {
        ...
        function $() {
            ...
            for (var bb = arguments.length, cb = new Array(bb), db = 0; db < bb; db++)
                cb[db] = arguments[db];
            return (ab = Z.call.apply(Z, [this].concat(cb))).state = {
                isAnimationFinished: !1
            }, ab.id = (0, s.uniqueId)('recharts-bar-'), ab.handleAnimationEnd = function() {
        ...
        return cb = $, Y = [{
            ...
            },
            {
                ...
                value: function(eb) {
                    var fb = this,
                        gb = this.props.shape,
                        hb = (0, w.filterProps)(this.props);
                    return eb && eb.map(function(ib, jb) {
                        var kb = H(H(H({}, hb), ib), {}, {
                            index: jb
                        });
                        return ab(k).createElement(o.Layer, D({
                            className: 'recharts-bar-rectangle'
                        }, (0, w.adaptEventsOfChild)(fb.props, ib, jb), {
                            key: 'rectangle-'.concat(jb)
                        }), $.renderRectangle(gb, kb));
                    });
                }
            },
            {
                ...
                value: function() {
                    var eb = this,
                        ...
                        gb = fb.data,
                        hb = fb.layout,
                        ib = fb.isAnimationActive,
                        jb = fb.animationBegin,
                        kb = fb.animationDuration,
                        lb = fb.animationEasing,
                        mb = fb.animationId,
                        nb = this.state.prevData;
                    return ab(k).createElement(m.default, {
                        ...
                        var pb = ob.t,
                            qb = gb.map(function(rb, sb) {
                                var tb = nb && nb[sb];
                                if (tb) {
                                    var ub = (0, s.interpolateNumber)(tb.x, rb.x),
                                        vb = (0, s.interpolateNumber)(tb.y, rb.y),
                                        wb = (0, s.interpolateNumber)(tb.width, rb.width),
                                        xb = (0, s.interpolateNumber)(tb.height, rb.height);
                                    return H(H({}, rb), {}, {
                                        x: ub(pb),
                                        y: vb(pb),
                                        width: wb(pb),
            ...
            },
            {
                ...
                value: function() {
                    var eb = this.props,
                        fb = eb.data,
                        gb = eb.isAnimationActive,
                        hb = this.state.prevData;
            ...
            },
            {
                ...
                value: function() {
                    var eb = this,
                        fb = this.props.data,
                        gb = (0, w.filterProps)(this.props.background);
                    return fb.map(function(hb, ib) {
                        hb.value;
                        var jb = hb.background,
                            kb = y(hb, [
                                'value',
                                'background'
                            ]);
                        ...
                        var lb = H(H(H(H(H({}, kb), {}, {
                            fill: '#eee'
                        }, jb), gb), (0, w.adaptEventsOfChild)(eb.props, hb, ib)), {}, {
                            index: ib,
            ...
            },
            {
                ...
                value: function() {
                    ...
                    var eb = this.props,
                        ...
                        ib = eb.layout,
                        jb = eb.children,
                        kb = (0, t.findAllByType)(jb, p.ErrorBar.displayName);
                    if (!kb)
                        return null;
            ...
            },
            {
                ...
                value: function() {
                    var eb = this.props,
                        ...
                        mb = eb.width,
                        nb = eb.height,
                        ob = eb.isAnimationActive,
                        pb = eb.background,
                        qb = eb.id;
                    if (fb || !gb || !gb.length)
                        return null;
                    var rb = this.state.isAnimationFinished,
                        sb = ab(l)('recharts-bar', hb),
                        tb = ib && ib.allowDataOverflow || jb && jb.allowDataOverflow,
                        ub = ab(E)(qb) ? this.id : qb;
                    return ab(k).createElement(o.Layer, {
                        className: sb
                    }, tb ? ab(k).createElement('defs', null, ab(k).createElement('clipPath', {
                        id: 'clipPath-'.concat(ub)
                    }, ab(k).createElement('rect', {
                        x: kb,
                        y: lb,
                        width: mb,
                        height: nb
    ...
    _U.displayName = 'Bar', _U.defaultProps = {
        ...
        var ib = W.layout,
            ...
            mb = jb.minPointSize,
            nb = 'horizontal' === ib ? ab : $,
            ob = db ? nb.scale.domain() : null,
            pb = (0, v.getBaseValueOfBar)({
                numericAxis: nb
            }),
            qb = (0, t.findAllByType)(lb, q.Cell.displayName),
            rb = fb.map(function(sb, tb) {
        ...
        return W = T, (X = [{
                ...
                value: function(bb) {
                    ...
                    if (eb)
                        if (db) {
                            ...
                            var kb = {
                                style: fb ? _D({}, fb, this.props.to) : this.props.to
                            };
            ...
            },
            {
                ...
                value: function(bb) {
                    var cb = this,
                        ...
                        gb = bb.easing,
                        hb = bb.begin,
                        ib = bb.onAnimationEnd,
                        jb = bb.onAnimationStart,
                        kb = (0, cb.default)(db, eb, (0, bb.configEasing)(gb), fb, this.changeStyle);
                    this.manager.start([
                        jb,
                        hb,
                        function() {
            ...
            },
            {
                ...
                value: function(bb) {
                    ...
                    return this.manager.start([fb].concat(t(db.reduce(function(kb, lb, mb) {
                        ...
                        var nb = lb.duration,
                            ob = lb.easing,
                            pb = void 0 === ob ? 'ease' : ob,
                            qb = lb.style,
                            rb = lb.properties,
                            sb = lb.onAnimationEnd,
                            tb = mb > 0 ? db[mb - 1] : lb,
                            ub = rb || Object.keys(qb);
                        ...
                        var vb = (0, m.getTransitionVal)(ub, nb, pb),
                            wb = A(A(A({}, tb.style), qb), {}, {
                                transition: vb
                            });
                        return [].concat(t(kb), [
                            wb,
                ...
                value: function(bb) {
                    ...
                    if (this.unSubscribe = lb.subscribe(this.handleStyleChange), 'function' != typeof gb && 'function' != typeof kb && 'spring' !== gb)
                        if (jb.length > 1)
                            ...
                            var mb = eb ? _D({}, eb, fb) : fb,
                                nb = (0, m.getTransitionVal)(Object.keys(mb), db, gb);
                            lb.start([
                                hb,
                                cb,
                                A(A({}, mb), {}, {
            ...
            },
            {
                ...
                value: function() {
                    var bb = this.props,
                        cb = bb.children,
                        db = (bb.begin, bb.duration, bb.attributeName, bb.easing, bb.isActive),
                        eb = (bb.steps, bb.from, bb.to, bb.canBegin, bb.onAnimationEnd, bb.shouldReAnimate, bb.onAnimationReStart, o(bb, [
                            'children',
                            'begin',
                            'duration',
                            'attributeName',
                        ...
                        fb = Z.Children.count(cb),
                        gb = (0, m.translateStyle)(this.state.style);
                    if ('function' == typeof cb)
                        return cb(gb);
                    if (!db || 0 === fb)
                        return cb;
    ...
    e.exports,
        function(g) {
            ...
            var w = '_owner',
                x = Function.prototype.bind.call(Function.prototype.call, Object.prototype.hasOwnProperty);
            ...
            var O = K(),
                ...
                Q = K(q()),
                R = K(q(j));
            o.circularDeepEqual = Q, o.circularShallowEqual = R, o.createCustomEqual = K, o.deepEqual = O, o.sameValueZeroEqual = j, o.shallowEqual = P, Object.defineProperty(o, '__esModule', {
                value: !0
            });
        }(e.exports);
}), d.register('.....', function(e, f) {
    ...
    var v = function(w, x, y) {
        ...
        x = function e(y, z, A) {
            var B = (0, g.mapObject)(function(C, D) {
                if (w(D)) {
                    var E = p(y(D.from, D.to, D.velocity), 2),
                        F = E[0],
                        G = E[1];
                    return l(l({}, D), {}, {
                        from: F,
        ...
        _y = function(z, A, B, C, D) {
            var E, F, G = (0, g.getIntersectionKeys)(z, A),
                H = G.reduce(function(I, J) {
                    return l(l({}, I), {}, _o({}, J, [
                        z[J],
                        A[J]
                    ]));
                ...
                },
                {
                    ...
                    value: function() {
                        var T = this,
                            U = this.props,
                            V = U.children,
                            W = (U.appearOptions, U.enterOptions, U.leaveOptions, m(U, [
                                'children',
                                'appearOptions',
                                'enterOptions',
                                'leaveOptions'
    ...
    var v = function(w, x, y, z, A) {
            var B, C = Math.min(Math.abs(y) / 2, Math.abs(z) / 2),
                D = z >= 0 ? 1 : -1,
                E = y >= 0 ? 1 : -1,
                F = z >= 0 && y >= 0 || z < 0 && y < 0 ? 1 : 0;
                ...
                },
                {
                    ...
                    value: function() {
                        var I = this,
                            ...
                            O = J.radius,
                            P = J.className,
                            Q = this.state.totalLength,
                            R = this.props,
                            S = R.animationEasing,
                            T = R.animationDuration,
                            U = R.animationBegin,
        ...
        var v = u.offset,
            ...
            F = _t.map(function(G, H) {
                ...
                return a(u).createElement(h.Layer, j({
                    ...
                    return a(u).createElement('line', j({}, cb, {
                        key: 'line-'.concat(db)
                    }));
                }));
            });
        return a(u).createElement(h.Layer, {
    ...
    function _J(K) {
        ...
        return L && L.length ? a(l).createElement(n.Layer, {
            className: 'recharts-label-list'
        }, L.map(function(S, T) {
            var U = a(i)(N) ? M(S, T) : (0, p.getValueByDataKey)(S && S.payload, N),
                V = a(i)(P) ? {} : {
                    id: ''.concat(P, '-').concat(T)
                };
            return a(l).createElement(m.Label, v({}, (0, q.filterProps)(S, !0), R, V, {
                ...
                value: U,
                textBreakAll: Q,
                viewBox: m.Label.parseViewBox(a(i)(O) ? S : z(z({}, S), {}, {
                    clockWise: O
                })),
                key: 'label-'.concat(T)
            }));
    ...
    _J.displayName = 'LabelList', _J.renderCallByParent = function(S, T) {
        ...
        if (!S || !S.children && U && !S.label)
            return null;
        var V = S.children,
            W = (0, o.findAllByType)(V, _J.displayName).map(function(X, Y) {
    ...
    var C = function(D, E, F) {
        ...
        var X = (0, o.polarToCartesian)(N, O, U, G),
            Y = (0, o.polarToCartesian)(N, O, U, G + 359 * (H ? 1 : -1)),
            Z = 'M'.concat(X.x, ',').concat(X.y, '\n    A').concat(U, ',').concat(U, ',0,1,').concat(H ? 0 : 1, ',\n    ').concat(Y.x, ',').concat(Y.y),
            $ = a(i)(D.id) ? (0, n.uniqueId)('recharts-radial-line-') : D.id;
    ...
    function _D(E) {
        ...
        if (a(h)(_r)) {
            ...
            F = function(O) {
                var P = O.value,
                    Q = O.formatter,
                    R = a(i)(O.children) ? P : O.children;
                return a(h)(Q) ? Q(R) : R;
            }(E);
        var O = function(P) {
                return (0, n.isNumber)(P.cx);
            }(G),
            P = (0, p.filterProps)(E, !0);
        ...
        var Q = O ? function(R) {
            var S = R.viewBox,
                ...
                Y = V.innerRadius,
                Z = V.outerRadius,
                $ = (V.startAngle + V.endAngle) / 2;
            if ('outside' === U) {
                var ab = (0, o.polarToCartesian)(W, X, Z + T, $),
                    bb = ab.x;
                return {
                    x: bb,
                    y: ab.y,
            ...
            var cb = (Y + Z) / 2,
                db = (0, o.polarToCartesian)(W, X, cb, $);
            return {
                x: db.x,
                y: db.y,
                textAnchor: 'middle',
        ...
        return a(j).createElement(l.Text, B({
            className: a(k)('recharts-label', _A)
        }, P, Q, {
            breakAll: _D
        }), F);
    }
    _D.displayName = 'Label', _D.defaultProps = {
        offset: 5
    };
    var Q = function(R) {
            var S = R.cx,
    ...
    _D.parseViewBox = Q, _D.renderCallByParent = function(S, T) {
        ...
        var V = S.children,
            W = Q(S),
            X = (0, I.findAllByType)(V, _D.displayName).map(function(Y, Z) {
    ...
    var P = /[ \f\n\r\t\v\u2028\u2029]+/,
        ...
        R = function(S) {
            return [{
                words: a(w)(S) ? [] : S.toString().split(P)
            }];
        },
        S = function(T, U) {
            if ((T.width || T.scaleToFit) && !l.Global.isSsr && U) {
                ...
                return V ? function(W, X, Y, Z, $) {
                    var ab = (0, k.isNumber)(W.maxLines),
                        bb = W.children,
                        cb = function() {
                    ...
                    for (var eb, fb = function(gb) {
                            var hb = bb.slice(0, gb),
                                ib = Q(L(L({}, W), {}, {
                                    children: hb + '\u2026'
                                })).wordsWithComputedWidth,
                                jb = cb(ib),
                                kb = jb.length > W.maxLines || function(lb) {
            ...
            return bb = Z, X = [{
                ...
                value: function() {
                    ...
                    if (!(0, k.isNumOrStr)(ob.x) || !(0, k.isNumOrStr)(ob.y))
                        return null;
                    var qb, rb = ob.x + ((0, k.isNumber)(eb) ? eb : 0),
                        sb = ob.y + ((0, k.isNumber)(fb) ? fb : 0);
                    switch (hb) {
                        case 'start':
                            qb = $(i)('calc('.concat(lb, ')'));
                            break;
        ...
        var t = {
            ...
            parse: function(u) {
                var v, w = this,
                    ...
                    B = 0,
                    C = 0,
                    D = (this.TERROR, this.EOF),
                    E = (this.options.errorRecoveryTokenDiscardCount, [
                        0,
                        54
                    ]);
                ...
                try {
                    ...
                    for (z[B] = null, y[B] = 0, x[B] = 0, ++B, this.pre_parse && this.pre_parse.call(this, F), F.pre_parse && F.pre_parse.call(this, F), _P = y[B - 1];;) {
                        if (_I = _P, this.defaultActions[_I])
                            ...
                            var T, U = this.describeSymbol(C) || C,
                                V = this.collect_expected_token_set(_I);
        ...
        var u = function() {
            ...
            var y = {
                ...
                yyerror: function(z) {
                    ...
                    var B = this.constructLexErrorInfo('Lexical error' + A + ': ' + z, this.options.lexerErrorsAreRecoverable),
                ...
                showPosition: function(z, A) {
                    var B = this.pastInput(z).replace(/\s/g, ' '),
                        C = new Array(B.length + 1).join('-');
                ...
                prettyPrintRange: function(z, A, B) {
                    ...
                    var C = (this.matched + this._input).split('\n'),
                        D = Math.max(1, A ? A.first_line : z.first_line - 3),
                        E = Math.max(1, B ? B.last_line : z.last_line + 1),
                        F = 1 + Math.log10(1 | E) | 0,
                        G = new Array(F).join(' '),
                        H = [],
                        I = C.slice(D - 1, E + 1).map(function(J, K) {
                            var L = K + D,
                                M = (G + L).substr(-F) + ': ' + J,
                                N = new Array(F + 1).join('^'),
                                O = 3,
                                P = 0;
    ...
    var w = function(x) {
        ...
        _y = function(z) {
            var A = z.ownerDocument.documentElement,
                B = {
                    top: 0,
                    left: 0
                };
    ...
    var _T = function(U) {
            var V, W = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
                X = arguments.length > 2 ? arguments[2] : void 0,
                Y = arguments.length > 3 ? arguments[3] : void 0,
                Z = -1,
                $ = null !== (V = null == W ? void 0 : W.length) && void 0 !== V ? V : 0;
            if ($ > 1) {
                if (Y && 'angleAxis' === Y.axisType && Math.abs(Math.abs(Y.range[1] - Y.range[0]) - 360) <= 0.000001)
                    for (var ab = Y.range, bb = 0; bb < $; bb++) {
                        var cb = bb > 0 ? X[bb - 1].coordinate : X[$ - 1].coordinate,
                            db = X[bb].coordinate,
                            eb = bb >= $ - 1 ? X[0].coordinate : X[bb + 1].coordinate,
                            fb = void 0;
            ...
            for (var ab = {}, bb = Object.keys($), cb = 0, db = bb.length; cb < db; cb++)
                for (var eb = $[bb[cb]].stackGroups, fb = Object.keys(eb), gb = 0, hb = fb.length; gb < hb; gb++) {
                    var ib = eb[fb[gb]],
                        jb = ib.items,
                        kb = ib.cateAxisId,
                        lb = jb.filter(function(mb) {
                            return (0, C.getDisplayName)(mb.type).indexOf('Bar') >= 0;
                        });
                    if (lb && lb.length) {
                        var mb = lb[0].props.barSize,
                            nb = lb[0].props[kb];
        ...
        Z = function($, ab, bb, cb, db) {
            var eb = ab.props.children,
                fb = (0, C.findAllByType)(eb, 'ErrorBar').filter(function(gb) {
                ...
                return $.reduce(function(hb, ib) {
                    var jb = _P(ib, bb, 0),
                        ...
                        lb = gb.reduce(function(mb, nb) {
                            var ob = _P(ib, nb, 0),
                                pb = kb[0] - Math.abs(a(l)(ob) ? ob[0] : ob),
                                qb = kb[1] + Math.abs(a(l)(ob) ? ob[1] : ob);
                            return [
                                Math.min(pb, mb[0]),
                                Math.max(qb, mb[1])
                            ];
        ...
        _db = function(eb, fb, gb) {
            if (!eb)
                return null;
            var hb = eb.scale,
                ib = eb.duplicateDomain,
                jb = eb.type,
                kb = eb.range,
                lb = 'scaleBand' === eb.realScaleType ? hb.bandwidth() / 2 : 2,
                mb = (fb || gb) && 'category' === jb && hb.bandwidth ? hb.bandwidth() / lb : 0;
        ...
        _hb = function(ib) {
            ...
            if (jb && !(jb.length <= 2)) {
                var kb = jb.length,
                    lb = ib.range(),
                    mb = Math.min(lb[0], lb[1]) - gb,
                    nb = Math.max(lb[0], lb[1]) + gb,
                    ob = ib(jb[0]),
                    pb = ib(jb[kb - 1]);
        ...
        _jb = function(kb, lb) {
            if (!lb || 2 !== lb.length || !(0, A.isNumber)(lb[0]) || !(0, A.isNumber)(lb[1]))
                return kb;
            var mb = Math.min(lb[0], lb[1]),
                nb = Math.max(lb[0], lb[1]),
                ob = [
                    kb[0],
                    kb[1]
                ];
        ...
        _nb = function(ob, pb) {
            var qb = pb.realScaleType,
                rb = pb.type,
                sb = pb.tickCount,
                tb = pb.originalDomain,
                ub = pb.allowDecimals,
                vb = qb || pb.scale;
            ...
            if (sb && 'number' === rb) {
                var yb = ob.domain();
                return {
                    niceTicks: (0, s.getTickValuesFixedDomain)(yb, sb, ub)
                };
            }
            return null;
        },
        ...
        _pb = function(qb) {
            var rb = qb.numericAxis,
                sb = rb.scale.domain();
            if ('number' === rb.type) {
                var tb = Math.min(sb[0], sb[1]),
                    ub = Math.max(sb[0], sb[1]);
        ...
        sb = /^dataMin[\s]*-[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/,
        tb = /^dataMax[\s]*\+[\s]*([0-9]+([.]{1}[0-9]+){0,1})$/,
        _ub = function(vb, wb, xb) {
            if (a(p)(vb))
                return vb(wb, xb);
            if (!a(l)(vb))
                return wb;
    ...
    function w(x, y, z) {
        if (x.lte(0))
            return new(a(w))(0);
        var A = i.default.getDigitCount(x.toNumber()),
            B = new(a(w))(10).pow(A),
            C = x.div(B),
            D = 1 !== A ? 0.05 : 0.1,
            E = new(a(w))(Math.ceil(j.div(k).toNumber())).add(z).mul(k).mul(B);
    ...
    function H(I, J, K, L) {
        ...
        var P = Math.ceil(N.sub(I).div(j).toNumber()),
            Q = Math.ceil(new(a(w))(J).sub(N).div(j).toNumber()),
            R = k + _l + 1;
    ...
    var _O = (0, M.memoize)(function(P) {
            ...
            var ab = H(Y, Z, V, U),
                ...
                cb = ab.tickMin,
                db = ab.tickMax,
                eb = N.default.rangeStep(cb, db.add(new(a(w))(0.1).mul(bb)), bb);
        ...
        _P = ((0, M.memoize)(function(Q) {
            ...
            if (Z === $)
                return C(Z, U, V);
            var ab = w(new(a(w))($).sub(Z).div(W - 1), V, 0),
                bb = (0, M.compose)((0, M.map)(function(cb) {
                    return new(a(w))(Z).add(new(a(w))(cb).mul(ab)).toNumber();
                }), M.range),
                cb = bb(0, W).filter(function(db) {
                    return db >= Z && db <= $;
                });
            ...
            if (Y === Z)
                return [Y];
            var $ = Math.max(R, 2),
                ab = w(new(a(w))(Z).sub(Y).div($ - 1), V, 0),
                bb = [].concat(j(N.default.rangeStep(new(a(w))(Y), new(a(w))(Z).sub(new(a(w))(0.99).mul(ab)), ab)), [Z]);
    ...
    ! function(g) {
        ...
        var _O = function() {
            ...
            return function(Y, Z, $, ab) {
                var bb, cb, db, eb, fb, gb, hb, ib, jb, kb, lb, mb, nb, ob, pb, qb, rb, sb, tb = Y.constructor,
                    ub = Y.s == Z.s ? 1 : -1,
                    vb = Y.d,
                    wb = Z.d;
                if (!Y.s)
        ...
        function _eb(fb, gb) {
            var hb, ib, jb, kb, lb, mb, nb, ob, pb, qb = 1,
                rb = fb,
                sb = rb.d,
                tb = rb.constructor,
                ub = G.precision;
        ...
        function _Hb(Ib, Jb) {
            var Kb, Lb, Mb, Nb, Ob, Pb, Qb, Rb, Sb, Tb, Ub = Ib.constructor,
                Vb = Ub.precision;
            if (!Ib.s || !Jb.s)
    ...
    function _p(q, r, s) {
        var t = (r - q) / Math.max(0, s),
            u = Math.floor(Math.log(_j) / Math.LN10),
            v = _j / Math.pow(10, _p);
        return _p >= 0 ? (v >= n ? 10 : v >= o ? 5 : v >= p ? 2 : 1) * Math.pow(10, _p) : -Math.pow(10, -_p) / (v >= n ? 10 : v >= o ? 5 : v >= p ? 2 : 1);
    }

    function t(u, v, w) {
        var x = Math.abs(v - u) / Math.max(0, w),
            y = Math.pow(10, Math.floor(Math.log(_j) / Math.LN10)),
            z = _j / _p;
    ...
    function u(v, w, x) {
        var y = Math.min(v.length, w.length) - 1,
            z = new Array(y),
            A = new Array(y),
            B = -1;
    ...
    (0, P.default)(h, _x, {
        ...
        rgb: function() {
            var V = this.h % 360 + 360 * (this.h < 0),
                W = isNaN(V) || isNaN(this.s) ? 0 : this.s,
                X = this.l,
                Y = X + (X < 0.5 ? X : 1 - X) * W,
                Z = 2 * X - Y;
    ...
    function j(k) {
        var l = k.length - 1;
        return function(m) {
            var n = m <= 0 ? m = 0 : m >= 1 ? (m = 1, l - 1) : Math.floor(m * l),
                o = k[n],
                p = k[n + 1],
                q = n > 0 ? k[n - 1] : 2 * o - p,
                r = n < l - 1 ? k[n + 2] : 2 * p - o;
    ...
    function _q(r) {
        ...
        function A(B) {
            ...
            function Q(R) {
                ...
                I && !G && (R = s(R, 1 / 0));
                var Y = V.length + R.length + W.length,
                    Z = Q < A ? new Array(A - Q + 1).join(C) : '';
        ...
        return {
            ...
            formatPrefix: function(X, Y) {
                var Z = A(((X = (0, U.default)(X)).type = 'f', X)),
                    $ = 3 * Math.max(-8, Math.min(8, Math.floor((0, C.default)(Y) / 3))),
                    ab = Math.pow(10, -$),
                    bb = p[8 + $ / 3];
                return function(cb) {
                    return Z(ab * cb) + bb;
    ...
    function g(h) {
        t: for (var i, j = h.length, k = 1, l = -1; g < j; ++g)
            switch (h[g]) {
                case '.':
                    l = i = g;
                    break;
    ...
    function _i(j, k) {
        ...
        var m = l[0],
            n = l[1],
            o = _i - (_g = 3 * Math.max(-8, Math.min(8, Math.floor(_i / 3)))) + 1,
            p = m.length;
    ...
    var g = d('.....'),
        h = d('.....'),
        i = (0, g.default)(j => j.setHours(0, 0, 0, 0), (j, k) => j.setDate(j.getDate() + k), (j, k) => (k - j - (k.getTimezoneOffset() - j.getTimezoneOffset()) * h.durationMinute) / h.durationDay, j => j.getDate() - 1),
        _j = i;
    i.range;
}), d.register('.....', function(e, f) {
    b(e.exports, 'default', function() {
    ...
    function x(y, z, A, B, C, D) {
        ...
        return [
            function(I, J, K) {
                ...
                const O = K && 'function' == typeof K.range ? K : F(M, N, K),
                    P = O ? O.range(M, +N + 1) : [];
    ...
    function _n() {
        ...
        function s(t) {
            var u, v, w = Array.from(o.apply(this, arguments), l),
                x = k.length,
                y = -1;
            for (const z of t)
                for (u = 0, ++y; u < s; ++u)
    ...
    var _J = function(K) {
        ...
        return S = P, N = [{
            ...
            value: function(U, V) {
                ...
                return 'vertical' === W && (0, k.isNumber)(U.props.height) ? {
                    height: U.props.height
                } : 'horizontal' === W ? {
                    width: U.props.width || V
                } : null;
            }
        }], (T = [{
                key: 'componentDidMount',
            ...
            },
            {
                ...
                value: function(U) {
                    var V, W, X = this.props,
                        ...
                        bb = X.chartWidth,
                        cb = X.chartHeight;
                    return U && (void 0 !== U.left && null !== U.left || void 0 !== U.right && null !== U.right) || (V = 'center' === Z && 'vertical' === Y ? {
                        left: ((bb || 0) - (this.getBBoxSnapshot() || {
                            width: 0
                        }).width) / 2
                    } : 'right' === Z ? {
                        right: ab && ab.right || 0
                        ...
                        left: ab && ab.left || 0
                    }), U && (void 0 !== U.top && null !== U.top || void 0 !== U.bottom && null !== U.bottom) || (W = 'middle' === $ ? {
                        top: ((cb || 0) - (this.getBBoxSnapshot() || {
                            height: 0
                        }).height) / 2
                    } : 'bottom' === $ ? {
                        bottom: ab && ab.bottom || 0
                    } : {
                        top: ab && ab.top || 0
                    }), p(p({}, V), W);
                }
    ...
    var A = 32,
        _B = function(C) {
            ...
            return D = H, E = [{
                    key: 'renderIcon',
                    value: function(I) {
                        var J = this.props.inactiveColor,
                            K = 16,
                            L = 5.333333333333333,
                            M = 10.666666666666666,
                            N = I.inactive ? J : I.color;
                        if ('plainline' === I.type)
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        return K.map(function(S, T) {
                            var U, V = S.formatter || N,
                                W = a(h)((q(U = {
                                    'recharts-legend-item': !0
                                }, 'legend-item-'.concat(T), !0), q(U, 'inactive', S.inactive), U));
                            if ('none' === S.type)
                                return null;
            ...
            return H = L, (I = [{
                    ...
                    value: function() {
                        var M = this.props,
                            ...
                            R = (0, i.default)().type(Q).size(function(S, T, U) {
                                if ('area' === T)
                                    return S;
                                switch (U) {
                                    case 'cross':
    ...
    var pb = {
        ...
        rb = Number.isFinite ? Number.isFinite : isFinite,
        sb = 'function' == typeof requestAnimationFrame ? requestAnimationFrame : 'function' == typeof setImmediate ? setImmediate : setTimeout,
        tb = 'function' == typeof cancelAnimationFrame ? cancelAnimationFrame : 'function' == typeof clearImmediate ? clearImmediate : clearTimeout,
        ub = function(vb, wb, xb) {
            var yb = wb.graphicalItems,
                zb = wb.dataStartIndex,
                Ab = wb.dataEndIndex,
                Bb = (yb || []).reduce(function(Cb, Db) {
        ...
        wb = function(xb, yb, zb, Ab) {
            var Bb = Ab || {
                ...
                Db = xb.orderedTooltipTicks,
                Eb = xb.tooltipAxis,
                Fb = xb.tooltipTicks,
                Gb = (0, G.calculateActiveTickIndex)(Cb, Db, Fb, Eb);
            if (Gb >= 0 && Fb) {
                var Hb = Fb[Gb] && Fb[Gb].value,
                    Ib = vb(xb, yb, Gb, Hb),
                    Jb = function(Kb, Lb, Mb, Nb) {
        ...
        xb = function(yb, zb) {
            var Ab = zb.axisType,
                Bb = void 0 === Ab ? 'xAxis' : Ab,
                Cb = zb.AxisComp,
                Db = zb.graphicalItems,
                Eb = zb.stackGroups,
                Fb = zb.dataStartIndex,
                Gb = zb.dataEndIndex,
                Hb = yb.children,
                Ib = ''.concat(Bb, 'Id'),
                Jb = (0, B.findAllByType)(Hb, Cb),
                Kb = {};
            return Jb && Jb.length ? Kb = function(Lb, Mb) {
                var Nb = Mb.axes,
                    Ob = Mb.graphicalItems,
                    Pb = Mb.axisType,
                    Qb = Mb.axisIdKey,
                    Rb = Mb.stackGroups,
                    Sb = Mb.dataStartIndex,
                    Tb = Mb.dataEndIndex,
                    Ub = Lb.layout,
                    Vb = Lb.children,
                    Wb = Lb.stackOffset,
                    Xb = (0, G.isCategoricalAxis)(Ub, Pb);
                return Nb.reduce(function(Yb, Zb) {
                    var $b = Zb.props,
                        ac = $b.type,
                        bc = $b.dataKey,
                        cc = $b.allowDataOverflow,
                        dc = $b.allowDuplicatedCategory,
                        ec = $b.scale,
                        fc = $b.ticks,
                        gc = Zb.props[Qb],
                        hc = ub(Lb.data, {
                ...
                var Nb = Mb.graphicalItems,
                    ...
                    Xb = Wb.length,
                    Yb = (0, G.isCategoricalAxis)(Ub, Pb),
                    Zb = -1;
                return Nb.reduce(function($b, ac) {
                    ...
                    }), 'number', Ub), Ob.defaultProps.allowDataOverflow), bc = (0, H.detectReferenceElementsDomain)(Vb, bc, cc, Pb)), lb(lb({}, $b), {}, _ob({}, cc, lb(lb({
                        axisType: Pb
                    }, Ob.defaultProps), {}, {
                        hide: !0,
        ...
        yb = function(zb) {
            var Ab = zb.children,
                Bb = zb.defaultShowTooltip,
                Cb = (0, B.findChildByType)(Ab, D.Brush.displayName);
            return {
                chartX: 0,
                chartY: 0,
        ...
        _Ab = function(Bb) {
            var Cb, Db, Eb = Bb.chartName,
                Fb = Bb.GraphicalChild,
                Gb = Bb.defaultTooltipEventType,
                Hb = void 0 === Gb ? 'axis' : Gb,
                Ib = Bb.validateTooltipEventTypes,
                Jb = void 0 === Ib ? ['axis'] : Ib,
                Kb = Bb.axisComponents,
                Lb = Bb.legendContent,
                Mb = Bb.formatAxisMap,
                Nb = Bb.defaultProps,
                Ob = function(Pb, Qb) {
                    var Rb = Qb.graphicalItems,
                        Sb = Qb.stackGroups,
                        Tb = Qb.offset,
                        Ub = Qb.updateId,
                        Vb = Qb.dataStartIndex,
                        Wb = Qb.dataEndIndex,
                        Xb = Pb.barSize,
                        Yb = Pb.layout,
                        Zb = Pb.barGap,
                    ...
                    return Rb.forEach(function(hc, ic) {
                        var jc = ub(Pb.data, {
                            ...
                            lc = kc.dataKey,
                            mc = kc.maxBarSize,
                            nc = hc.props[''.concat(cc, 'Id')],
                            oc = hc.props[''.concat(dc, 'Id')],
                            pc = Kb.reduce(function(qc, rc) {
                                var sc, tc = Qb[''.concat(rc.axisType, 'Map')],
                                    uc = hc.props[''.concat(rc.axisType, 'Id')],
                                    vc = tc && tc[uc];
                                return lb(lb({}, qc), {}, (_ob(sc = {}, rc.axisType, vc), _ob(sc, ''.concat(rc.axisType, 'Ticks'), (0, G.getTicksOfAxis)(vc)), sc));
                            }, {}),
                            qc = pc[dc],
                            rc = pc[''.concat(dc, 'Ticks')],
                            sc = Sb && Sb[nc] && Sb[nc].hasStack && (0, G.getStackedDataOfItem)(hc, Sb[nc].stackGroups),
                            tc = (0, B.getDisplayName)(hc.type).indexOf('Bar') >= 0,
                            uc = (0, G.getBandSizeOfAxis)(qc, rc),
                            vc = [];
                        if (tc) {
                            var wc, xc, yc = a(n)(mc) ? ac : mc,
                                zc = null !== (wc = null !== (xc = (0, G.getBandSizeOfAxis)(qc, rc, !0)) && void 0 !== xc ? xc : yc) && void 0 !== wc ? wc : 0;
                            vc = (0, G.getBarPosition)({
                                ...
                                return lb(lb({}, Ac), {}, {
                                    position: lb(lb({}, Ac.position), {}, {
                                        offset: Ac.position.offset - zc / 2
                                    })
                                });
                            }));
                        }
                        ...
                        Bc && gc.push({
                            props: lb(lb({}, Bc(lb(lb({}, pc), {}, {
                                ...
                                key: hc.key || 'item-'.concat(ic)
                            }, _ob(Ac, cc, pc[cc]), _ob(Ac, dc, pc[dc]), _ob(Ac, 'animationId', Ub), Ac)),
                ...
                Pb = function(Qb, Rb) {
                    ...
                    var Wb = Sb.children,
                        ...
                        Yb = Sb.stackOffset,
                        Zb = Sb.data,
                        $b = Sb.reverseStackOrder,
                        ac = zb(Xb),
                        bc = ac.numericAxisName,
                        cc = ac.cateAxisName,
                        dc = (0, B.findAllByType)(Wb, Fb),
                        ec = (0, G.getStackGroupsByAxisId)(Zb, dc, ''.concat(bc, 'Id'), ''.concat(cc, 'Id'), Yb, $b),
                        fc = Kb.reduce(function(gc, hc) {
                        ...
                        gc = function(hc, ic) {
                            var jc = hc.props,
                                ...
                                rc = jc.children,
                                sc = jc.margin || {},
                                tc = (0, B.findChildByType)(rc, D.Brush.displayName),
                                uc = (0, B.findChildByType)(rc, v.Legend.displayName),
                                vc = Object.keys(oc).reduce(function(wc, xc) {
                                    var yc = oc[xc],
                                        zc = yc.orientation;
                                ...
                                xc = lb(lb({}, wc), vc),
                                yc = xc.bottom;
                            return tc && (xc.bottom += tc.props.height || D.Brush.defaultProps.height), uc && ic && (xc = (0, G.appendOffsetOfLegend)(xc, kc, jc, ic)), lb(lb({
                                brushBottom: yc
                            }, xc), {}, {
                    ...
                    var hc, ic, jc, kc = fc[''.concat(cc, 'Map')],
                        lc = (hc = kc, ic = (0, F.getAnyElementOfObject)(hc), {
            ...
            return Db = Cb = function(Qb) {
                ...
                function Vb(Wb) {
                    ...
                    return function(Yb, Zb) {
                        ...
                        var Zb = Xb.props.onMouseEnter,
                            $b = Xb.getMouseInfo(Yb);
                        if ($b) {
                            var ac = lb(lb({}, $b), {}, {
                                isTooltipActive: !0
                            });
                        ...
                        var Zb = Xb.state,
                            $b = Zb.isTooltipActive,
                            ac = Zb.activeCoordinate,
                            bc = Zb.activePayload,
                            cc = Zb.offset,
                            dc = Zb.activeTooltipIndex,
                            ec = Xb.getTooltipEventType();
                        if (!Yb || !Yb.props.cursor || !$b || !ac || 'ScatterChart' !== Eb && 'axis' !== ec)
                            return null;
                        var fc, gc = Xb.props.layout,
                            hc = w.Curve;
                        if ('ScatterChart' === Eb)
                            fc = ac, hc = x.Cross;
                        else if ('BarChart' === Eb)
                            ...
                            fc = {
                                points: Xb.getCursorPoints()
                            }, hc = w.Curve;
                        var mc = Yb.key || '_recharts-cursor',
                            nc = lb(lb(lb(lb({
                                stroke: '#ccc',
                                pointerEvents: 'none'
                        ...
                        var ac = a(l)(Yb, 'type.axisType'),
                            bc = a(l)(Xb.state, ''.concat(ac, 'Map'))[Yb.props[''.concat(ac, 'Id')]];
                        ...
                        var Zb = Xb.state,
                            ...
                            dc = cc.width,
                            ec = cc.height,
                            fc = (0, F.getAnyElementOfObject)($b),
                            gc = a(h)(ac, function(hc) {
                                return a(V)(hc.domain, rb);
                            }) || (0, F.getAnyElementOfObject)(ac),
                            hc = Yb.props || {};
                        ...
                        var Zb = Yb.props,
                            ...
                            dc = cc.radiusAxisMap,
                            ec = cc.angleAxisMap,
                            fc = (0, F.getAnyElementOfObject)(dc),
                            gc = (0, F.getAnyElementOfObject)(ec),
                            hc = gc.cx,
                            ic = gc.cy,
                            jc = gc.innerRadius,
                            kc = gc.outerRadius;
                        ...
                        var Yb = Xb.state.formattedGraphicalItems,
                            Zb = Xb.props,
                            $b = Zb.children,
                            ac = Zb.width,
                            bc = Zb.height,
                            cc = Xb.props.margin || {},
                            dc = ac - (cc.left || 0) - (cc.right || 0),
                            ec = (0, G.getLegendProps)({
                                children: $b,
                        ...
                        var Yb = Xb.props.children,
                            Zb = (0, B.findChildByType)(Yb, u.Tooltip.displayName);
                        if (!Zb)
                            return null;
                        var $b = Xb.state,
                            ac = $b.isTooltipActive,
                            bc = $b.activeCoordinate,
                            cc = $b.activePayload,
                            dc = $b.activeLabel,
                            ec = $b.offset;
                        ...
                        if (!ac)
                            return null;
                        var bc = Xb.getTooltipEventType(),
                            cc = Xb.state,
                            dc = cc.isTooltipActive,
                            ec = cc.tooltipAxis,
                            fc = cc.activeTooltipIndex,
                            gc = cc.activeLabel,
                            hc = Xb.props.children,
                            ic = (0, B.findChildByType)(hc, u.Tooltip.displayName),
                            jc = ac.props,
                            kc = jc.points,
                            lc = jc.isRange,
                            mc = jc.baseLine,
                            nc = ac.item.props,
                            oc = nc.activeDot,
                            pc = !nc.hide && dc && ic && oc && fc >= 0,
                            qc = {};
                        'axis' !== bc && ic && 'click' === ic.props.trigger ? qc = {
                            onClick: (0, G.combineEventHandlers)(Xb.handleItemMouseEnter, null, Yb.props.onCLick)
                        } : 'axis' !== bc && (qc = {
                        ...
                        return (0, q.cloneElement)(Yb, lb(lb({
                            key: 'recharts-customized-'.concat($b)
                        }, Xb.props), Xb.state));
                ...
                return Xb = Vb, (Sb = [{
                    ...
                    },
                    {
                        ...
                        value: function(Xb) {
                            if (!this.container)
                                return null;
                            var Yb = (0, E.getOffset)(this.container),
                                Zb = (0, E.calculateChartCoordinate)(Xb, Yb),
                                $b = this.inRange(Zb.chartX, Zb.chartY);
                            if (!$b)
                                return null;
                            var ac = this.state,
                                bc = ac.xAxisMap,
                            ...
                            if ('axis' !== this.getTooltipEventType() && bc && cc) {
                                var dc = (0, F.getAnyElementOfObject)(bc).scale,
                                    ec = (0, F.getAnyElementOfObject)(cc).scale,
                                    fc = dc && dc.invert ? dc.invert(Zb.chartX) : null,
                                    gc = ec && ec.invert ? ec.invert(Zb.chartY) : null;
                                return lb(lb({}, Zb), {}, {
                                    xValue: fc,
                                    yValue: gc
                                });
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var Xb = this.props.layout,
                                Yb = this.state,
                                Zb = Yb.activeCoordinate,
                                $b = Yb.offset,
                                ac = Yb.tooltipAxisBandSize,
                                bc = ac / 2;
                            return {
                                stroke: 'none',
                                fill: '#ccc',
                    ...
                    },
                    {
                        key: 'getCursorPoints',
                        value: function() {
                            var Xb, Yb, Zb, $b, ac = this.props.layout,
                                bc = this.state,
                                cc = bc.activeCoordinate,
                                dc = bc.offset;
                            if ('horizontal' === ac)
                                ...
                                var jc = cc.cx,
                                    ...
                                    mc = cc.outerRadius,
                                    nc = cc.angle,
                                    oc = (0, I.polarToCartesian)(jc, kc, lc, nc),
                                    pc = (0, I.polarToCartesian)(jc, kc, mc, nc);
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var Xb = this.props.children,
                                Yb = this.getTooltipEventType(),
                                Zb = (0, B.findChildByType)(Xb, u.Tooltip.displayName),
                                $b = {};
                            return Zb && 'axis' === Yb && ($b = 'click' === Zb.props.trigger ? {
                    ...
                    },
                    {
                        ...
                        value: function(Xb) {
                            var Yb = this.props,
                                Zb = Yb.layout,
                                $b = Yb.syncMethod,
                                ac = this.state.updateId,
                                bc = Xb.dataStartIndex,
                                cc = Xb.dataEndIndex;
                            if (a(n)(Xb.dataStartIndex) && a(n)(Xb.dataEndIndex))
                                if (a(n)(Xb.activeTooltipIndex))
                                    ...
                                    var kc = lb(lb({}, hc), {}, {
                                        ...
                                        lc = Math.min(dc, kc.x + kc.width),
                                        mc = Math.min(ec, kc.y + kc.height),
                                        nc = ic[fc] && ic[fc].value,
                                        oc = vb(this.state, this.props.data, fc),
                                        pc = ic[fc] ? {
                    ...
                    },
                    {
                        key: 'renderClipPath',
                        value: function() {
                            var Xb = this.clipPathId,
                                Yb = this.state.offset,
                                Zb = Yb.left,
                                $b = Yb.top,
                                ac = Yb.height,
                                bc = Yb.width;
                ...
                if (Sb !== Rb.prevData || Ub !== Rb.prevWidth || Vb !== Rb.prevHeight || Wb !== Rb.prevLayout || Xb !== Rb.prevStackOffset || !(0, J.shallowEqual)(Yb, Rb.prevMargin)) {
                    var $b = yb(Qb),
                        ...
                        bc = lb(lb({}, wb(Rb, Sb, Wb)), {}, {
                            updateId: Rb.updateId + 1
                        }),
                        cc = lb(lb(lb({}, $b), ac), bc);
                    return lb(lb(lb({}, cc), Pb(lb({
                        props: Qb
                    }, cc), Rb)), {}, {
                        prevData: Sb,
                        prevWidth: Ub,
    ...
    var _I = function(J) {
        ...
        function O() {
            ...
            return (P = N.call.apply(N, [this].concat(R))).state = {
                ...
                var U = T.key,
                    V = T.tooltipDimension,
                    W = T.viewBoxDimension,
                    X = P.props,
                    Y = X.allowEscapeViewBox,
                    Z = X.coordinate,
                    $ = X.offset,
                    ab = X.position,
                    bb = X.viewBox;
            ...
            },
            {
                ...
                value: function() {
                    var T, U, V, W = this,
                        X = this.props,
                        Y = X.payload,
                        Z = X.isAnimationActive,
                        $ = X.animationDuration,
                        ab = X.animationEasing,
                        bb = X.filterNull,
                        cb = function(db, eb) {
                    ...
                    lb = t(t({}, (0, k.translateStyle)({
                        transform: this.props.useTranslate3d ? 'translate3d('.concat(U, 'px, ').concat(V, 'px, 0)') : 'translate('.concat(U, 'px, ').concat(V, 'px)')
                    })), lb), Z && jb && (lb = t(t({}, (0, k.translateStyle)({
                        transition: 'transform '.concat($, 'ms ').concat(ab)
                    })), lb));
                    ...
                    if (Q && Q.length) {
                        var V = (U ? a(h)(Q, U) : Q).map(function(W, X) {
                            ...
                            return a(j).createElement('li', {
                                ...
                                style: Y
                            }, (0, l.isNumOrStr)(ab) ? a(j).createElement('span', {
                                className: 'recharts-tooltip-item-name'
                            }, ab) : null, (0, l.isNumOrStr)(ab) ? a(j).createElement('span', {
                                className: 'recharts-tooltip-item-separator'
                            }, R) : null, a(j).createElement('span', {
            ...
            },
            {
                ...
                value: function() {
                    var P = this.props,
                        ...
                        Z = !a(g)(U),
                        $ = Z ? U : '',
                        ab = a(k)('recharts-default-tooltip', Q),
                        bb = a(k)('recharts-tooltip-label', S);
    ...
    var w = function(x) {
            var y = x.cx,
                ...
                D = x.isExternal,
                E = x.cornerRadius,
                F = x.cornerIsExternal,
                G = E * (D ? 1 : -1) + A,
                H = Math.asin(E / G) / j.RADIAN,
                I = F ? B : B + C * H,
                J = F ? B - C * H : B;
            return {
        ...
        x = function(y) {
            var z = y.cx,
                ...
                F = D + E,
                G = (0, j.polarToCartesian)(z, A, C, D),
                H = (0, j.polarToCartesian)(z, A, C, F),
                I = 'M '.concat(G.x, ',').concat(G.y, '\n    A ').concat(C, ',').concat(C, ',0,\n    ').concat(+(Math.abs(E) > 180), ',').concat(+(D > F), ',\n    ').concat(H.x, ',').concat(H.y, '\n  ');
            if (B > 0) {
                var J = (0, j.polarToCartesian)(z, A, B, D),
                    K = (0, j.polarToCartesian)(z, A, B, F);
            ...
            return A = E, (B = [{
                ...
                value: function() {
                    var F = this.props,
                        ...
                        J = F.outerRadius,
                        K = F.cornerRadius,
                        L = F.forceCornerRadius,
                        M = F.cornerIsExternal,
                        N = F.startAngle,
                        O = F.endAngle,
                        P = F.className;
                    if (J < I || N === O)
                        return null;
                    var Q, R = a(h)('recharts-sector', P),
                        S = J - I,
                        T = (0, k.getPercentValue)(K, S, 0, !0);
                    return Q = T > 0 && Math.abs(N - O) < 360 ? function(U) {
                        var V = U.cx,
                            ...
                            Z = U.cornerRadius,
                            $ = U.forceCornerRadius,
                            ab = U.cornerIsExternal,
                            bb = U.startAngle,
                            cb = U.endAngle,
                            db = (0, k.mathSign)(cb - bb),
                            eb = w({
                                cx: V,
                                cy: W,
                                radius: Y,
                            ...
                            jb = ib.circleTangency,
                            kb = ib.lineTangency,
                            lb = ib.theta,
                            mb = ab ? Math.abs(bb - cb) : Math.abs(bb - cb) - hb - lb;
                        if (mb < 0)
                        ...
                        if (X > 0) {
                            var ob = w({
                                ...
                                tb = sb.circleTangency,
                                ub = sb.lineTangency,
                                vb = sb.theta,
                                wb = ab ? Math.abs(bb - cb) : Math.abs(bb - cb) - rb - vb;
                            if (wb < 0 && 0 === Z)
    ...
    var _O = function(P) {
        ...
        return Q = U, S = [{
            ...
            },
            {
                ...
                value: function(W, X) {
                    var Y, Z, $ = W.ticks,
                        ...
                        jb = bb.width,
                        kb = bb.height,
                        lb = 'top' === cb || 'bottom' === cb ? 'width' : 'height',
                        mb = ($ || []).slice(),
                        nb = eb && 'width' === lb ? (0, l.getStringSize)(eb, {
                            fontSize: fb,
                            letterSpacing: gb
                        })[lb] : 0,
                        ob = mb.length,
                        pb = ob >= 2 ? (0, q.mathSign)(mb[1].coordinate - mb[0].coordinate) : 1;
                    if (1 === pb ? (Y = 'width' === lb ? hb : ib, Z = 'width' === lb ? hb + jb : ib + kb) : (Y = 'width' === lb ? hb + jb : ib + kb, Z = 'width' === lb ? hb : ib), X) {
                        var qb = $[ob - 1],
                            rb = a(h)(ab) ? ab(qb.value, ob - 1) : qb.value,
                            sb = (0, l.getStringSize)(rb, {
                                fontSize: fb,
                                letterSpacing: gb
                            })[lb] + nb,
                            tb = pb * (qb.coordinate + pb * sb / 2 - Z);
                        mb[ob - 1] = qb = x(x({}, qb), {}, {
                            tickCoord: tb > 0 ? qb.coordinate - tb * pb : qb.coordinate
                        }), pb * (qb.tickCoord - pb * sb / 2 - Y) >= 0 && pb * (qb.tickCoord + pb * sb / 2 - Z) <= 0 && (Z = qb.tickCoord - pb * (sb / 2 + db), mb[ob - 1] = x(x({}, qb), {}, {
                            isShow: !0
                        }));
                    }
                    for (var ub = X ? ob - 1 : ob, vb = 0; vb < ub; vb++) {
                        var wb = mb[vb],
                            xb = a(h)(ab) ? ab(wb.value, vb) : wb.value,
                            yb = (0, l.getStringSize)(xb, {
                                fontSize: fb,
                                letterSpacing: gb
                            })[lb] + nb;
                        if (0 === vb) {
                            ...
                            mb[vb] = wb = x(x({}, wb), {}, {
                                tickCoord: zb < 0 ? wb.coordinate - zb * pb : wb.coordinate
                            });
                        } else
                            mb[vb] = wb = x(x({}, wb), {}, {
                                tickCoord: wb.coordinate
                            });
                        pb * (wb.tickCoord - pb * yb / 2 - Y) >= 0 && pb * (wb.tickCoord + pb * yb / 2 - Z) <= 0 && (Y = wb.tickCoord + pb * (yb / 2 + db), mb[vb] = x(x({}, wb), {}, {
                            isShow: !0
                        }));
                    }
            ...
            },
            {
                ...
                value: function(W) {
                    var X, Y, Z = W.ticks,
                        ...
                        ib = ab.width,
                        jb = ab.height,
                        kb = 'top' === bb || 'bottom' === bb ? 'width' : 'height',
                        lb = db && 'width' === kb ? (0, l.getStringSize)(db, {
                            fontSize: eb,
                            letterSpacing: fb
                        })[kb] : 0,
                        mb = (Z || []).slice(),
                        nb = mb.length,
                        ob = nb >= 2 ? (0, q.mathSign)(mb[1].coordinate - mb[0].coordinate) : 1;
                    1 === ob ? (X = 'width' === kb ? gb : hb, Y = 'width' === kb ? gb + ib : hb + jb) : (X = 'width' === kb ? gb + ib : hb + jb, Y = 'width' === kb ? gb : hb);
                    for (var pb = nb - 1; pb >= 0; pb--) {
                        var qb = mb[pb],
                            rb = a(h)($) ? $(qb.value, nb - pb - 1) : qb.value,
                            sb = (0, l.getStringSize)(rb, {
                                fontSize: eb,
                                letterSpacing: fb
                            })[kb] + lb;
                        if (pb === nb - 1) {
                            ...
                            mb[pb] = qb = x(x({}, qb), {}, {
                                tickCoord: tb > 0 ? qb.coordinate - tb * ob : qb.coordinate
                            });
                        } else
                            mb[pb] = qb = x(x({}, qb), {}, {
                                tickCoord: qb.coordinate
                            });
                        ob * (qb.tickCoord - ob * sb / 2 - X) >= 0 && ob * (qb.tickCoord + ob * sb / 2 - Y) <= 0 && (Y = qb.tickCoord - ob * (sb / 2 + cb), mb[pb] = x(x({}, qb), {}, {
                            isShow: !0
                        }));
                    }
            ...
            },
            {
                key: 'renderTickItem',
                value: function(W, X, Y) {
                    return a(i).isValidElement(W) ? a(i).cloneElement(W, X) : a(h)(W) ? W(X) : a(i).createElement(n.Text, t({}, X, {
            ...
            },
            {
                ...
                value: function(W) {
                    var X, Y, Z, $, ab, bb, cb = this.props,
                        ...
                        lb = jb ? -1 : 1,
                        mb = W.tickSize || ib,
                        nb = (0, q.isNumber)(W.tickCoord) ? W.tickCoord : W.coordinate;
                    switch (hb) {
                        case 'top':
            ...
            },
            {
                ...
                value: function() {
                    var W = this.props,
                        ...
                        bb = W.mirror,
                        cb = W.axisLine,
                        db = x(x(x({}, (0, r.filterProps)(this.props)), (0, r.filterProps)(cb)), {}, {
                            fill: 'none'
                        });
                    if ('top' === ab || 'bottom' === ab) {
                    ...
                    return a(i).createElement('line', t({}, db, {
                        className: a(j)('recharts-cartesian-axis-line', a(H)(cb, 'className'))
                    }));
                }
            },
            {
                ...
                value: function(W, X, Y) {
                    var Z = this,
                        ...
                        db = $.tickFormatter,
                        eb = $.unit,
                        fb = U.getTicks(x(x({}, this.props), {}, {
                            ticks: W
                        }), X, Y),
                        gb = this.getTickTextAnchor(),
                        hb = this.getTickVerticalAnchor(),
                        ib = (0, r.filterProps)(this.props),
                        jb = (0, r.filterProps)(cb),
                        kb = x(x({}, ib), {}, {
                            fill: 'none'
                        }, (0, r.filterProps)(ab)),
                        lb = fb.map(function(mb, nb) {
                            var ob = Z.getTickLineCoord(mb),
                                pb = ob.line,
                                qb = ob.tick,
                                rb = x(x(x(x({
                                    textAnchor: gb,
                            ...
                            return a(i).createElement(m.Layer, t({
                                ...
                                key: 'tick-'.concat(nb)
                            }, (0, r.adaptEventsOfChild)(Z.props, mb, nb)), ab && a(i).createElement('line', t({}, kb, pb, {
                                className: a(j)('recharts-cartesian-axis-tick-line', a(H)(ab, 'className'))
                            })), cb && U.renderTickItem(cb, rb, ''.concat(a(h)(db) ? db(mb.value, nb) : mb.value).concat(eb || '')));
                        });
            ...
            return M = Q, O = [{
                        ...
                        if (U !== T.prevData || Y !== T.prevUpdateId)
                            return w({
                                ...
                                var bb = ab.data,
                                    ...
                                    eb = ab.x,
                                    fb = ab.width,
                                    gb = ab.travellerWidth;
                                if (!bb || !bb.length)
                                    return {};
                                var hb = bb.length,
                                    ib = (0, k.point)().domain(a(h)(0, hb)).range([
                                        eb,
                                        eb + fb - gb
                                    ]),
                ...
                },
                {
                    ...
                    value: function(S) {
                        var T = S.startX,
                            U = S.endX,
                            V = this.state.scaleValues,
                            W = this.props,
                            X = W.gap,
                            Y = W.data.length - 1,
                            Z = Math.min(T, U),
                            $ = Math.max(T, U),
                            ab = Q.getIndexInRange(V, Z),
                            bb = Q.getIndexInRange(V, $);
                        return {
                            startIndex: ab - ab % X,
                ...
                },
                {
                    ...
                    value: function(S) {
                        var T = this.props,
                            ...
                            V = T.tickFormatter,
                            W = T.dataKey,
                            X = (0, n.getValueByDataKey)(U[S], W, S);
                ...
                },
                {
                    ...
                    value: function(S, T) {
                        var U = this.props,
                            ...
                            X = U.height,
                            Y = U.traveller,
                            Z = Math.max(S, this.props.x),
                            $ = w(w({}, (0, q.filterProps)(this.props)), {}, {
                                x: Z,
                                y: V,
                                width: W,
                                height: X
                ...
                },
                {
                    ...
                    value: function() {
                        var S = this.props,
                            ...
                            db = ab.isTextActive,
                            eb = ab.isSlideMoving,
                            fb = ab.isTravellerMoving;
                        if (!T || !T.length || !(0, o.isNumber)(W) || !(0, o.isNumber)(X) || !(0, o.isNumber)(Y) || !(0, o.isNumber)(Z) || Y <= 0 || Z <= 0)
                            return null;
                        var gb = a(j)('recharts-brush', U),
                            hb = 1 === a(i).Children.count(V),
                            ib = (0, p.generatePrefixStyle)('userSelect', 'none');
                        return a(i).createElement(l.Layer, {
                            className: gb,
    ...
    function _z(A) {
        ...
        var J = _y.x,
            ...
            M = A.className,
            N = v(v({
                clipPath: (0, n.ifOverflowMatches)(A, 'hidden') ? 'url(#'.concat(F, ')') : void 0
            }, (0, q.filterProps)(A, !0)), {}, {
                cx: J,
                cy: K
            });
        return a(h).createElement(j.Layer, {
            className: a(i)('recharts-reference-dot', M)
        }, _z.renderDot(L, N), l.Label.renderCallByParent(A, {
            x: J - D,
            y: K - D,
            width: 2 * D,
            height: 2 * D
    ...
    var _v = function(w, x, y, z, A) {
            ...
            return F.reduce(function(I, J) {
                ...
                if ('number' === P.type && ('gap' === P.padding || 'no-gap' === P.padding)) {
                    var X = R[1] - R[0],
                        Y = 1 / 0,
                        Z = P.categoricalDomain.sort();
                    Z.forEach(function($, ab) {
                        ab > 0 && (Y = Math.min(($ || 0) - (Z[ab - 1] || 0), Y));
                    });
                    var $ = Y / X,
                        ab = 'vertical' === P.layout ? y.height : y.width;
                    if ('gap' === P.padding && (K = $ * ab / 2), 'no-gap' === P.padding) {
                        var bb = (0, k.getPercentValue)(w.barCategoryGap, $ * ab),
                            cb = $ * ab / 2;
                        K = cb - bb - (cb - bb) / ab * bb;
                    }
                }
                ...
                var db = (0, i.parseScale)(P, A, H),
                    eb = db.scale,
                    fb = db.realScaleType;
                eb.domain(R).range(L), (0, i.checkDomainOfScale)(eb);
                var gb = (0, i.getTicksOfScale)(eb, r(r({}, P), {}, {
                    realScaleType: fb
                }));
    ...
    function _D(E) {
        ...
        var P = y(O, 2),
            ...
            V = T.y,
            W = u(u({
                clipPath: (0, m.ifOverflowMatches)(E, 'hidden') ? 'url(#'.concat(N, ')') : void 0
            }, (0, q.filterProps)(E, !0)), {}, {
                x1: R,
                y1: S,
                x2: U,
        ...
        return a(i).createElement(k.Layer, {
            className: a(j)('recharts-reference-line', _D)
        }, function(X, Y) {
            return a(i).isValidElement(X) ? a(i).cloneElement(X, Y) : a(h)(X) ? X(Y) : a(i).createElement('line', C({}, Y, {
    ...
    function _z(A) {
        ...
        return a(h).createElement(j.Layer, {
            className: a(i)('recharts-reference-area', F)
        }, _z.renderRect(M, v(v({
            clipPath: O
        }, (0, q.filterProps)(A, !0)), N)), k.Label.renderCallByParent(A, N));
    }
    _z.displayName = 'ReferenceArea', _z.defaultProps = {
        ...
        return a(h).isValidElement(O) ? a(h).cloneElement(O, P) : a(E)(O) ? O(P) : a(h).createElement(F.Rectangle, r({}, P, {
            ...
            },
            {
                ...
                value: function() {
                    ...
                    if (!(0, i.isNumber)(R) || R <= 0 || !(0, i.isNumber)(S) || S <= 0 || !(0, i.isNumber)(P) || P !== +P || !(0, i.isNumber)(Q) || Q !== +Q)
                        return null;
                    var bb = this.props,
                        cb = bb.horizontalPoints,
                        db = bb.verticalPoints;
                    ...
                    }, this.renderBackground(), T && this.renderHorizontal(cb), U && this.renderVertical(db), T && this.renderHorizontalStripes(cb), U && this.renderVerticalStripes(db));
                }
            }
    ...
    var _r = (0, i.forwardRef)(function(s, t) {
        ...
        return a(i).createElement(j.default, {
            ...
            onResize: Q,
            targetRef: K
        }, a(i).createElement('div', m({}, null != F ? {
            id: ''.concat(F)
        } : {}, {
            ...
            var U = (0, k.isPercent)(w) ? S : w,
                V = (0, k.isPercent)(y) ? T : y;
    ...
    var p = function(q) {
        ...
        q = 'object' == typeof o && o && o.Object === Object && o,
    ...
    var ab = function(bb, cb, db) {
        ...
        _gb = function(hb) {
            function ib(jb) {
                ...
                var lb = jb.skipOnMount,
                    mb = jb.refreshMode,
                    nb = jb.refreshRate,
                    ob = void 0 === nb ? 1000 : nb,
                    pb = jb.refreshOptions;
                return kb.state = {
                    width: void 0,
                    height: void 0

...
var _e = function(t) {
    ...
    return i.createElement("svg", fe({
        className: M("".concat(n, "-circle"), y),
...
function U({
    ...
    let r = t;
    return e && "progress" in e && (r = e.progress), e && "percent" in e && (r = e.percent), r
}
const We = ({
        percent: e,
        success: t,
    ...
    Q = (e, t, r) => {
        ...
        if (t === "step") {
            const g = r.steps,
                u = r.strokeWidth;
            typeof e == "string" || typeof e > "u" ? (l = e === "small" ? 2 : 14, a = u ?? 8) : typeof e == "number" ? [l, a] = [e, e] : [l = 14, a = 8] = Array.isArray(e) ? e : [e.width, e.height], l *= g
        } else if (t === "line") {
            const g = r == null ? void 0 : r.strokeWidth;
            typeof e == "string" || typeof e > "u" ? a = g || (e === "small" ? 6 : 8) : typeof e == "number" ? [l, a] = [e, e] : [l = -1, a = 8] = Array.isArray(e) ? e : [e.width, e.height]
        } else(t === "circle" || t === "dashboard") && (typeof e == "string" || typeof e > "u" ? [l, a] = e === "small" ? [60, 60] : [120, 120] : typeof e == "number" ? [l, a] = [e, e] : Array.isArray(e) && (l = (n = (o = e[0]) !== null && o !== void 0 ? o : e[1]) !== null && n !== void 0 ? n : 120, a = (s = (c = e[0]) !== null && c !== void 0 ? c : e[1]) !== null && s !== void 0 ? s : 120));
        return [l, a]
    },
    Re = 3,
    Te = e => Re / e * 100,
    Me = e => {
        ...
        const C = {
            ...
            S = i.useMemo(() => {
                if (c || c === 0) return c;
                if (l === "dashboard") return 75
            }, [c, l]),
            p = We(e),
            v = n || l === "dashboard" && "bottom" || void 0,
            O = Object.prototype.toString.call(e.strokeColor) === "[object Object]",
            P = Le({
                success: g,
...
const qe = e => {
        ...
        }), t = t.sort((r, o) => r.key - o.key), t.map(({
            key: r,
            value: o
        }) => `${o} ${r}%`).join(", ")
    },
    ...
    Ye = e => {
        const {
            ...
            [Y]: s,
            background: s
        }, C = l === "square" || l === "butt" ? 0 : void 0, S = n ?? [-1, c || (n === "small" ? 6 : 8)], [p, v] = Q(S, "line", {
            strokeWidth: c
        }), O = {
        ...
        return h === "outer" && m === "center" ? i.createElement("div", {
            className: `${t}-layout-bottom`
        }, x, a) : i.createElement("div", {
            className: `${t}-outer`,
            style: I
        }, w && a, x, d && a)
    },
    Qe = e => {
        const {
            ...
            prefixCls: a,
            children: g
        } = e, u = o(r * (n / 100)), m = t ?? [t === "small" ? 2 : 14, c], [h, y] = Q(m, "step", {
            steps: r,
            strokeWidth: c
        }), C = h / r, S = Array.from({
            length: r
        ...
        for (let p = 0; p < r; p++) {
            const v = Array.isArray(s) ? s[p] : s;
            S[p] = i.createElement("div", {
                key: p,
                className: M(`${a}-steps-item`, {
                    [`${a}-steps-item-active`]: p <= u - 1
                }),
                style: {
...
const ze = ["normal", "exception", "active", "success"],
    ot = i.forwardRef((e, t) => {
        ...
        let B;
        u === "line" ? B = c ? i.createElement(Qe, Object.assign({}, e, {
            strokeColor: O,
            prefixCls: d,
            steps: typeof c == "object" ? c.count : c
        }), D) : i.createElement(Ye, Object.assign({}, e, {
            strokeColor: v,
            prefixCls: d,
            direction: x,
            percentPosition: {
        ...
        }), D) : (u === "circle" || u === "dashboard") && (B = i.createElement(Me, Object.assign({}, e, {
            strokeColor: v,
            prefixCls: d,
            progressStatus: $
        }), D));
        const V = M(d, `${d}-status-${$}`, {
            ...
            [`${d}-inline-circle`]: u === "circle" && Q(a, "circle")[0] <= 20,
            [`${d}-line`]: W,
            [`${d}-line-align-${S}`]: W,
            [`${d}-line-position-${p}`]: W,
            [`${d}-steps`]: c,

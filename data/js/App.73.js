...
`), k.default.Snow, k.default.Black, l.Fonts.SFPro),
    ...
    var _r = s => {
        ...
        const y = b(n)((0, l.dateFromObjectId)(s.id)).add(546, 'days'),
            z = !b(n)().isAfter(y) && Math.abs(b(n)().diff(y, 'months')) < 3;
...
`));
    ...
    var _p = q => {
        ...
        return (0, f.jsx)(_q, {
            children: r === g.Tab.share ? (0, f.jsx)(l.default, {
                id: s
            }) : r === g.Tab.results ? (0, f.jsx)(m.default, {
                id: s,
                groups: t.groups
            }) : r === g.Tab.info ? (0, f.jsx)(n.default, {
                info: t
            }) : null
        });
    };
    ...
    var _r = s => {
        ...
        if (!w.length)
            return (0, f.jsx)(n.default, {
                children: s.group ? 'Nobody in this class has completed this assignment yet' : 'Nobody has completed this assignment yet'
            });
                        ...
                        children: [
                            (0, f.jsxs)(_y, {
                                children: [
                                    ...
                                    (0, f.jsx)(_A, {
                                        children: z ? `Completed ${ y.length } times` : `Completed ${ (0, n.default)(y[0].completedAt) }`
                                    })
                                ]
                            }),
                            (0, f.jsx)(_B, {
...
`)),
    ...
    var f = c('.....'),
        ...
        n = c('.....');
    var _o = p => {
        const [q, r] = l.useState(), {
            links: s
        } = p, t = l.useMemo(() => p.links.map(u => u.type === m.MapAssignmentResultLinkType.gameReport ? {
            link: u,
...
`), j.FontWeights.Bold);
    ...
    var _o = p => {
        ...
        if (!q.length)
            return (0, f.jsx)(n.default, {
                children: p.group ? 'No students in this class are currently working on this assignment' : 'Nobody is currently working on this assignment'
            });
    ...
    var _q = r => {
        ...
        return (0, f.jsx)(_r, {
            children: (0, f.jsx)(h.default, {
                ...
                header: v => v || t.length ? v ? (0, f.jsx)(_s, {
...
`));
    ...
    var _i = j => {
        ...
        return l !== g.IHookConnectedResourceType.kit ? null : (0, f.jsx)(h.default, {
            id: k
        });
    };
}), c.register('.....', function(d, e) {
                ...
                children: (0, f.jsxs)(_w, {
                    children: [
                        ...
                        (0, f.jsxs)(_y, {
                            children: [
                                (0, f.jsx)(_z, {
                                    children: (null == A ? void 0 : A.title) || 'Deleted Kit'
                                }),
                                (0, f.jsx)(_A, {
                                    children: 'Kit'
                                })

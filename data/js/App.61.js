...
c.register('.....', function (d, e) {
    ...
    var _C = () => {
        const [D, E] = h.useState(!0), [F, G] = h.useState(''), [H, I] = h.useState(''), [J, K] = h.useState((0, p.isLoggedIn)() ? (0, p.getUser)().email : ''), [L, M] = h.useState(!1), {plan: N} = (0, s.useParams)();
        h.useEffect(() => {
            (0, p.request)({
                url: '/api/quote/fetch-plans',
                success: O => {
                    N && (O && O.plans && !O.plans.includes(N) ? (0, q.throwError)({
                        title: 'Invalid plan',
                        onOk: () => window.location.href = '/'
                    }) : (G(N), E(!1)));
                },
                error: () => (0, q.throwError)({ title: 'Plan not found' })
            });
        }, []);
        const O = H && J && (0, r.validateEmail)(J), P = Q => {
                I(Q.target.value);
            }, Q = R => {
                K(R.target.value);
            }, R = () => {
                !L && O && (M(!0), (0, p.request)({
                    ...
                    success: S => {
                        (0, t.NavigateTo)(`/quote/${ S.quoteId }`);
                    },
        ...
        return (0, g.jsxs)(_D, {
            ...
            children: [
                ...
                (0, g.jsx)(_E, {
                    children: D ? (0, g.jsx)('div', {
                        className: 'maxWidth hc flex',
                        children: (0, g.jsx)(o.default, {})
                    }) : (0, g.jsxs)(g.Fragment, {
                        children: [
                            (0, g.jsx)(p.Title, { title: 'New Quote' }),
                            (0, g.jsxs)(_F, {
                                ...
                                children: [
                                    ...
                                    (0, g.jsxs)('div', {
                                        children: [
                                            (0, g.jsx)(_G, { children: 'New Quote' }),
                                            (0, g.jsx)(_H, { children: 'We\'re so excited to get your group on Gimkit Pro!' })
                                        ]
                                    })
                                ]
                            }),
                            (0, g.jsx)(m.default, {}),
                            (0, g.jsx)(_I, { children: 'What is the name of your group?' }),
                            (0, g.jsx)(n.default, {
                                onChange: P,
                            ...
                            (0, g.jsx)(_I, { children: 'What is your email?' }),
                            (0, g.jsx)(n.default, {
                                onChange: Q,
    ...
    const _D = i.default.div(v || (v = B`
  min-height: 100%;
  background: ${ 0 };
  width: 100%;
  color: ${ 0 };
  font-family: ${ 0 };
`), j.default.Snow, j.default.Black, k.Fonts.SFPro), _E = i.default.div(w || (w = B`
  width: 100%;
  max-width: 550px;
  padding: 20px;
`)), _F = i.default.div(x || (x = B`
  width: 100%;
`)), _G = i.default.h1(y || (y = B`
  font-size: 39px;
  color: ${ 0 };
  font-weight: ${ 0 };
  margin-bottom: -10px;
`), j.default.Black, k.FontWeights.UltraBold), _H = i.default.p(z || (z = B`
  font-size: 17px;
  margin-bottom: 0px;
`)), _I = i.default.h2(A || (A = B`
  font-weight: ${ 0 };
  color: ${ 0 };
  font-size: 22px;
  margin-bottom: 0px;

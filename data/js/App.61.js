...
c.register('l29Zi', function(d, e) {
    ...
    var _C = () => {
        const [D, E] = h.useState(!0), [F, G] = h.useState(''), [H, I] = h.useState(''), [J, K] = h.useState((0, p.isLoggedIn)() ? (0, p.getUser)().email : ''), [L, M] = h.useState(!1), {
            plan: N
        } = (0, s.useParams)();
        h.useEffect(() => {
            (0, p.request)({
                ...
                success: D => {
                    N && (D && D.plans && !D.plans.includes(N) ? (0, q.throwError)({
                        title: 'Invalid plan',
        ...
        const O = H && J && (0, r.validateEmail)(J),
            P = D => {
                I(D.target.value);
            },
            Q = D => {
            ...
            R = () => {
                !L && O && (M(!0), (0, p.request)({
                    ...
                    success: D => {
                        (0, t.NavigateTo)(`/quote/${ D.quoteId }`);
                    },
                    error: () => (0, q.throwError)({

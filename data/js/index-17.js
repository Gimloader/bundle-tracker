...
function Fe() {
    return ht || (ht = 1, (function(N) {
        ...
        O.read = function(s, g, a, u, y) {
            ...
            for (v = v << y | T, K += y; K > 0; s[a + ne] = v & 255, ne += ae, v /= 256, K -= 8);
            s[a + ne - ae] |= fe * 128
        };
        /*!
        ...
        (function(s) {
            ...
            function ne(r, e, t) {
                return oe(r), r <= 0 ? K(r) : e !== void 0 ? typeof t == "string" ? K(r).fill(e, t) : K(r).fill(e) : K(r)
            }
            ...
            function Le(r) {
                ...
                if (r.length !== void 0) return typeof r.length != "number" || qe(r.length) ? K(0) : ce(r);
                ...
                if (f) {
                    ...
                    for (Z = t; Z < m; Z++)
                        if (Q(r, Z) === Q(e, ee === -1 ? 0 : Z - ee)) {
                            if (ee === -1 && (ee = Z), Z - ee + 1 === V) return ee * w
                        } else ee !== -1 && (Z -= Z - ee), ee = -1
                } else
                    for (t + V > m && (t = m - V), Z = t; Z >= 0; Z--) {
                        let ee = !0;
                        for (let X = 0; X < V; X++)
                            if (Q(r, Z + X) !== Q(e, X)) {
                                ee = !1;
            ...
            function W(r, e, t, n) {
                ...
                let m;
                for (m = 0; m < n; ++m) {
                    const V = parseInt(e.substr(m * 2, 2), 16);
                    if (qe(V)) return m;
                    r[t + m] = V
                }
                return m
            ...
            function x(r, e, t, n) {
                return Ne(Yt(e, r.length - t), r, t, n)
            }
            ...
            function z(r, e, t) {
                ...
                for (; f < t;) {
                    ...
                    m === null ? (m = 65533, V = 1) : m > 65535 && (m -= 65536, n.push(m >>> 10 & 1023 | 55296), m = 56320 | m & 1023), n.push(m), f += V
                }
                return $(n)
            }
            const H = 4096;
            ...
            h.prototype.writeBigUInt64LE = _e(function(e, t = 0) {
                ...
                let w = 0,
                    m = 1,
                    V = 0;
                for (this[t] = e & 255; ++w < n && (m *= 256);) e < 0 && V === 0 && this[t + w - 1] !== 0 && (V = 1), this[t + w] = (e / m >> 0) - V & 255;
                return t + n
                ...
                let w = n - 1,
                    m = 1,
                    V = 0;
                for (this[t + w] = e & 255; --w >= 0 && (m *= 256);) e < 0 && V === 0 && this[t + w + 1] !== 0 && (V = 1), this[t + w] = (e / m >> 0) - V & 255;
                return t + n
            ...
            h.prototype.writeDoubleLE = function(e, t, n) {
                ...
                if (typeof e == "number")
                    ...
                    const m = h.isBuffer(e) ? e : h.from(e, f),
                        V = m.length;
                    if (V === 0) throw new TypeError('The value "' + e + '" is invalid for argument "value"');
                    for (w = 0; w < n - t; ++w) this[w + t] = m[w % V]
                }
                return this
            };
            const Re = {};
            ...
            function lt(r, e, t, n, f, w) {
                if (r > t || r < e) {
                    ...
                    let V;
                    throw e === 0 || e === BigInt(0) ? V = `>= 0${m} and < 2${m} ** ${(w+1)*8}${m}` : V = `>= -(2${m} ** ${(w+1)*8-1}${m}) and < 2 ** ${(w+1)*8-1}${m}`, new Re.ERR_OUT_OF_RANGE("value", V, r)
                }
                qt(n, f, w)
            }
...
function ir() {
    ...
    dt = 1, typeof G > "u" || !G.version || G.version.indexOf("v0.") === 0 || G.version.indexOf("v1.") === 0 && G.version.indexOf("v1.8.") !== 0 ? Ue.exports = {
        nextTick: N
    } : Ue.exports = G;
...
function at() {
    ...
    Pe.exports = c, Pe.exports.once = l, c.EventEmitter = c, c.prototype._events = void 0, c.prototype._eventsCount = 0, c.prototype._maxListeners = void 0;
    var R = 10;
    ...
    function B(a, u, y, b) {
        ...
        if (E(y), T = a._events, T === void 0 ? (T = a._events = Object.create(null), a._eventsCount = 0) : (T.newListener !== void 0 && (a.emit("newListener", u, y.listener ? y.listener : y), T = a._events), D = T[u]), D === void 0) D = T[u] = y, ++a._eventsCount;
            ...
            D.warned = !0;
            var K = new Error("Possible EventEmitter memory leak detected. " + D.length + " " + String(u) + " listeners added. Use emitter.setMaxListeners() to increase limit");
            K.name = "MaxListenersExceededWarning", K.emitter = a, K.type = u, K.count = D.length, F(K)
        }
        return a
    }
    ...
    c.prototype.once = function(u, y) {
        ...
        if (b === y || b.listener === y) --this._eventsCount === 0 ? this._events = Object.create(null) : (delete v[u], v.removeListener && this.emit("removeListener", u, b.listener || y));
            ...
            T === 0 ? b.shift() : S(b, T), b.length === 1 && (v[u] = b[0]), v.removeListener !== void 0 && this.emit("removeListener", u, K || y)
        }
        return this
...
function Ct() {
    return Et || (Et = 1, Ye = at().EventEmitter), Ye
}
var Ve, bt;
...
function Ut() {
    ...
    function N(R, E) {
        ...
        return B || P ? (E ? E(R) : R && (this._writableState ? this._writableState.errorEmitted || (this._writableState.errorEmitted = !0, G.nextTick(k, this, R)) : G.nextTick(k, this, R)), this) : (this._readableState && (this._readableState.destroyed = !0), this._writableState && (this._writableState.destroyed = !0), this._destroy(R || null, function(C) {
            !E && C ? _._writableState ? _._writableState.errorEmitted ? G.nextTick(I, _) : (_._writableState.errorEmitted = !0, G.nextTick(L, _, C)) : G.nextTick(L, _, C) : E ? (G.nextTick(I, _), E(C)) : G.nextTick(I, _)
        }), this)
    }
...
function Ae() {
    ...
    }, TypeError), I("ERR_STREAM_UNSHIFT_AFTER_END_EVENT", "stream.unshift() after end event"), $e.codes = L, $e
}
var Xe, Rt;
...
function Dt() {
    ...
    function y(p, d, M) {
        ...
        this.decodeStrings = !W, this.defaultEncoding = p.defaultEncoding || "utf8", this.length = 0, this.writing = !1, this.corked = 0, this.sync = !0, this.bufferProcessing = !1, this.onwrite = function(Y) {
            ae(d, Y)
    ...
    function T(p, d) {
        var M = new s;
        a(p, M), G.nextTick(d, M)
    }

    function D(p, d, M, W) {
        var Y;
        return M === null ? Y = new l : typeof M != "string" && !d.objectMode && (Y = new A("chunk", ["string", "Buffer"], M)), Y ? (a(p, Y), G.nextTick(W, Y), !1) : !0
    }
    v.prototype.write = function(p, d, M) {
        var W = this._writableState,
            Y = !1,
            i = !W.objectMode && E(p);
        return i && !k.isBuffer(p) && (p = R(p)), typeof d == "function" && (M = d, d = null), i ? d = "buffer" : d || (d = W.defaultEncoding), typeof M != "function" && (M = u), W.ending ? T(this, M) : (i || D(this, W, p, M)) && (W.pendingcb++, Y = h(this, W, i, p, d, M)), Y
    ...
    function h(p, d, M, W, Y, i) {
        if (!M) {
            var o = K(d, W, Y);
            W !== o && (M = !0, Y = "buffer", W = o)
        }
        ...
        } else J(p, d, !1, x, W, Y, i);
        return j
    }

    function J(p, d, M, W, Y, i, o) {
        d.writelen = W, d.writecb = o, d.writing = !0, d.sync = !0, d.destroyed ? d.onwrite(new O("write")) : M ? p._writev(Y, d.onwrite) : p._write(Y, i, d.onwrite), d.sync = !1
    }

    function oe(p, d, M, W, Y) {
        --d.pendingcb, M ? (G.nextTick(Y, W), G.nextTick(le, p, d), p._writableState.errorEmitted = !0, a(p, W)) : (Y(W), p._writableState.errorEmitted = !0, a(p, W), le(p, d))
    }
    ...
    function ae(p, d) {
        var M = p._writableState,
            W = M.sync,
            Y = M.writecb;
        if (typeof Y != "function") throw new U;
        if (ne(M), d) oe(p, M, W, d, Y);
        else {
            var i = pe(M) || p.destroyed;
            !i && !M.corked && !M.bufferProcessing && M.bufferedRequest && de(p, M), W ? G.nextTick(fe, p, M, i, Y) : fe(p, M, i, Y)
        }
    }
    ...
    function de(p, d) {
        ...
        if (p._writev && M && M.next) {
            ...
            i.entry = M;
            for (var o = 0, x = !0; M;) Y[o] = M, M.isBuf || (x = !1), M = M.next, o += 1;
            Y.allBuffers = x, J(p, d, !0, d.length, Y, "", i.finish), d.pendingcb++, d.lastBufferedRequest = null, i.next ? (d.corkedRequestsFree = i.next, i.next = null) : d.corkedRequestsFree = new N(d), d.bufferedRequestCount = 0
        } else {
            for (; M;) {
                var j = M.chunk,
                    z = M.encoding,
                    H = M.callback,
                    $ = d.objectMode ? 1 : j.length;
                if (J(p, d, !1, $, j, z, H), M = M.next, d.bufferedRequestCount--, d.writing) break
            }
    ...
    function ye(p, d) {
        !d.prefinished && !d.finalCalled && (typeof p._final == "function" && !d.destroyed ? (d.pendingcb++, d.finalCalled = !0, G.nextTick(Le, p, d)) : (d.prefinished = !0, p.emit("prefinish")))
    }
    ...
    function Ee(p, d, M) {
        d.ending = !0, le(p, d), M && (d.finished ? G.nextTick(M) : p.once("finish", M)), d.ended = !0, p.writable = !1
    }
...
function Be() {
    ...
    function E() {
        this._writableState.ended || G.nextTick(_, this)
    }
...
function kt() {
    ...
    function D(i, o, x, j, z) {
        ...
        if (o === null) H.reading = !1, ae(i, H);
            ...
            if (z || ($ = h(H, o)), $) u(i, $);
                ...
                if (typeof o != "string" && !H.objectMode && Object.getPrototypeOf(o) !== F.prototype && (o = c(o)), j) H.endEmitted ? u(i, new l) : K(i, H, o, !0);
                else if (H.ended) u(i, new S);
            else {
                if (H.destroyed) return !1;
                H.reading = !1, H.decoder && !x ? (o = H.decoder.write(o), H.objectMode || o.length !== 0 ? K(i, H, o, !1) : de(i, H)) : K(i, H, o, !1)
    ...
    function fe(i) {
        ...
        _("emitReadable", o.needReadable, o.emittedReadable), o.needReadable = !1, o.emittedReadable || (_("emitReadable", o.flowing), o.emittedReadable = !0, G.nextTick(ce, i))
    }
    ...
    function de(i, o) {
        o.readingMore || (o.readingMore = !0, G.nextTick(pe, i, o))
    }
    ...
    T.prototype._read = function(i) {
        ...
        var z = (!o || o.end !== !1) && i !== G.stdout && i !== G.stderr,
            H = z ? ge : we;
        j.endEmitted ? G.nextTick(H) : x.once("end", H), i.on("unpipe", $);
        ...
        function De() {
            _("cleanup"), i.removeListener("close", ve), i.removeListener("finish", me), i.removeListener("drain", be), i.removeListener("error", re), i.removeListener("unpipe", $), x.removeListener("end", ge), x.removeListener("end", we), x.removeListener("data", te), Oe = !0, j.awaitDrain && (!i._writableState || i._writableState.needDrain) && be()
        }
        x.on("data", te);
        ...
        function te(se) {
            _("ondata");
            var he = i.write(se);
            _("dest.write", he), he === !1 && ((j.pipesCount === 1 && j.pipes === i || j.pipesCount > 1 && Y(j.pipes, i) !== -1) && !Oe && (_("false write response, pause", j.awaitDrain), j.awaitDrain++), x.pause())
        }
    ...
    T.prototype.unpipe = function(i) {
        ...
        var $ = Y(o.pipes, i);
        return $ === -1 ? this : (o.pipes.splice($, 1), o.pipesCount -= 1, o.pipesCount === 1 && (o.pipes = o.pipes[0]), i.emit("unpipe", this, x), this)
    }, T.prototype.on = function(i, o) {
        var x = I.prototype.on.call(this, i, o),
            j = this._readableState;
        return i === "data" ? (j.readableListening = this.listenerCount("readable") > 0, j.flowing !== !1 && this.resume()) : i === "readable" && !j.endEmitted && !j.readableListening && (j.readableListening = j.needReadable = !0, j.flowing = !1, j.emittedReadable = !1, _("on readable", j.length, j.reading), j.length ? fe(this) : j.reading || G.nextTick(le, this)), x
    ...
    function Ee(i, o) {
        o.resumeScheduled || (o.resumeScheduled = !0, G.nextTick(Ie, i, o))
    }
    ...
    T.prototype.wrap = function(i) {
        ...
        i.on("end", function() {
            ...
            if (_("wrapped data"), x.decoder && ($ = x.decoder.write($)), !(x.objectMode && $ == null) && !(!x.objectMode && (!$ || !$.length))) {
                var ge = o.push($);
                ge || (j = !0, i.pause())
            }
        });
        ...
        return this._read = function($) {
            _("wrapped _read", $), j && (j = !1, i.resume())
        }, this
    ...
    function M(i) {
        var o = i._readableState;
        _("endReadable", o.endEmitted), o.endEmitted || (o.ended = !0, G.nextTick(W, o, i))
    }
...
export {
    at as a, Fe as b, ir as c, or as d, Xt as e, _t as f, ar as g, kt as h, Dt as i, Be as j, jt as k, Qt as l, ft as m, er as n, $t as r
};
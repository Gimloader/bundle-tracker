...
c.register('.....', function (d, e) {
    ...
    var _f = { titleFont: c('.....').Fonts.FugazOne };
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
        return _i;
    });
    var f = c('.....'), g = c('.....'), h = new Map([
            [
                'Win',
                'Meta'
            ],
            ...
            var l = (0, g.default)(j), m = (0, g.default)(k);
    ...
    var _z = A => {
        ...
        return (0, f.jsxs)(_A, {
            ...
            children: [
                A.hideListName ? null : (0, f.jsx)(_B, { children: A.list.name }),
                (0, f.jsxs)(_C, {
                    children: [
                        (0, f.jsx)(_D, {
                            animate: { x: G },
                            initial: { x: A.verticalList ? 0 : m.default.sideMargin },
                            transition: {
                                duration: 0.3,
                                ease: 'easeOut'
                            },
                        ...
                        A.verticalList ? null : (0, f.jsxs)(_E, {
                            children: [
                                (0, f.jsx)(_G, {
                                    ...
                                    onClick: J,
                                    children: (0, f.jsx)(_I, {
                                        style: { cursor: H ? 'pointer' : 'auto' },
                                        children: (0, f.jsx)('i', { className: 'fas fa-chevron-left' })
                                    })
                                }),
                                (0, f.jsx)(_H, {
                                    ...
                                    children: (0, f.jsx)(_I, {
                                        ...
                                        children: (0, f.jsx)('i', { className: 'fas fa-chevron-right' })
                                    })
                                })
                            ]
                        })
    ...
    const _A = i.default.div.attrs({ className: 'maxWidth' })(p || (p = y``)), _B = i.default.div(q || (q = y`
  font-family: ${ 0 };
  text-align: center;
  margin-bottom: 15px;
...
`), n.default.titleFont), _C = i.default.div.attrs({ className: 'maxWidth' })(r || (r = y`
  position: relative;
  overflow: hidden;
`)), _D = (0, i.default)(g.motion.div).attrs({ className: 'flex' })(s || (s = y``)), _E = i.default.div.attrs({ className: 'maxAll flex vc between' })(t || (t = y`
  position: absolute;
  top: 0;
  left: 0;
  pointer-events: none;
`)), F = (0, i.default)(g.motion.div).attrs({ className: 'flex-center maxHeight' })(u || (u = y`
  width: 60px;
  line-height: 1;
  color: ${ 0 };
`), o.default.White), _G = (0, i.default)(F)(v || (v = y`
...
`)), _I = i.default.div.attrs({ className: 'flex-center' })(x || (x = y`
  font-size: 32px;
  pointer-events: all;
...
`));
    ...
    const _x = 350, _y = 10, _z = _x + _y, A = 0.2;
    var _B = C => {
            ...
            children: [
                ...
                (0, f.jsxs)(_F, {
                    children: [
                        ...
                        (0, f.jsx)(_I, { children: C.name }),
                        (0, f.jsx)(_J, {
                            animate: { height: D ? 'auto' : 0 },
                            initial: { height: 0 },
                            transition: { duration: A },
                            children: C.tagline
                        })
    ...
    const _C = l.default.div.attrs({ className: 'flex flex-column between' })(o || (o = w`
  border-width: 4px;
  border-style: solid;
  width: ${ 0 }px;
  height: 180px;
...
`), _x), _D = (0, l.default)(j.motion.div).attrs({ className: 'maxWidth' })(p || (p = w`
  padding: 10px 15px;
`)), _E = l.default.img.attrs({ src: '/client/img/pro/star.svg' })(q || (q = w`
  height: 20px;
`)), _F = l.default.div.attrs({ className: 'maxWidth flex-column' })(r || (r = w`
  padding: 10px 15px;
  background: linear-gradient(
    to top,
    hsla(0, 0%, 0%, 0.69) 0%,
...
`)), _G = (0, l.default)(j.motion.div)(s || (s = w`
  ...
  color: ${ 0 };
`), m.default.titleFont, g.default.Black, g.default.White), _H = (0, l.default)(j.motion.div)(t || (t = w`
  font-family: ${ 0 };
  text-transform: uppercase;
  ...
  border-radius: 10px;
  margin-bottom: 4px;
`), m.default.titleFont), _I = l.default.div(u || (u = w`
  font-family: ${ 0 };
  text-transform: uppercase;
  font-size: 22px;
  text-shadow: 2px 2px 2px ${ 0 };
  color: ${ 0 };
`), m.default.titleFont, g.default.Black, g.default.White), _J = (0, l.default)(j.motion.div)(v || (v = w`
  font-size: 14px;
  text-shadow: 1px 1px 1px ${ 0 };
...
`), g.default.Black, h.Fonts.ProductSans);
    ...
    var _w = x => {
        ...
        if (!y)
            return null;
        const z = (0, r.getFreePlanType)(), A = x.showModes && z === r.FreePlanType.limitedModes;
                ...
                (0, f.jsx)(g.default, {
                    ...
                    children: (0, f.jsxs)(_y, {
                        children: [
                            ...
                            (0, f.jsx)(n.default, { showingModes: A })
                        ]
                    })
                })
            ]
...
`)), _y = l.default.div.attrs({ className: 'maxWidth' })(t || (t = u`
  color: ${ 0 };
  font-family: ${ 0 };
    ...
    var _w = x => {
        ...
        return (0, f.jsxs)('div', {
            ...
            children: [
                ...
                (0, p.onlyOfferAnnualUpgrade)() ? (0, f.jsx)(_x, { children: '$59.88 a year - works out to $4.99 a month' }) : null,
                (0, f.jsx)(i.default, { style: { margin: '26px 0px' } }),
                (0, f.jsxs)('div', {
                    className: 'flex vc',
                    children: [
                        (0, f.jsx)(_y, {
...
`), j.default.Black), _z = o.default.i.attrs({ className: 'fas fa-circle' })(u || (u = v`
  margin: 0px 12px;
  font-size: 10px;
`));
}), c.register('.....', function (d, e) {
    ...
    const r = [
        {
            ...
            answer: (0, f.jsxs)('span', {
                children: [
                    ...
                    ' ',
                    (0, f.jsx)('b', { children: 'So if you purchase a year of Gimkit Pro today and your school upgrades next month, we\u2019d refund you $54.89.' }),
                    ' ',
    ...
    var _s = () => (0, f.jsxs)(f.Fragment, {
        children: [
            (0, f.jsx)(g.default, { style: { margin: '26px 0px' } }),
            (0, f.jsx)(_t, {
                children: r.map(t => (0, f.jsxs)(_u, {
                    children: [
                        (0, f.jsx)(_v, { children: t.question }),
                        (0, f.jsx)(_w, { children: t.answer })
                    ]
                }, t.question))
            })
        ]
    });
    const _t = j.default.div.attrs({ className: 'maxWidth' })(m || (m = q`
  padding: 0px ${ 0 }px;
`), () => k.PADDING), _u = j.default.div(n || (n = q`
  margin-bottom: 15px;
  background: ${ 0 };
  padding: 30px;
  border-radius: 6px;
...
`), h.default.White, h.default.BorderGray), _v = j.default.div(o || (o = q`
  font-size: 21px;
  font-weight: ${ 0 };
`), i.FontWeights.Bold), _w = j.default.div(p || (p = q`
  font-size: 16px;
  margin-top: 5px;
`));
}), c.register('.....', function (d, e) {
    ...
    var _y = z => {
        ...
        return b(g).useEffect(() => {
            ...
            children: A ? (0, f.jsx)('div', {
                ...
                children: [
                    (0, f.jsx)(_C, { onClick: z.onCancel }),
                    (0, f.jsxs)(_A, {
                        children: [
                            (0, f.jsx)('span', {
                                style: { fontWeight: s.FontWeights.UltraBold },
                                children: 'Pay For Me'
                            }),
                            ' ',
                            'link'
    ...
    const _z = q.default.div.attrs({ className: 'maxWidth' })(t || (t = x`
  color: ${ 0 };
  font-family: ${ 0 };
  padding: 30px;
`), r.default.Black, s.Fonts.SFPro), _A = q.default.div(u || (u = x`
  font-size: 32px;
`)), _B = q.default.div(v || (v = x`
  font-size: 17px;
  margin-top: 14px;
`)), _C = q.default.i.attrs({ className: 'fal fa-times' })(w || (w = x`
  position: absolute;
  font-size: 24px;
  top: 30px;
  right: 30px;
...
`));
    ...
    var _n = () => {
        ...
        }) : (0, f.jsx)(_o, { children: (0, f.jsx)('div', { style: { height: 180 } }) });
    };
    const _o = i.default.div.attrs({ className: 'maxWidth' })(l || (l = (p => p)`
  margin-top: ${ 0 }px;
`), () => 25 - k.BOTTOM_PADDING);
}), c.register('.....', function (d, e) {
    ...
    var _t = u => {
        ...
        return (0, f.jsxs)(_u, {
            ...
            children: [
                (0, f.jsx)(_v, { onClick: u.close }),
                (0, f.jsxs)(_w, {
                    children: [
                        (0, f.jsx)(_x, {
                            children: v && v.title ? v.title : (0, i.isUpgraded)() ? (0, f.jsx)(f.Fragment, { children: 'Your trial ends soon.' }) : (0, l.getFreePlanType)() === l.FreePlanType.limitedGames ? (0, f.jsx)(f.Fragment, { children: 'Upgrade to host unlimited games' }) : (0, f.jsx)('div', {
                                style: {
                                    fontSize: 40,
                                    marginTop: 30
                                },
                        ...
                        (0, f.jsx)(_y, {
                            style: { marginTop: u.showingModes ? 10 : 5 },
                            children: (() => {
                                if (v && v.description)
                                    return v.description;
                                const w = (0, l.getFreePlanType)(), x = w === l.FreePlanType.limitedModes ? 'a few game modes that rotate every few weeks' : `host ${ (0, l.getLimitedGameLimit)() } games per month`;
                                return (0, f.jsxs)('div', {
                                    className: 'maxWidth',
    ...
    const _u = j.default.div.attrs({ className: 'maxWidth flex flex-column vc' })(m || (m = r`
  padding: ${ 0 }px 0px;
  padding-top: 30px;
  background: ${ 0 };
  color: ${ 0 };
...
`), () => k.PADDING), _w = j.default.div.attrs({ className: 'maxWidth' })(o || (o = r`
  padding: 0px ${ 0 }px;
`), () => k.PADDING), _x = j.default.div(p || (p = r`
  font-size: 42px;
  font-weight: ${ 0 };
`), h.FontWeights.UltraBold), _y = j.default.div(q || (q = r`
  font-size: 20px;
`));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
    ...
    var _f = {
        icon: {
            ...
            children: [{
                    tag: 'path',
                    attrs: { d: 'M928 161H699.2c-49.1 0-97.1 14.1-138.4 40.7L512 233l-48.8-31.3A255.2 255.2 0 00324.8 161H96c-17.7 0-32 14.3-32 32v568c0 17.7 14.3 32 32 32h228.8c49.1 0 97.1 14.1 138.4 40.7l44.4 28.6c1.3.8 2.8 1.3 4.3 1.3s3-.4 4.3-1.3l44.4-28.6C602 807.1 650.1 793 699.2 793H928c17.7 0 32-14.3 32-32V193c0-17.7-14.3-32-32-32zM324.8 721H136V233h188.8c35.4 0 69.8 10.1 99.5 29.2l48.8 31.3 6.9 4.5v462c-47.6-25.6-100.8-39-155.2-39zm563.2 0H699.2c-54.4 0-107.6 13.4-155.2 39V298l6.9-4.5 48.8-31.3c29.7-19.1 64.1-29.2 99.5-29.2H888v488zM396.9 361H211.1c-3.9 0-7.1 3.4-7.1 7.5v45c0 4.1 3.2 7.5 7.1 7.5h185.7c3.9 0 7.1-3.4 7.1-7.5v-45c.1-4.1-3.1-7.5-7-7.5zm223.1 7.5v45c0 4.1 3.2 7.5 7.1 7.5h185.7c3.9 0 7.1-3.4 7.1-7.5v-45c0-4.1-3.2-7.5-7.1-7.5H627.1c-3.9 0-7.1 3.4-7.1 7.5zM396.9 501H211.1c-3.9 0-7.1 3.4-7.1 7.5v45c0 4.1 3.2 7.5 7.1 7.5h185.7c3.9 0 7.1-3.4 7.1-7.5v-45c.1-4.1-3.1-7.5-7-7.5zm416 0H627.1c-3.9 0-7.1 3.4-7.1 7.5v45c0 4.1 3.2 7.5 7.1 7.5h185.7c3.9 0 7.1-3.4 7.1-7.5v-45c.1-4.1-3.1-7.5-7-7.5z' }
                }]
        },
        name: 'read',
        theme: 'outlined'

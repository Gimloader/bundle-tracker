...
`));
    ...
    var _E = (0, q.observer)(F => {
        var G;
        const H = !(0, o.default)() || !(0, p.CanAddWires)(),
            I = 'left' === F.side,
            J = I ? F.wire.startDevice : F.wire.endDevice,
            K = (0, s.default)(J),
            L = (null == K || null === (G = K.deviceOption) || void 0 === G ? void 0 : G.id) === w.default.wireRepeater,
            M = i.useMemo(() => {
                var N, O, P, Q;
...
`));
    ...
    var _o = p => (0, f.jsxs)(_p, {
        ...
        children: [
            (0, f.jsx)(_q, {
                selected: p.selected,
                children: p.selected ? (0, f.jsx)(j.default, {
                    name: 'fas fa-check'
                }) : null
            }),
            (0, f.jsx)(g.default.Text, {
                style: {
                    fontWeight: p.selected ? k.FontWeights.Bold : k.FontWeights.Normal
                },
                children: p.children
            })
        ]
...
`), q => q.readOnly ? 'not-allowed' : 'pointer'),

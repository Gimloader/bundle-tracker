...
d.register('.....', function(e, f) {
    ...
    var _B = (0, n.observer)(C => {
        ...
        const K = i.useMemo(() => D === p.AddScreen.terrain, [D]),
            L = i.useMemo(() => D === p.AddScreen.props, [D]),
            M = i.useMemo(() => D === p.AddScreen.devices, [D]),
            N = () => {
        ...
        return (0, h.jsx)(w.default, {
            ...
            children: (0, h.jsx)(_C, {
                children: (0, h.jsxs)(k.default, {
                    ...
                    setToWires: () => {
                        E.mode = t.AddingMode.wire, (0, u.default)(v.default.adding), (0, z.EmitTutorialEvent)({
    ...
    var _s = t => {
        const {
            ...
            return (0, q.IsTutorial)() ? B.sort((C, D) => {
                const E = r.TutorialConsts.topTerrain.indexOf(C.id),
                    F = r.TutorialConsts.topTerrain.indexOf(D.id);
...
`), J => J.borderRadius, J => J.focused ? '#ffca28' : 'rgba(255, 255, 255, 0.1)'),
...
`), j.Fonts.FugazOne);
    ...
    const _i = j => {
        ...
        const n = l.minimumRoleLevel,
            o = l.maximumRoleLevel;
    ...
    var _w = (0, h.observer)(x => {
        const {
            worldOptions: y
        } = (0, m.default)(), [z, A] = i.useState(-1), [B] = (0, j.useDebouncedValue)(x.searchQuery, 200), C = i.useMemo(() => {
            var D, E;
            const F = y.propsOptions.filter(G => (0, u.IsRoleLevelBetween)(G.minimumRoleLevel)),
                G = null === (D = null === (E = x.searchQuery) || void 0 === E ? void 0 : E.trim()) || void 0 === D ? void 0 : D.toLowerCase();
            if (!G && !(0, s.IsTutorial)())
                return F;
            const H = F.filter(I => I.name.toLowerCase().includes(G));
            return (0, s.IsTutorial)() ? H.sort((I, J) => {
                const K = t.TutorialConsts.topProps.indexOf(I.id),
                    L = t.TutorialConsts.topProps.indexOf(J.id);
...
`));
    ...
    var _J = K => {
        ...
        return (0, o.default)(b(p).Input.Keyboard.KeyCodes.ENTER, () => {
            ...
            var U;
            K.focused && (null === (U = P.current) || void 0 === U || U.scrollIntoView({
                block: 'center'
            }));
...
`), L => L.borderRadius, L => L.focused ? '#ffca28' : 'rgba(255, 255, 255, 0.1)'),
...
`));
    ...
    var _x = (0, i.observer)(y => {
        const [z, A] = j.useState(-1), {
            ...
            const E = null == C ? void 0 : C.toLowerCase(),
                F = B.filter(G => !w.includes(G.id)).filter(G => (0, s.CanAddDeviceType)(G.id, void 0)).filter(G => (0, v.CanAddDeviceForCurrentMapStyle)({
                    deviceTypeId: G.id
                })).filter(G => !y.list || y.list.includes(G.id)).filter(G => {
                    var H, I;
                    ...
                    const I = G.name.toLowerCase().includes(E),
                        J = H.name.toLowerCase().includes(E);
                    return I && !J ? -1 : !I && J ? 1 : G.name.length < H.name.length ? -1 : G.name.length > H.name.length ? 1 : 0;
                });
            if ((0, t.IsTutorial)())
                return F.sort((G, H) => {
                    const I = u.TutorialConsts.topDevices.indexOf(G.id),
                        J = u.TutorialConsts.topDevices.indexOf(H.id);
    ...
    var _I = J => {
        ...
        return (0, q.default)(b(s).Input.Keyboard.KeyCodes.ENTER, () => {
            ...
            var S;
            J.focused && (null === (S = O.current) || void 0 === S || S.scrollIntoView({
                block: 'center'
            }));
...
`), K => K.borderRadius, K => K.focused ? '#ffca28' : 'rgba(255, 255, 255, 0.1)'),
...
`)),
    ...
    const _i = j => {
        const {
            deviceTypeId: k
        } = j, l = (0, g.FetchDeviceOptionById)(k);
    ...
    const p = `${ (0, k.CapitalizeFirstLetter)(l.default.device.plural) }`,
        q = r => (0, m.default)(`editor/icons/device_collections/${ r }.svg`),
        r = [{
                icon: q('starting'),
                name: `Starting ${ p }`,

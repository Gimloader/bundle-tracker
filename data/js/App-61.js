...
const be = e => {
        ...
        h.useEffect(() => {
            const s = p(g.Adding.SwitchToRemoveMode(), () => {
                ...
                O = p(g.Adding.Terrain.BrushSize.Four(), () => {
        ...
        if (me()) {
            if (ue()) {
                if (r.me.editing.device.usingMultiselect) {
                    const o = pe(),
                        m = De(o),
                        O = r.me.adding.devices.existingDevice.action === M.copy,
                    ...
                    if (oe && !G ? j = `Multiple ${d.device.plural}/${d.prop.plural}` : G && (j = `Multiple ${d.prop.plural}`), S.length === 1) {
                        const T = S[0],
                            U = R(T == null ? void 0 : T.id);
                        U && (j = U)
                    }
                    return {
                        tagline: O ? "Copying" : "Moving",
                        title: j,
                        ...
                        children: [i.jsxs(z, {
                            children: [i.jsx(F, {
                                ...
                                children: i.jsx(b, {
                                    ...
                                    children: new Array(q.maxDepth - q.minDepth + 1).fill(0).map((u, o) => i.jsxs(b.Option, {
                                        value: o + 1,
...
`,
    ...
    Ne = W(() => {
        ...
        } = K(), n = h.useMemo(() => e.hoveringOverSupportedDevice ? t[0] ? R(t[0]) ?? _(d.device.singular) : _(d.device.singular) : `Select a ${d.device.singular} or ${d.prop.singular} to ${e.startDeviceSelected?"complete":"start"} the ${d.wire.singular}`, [e.hoveringOverSupportedDevice, t, e.startDeviceSelected]);
        return i.jsxs(Me, {
            className: "maxWidth",
            children: [i.jsx(Be, {
                children: i.jsx(f.Text, {
            ...
            children: i.jsx(Ge, {
                children: i.jsxs(_e, {
                    ...
                    children: [i.jsx(Ue, {
                        ...
                        addingInfo: n
                    }), n.notAllowedToAddMessage ? i.jsx(qe, {
                        children: i.jsxs(f.Text, {
                            style: {
                                fontWeight: Y.Bold
                            },

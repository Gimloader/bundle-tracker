...
`));
    ...
    (e = p.exports = f.debug = f.default = f).coerce = function(q) {
        ...
        var s = ('string' == typeof q ? q : '').split(/[\s,]+/),
            t = s.length;
        for (r = 0; r < t; r++)
        ...
        if ('string' == typeof D)
            E = function(F) {
                ...
                if (m === H.type || n === H.type) {
                    for (var I = '';
                        '-' !== F.charAt(++G) && (I += F.charAt(G), G != F.length););
                ...
                if (!n)
                    if ('pong' === r.type && 'probe' === r.data) {
                        ...
                        k.priorWebsocketSuccess = 'websocket' === m.name, g('pausing current transport "%s"', o.transport.name), o.transport.pause(function() {
                            n || 'closed' !== o.readyState && (g('changing transport and sending upgrade packet'), _x(), o.setTransport(m), m.send([{
                                type: 'upgrade'
    ...
    var f = c('.....'),
        ...
        h = c('.....'),
        i = c('.....'),
        j = c('.....')('engine.io-client:polling-xhr'),
        k = c('.....');
    ...
    if (d.exports = m, d.exports.Request = p, i(m, g), m.prototype.supportsBinary = !0, m.prototype.request = function(q) {
            ...
            var s = 'string' != typeof q && void 0 !== q,
                t = this.request({
                    method: 'POST',
                    data: q,
                    isBinary: s
    ...
    i(_m, f), _m.prototype.name = 'polling', _m.prototype.doOpen = function() {
        ...
        function p() {
            k('writing close packet'), o.write([{
                type: 'close'
            }]);
        }
    ...
    K = function(I, J, K, L) {
        ...
        if ('undefined' != typeof ArrayBuffer && M instanceof ArrayBuffer)
            return function(N, O, P) {
                ...
                var Q = N.data,
                    R = new Uint8Array(Q),
                    S = new Uint8Array(1 + Q.byteLength);
                S[0] = z[N.type];
        ...
        var N = z[I.type];
        return void 0 !== I.data && (N += K ? v.encode(String(I.data), {
            strict: !1
        }) : String(I.data)), L('' + N);
    }, i = function(I, J) {
        var K, L = 'b' + J[I.type];
        ...
        D(I, function(K, L) {
            K(K, !0, !0, function(M) {
                ...
                var Q = (M instanceof ArrayBuffer ? M.byteLength : M.size).toString(),
                    R = new Uint8Array(Q.length + 1);
    ...
    var f, g, h = c('.....').Buffer,
        ...
        l = c('.....'),
        m = c('.....'),
        n = c('.....')('engine.io-client:websocket');
    ...
    d.exports.default = class {
        ...
        call(f, g) {
            this.callbacks = this.callbacks.map(h => h.timesCalled > 0 && !h.canCallMultipleTimes ? h : (h.callback(f, g), Object.assign({}, h, {
                timesCalled: h.timesCalled + 1
            })));
        }
        constructor() {

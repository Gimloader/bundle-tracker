...
function St() {
    ...
    Fe = 1;
    var i = !1,
        r, e, t, o, n, a, s, l, c, p, u, h, f, w, C;

    function v() {
        if (!i) {
            i = !0;
            var b = navigator.userAgent,
                g = /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(b),
                _ = /(Mac OS X)|(Windows)|(Linux)/.exec(b);
            if (h = /\b(iPhone|iP[ao]d)/.exec(b), f = /\b(iP[ao]d)/.exec(b), p = /Android/i.exec(b), w = /FBAN\/\w+;/i.exec(b), C = /Mobile/i.exec(b), u = !!/Win64/.exec(b), g) {
                r = g[1] ? parseFloat(g[1]) : g[5] ? parseFloat(g[5]) : NaN, r && document && document.documentMode && (r = document.documentMode);
                var S = /(?:Trident\/(\d+.\d+))/.exec(b);
                a = S ? parseFloat(S[1]) + 4 : r, e = g[2] ? parseFloat(g[2]) : NaN, t = g[3] ? parseFloat(g[3]) : NaN, o = g[4] ? parseFloat(g[4]) : NaN, o ? (g = /(?:Chrome\/(\d+\.\d+))/.exec(b), n = g && g[1] ? parseFloat(g[1]) : NaN) : n = NaN
            } else r = e = t = n = o = NaN;
            if (_) {
                if (_[1]) {
                    var M = /(?:Mac OS X (\d+(?:[._]\d+)?))/.exec(b);
                    s = M ? parseFloat(M[1].replace("_", ".")) : !0
                } else s = !1;
                l = !!_[2], c = !!_[3]
            } else s = l = c = !1
        }
...
function _t() {
     ...
     */
    function e(t, o) {
        if (!i.canUseDOM || o && !("addEventListener" in document)) return !1;
        var n = "on" + t,
            a = n in document;
        if (!a) {
            var s = document.createElement("div");
            s.setAttribute(n, "return;"), a = typeof s[n] == "function"
        }
...
function Et() {
    ...
    function n(a) {
        var s = 0,
            ...
            c = 0,
            p = 0;
        return "detail" in a && (l = a.detail), "wheelDelta" in a && (l = -a.wheelDelta / 120), "wheelDeltaY" in a && (l = -a.wheelDeltaY / 120), "wheelDeltaX" in a && (s = -a.wheelDeltaX / 120), "axis" in a && a.axis === a.HORIZONTAL_AXIS && (s = l, l = 0), c = s * e, p = l * e, "deltaY" in a && (p = a.deltaY), "deltaX" in a && (c = a.deltaX), (c || p) && a.deltaMode && (a.deltaMode == 1 ? (c *= t, p *= t) : (c *= o, p *= o)), c && !s && (s = c < 1 ? -1 : 1), p && !l && (l = p < 1 ? -1 : 1), {
            spinX: s,
            spinY: l,
            pixelX: c,
            pixelY: p
...
function Pt() {
    return Ue || (Ue = 1, ye = Et()), ye
}
var zt = Pt();
const Dt = st(zt);

function At(i, r, e, t, o, n) {
    n === void 0 && (n = 0);
    var a = V(i, r, n),
        s = a.width,
        l = a.height,
...
function re(i, r, e, t, o) {
    o === void 0 && (o = 0);
    var n = V(r.width, r.height, o),
        a = n.width,
        s = n.height;
    return {
        x: Ze(i.x, a, e.width, t),
        y: Ze(i.y, s, e.height, t)
    }
}
...
function jt(i, r, e, t, o, n, a) {
    n === void 0 && (n = 0), a === void 0 && (a = !0);
    var s = a ? It : Tt,
        l = V(r.width, r.height, n),
        c = V(r.naturalWidth, r.naturalHeight, n),
        p = {
            x: s(100, ((l.width - e.width / o) / 2 - i.x / o) / l.width * 100),
            y: s(100, ((l.height - e.height / o) / 2 - i.y / o) / l.height * 100),
            width: s(100, e.width / l.width * 100 / o),
            height: s(100, e.height / l.height * 100 / o)
        },
        u = Math.round(s(c.width, p.width * c.width / 100)),
        h = Math.round(s(c.height, p.height * c.height / 100)),
        ...
        C = P(P({}, w), {
            x: Math.round(s(c.width - w.width, p.x * c.width / 100)),
            y: Math.round(s(c.height - w.height, p.y * c.height / 100))
        });
    return {
...
function Nt(i, r, e, t, o, n) {
    var a = V(r.width, r.height, e),
        s = fe(t.width / a.width * (100 / i.width), o, n),
        l = {
            x: s * a.width / 2 - t.width / 2 - a.width * s * (i.x / 100),
            y: s * a.height / 2 - t.height / 2 - a.height * s * (i.y / 100)
        };
    return {
        crop: l,
        zoom: s
...
function Ft(i, r, e, t, o, n) {
    e === void 0 && (e = 0);
    var a = V(r.naturalWidth, r.naturalHeight, e),
        s = fe(Ot(i, r, t), o, n),
        l = t.height > t.width ? t.height / i.height : t.width / i.width,
        c = {
            x: ((a.width - i.width) / 2 - i.x) * l,
            y: ((a.height - i.height) / 2 - i.y) * l
        };
    return {
        crop: c,
        zoom: s
...
function V(i, r, e) {
    var t = Wt(e);
    return {
        width: Math.abs(Math.cos(t) * i) + Math.abs(Math.sin(t) * r),
        height: Math.abs(Math.sin(t) * i) + Math.abs(Math.cos(t) * r)
    }
}
...
var kt = `.reactEasyCrop_Container {
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
    ...
    Bt = (function(i) {
        ...
        function r() {
            ...
            return e.cropperRef = m.createRef(), e.imageRef = m.createRef(), e.videoRef = m.createRef(), e.containerPosition = {
                ...
                if (e.props.initialCroppedAreaPercentages) {
                    var o = Nt(e.props.initialCroppedAreaPercentages, e.mediaSize, e.props.rotation, t, e.props.minZoom, e.props.maxZoom),
                        n = o.crop,
                        a = o.zoom;
                    e.props.onCropChange(n), e.props.onZoomChange && e.props.onZoomChange(a)
                } else if (e.props.initialCroppedAreaPixels) {
                    var s = Ft(e.props.initialCroppedAreaPixels, e.mediaSize, e.props.rotation, t, e.props.minZoom, e.props.maxZoom),
                        n = s.crop,
                        a = s.zoom;
                    e.props.onCropChange(n), e.props.onZoomChange && e.props.onZoomChange(a)
                }
            }, e.computeSizes = function() {
                var t, o, n, a, s, l, c = e.imageRef.current || e.videoRef.current;
                if (c && e.containerRef) {
                    e.containerRect = e.containerRef.getBoundingClientRect(), e.saveContainerPosition();
                    var p = e.containerRect.width / e.containerRect.height,
                        u = ((t = e.imageRef.current) === null || t === void 0 ? void 0 : t.naturalWidth) || ((o = e.videoRef.current) === null || o === void 0 ? void 0 : o.videoWidth) || 0,
                        h = ((n = e.imageRef.current) === null || n === void 0 ? void 0 : n.naturalHeight) || ((a = e.videoRef.current) === null || a === void 0 ? void 0 : a.videoHeight) || 0,
                    ...
                    var v = e.props.cropSize ? e.props.cropSize : At(e.mediaSize.width, e.mediaSize.height, e.containerRect.width, e.containerRect.height, e.props.aspect, e.props.rotation);
                    return (((s = e.state.cropSize) === null || s === void 0 ? void 0 : s.height) !== v.height || ((l = e.state.cropSize) === null || l === void 0 ? void 0 : l.width) !== v.width) && e.props.onCropSizeChange && e.props.onCropSizeChange(v), e.setState({
                        cropSize: v
                ...
                if (t.preventDefault(), !e.isTouching) {
                    var o = r.getMousePoint(t),
                        n = e.gestureZoomStart - 1 + t.scale;
                    if (e.setNewZoom(n, o, {
                ...
                e.dragStartPosition = {
                    x: a,
                    y: s
                }, e.dragStartCrop = P({}, e.props.crop), (n = (o = e.props).onInteractionStart) === null || n === void 0 || n.call(o)
            }, e.onDrag = function(t) {
                var o = t.x,
                    n = t.y;
                e.currentWindow && (e.rafDragTimeout && e.currentWindow.cancelAnimationFrame(e.rafDragTimeout), e.rafDragTimeout = e.currentWindow.requestAnimationFrame(function() {
                    if (e.state.cropSize && !(o === void 0 || n === void 0)) {
                        var a = o - e.dragStartPosition.x,
                            s = n - e.dragStartPosition.y,
                            l = {
                                x: e.dragStartCrop.x + a,
                                y: e.dragStartCrop.y + s
                            },
                            c = e.props.restrictPosition ? re(l, e.mediaSize, e.state.cropSize, e.props.zoom, e.props.rotation) : l;
                ...
                if (e.currentWindow && !(e.props.onWheelRequest && !e.props.onWheelRequest(t))) {
                    ...
                    var o = r.getMousePoint(t),
                        n = Dt(t).pixelY,
                        a = e.props.zoom - n * e.props.zoomSpeed / 200;
                    e.setNewZoom(a, o, {
                        shouldUpdatePosition: !0
                        ...
                        var s, l;
                        return (l = (s = e.props).onInteractionStart) === null || l === void 0 ? void 0 : l.call(s)
                    }), e.wheelTimer && clearTimeout(e.wheelTimer), e.wheelTimer = e.currentWindow.setTimeout(function() {
                        return e.setState({
                            hasWheelJustStarted: !1
                        }, function() {
                            var s, l;
                            return (l = (s = e.props).onInteractionEnd) === null || l === void 0 ? void 0 : l.call(s)
                        })
                    }, 250)
                }
                ...
                return {
                    x: e.containerRect.width / 2 - (n - o.x),
                ...
                if (!(!e.state.cropSize || !e.props.onZoomChange)) {
                    var c = fe(t, e.props.minZoom, e.props.maxZoom);
                    if (l) {
                        var p = e.getPointOnContainer(o, e.containerPosition),
                            u = e.getPointOnMedia(p),
                            h = {
                                x: u.x * c - p.x,
                                y: u.y * c - p.y
                            },
                ...
                if (e.state.cropSize) {
                    ...
                    if (e.isInitialized && (!((t = e.previousCropSize) === null || t === void 0) && t.width) && (!((o = e.previousCropSize) === null || o === void 0) && o.height)) {
                        ...
                        if (a) {
                            var s = e.state.cropSize.width / e.previousCropSize.width,
                                l = e.state.cropSize.height / e.previousCropSize.height;
                            n = {
                                x: e.props.crop.x * s,
                                y: e.props.crop.y * l
                            }
                    ...
                    var c = e.props.restrictPosition ? re(n, e.mediaSize, e.state.cropSize, e.props.zoom, e.props.rotation) : n;
                    e.previousCropSize = e.state.cropSize, e.props.onCropChange(c), e.emitCropData()
                }
                ...
                if (e.state.cropSize) {
                    ...
                    e.props.restrictPosition && (f = re(f, e.mediaSize, e.state.cropSize, p, u)), t.repeat || (n = (o = e.props).onInteractionStart) === null || n === void 0 || n.call(o), l(f)
                }
        ...
        return r.prototype.componentDidMount = function() {
            !this.currentDoc || !this.currentWindow || (this.containerRef && (this.containerRef.ownerDocument && (this.currentDoc = this.containerRef.ownerDocument), this.currentDoc.defaultView && (this.currentWindow = this.currentDoc.defaultView), this.initResizeObserver(), typeof window.ResizeObserver > "u" && this.currentWindow.addEventListener("resize", this.computeSizes), this.props.zoomWithScroll && this.containerRef.addEventListener("wheel", this.onWheel, {
                passive: !1
            }), this.containerRef.addEventListener("gesturestart", this.onGestureStart)), this.currentDoc.addEventListener("scroll", this.onScroll), this.props.disableAutomaticStylesInjection || (this.styleRef = this.currentDoc.createElement("style"), this.styleRef.setAttribute("type", "text/css"), this.props.nonce && this.styleRef.setAttribute("nonce", this.props.nonce), this.styleRef.innerHTML = kt, this.currentDoc.head.appendChild(this.styleRef)), this.imageRef.current && this.imageRef.current.complete && this.onMediaLoad(), this.props.setImageRef && this.props.setImageRef(this.imageRef), this.props.setVideoRef && this.props.setVideoRef(this.videoRef), this.props.setCropperRef && this.props.setCropperRef(this.cropperRef))
            ...
            var t, o, n, a, s, l, c, p, u;
            e.rotation !== this.props.rotation ? (this.computeSizes(), this.recomputeCropPosition()) : e.aspect !== this.props.aspect ? this.computeSizes() : e.objectFit !== this.props.objectFit ? this.computeSizes() : e.zoom !== this.props.zoom ? this.recomputeCropPosition() : ((t = e.cropSize) === null || t === void 0 ? void 0 : t.height) !== ((o = this.props.cropSize) === null || o === void 0 ? void 0 : o.height) || ((n = e.cropSize) === null || n === void 0 ? void 0 : n.width) !== ((a = this.props.cropSize) === null || a === void 0 ? void 0 : a.width) ? this.computeSizes() : (((s = e.crop) === null || s === void 0 ? void 0 : s.x) !== ((l = this.props.crop) === null || l === void 0 ? void 0 : l.x) || ((c = e.crop) === null || c === void 0 ? void 0 : c.y) !== ((p = this.props.crop) === null || p === void 0 ? void 0 : p.y)) && this.emitCropAreaChange(), e.zoomWithScroll !== this.props.zoomWithScroll && this.containerRef && (this.props.zoomWithScroll ? this.containerRef.addEventListener("wheel", this.onWheel, {
                passive: !1
            ...
            if (this.props.objectFit === "cover") {
                ...
                if (a && this.containerRef) {
                    ...
                    var s = this.containerRect.width / this.containerRect.height,
                        l = ((e = this.imageRef.current) === null || e === void 0 ? void 0 : e.naturalWidth) || ((t = this.videoRef.current) === null || t === void 0 ? void 0 : t.videoWidth) || 0,
                        c = ((o = this.imageRef.current) === null || o === void 0 ? void 0 : o.naturalHeight) || ((n = this.videoRef.current) === null || n === void 0 ? void 0 : n.videoHeight) || 0,
                        p = l / c;
            ...
            this.lastPinchDistance = Be(t, o), this.lastPinchRotation = Ge(t, o), this.onDragStart(qe(t, o))
        }, r.prototype.onPinchMove = function(e) {
            var t = this;
            if (!(!this.currentDoc || !this.currentWindow)) {
                var o = r.getTouchPoint(e.touches[0]),
                    n = r.getTouchPoint(e.touches[1]),
                    a = qe(o, n);
                this.onDrag(a), this.rafPinchTimeout && this.currentWindow.cancelAnimationFrame(this.rafPinchTimeout), this.rafPinchTimeout = this.currentWindow.requestAnimationFrame(function() {
                    var s = Be(o, n),
                        l = t.props.zoom * (s / t.lastPinchDistance);
                    t.setNewZoom(l, a, {
                        shouldUpdatePosition: !1
                    }), t.lastPinchDistance = s;
                    var c = Ge(o, n),
                        p = t.props.rotation + (c - t.lastPinchRotation);
                    t.props.onRotationChange && t.props.onRotationChange(p), t.lastPinchRotation = c
                })
            }
            ...
            var e = this,
                ...
                C = o.cropShape,
                v = o.showGrid,
                T = o.roundCropAreaPixels,
                b = o.style,
                g = b.containerStyle,
                _ = b.cropAreaStyle,
                S = b.mediaStyle,
                M = o.classes,
                N = M.containerClassName,
                U = M.cropAreaClassName,
                X = M.mediaClassName,
            ...
            return m.createElement("div", {
                ...
                style: g,
                className: de("reactEasyCrop_Container", N)
            }, n ? m.createElement("img", P({
                alt: "",
                className: de("reactEasyCrop_Image", F === "contain" && "reactEasyCrop_Contain", F === "horizontal-cover" && "reactEasyCrop_Cover_Horizontal", F === "vertical-cover" && "reactEasyCrop_Cover_Vertical", X)
            }, s, {
                src: n,
                ref: this.imageRef,
                style: P(P({}, S), {
                    transform: c || "translate(".concat(u, "px, ").concat(h, "px) rotate(").concat(f, "deg) scale(").concat(w, ")")
                }),
                onLoad: this.onMediaLoad
            })) : a && m.createElement("video", P({
                autoPlay: !0,
                playsInline: !0,
                loop: !0,
                muted: !0,
                className: de("reactEasyCrop_Video", F === "contain" && "reactEasyCrop_Contain", F === "horizontal-cover" && "reactEasyCrop_Cover_Horizontal", F === "vertical-cover" && "reactEasyCrop_Cover_Vertical", X)
            }, s, {
                ref: this.videoRef,
                ...
                return m.createElement("source", P({
                    key: z.src
                }, z))
            })), this.state.cropSize && m.createElement("div", P({
                ref: this.cropperRef,
                style: P(P({}, _), {
                ...
                "data-testid": "cropper",
                className: de("reactEasyCrop_CropArea", C === "round" && "reactEasyCrop_CropAreaRound", v && "reactEasyCrop_CropAreaGrid", U)
            }, l)))
        }, r.defaultProps = {
            zoom: 1,
            rotation: 0,
...
const L = "img-crop",
    ...
    Gt = m.forwardRef((i, r) => {
        const {
            ...
            x: 0,
            y: 0
        }), [g, _] = m.useState(Se), [S, M] = m.useState(he), [N, U] = m.useState(c), X = m.useRef({
            width: 0,
            height: 0,
            x: 0,
            y: 0
        }), F = m.useCallback((se, ce) => {
            X.current = ce
        }, []), z = m.useRef(c);
        z.current !== c && (z.current = c, U(c));
        const W = g !== Se || S !== he || N !== c,
            J = () => {
                _(Se), M(he), U(c)
            };
        ...
        const Q = "[display:flex] [align-items:center] [width:60%] [margin-inline:auto]",
            k = "[display:flex] [align-items:center] [justify-content:center] [height:32px] [width:32px] [background:transparent] [border:0] [font-family:inherit] [font-size:18px] [cursor:pointer] disabled:[opacity:20%] disabled:[cursor:default]",
            ee = "[flex:1]";
        return d.jsxs(d.Fragment, {
            children: [d.jsx(Bt, Object.assign({}, v, {
                ref: e,
                image: l,
                crop: T,
                zoom: g,
                ...
                className: `${L}-control ${L}-control-zoom ${Q}`,
                children: [d.jsx("button", {
                    className: k,
                    onClick: () => _(+(g - ie).toFixed(1)),
                    disabled: g - ie < p,
                    children: "－"
                }), d.jsx(ge, {
                    className: ee,
                ...
                className: `${L}-control ${L}-control-rotation ${Q}`,
                children: [d.jsx("button", {
                    className: `${k} [font-size:16px]`,
                    onClick: () => M(S - Re),
                    disabled: S === He,
                    children: "↺"
                }), d.jsx(ge, {
                ...
                className: `${L}-control ${L}-control-aspect ${Q}`,
                children: [d.jsx("button", {
                    className: k,
                    onClick: () => U(+(N - ne).toFixed(2)),
                    disabled: N - ne < h,
                    children: "↕"
                }), d.jsx(ge, {
                    className: ee,
...
const $t = (i, r) => {
        ...
        for (let s = 0; s < a; s++) {
            const l = (e = o[s]) !== null && e !== void 0 ? e : 0,
                c = (t = n[s]) !== null && t !== void 0 ? t : 0;
            if (l > c) return !0;
            if (l < c) return !1
        }
        return !0
    ...
    Xt = m.forwardRef((i, r) => {
        ...
        z.current.onModalOk = M, z.current.onModalCancel = N, z.current.beforeCrop = X;
        const W = m.useRef(null),
            J = m.useCallback(y => {
                var D;
                const R = document.createElement("canvas"),
                    x = R.getContext("2d"),
                    I = (((D = y == null ? void 0 : y.getRootNode) === null || D === void 0 ? void 0 : D.call(y)) || document).querySelector(`.${L}-media`),
                    {
                        width: E,
                        height: A,
                        x: q,
                        y: H
                    } = W.current.cropPixelsRef.current;
                if (n && W.current.rotation !== he) {
                    const {
                        naturalWidth: Z,
                        naturalHeight: Y
                    } = I, te = W.current.rotation * (Math.PI / 180), oe = Math.abs(Math.sin(te)), $ = Math.abs(Math.cos(te)), O = Z * $ + Y * oe, j = Y * $ + Z * oe;
                    R.width = O, R.height = j, x.fillStyle = t, x.fillRect(0, 0, O, j);
                    const De = O / 2,
                        Ae = j / 2;
                    x.translate(De, Ae), x.rotate(te), x.translate(-De, -Ae);
                    const it = (O - Z) / 2,
                        nt = (j - Y) / 2;
                    x.drawImage(I, 0, 0, Z, Y, it, nt, Z, Y);
                    const at = x.getImageData(0, 0, O, j);
                    R.width = E, R.height = A, x.putImageData(at, -q, -H)
                } else R.width = E, R.height = A, x.fillStyle = t, x.fillRect(0, 0, E, A), x.drawImage(I, q, H, E, A, 0, 0, E, A);
                return R
            }, [t, n]),
            [Q, k] = m.useState(!1),
            [ee, se] = m.useState(""),
            ce = m.useRef(void 0),
            Ee = m.useRef(void 0),
            le = m.useCallback(y => pe(void 0, [y], void 0, function*({
                beforeUpload: D,
                file: R,
                resolve: x,
                reject: G
            ...
            Pe = m.useCallback(y => ((D, R) => new Promise((x, G) => pe(void 0, void 0, void 0, function*() {
                let I = D;
                if (typeof z.current.beforeCrop == "function") try {
                    const A = yield z.current.beforeCrop(D, R);
                    if (A === !1) return le({
                        beforeUpload: y,
                        file: D,
                        resolve: x,
                ...
                E.addEventListener("load", () => {
                    typeof E.result == "string" && (k(!0), setTimeout(() => {
                        se(E.result)
                    }, 10))
                }), E.readAsDataURL(I), ce.current = () => {
                    var A, q;
                    k(!1), se(""), W.current.onReset();
                    let H = !1;
                    (q = (A = z.current).onModalCancel) === null || q === void 0 || q.call(A, Z => {
                        x(Z), H = !0
                    }), H || x(Je.LIST_IGNORE)
                }, Ee.current = A => pe(void 0, void 0, void 0, function*() {
                    k(!1), se(""), W.current.onReset();
                    const q = J(A.target),
                        {
                            type: H,
                    ...
                    q.toBlob(te => pe(void 0, void 0, void 0, function*() {
                        const oe = new File([te], Z, {
                            type: H
                        });
                        Object.assign(oe, {
                            uid: Y
                            ...
                            resolve: $ => {
                                var O, j;
                                x($), (j = (O = z.current).onModalOk) === null || j === void 0 || j.call(O, $)
                            },
                            reject: $ => {
                                var O, j;
                                G($), (j = (O = z.current).onModalOk) === null || j === void 0 || j.call(O, $)
                            }
                        })
                    }), H, e)
                })
            ...
            Qe = m.useCallback(y => {
                const D = Array.isArray(y) ? y[0] : y,
                    R = D.props,
                    {
                        beforeUpload: x,
                        accept: G
                    } = R,
                    I = lt(R, ["beforeUpload", "accept"]);
            ...
            et = m.useMemo(() => {
                const y = {};
                return g !== void 0 && (y.width = g), _ !== void 0 && (y.okText = _), S !== void 0 && (y.cancelText = S), y
            }, [S, _, g]),
            tt = `${L}-modal${T?` ${T}`:""}`,
            ze = (typeof window > "u" ? "" : window.navigator.language) === "zh-CN",
            ot = b || (ze ? "编辑图片" : "Edit image"),
            rt = l || (ze ? "重置" : "Reset");
        return d.jsxs(d.Fragment, {
            children: [Qe(F), d.jsx(pt, Object.assign({}, U, et, {
                open: Q,
                title: ot,
                onCancel: ce.current,
                onOk: Ee.current,
    ...
    Yt = i => new Promise((r, e) => {
        const t = new Image;
        t.addEventListener("load", () => r(t)), t.addEventListener("error", o => e(o)), t.setAttribute("crossOrigin", "anonymous"), t.src = i
    });

function Vt(i) {
    return i * Math.PI / 180
}
const Kt = async (i, r, e = 0) => {
    const t = await Yt(i),
        o = document.createElement("canvas"),
        n = o.getContext("2d"),
        s = 2 * (Math.max(t.width, t.height) / 2 * Math.sqrt(2));
    o.width = s, o.height = s, n.translate(s / 2, s / 2), n.rotate(Vt(e)), n.translate(-s / 2, -s / 2), n.drawImage(t, s / 2 - t.width * .5, s / 2 - t.height * .5);
    const l = n.getImageData(0, 0, s, s);
    return o.width = r.width, o.height = r.height, n.putImageData(l, 0 - s / 2 + t.width * .5 - r.x, 0 - s / 2 + t.height * .5 - r.y), o.toDataURL("image/jpeg")
}, Xe = 2, Jt = i => {
    const [r, e] = m.useState(i.imageUrl ? [{
        uid: ut(),
        name: "Image",
        thumbUrl: i.imageUrl,
        url: i.imageUrl
        ...
        let u = p.url;
        u || (u = await new Promise(w => {
            const C = new FileReader;
            C.readAsDataURL(p.originFileObj), C.onload = () => w(C.result)
        }));
        const h = new Image;
        h.src = u;
        ...
        const u = p.type === "image/jpeg";
        u || Ie.error("You can only upload JPEG files!");
        const h = p.size / 1024 / 1024 < Xe;
        return h || Ie.error(`Image must be less than ${Xe}MB!`), u && h
    }, l = p => new Promise(u => {
        const h = new FileReader;
        h.readAsDataURL(p), h.onload = () => {
            const f = h.result;
            u(f)
        }
    }), c = async () => {
        try {
            const p = await l(r[0].originFileObj),
                u = await Kt(p, t);
            i.onImageChange(u)
        } catch {
            i.onImageChange(i.imageUrl)
        }
    };
    return Me.useEffect(() => {
        r.length ? c().then(p => !0).catch(p => !1) : i.onImageChange()
    }, [r.length, t]), d.jsxs(Me.Fragment, {
        children: [d.jsxs(eo, {
            children: [d.jsxs(to, {
                children: [d.jsx(Ye, {
...
`, ae = K.div.attrs({
  ...
  padding: 10px;
  border-radius: 6px;
`, ro = "https://docs.creative.gimkit.com/general/publishing/community-rules-for-publishing-with-gimkit-creative", Lr = i => {
    const [r, e, t] = ht(!1), [o] = B.useForm(), n = xt(), a = c => {
        o.setFieldsValue({
            imageUrl: c
        })
    }, s = c => {
    ...
    return d.jsxs(B, {
        ...
        initialValues: {
            ...
            imageUrl: i.imageUrl,
            educationalRating: i.educationalRating
        },
        children: [d.jsx(ue, {
            label: "Name"
        }), d.jsx(B.Item, {
            ...
            rules: [{
                required: !0,
                validator: (c, p) => p ? Promise.resolve() : Promise.reject("Please accept")
            }],
            children: d.jsxs(Oe, {
                children: ["I confirm that all content written/upload above and all content in my map follow the ", l]
            })
        }), d.jsx(B.Item, {
            valuePropName: "checked",
            name: "ban",
            ...
            children: d.jsxs(Oe, {
                children: ["I understand that my account may be permanently banned if I violate the ", l]
            })
        }), d.jsx(mt, {}), d.jsx(B.Item, {
            children: d.jsx(Ve, {
                type: "primary",
                htmlType: "submit",
                block: !0,
                ...
                icon: d.jsx(yt, {}),
                loading: r,
                children: i.isForUpdating ? "Save Changes" : `Publish for ${n?"Free":"1,000 "+gt.currency}`
            })
        }), !n && !i.isForUpdating ? d.jsx("div", {
            className: "maxWidth",
            style: {
                marginTop: -10,
                textAlign: "center"
            },
            children: d.jsxs(_e.Text, {
    ...
    children: [d.jsx(_e.Text, {
        style: {
            fontWeight: Ke.Bold,
            color: me.White
        },
        children: i.label
    }), i.description ? d.jsx("div", {
        children: d.jsx(_e.Text, {
            style: {
                marginTop: 5
            },

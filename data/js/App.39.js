...
b.register('.....', function (c, d) {
    ...
    var _s = () => {
        ...
        return w && n.default[w] && (i.default.login.accountType = n.default[w]), g.useEffect(() => {
            ...
            children: [
                (0, f.jsx)(l.Title, { title: x ? 'Join Class' : t ? 'Login' : 'Sign Up' }),
                (0, f.jsx)(h.default.Provider, {
                    value: i.default,
                    children: (0, f.jsx)(_t, { children: (0, f.jsx)(k.default, {}) })
                })
            ]
        });
    };
    const _t = j.default.div(r || (r = (u => u)`
...
`));
    ...
    var e = b('.....'), f = b('.....'), g = b('.....'), h = b('.....'), i = b('.....'), j = b('.....'), k = b('.....'), l = b('.....'), m = b('.....'), n = b('.....'), o = b('.....'), p = b('.....'), q = b('.....'), r = b('.....'), s = b('.....'), t = b('.....'), u = b('.....'), v = b('.....'), w = b('.....'), x = b('.....'), y = b('.....'), z = b('.....'), A = b('.....');
    let B;
    var _C = (0, g.observer)(() => {
        const {
                login: D,
                navigation: E
            } = f.useContext(s.default), {currentStage: F} = (0, j.default)(), [G, H] = f.useState(!0), [I, J] = f.useState(!1);
        f.useEffect(() => {
            ...
            K ? (0, x.request)({
                ...
                success: L => {
                    E.classJoiningId = K, E.classJoiningName = L.groupName, E.classJoiningTeacherName = L.teacherName, D.accountType = z.default.student, E.redirectUri || (E.redirectUri = `/class/join/${ K }`), H(!1);
                },
        ...
        return G ? (0, e.jsx)(_D, {}) : (0, e.jsxs)(_D, {
            children: [
                (0, e.jsx)(k.default, { message: F === l.default.email && I ? 'Password changed successfully!' : '' }),
                (() => {
                    ...
                    return K === l.default.email ? (0, e.jsx)(m.default, {}) : K === l.default.password ? (0, e.jsx)(n.default, {}) : K === l.default.accountType ? (0, e.jsx)(o.default, {}) : K === l.default.nameAndPassword ? (0, e.jsx)(p.default, {}) : K === l.default.school ? (0, e.jsx)(q.default, {}) : K === l.default.educatorSpecificInfo ? (0, e.jsx)(r.default, {}) : K === l.default.acceptPolicies ? (0, e.jsx)(w.default, {}) : K === l.default.nonSchoolSpecificInfo ? (0, e.jsx)(y.default, {}) : null;
                })()
            ]
        });
    });
    const _D = h.default.div.attrs({ className: 'scroll-y' })(B || (B = (E => E)`
  width: 90%;
  max-width: 520px;
  padding: 20px;
  background: ${ 0 };
...
`), i.default.White);
    ...
    var e = b('.....'), f = b('.....'), g = b('.....');
    var _h = () => {
        const {informationNeeded: i} = f.default.login, j = (k => k.includes(g.informationTypes.email) ? e.default.email : k.includes(g.informationTypes.password) ? e.default.password : k.includes(g.informationTypes.acceptedLatestPolicies) ? e.default.acceptPolicies : k.includes(g.informationTypes.accountType) ? e.default.accountType : k.includes(g.informationTypes.accountPassword) || k.includes(g.informationTypes.firstName) || k.includes(g.informationTypes.lastName) ? e.default.nameAndPassword : k.includes(g.informationTypes.country) ? e.default.school : k.includes(g.informationTypes.areaOfExpertise) || k.includes(g.informationTypes.gradeLevel) ? e.default.educatorSpecificInfo : k.includes(g.informationTypes.organization) ? e.default.nonSchoolSpecificInfo : null)(i);
        return { currentStage: j };
    };
}), b.register('.....', function (c, d) {
    a(c.exports, 'default', function () {
        return _t;
    ...
    let o, p, q, r, s = t => t;
    var _t = (0, k.observer)(u => {
        const {navigation: v} = f.useContext(l.default), w = !!v.classJoiningName, x = w ? '/client/img/gimkitGIcon.svg' : '/client/img/svgLogo.svg', y = w ? 55 : 42;
        return (0, e.jsxs)(_u, {
            children: [
                u.message && (0, e.jsx)(h.default, {
                ...
                v.classJoiningName ? (0, e.jsxs)(e.Fragment, {
                    children: [
                        (0, e.jsx)(_w, { children: v.classJoiningName }),
                        (0, e.jsx)(_x, { children: v.classJoiningTeacherName })
                    ]
                }) : null,
                (0, e.jsx)(i.default, {})
            ]
...
`)), _w = g.default.div(q || (q = s`
  ...
  font-size: 28px;
  font-weight: ${ 0 };
`), m.default.Black, n.FontWeights.Bold), _x = g.default.div(r || (r = s`
...
`));
    ...
    var _p = (0, b('.....').observer)(() => {
        const {
                ...
                w || r.loggingIn || (q.password = s, q.informationNeeded.replace(q.informationNeeded.filter(y => y !== o.informationTypes.password)));
            };
        return (0, e.jsxs)(e.Fragment, {
            children: [
                ...
                (0, e.jsx)(i.default.Password, {
                    ...
                    onPressEnter: x,
                    onChange: y => {
                        r.loginError = null, t(y.target.value);
                    }
                }),
                (0, e.jsx)(k.default, {
                    onClick: x,
    ...
    let q, r, s = t => t;
    const t = u => (0, e.jsx)(_w, {
        backgroundColor: u.background,
        onClick: u.handleSelect,
        children: u.children
    });
    var _u = (0, g.observer)(() => {
        const [v, w] = f.useState(!0), {login: x} = f.useContext(k.default), y = () => x.informationNeeded.replace(x.informationNeeded.filter(z => z !== m.informationTypes.accountType)), z = () => x.googleToken || x.userExists ? [] : [
                ...
                (0, e.jsxs)(_v, {
                    children: [
                        (0, e.jsxs)(t, {
                            ...
                            background: '#33691e',
                            children: [
                                (0, e.jsx)('div', { children: (0, e.jsx)('i', { className: 'fas fa-chalkboard-teacher' }) }),
                                'Educator'
                            ]
                        }),
                        (0, e.jsxs)(t, {
                            ...
                            background: '#9E5F28',
                            children: [
                                (0, e.jsx)('div', { children: (0, e.jsx)('i', { className: 'fas fa-user' }) }),
                                'Student'
                            ]
                        })
                    ]
  ...
  flex-wrap: wrap;
  margin-top: 20px;
`)), _w = j.default.div.attrs({ className: 'flex-center flex-column light-shadow' })(r || (r = s`
  border-radius: 4px;
  font-weight: ${ 0 };
  color: ${ 0 };
  background: ${ 0 };
...
`), h.FontWeights.Bold, i.default.White, x => x.backgroundColor, x => (0, o.lighten)(0.1, x.backgroundColor));
}), b.register('.....', function (c, d) {
    let e;
    var f;
    a(c.exports, 'default', function () {
    ...
    var e = b('.....'), f = b('.....'), g = b('.....'), h = b('.....'), i = b('.....'), j = b('.....'), k = b('.....'), l = b('.....'), m = b('.....'), n = b('.....'), o = b('.....');
    const _p = 20, _q = 25, _r = s => (0, e.jsx)('div', {
            style: {
    ...
    var _t = () => {
        const {login: u} = f.useContext(g.default), [v, w] = f.useState(u.firstName), [x, y] = f.useState(u.lastName), [z, A] = f.useState(u.password), B = () => {
                let C = !0;
                ...
                B() && (v && (u.firstName = v), x && (u.lastName = x), z && (u.password = z), u.informationNeeded.replace(u.informationNeeded.filter(D => D !== m.informationTypes.firstName && D !== m.informationTypes.lastName && D !== m.informationTypes.accountPassword)));
            }, D = u.accountType === o.default.student;
        return (0, e.jsxs)(e.Fragment, {
            children: [
                (0, e.jsx)(_r, { children: 'First Name' }),
                (0, e.jsx)(k.default, {
                    maxLength: _p,
                    style: s,
                    size: 'large',
                ...
                (0, e.jsx)('div', { style: { height: 10 } }),
                !D && (0, e.jsx)(n.default, { link: 'https://www.notion.so/gimkit/First-Last-Name-8983e473b6bb4450aaf2f413702cc061' })
            ]
        });
    };
}), b.register('.....', function (c, d) {
    ...
    b('.....');
    var f = b('.....');
    var _g = h => (0, e.jsxs)('div', {
        style: { justifyContent: 'space-between' },
        className: 'flex maxWidth',
        children: [
            (0, e.jsx)('div', {}),
            (0, e.jsx)(f.default, { link: h.link })
        ]
    });
}), b.register('.....', function (c, d) {
    a(c.exports, 'default', function () {
    ...
    var _u = () => {
        const {login: v} = f.useContext(r.default), [w, x] = f.useState(''), [y, z] = f.useState(!1), [A, B] = f.useState(''), [C, D] = f.useState(!1), [E, F] = f.useState(!1), [G, H] = f.useState([]);
        f.useEffect(() => {
            A && (F(!0), (0, n.request)({
                ...
                data: { zipCode: A },
                success: I => {
                    I && I.schoolList && I.schoolList.length ? (H(I.schoolList), z(!1)) : _I();
                },
                error: () => _I(),
                both: () => F(!1)
            }));
        ...
        const _I = J => {
                v.country = J || w, v.informationNeeded.replace(v.informationNeeded.filter(K => K !== s.informationTypes.country));
            }, J = (K, L) => {
                v.schoolId = K, v.districtId = L, _I();
            };
        return (0, e.jsxs)(e.Fragment, {
            children: [
                G && G.length && !y ? (0, e.jsx)(e.Fragment, {
                    children: (0, e.jsxs)('div', {
                        ...
                        children: [
                            (0, e.jsx)('i', { className: 'fad fa-long-arrow-left' }),
                            ' Go Back'
                        ]
                    })
                }) : null,
                ...
                !G.length && (0, e.jsxs)(e.Fragment, {
                    children: [
                        !y && (0, e.jsxs)(e.Fragment, {
                            children: [
                                (0, e.jsx)(m.Title, { children: '\uD83D\uDDFA️ Country' }),
                                (0, e.jsx)(k.default, {
                                    style: { width: '100%' },
                                    showSearch: !0,
                                    ...
                                    filterOption: (K, L) => L.props.children.toLowerCase().indexOf(K.toLowerCase()) >= 0,
                                    size: 'large',
                                    children: Object.keys(g.countries).sort(K => 'US' === K ? 1 : -1).reverse().map(K => {
                                        const L = g.countries[K];
                                        let M = '';
                                        return L.emoji && (M += `${ L.emoji } `), L.name && ('United States' === L.name ? M += 'United States Of America' : M += L.name), (0, e.jsx)(k.default.Option, {
                                            value: K,
                                            children: M
                                        }, K);
                                    })
                        ...
                        !E && y && (0, e.jsxs)(e.Fragment, {
                            children: [
                                (0, e.jsx)(m.Title, { children: '\uD83C\uDDFA\uD83C\uDDF2 Zip Code of School' }),
                                (0, e.jsx)(j.default, {
                                    onChange: K => {
                                        const L = K.target.value;
                                        D(!1), L && 5 === String(L).length && B(L);
                                    },
                                    type: 'number',
                ...
                E && (0, e.jsx)(l.default, { size: 'large' }),
                G && G.length ? (0, e.jsxs)(e.Fragment, {
                    children: [
                        G.map(K => (0, e.jsx)(o.default, {
                            name: K.schoolName,
                            description: `${ K.address.city }, ${ K.address.stateFull }`,
                            onSelect: () => J(K && K.schoolid ? K.schoolid : null, K && K.district && K.district.districtID ? K.district.districtID : null)
                        }, K.schoolid)),
                        (0, e.jsx)(o.default, {
                            name: 'Other',
                ...
                (0, e.jsx)(i.default, {}),
                (0, e.jsx)(t.default, { link: 'https://www.notion.so/gimkit/Country-Zip-Code-School-9bca6de77686407cad0a4298a4a1d00e' })
            ]
        });
    };
}), b.register('.....', function (c, d) {
    c.exports, c.exports = function (e) {
        ...
        return g.m = e, g.c = f, g.d = function (i, j, k) {
            g.o(i, j) || Object.defineProperty(i, j, {
                enumerable: !0,
                get: k
            });
        }, g.r = function (i) {
            ...
            if (1 & j && (i = g(i)), 8 & j)
                return i;
            if (4 & j && 'object' == typeof i && i && i.__esModule)
                return i;
            var k = Object.create(null);
            if (g.r(k), Object.defineProperty(k, 'default', {
                    enumerable: !0,
                    value: i
                }), 2 & j && 'string' != typeof i)
                for (var l in i)
        ...
        function (e, f, g) {
            var h = g(2), i = g(3), j = g(4), k = g(5), l = g(6).ucs2, m = 127462 - 'A'.charCodeAt(0), n = /^[A-Z]{2}$/;
            e.exports = {
                continents: h,
                countries: i,
                languages: j,
        ...
        function (e, f, g) {
            (function (h, i) {
                ...
                !function (l) {
                    var m = 'object' == k(f) && f && !f.nodeType && f, n = 'object' == k(h) && h && !h.nodeType && h, o = 'object' == (void 0 === i ? 'undefined' : k(i)) && i;
                    o.global !== o && o.window !== o && o.self !== o || (l = o);
                    var p, q, r = 2147483647, s = /^xn--/, t = /[^\x20-\x7E]/, u = /[\x2E\u3002\uFF0E\uFF61]/g, v = {
                            overflow: 'Overflow: input needs wider integers to process',
                            'not-basic': 'Illegal input >= 0x80 (not a basic code point)',
                            'invalid-input': 'Invalid input'
                        }, w = Math.floor, x = String.fromCharCode;
                    function y(z) {
                    ...
                    function C(D, E) {
                        var F = D.split('@'), G = '';
                        return F.length > 1 && (G = F[0] + '@', D = F[1]), G + z((D = D.replace(u, '.')).split('.'), E).join('.');
                    }
                    function F(G) {
                        for (var H, I, J = [], K = 0, L = G.length; K < L;)
                            (H = G.charCodeAt(K++)) >= 55296 && H <= 56319 && K < L ? 56320 == (64512 & (I = G.charCodeAt(K++))) ? J.push(((1023 & H) << 10) + (1023 & I) + 65536) : (J.push(H), K--) : J.push(H);
                        return J;
                    }
                    function L(M) {
                        return z(M, function (N) {
                            var O = '';
                    ...
                    function N(O, P, Q) {
                        var R = 0;
                        for (O = Q ? w(O / 700) : O >> 1, O += w(O / P); O > 455; R += 36)
                            O = w(O / 35);
                        return w(R + 36 * O / (O + 38));
                    }
                    function P(Q) {
                        var R, S, T, U, V, W, X, Y, Z, $, ab, bb = [], cb = Q.length, db = 0, eb = 128, fb = 72;
                        for ((S = Q.lastIndexOf('-')) < 0 && (S = 0), T = 0; T < S; ++T)
                            Q.charCodeAt(T) >= 128 && y('not-basic'), bb.push(Q.charCodeAt(T));
                        for (U = S > 0 ? S + 1 : 0; U < cb;) {
                            for (V = db, W = 1, X = 36; U >= cb && y('invalid-input'), ((Y = (ab = Q.charCodeAt(U++)) - 48 < 10 ? ab - 22 : ab - 65 < 26 ? ab - 65 : ab - 97 < 26 ? ab - 97 : 36) >= 36 || Y > w((r - db) / W)) && y('overflow'), db += Y * W, !(Y < (Z = X <= fb ? 1 : X >= fb + 26 ? 26 : X - fb)); X += 36)
                                W > w(r / ($ = 36 - Z)) && y('overflow'), W *= $;
                            fb = N(db - V, R = bb.length + 1, 0 == V), w(db / R) > r - eb && y('overflow'), eb += w(db / R), db %= R, bb.splice(db++, 0, eb);
                        }
                        return L(bb);
                    }
                    function fb(gb) {
                        var hb, ib, jb, kb, lb, mb, nb, ob, pb, qb, rb, sb, tb, ub, vb, wb = [];
                        for (sb = (gb = F(gb)).length, hb = 128, ib = 0, lb = 72, mb = 0; mb < sb; ++mb)
                            (rb = gb[mb]) < 128 && z.push(fb(rb));
                        for (jb = kb = z.length, kb && z.push('-'); jb < sb;) {
                            for (nb = r, mb = 0; mb < sb; ++mb)
                                (rb = gb[mb]) >= hb && rb < nb && (nb = rb);
                            for (nb - hb > w((r - ib) / (tb = jb + 1)) && y('overflow'), ib += (nb - hb) * tb, hb = nb, mb = 0; mb < sb; ++mb)
                                if ((rb = gb[mb]) < hb && ++ib > r && y('overflow'), rb == hb) {
                                    for (ob = ib, pb = 36; !(ob < (qb = pb <= lb ? 1 : pb >= lb + 26 ? 26 : pb - lb)); pb += 36)
                                        vb = ob - qb, ub = 36 - qb, z.push(fb(M(qb + vb % ub, 0))), ob = w(vb / ub);
                                    z.push(fb(M(ob, 0))), lb = N(ib, tb, jb == kb), ib = 0, ++jb;
                                }
                            ++ib, ++hb;
                        }
                        return z.join('');
                    ...
                    if (qb = {
                            ...
                            encode: fb,
                            toASCII: function (wb) {
                                return C(wb, function (xb) {
                                    return tb.test(xb) ? 'xn--' + fb(xb) : xb;
                                });
                            },
                            toUnicode: function (wb) {
                                return C(wb, function (xb) {
                                    return sb.test(xb) ? P(xb.slice(4).toLowerCase()) : xb;
                                });
                            }
                        }, 'object' == lb(ib(0)) && ib(0))
                        void 0 === (kb = function () {
                            return qb;
                        }.call(hb, ib, hb, h)) || (h.exports = kb);
                    else if (nb && ob)
                        if (h.exports == nb)
                            ob.exports = qb;
                        else
                            for (rb in qb)
                                qb.hasOwnProperty(rb) && (nb[rb] = qb[rb]);
                    else
                        mb.punycode = qb;
                }(this);
            }.call(this, g(7)(e), g(8)));
        ...
        function (e, f) {
            e.exports = function (g) {
                return g.webpackPolyfill || (g.deprecate = function () {
                }, g.paths = [], g.children || (g.children = []), Object.defineProperty(g, 'loaded', {
                    enumerable: !0,
                    get: function () {
                        return g.l;
                    }
    ...
    var _q = () => {
        const {login: r} = f.useContext(k.default), [s, t] = f.useState(''), [u, v] = f.useState(''), w = !s || !u;
        return (0, e.jsxs)(e.Fragment, {
            children: [
                (0, e.jsx)(g.Title, { children: '\uD83D\uDCA1 Area of Expertise' }),
                (0, e.jsx)(i.default, {
                    style: { width: '100%' },
                ...
                (0, e.jsx)('div', { style: { height: 10 } }),
                (0, e.jsx)(g.Title, { children: '\uD83C\uDF82 Grade Level' }),
                (0, e.jsx)(i.default, {
                    style: { width: '100%' },
                    placeholder: 'Select one...',
                    size: 'large',
                ...
                (0, e.jsx)(j.default, {
                    ...
                    disabled: w,
                    onClick: () => {
                        w || (r.areaOfExpertise = s, r.gradeLevel = u, r.informationNeeded.replace(r.informationNeeded.filter(x => x !== l.informationTypes.areaOfExpertise && x !== l.informationTypes.gradeLevel)));
                    },
                    children: 'Continue'
                }),
                (0, e.jsx)(h.default, {}),
                ...
                (0, e.jsx)('div', { style: { height: 25 } }),
                (0, e.jsx)(m.default, { link: 'https://www.notion.so/gimkit/Area-of-Expertise-Grade-Level-a435b570d18844c78f323708686e0f52' })
            ]
        });
    };
}), b.register('.....', function (c, d) {
        ...
        if (p.userExists) {
            const t = () => {
                ...
                q.loggingIn = !0, (0, f.request)({
                    ...
                    data: u,
                    success: v => {
                        if (k.default.user.setUser(v.user, !0), p.authenticated = !0, v.modal && v.modal.type && i.default[v.modal.type]({
                                title: 'Account Information',
                                content: v.modal.message
                            }), v.informationNeeded.length)
                            p.informationNeeded.replace([
                                ...p.informationNeeded,
                                ...v.informationNeeded
                            ]);
                        else {
                            let w = e.default.navigation.redirectUri;
                            w || (w = h.DASHBOARD), w.includes('logout') && (w = h.DASHBOARD), r ? s() : (0, m.NavigateTo)(w);
                        }
                    },
                    error: v => {
                        e.default.navigation.loginError = v, e.default.login.password ? e.default.login.informationNeeded.replace([
            ...
            if (p.authenticated) {
                const u = (() => {
                    const {login: v} = e.default, w = Object.keys(v), x = [];
                    return w.forEach(y => {
                        const z = v[y];
                        '' !== z && null != z && ('accountType' === y && x.push({
            ...
            e.default.navigation.creatingAccount = !0, (0, f.request)({
                ...
                data: v,
                success: w => {
                    sessionStorage.setItem('NEW_USER', 'YES'), k.default.user.setUser(w, !0);
                    let x = e.default.navigation.redirectUri;
                    x || (x = h.DASHBOARD), r ? s() : (0, m.NavigateTo)(x);
                },
                error: w => {
    ...
    var e = b('.....'), f = b('.....'), g = b('.....'), h = b('.....'), i = b('.....'), j = b('.....'), k = b('.....'), l = b('.....'), m = b('.....');
    var _n = (0, g.observer)(() => {
        const {login: o} = f.useContext(h.default);
        return (0, e.jsxs)(e.Fragment, {
            children: [
                (0, e.jsxs)('div', {
                    style: {
                ...
                (0, e.jsx)(l.default, {
                    ...
                    size: 'large',
                    onClick: () => {
                        o.acceptsLatestPolicies = !0, o.informationNeeded.replace(o.informationNeeded.filter(p => p !== i.informationTypes.acceptedLatestPolicies));
                    },
                    children: 'I Agree'
                })
            ]
    ...
    var _m = () => {
        const [n, o] = f.useState(''), {login: p} = f.useContext(j.default), q = () => {
                p.organization = n, p.informationNeeded.replace(p.informationNeeded.filter(r => r !== k.informationTypes.organization));
            };
        return (0, e.jsxs)(e.Fragment, {
            children: [
                (0, e.jsx)(g.Title, { children: 'Organization (optional)' }),
                (0, e.jsx)(h.default, {
                    size: 'large',
                    style: { width: '100%' },
                ...
                (0, e.jsx)('div', { style: { height: 10 } }),
                (0, e.jsx)(l.default, { link: 'https://www.notion.so/gimkit/Organization-0931f4ca9b48423c97663801d8b95387' })
            ]
        });
    };
}), b.register('.....', function (c, d) {
    ...
    function _h(i, j, k) {
        return function (l) {
            const {
                    prefixCls: m,
                    style: n
                } = l, o = f.useRef(null), [p, q] = f.useState(0), [r, s] = f.useState(0), [t, u] = (0, e.default)(!1, { value: l.open }), {getPrefixCls: v} = f.useContext(g.ConfigContext), w = v(j || 'select', m);
            return f.useEffect(() => {
                if (u(!0), 'undefined' != typeof ResizeObserver) {
                    const x = new ResizeObserver(y => {
                            const z = y[0].target;
                            q(z.offsetHeight + 8), s(z.offsetWidth);
                        }), y = setInterval(() => {
                            var z;
                            const A = k ? `.${ k(w) }` : `.${ w }-dropdown`, B = null === (z = o.current) || void 0 === z ? void 0 : z.querySelector(A);
    ...
    const g = new (0, e.Keyframes)('antMoveDownIn', {
            ...
            const {antCls: q} = o, r = `${ q }-${ p }`, {
                    inKeyframes: s,
                    outKeyframes: t
                } = m[p];
            return [
                (0, f.initMotion)(r, s, t, o.motionDurationMid),
                {
                    [`\n        ${ r }-enter,\n        ${ r }-appear\n      `]: {
                        opacity: 0,
                        animationTimingFunction: o.motionEaseOutCirc
                    },
                    [`${ r }-leave`]: { animationTimingFunction: o.motionEaseInOutCirc }
                }
            ];
        };
}), b.register('.....', function (c, d) {

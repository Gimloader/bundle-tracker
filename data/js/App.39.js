...
`), i.default.White);
    ...
    var _t = (0, k.observer)(u => {
        const {
            navigation: v
        } = f.useContext(l.default), w = !!v.classJoiningName, x = w ? '/client/img/gimkitGIcon.svg' : '/client/img/svgLogo.svg', y = w ? 55 : 42;
        return (0, e.jsxs)(_u, {
            children: [
                ...
                v.classJoiningName ? (0, e.jsxs)(e.Fragment, {
                    children: [
                        (0, e.jsx)(_w, {
                            children: v.classJoiningName
                        }),
                        (0, e.jsx)(_x, {
                            children: v.classJoiningTeacherName
                        })
                    ]
                }) : null,
                (0, e.jsx)(i.default, {})
...
`));
    ...
    var _u = (0, g.observer)(() => {
        const [v, w] = f.useState(!0), {
            login: x
        } = f.useContext(k.default), y = () => x.informationNeeded.replace(x.informationNeeded.filter(z => z !== m.informationTypes.accountType)), z = () => x.googleToken || x.userExists ? [] : [

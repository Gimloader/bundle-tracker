...
c.register('.....', function (d, e) {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = function (x, y) {
            var z = {};
            for (var A in x)
    ...
    const x = 'SECRET_COMBOBOX_MODE_DO_NOT_USE', y = (z, A) => {
            var {
                    prefixCls: B,
                    bordered: C = !0,
                    className: D,
            ...
            let mb;
            mb = void 0 !== N ? N : 'combobox' === eb ? null : (null == T ? void 0 : T('Select')) || k.createElement(m.default, { componentName: 'Select' });
            const {
                    suffixIcon: nb,
                    itemIcon: ob,
                    removeIcon: pb,
                    ...
                    'suffixIcon',
                    'itemIcon'
                ]), sb = a(f)(G || H, { [`${ Z }-dropdown-${ U }`]: 'rtl' === U }, E, db), tb = ab || L || Y, ub = k.useContext(n.default), vb = null != M ? M : ub, wb = a(f)({
                    [`${ Z }-lg`]: 'large' === tb,
                    [`${ Z }-sm`]: 'small' === tb,
                    [`${ Z }-rtl`]: 'rtl' === U,
                    [`${ Z }-borderless`]: !C,
        ...
        }, z = k.forwardRef(y), A = (0, u.default)(z);
    ...
    c('.....');
    var n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = c('.....'), x = c('.....'), y = c('.....'), z = c('.....');
    c('.....');
    var A = [
            'id',
            'mode',
    ...
    var C = n.forwardRef(function (D, E) {
            var F = D.id, G = D.mode, H = D.prefixCls, I = void 0 === H ? 'rc-select' : H, J = D.backfill, K = D.fieldNames, L = D.inputValue, M = D.searchValue, N = D.onSearch, O = D.autoClearSearchValue, P = void 0 === O || O, Q = D.onSelect, R = D.onDeselect, S = D.dropdownMatchSelectWidth, T = void 0 === S || S, U = D.filterOption, V = D.filterSort, W = D.optionFilterProp, X = D.optionLabelProp, Y = D.options, Z = D.children, $ = D.defaultActiveFirstOption, ab = D.menuItemSelectedIcon, bb = D.virtual, cb = D.listHeight, db = void 0 === cb ? 200 : cb, eb = D.listItemHeight, fb = void 0 === eb ? 20 : eb, gb = D.value, hb = D.defaultValue, ib = D.labelInValue, jb = D.onChange, kb = (0, k.default)(D, A), lb = (0, r.default)(F), mb = (0, o.isMultiple)(G), nb = !(Y || !Z), ob = n.useMemo(function () {
                ...
                }), rb = (0, j.default)(qb, 2), sb = rb[0], tb = rb[1], ub = (0, s.default)(Y, Z, pb, W, X), vb = ub.valueOptions, wb = ub.labelOptions, xb = ub.options, yb = n.useCallback(function (zb) {
                    ...
                    X,
                    vb
                ]), zb = (0, m.default)(hb, { value: gb }), Ab = (0, j.default)(zb, 2), Bb = Ab[0], Cb = Ab[1], Db = n.useMemo(function () {
                    var Eb, Fb = yb(Bb);
                    ...
                    yb,
                    G
                ]), Eb = (0, p.default)(Db, vb), Fb = (0, j.default)(Eb, 2), Gb = Fb[0], Hb = Fb[1], Ib = n.useMemo(function () {
                    if (!G && 1 === Gb.length) {
                        var Jb = Gb[0];
                    ...
                    return Gb.map(function (Kb) {
                        var Lb;
                        return (0, i.default)((0, i.default)({}, Kb), {}, { label: null !== (Lb = Kb.label) && void 0 !== Lb ? Lb : Kb.value });
                    });
                }, [
                    G,
                    Gb
            ...
            var Kb = (0, t.default)(function (Lb, Mb) {
                    ...
                    Gb,
                    G
                ]), Mb = (0, q.default)(Lb, pb, sb, ob, W), Nb = n.useMemo(function () {
                ...
                }, Rb = n.useState(null), Sb = (0, j.default)(Rb, 2), Tb = Sb[0], Ub = Sb[1], Vb = n.useState(0), Wb = (0, j.default)(Vb, 2), Xb = Wb[0], Yb = Wb[1], Zb = void 0 !== $ ? $ : 'combobox' !== G, $b = n.useCallback(function (ac, bc) {
                    var cc = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, dc = cc.source, ec = void 0 === dc ? 'keyboard' : dc;
                    ...
                    if (cc && Q) {
                        var fc = ec(), gc = (0, j.default)(fc, 2), hc = gc[0], ic = gc[1];
                        Q(hc, ic);
                    } else if (!cc && R && 'clear' !== dc) {
                        var jc = ec(), kc = (0, j.default)(jc, 2), lc = kc[0], mc = kc[1];
                        R(lc, mc);
                    }
            ...
            return n.createElement(x.default.Provider, { value: cc }, n.createElement(o.default, (0, f.default)({}, kb, {
                id: lb,
                prefixCls: I,
                ref: E,
                omitDomProps: B,
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = c('.....'), x = c('.....'), y = c('.....'), z = c('.....'), A = c('.....'), B = [
            'id',
            'prefixCls',
            'className',
            'showSearch',
    ...
    var E = s.forwardRef(function (F, G) {
            var H, I, J = F.id, K = F.prefixCls, L = F.className, M = F.showSearch, N = F.tagRender, O = F.direction, P = F.omitDomProps, Q = F.displayValues, R = F.onDisplayValuesChange, S = F.emptyOptions, T = F.notFoundContent, U = void 0 === T ? 'Not Found' : T, V = F.onClear, W = F.mode, X = F.disabled, Y = F.loading, Z = F.getInputElement, $ = F.getRawInputElement, ab = F.open, bb = F.defaultOpen, cb = F.onDropdownVisibleChange, db = F.activeValue, eb = F.onActiveValueChange, fb = F.activeDescendantId, gb = F.searchValue, hb = F.autoClearSearchValue, ib = F.onSearch, jb = F.onSearchSplit, kb = F.tokenSeparators, lb = F.allowClear, mb = F.showArrow, nb = F.inputIcon, ob = F.clearIcon, pb = F.OptionList, qb = F.animation, rb = F.transitionName, sb = F.dropdownStyle, tb = F.dropdownClassName, ub = F.dropdownMatchSelectWidth, vb = F.dropdownRender, wb = F.dropdownAlign, xb = F.placement, yb = F.getPopupContainer, zb = F.showAction, Ab = void 0 === zb ? [] : zb, Bb = F.onFocus, Cb = F.onBlur, Db = F.onKeyUp, Eb = F.onKeyDown, Fb = F.onMouseDown, Gb = (0, l.default)(F, B), Hb = _D(W), Ib = (void 0 !== M ? M : Hb) || 'combobox' === W, Jb = (0, k.default)({}, Gb);
            C.forEach(function (Kb) {
                delete Jb[Kb];
            }), null == P || P.forEach(function (Kb) {
                delete Jb[Kb];
            });
            var Kb = s.useState(!1), Lb = (0, j.default)(Kb, 2), Mb = Lb[0], Nb = Lb[1];
            s.useEffect(function () {
                Nb((0, p.default)());
            }, []);
            var Ob = s.useRef(null), Pb = s.useRef(null), Qb = s.useRef(null), Rb = s.useRef(null), Sb = s.useRef(null), Tb = (0, u.default)(), Ub = (0, j.default)(Tb, 3), Vb = Ub[0], Wb = Ub[1], Xb = Ub[2];
            ...
            var Yb = s.useMemo(function () {
                    ...
                    W,
                    Q
                ]), Zb = 'combobox' === W && 'function' == typeof Z && Z() || null, $b = 'function' == typeof $ && $(), ac = (0, r.useComposeRef)(Pb, null == $b || null === (H = $b.props) || void 0 === H ? void 0 : H.ref), bc = (0, o.default)(void 0, {
                    defaultValue: bb,
                    value: ab
                }), cc = (0, j.default)(bc, 2), dc = cc[0], ec = cc[1], fc = dc, gc = !U && S;
            (X || gc && fc && 'combobox' === W) && (fc = !1);
            var hc = !gc && fc, ic = s.useCallback(function (jc) {
                ...
                }, [kb]), kc = function (lc, mc, nc) {
                    var oc = !0, pc = lc;
                    null == eb || eb(null);
                    var qc = nc ? null : (0, A.getSeparatedContent)(lc, kb);
                    return 'combobox' !== W && qc && (pc = '', null == jb || jb(qc), ic(!1), oc = !1), ib && Yb !== pc && ib(pc, { source: mc ? 'typing' : 'effect' }), oc;
                };
            s.useEffect(function () {
            ...
            var lc = (0, v.default)(), mc = (0, j.default)(lc, 2), nc = mc[0], oc = mc[1], pc = s.useRef(!1), qc = [];
            s.useEffect(function () {
                return function () {
            ...
            var rc, sc = s.useState(null), tc = (0, j.default)(sc, 2), uc = tc[0], vc = tc[1], wc = s.useState({}), xc = (0, j.default)(wc, 2)[1];
            ...
            var Cc, Dc = s.createElement(pb, { ref: Sb }), Ec = a(m)(K, L, (I = {}, (0, h.default)(I, ''.concat(K, '-focused'), Vb), (0, h.default)(I, ''.concat(K, '-multiple'), Hb), (0, h.default)(I, ''.concat(K, '-single'), !Hb), (0, h.default)(I, ''.concat(K, '-allow-clear'), lb), (0, h.default)(I, ''.concat(K, '-show-arrow'), Bc), (0, h.default)(I, ''.concat(K, '-disabled'), X), (0, h.default)(I, ''.concat(K, '-loading'), Y), (0, h.default)(I, ''.concat(K, '-open'), fc), (0, h.default)(I, ''.concat(K, '-customize-input'), Zb), (0, h.default)(I, ''.concat(K, '-show-search'), Ib), I)), Fc = s.createElement(y.default, {
                    ref: Qb,
                    disabled: X,
                    prefixCls: K,
                    visible: hc,
                ...
                }, $b ? s.cloneElement($b, { ref: ac }) : s.createElement(x.default, (0, g.default)({}, F, {
                    domRef: Pb,
                    prefixCls: K,
                    inputElement: Zb,
                    ref: Rb,
                    ...
                    onSearchSubmit: function (Gc) {
                        Gc && Gc.trim() && ib(Gc, { source: 'submit' });
                    },
            ...
            return Cc = $b ? Fc : s.createElement('div', (0, g.default)({ className: Ec }, Jb, {
                ref: Ob,
                onMouseDown: function (Gc) {
                    var Hc, Ic = Gc.target, Jc = null === (Hc = Qb.current) || void 0 === Hc ? void 0 : Hc.getPopupElement();
                ...
                onBlur: function () {
                    Wb(!1, function () {
                        pc.current = !1, ic(!1);
                    }), X || (Yb && ('tags' === W ? ib(Yb, { source: 'submit' }) : 'multiple' === W && ib('', { source: 'blur' })), Cb && Cb.apply(void 0, arguments));
                }
                ...
                var Hc = Gc.label, Ic = Gc.value;
                return [
                    'number',
                    'string'
                ].includes((0, f.default)(Hc)) ? Hc : Ic;
            }).join(', '))), Fc, yc, zc), s.createElement(t.BaseSelectContext.Provider, { value: Ac }, Cc);
        }), _F = E;
}), c.register('.....', function (d, e) {
    ...
    var f = c('.....'), g = c('.....');
    function _h() {
        var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 10, j = g.useState(!1), k = (0, f.default)(j, 2), l = k[0], m = k[1], n = g.useRef(null), o = function () {
    ...
    var f = c('.....');
    function _g() {
        var h = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 250, i = f.useRef(null), j = f.useRef(null);
        function k(l) {
    ...
    function _g(h, i, j, k) {
        ...
        _g.current = {
            ...
            return window.addEventListener('mousedown', m), function () {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = (h = c('.....'), c('.....')), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = function (o, p) {
            var q = (0, h.useRef)(null), r = (0, h.useRef)(!1), s = o.prefixCls, t = o.open, u = o.mode, v = o.showSearch, w = o.tokenWithEnter, x = o.autoClearSearchValue, y = o.onSearch, z = o.onSearchSubmit, A = o.onToggleOpen, B = o.onInputKeyDown, C = o.domRef;
            ...
            var D = (0, l.default)(0), E = (0, g.default)(D, 2), F = E[0], G = E[1], H = (0, h.useRef)(null), I = function (J) {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = (h = c('.....'), c('.....')), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....');
    function p(q) {
        var r;
    ...
    var r = function (s) {
            ...
            var u = t.id, v = t.prefixCls, w = t.values, x = t.open, y = t.searchValue, z = t.autoClearSearchValue, A = t.inputRef, B = t.placeholder, C = t.disabled, D = t.mode, E = t.showSearch, F = t.autoFocus, G = t.autoComplete, H = t.activeDescendantId, I = t.tabIndex, J = t.removeIcon, K = t.maxTagCount, L = t.maxTagTextLength, M = t.maxTagPlaceholder, N = void 0 === M ? function (O) {
                    return '+ '.concat(O.length, ' ...');
                } : M, O = t.tagRender, P = t.onToggleOpen, Q = t.onRemove, R = t.onInputChange, S = t.onInputPaste, T = t.onInputKeyDown, U = t.onInputMouseDown, V = t.onInputCompositionStart, W = t.onInputCompositionEnd, X = h.useRef(null), Y = (0, h.useState)(0), Z = (0, g.default)(Y, 2), $ = Z[0], ab = Z[1], bb = (0, h.useState)(!1), cb = (0, g.default)(bb, 2), db = cb[0], eb = cb[1], fb = ''.concat(v, '-selection'), gb = x || 'multiple' === D && !1 === z || 'tags' === D ? y : '', hb = 'tags' === D || 'multiple' === D && !1 === z || E && (x || db);
            function ib(jb, kb, lb, mb, nb) {
                ...
                }, h.createElement('span', { className: ''.concat(fb, '-item-content') }, kb), mb && h.createElement(l.default, {
            ...
            var jb = h.createElement('div', {
                    ...
                    'aria-hidden': !0
                }, gb, '\xA0')), kb = h.createElement(k.default, {
                    prefixCls: ''.concat(fb, '-overflow'),
                    data: w,
                    renderItem: function (lb) {
                        var mb = lb.disabled, nb = lb.label, ob = lb.value, pb = !C && !mb, qb = nb;
                    ...
                    renderRest: function (lb) {
                        ...
                        return ib({ title: mb }, mb, !1);
                    },
                    suffix: jb,
                    itemKey: p,
                    maxCount: K
                });
            return h.createElement(h.Fragment, null, kb, !w.length && !gb && h.createElement('span', { className: ''.concat(fb, '-placeholder') }, B));
        };
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _f;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = (j = c('.....'), c('.....')), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), _p = j.createContext(null), q = 'responsive', r = 'invalidate';
    function s(t) {
        return '+ '.concat(t.length, ' ...');
    }
    function t(u, v) {
        var w = u.prefixCls, x = void 0 === w ? 'rc-overflow' : w, y = u.data, z = void 0 === y ? [] : y, A = u.renderItem, _B = u.renderRawItem, C = u.itemKey, D = u.itemWidth, E = void 0 === D ? 10 : D, F = u.ssr, G = u.style, H = u.className, I = u.maxCount, J = u.renderRest, K = u.renderRawRest, L = u.suffix, M = u.component, N = void 0 === M ? 'div' : M, O = u.itemComponent, P = u.onVisibleChange, Q = (0, i.default)(u, [
                'prefixCls',
                'data',
                'renderItem',
                'renderRawItem',
                ...
                'itemComponent',
                'onVisibleChange'
            ]), R = (0, n.useBatchFrameState)(), S = 'full' === F, T = R(null), U = (0, h.default)(T, 2), V = U[0], W = U[1], X = V || 0, Y = R(new Map()), Z = (0, h.default)(Y, 2), $ = Z[0], ab = Z[1], bb = R(0), cb = (0, h.default)(bb, 2), db = cb[0], eb = cb[1], fb = R(0), gb = (0, h.default)(fb, 2), hb = gb[0], ib = gb[1], jb = R(0), kb = (0, h.default)(jb, 2), lb = kb[0], mb = kb[1], nb = (0, j.useState)(null), ob = (0, h.default)(nb, 2), pb = ob[0], qb = ob[1], rb = (0, j.useState)(null), sb = (0, h.default)(rb, 2), tb = sb[0], ub = sb[1], vb = j.useMemo(function () {
                return null === tb && S ? Number.MAX_SAFE_INTEGER : tb || 0;
            }, [
                tb,
                V
            ]), wb = (0, j.useState)(!1), xb = (0, h.default)(wb, 2), yb = xb[0], zb = xb[1], Ab = ''.concat(x, '-item'), Bb = Math.max(db, hb), Cb = t.length && I === q, Db = I === r, Eb = Cb || 'number' == typeof I && t.length > I, Fb = (0, j.useMemo)(function () {
                var Gb = t;
            ...
            }, [C]), Ib = (0, j.useCallback)(A || function (Jb) {
                return Jb;
            }, [A]);
        function Jb(Kb, Lb) {
        ...
        j.useLayoutEffect(function () {
            if (X && Bb && Fb) {
                var Mb = lb, Nb = Fb.length, Ob = Nb - 1;
                if (!Nb)
        ...
        if (K)
            K && (Ob = j.createElement(_p.Provider, { value: (0, g.default)((0, g.default)({}, Pb), Rb) }, K(Gb)));
        else {
            var Sb = J || s;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = void 0;
    function m(n, o) {
        var p = n.prefixCls, q = n.invalidate, r = n.item, s = n.renderItem, _t = n.responsive, u = n.registerSize, v = n.itemKey, w = n.className, x = n.style, y = n.children, z = n.display, A = n.order, B = n.component, C = void 0 === B ? 'div' : B, D = (0, h.default)(n, [
                'prefixCls',
                'invalidate',
                'item',
                'renderItem',
    ...
    var f = c('.....'), g = c('.....'), h = c('.....');
    function _i() {
        var j = (0, g.useState)({}), k = (0, f.default)(j, 2)[1], l = (0, g.useRef)([]), m = (0, g.useRef)(!1), n = 0, o = 0;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = function (m, n) {
            ...
            if (!o) {
                var p = m.component, q = void 0 === p ? 'div' : p, r = (0, g.default)(m, ['component']);
                return h.createElement(q, (0, f.default)({}, r, { ref: n }));
            }
            var s = o.className, t = (0, g.default)(o, ['className']), u = m.className, v = (0, g.default)(m, ['className']);
            return h.createElement(k.OverflowContext.Provider, { value: null }, h.createElement(j.default, (0, f.default)({
                ref: n,
                className: a(i)(s, u)
            }, t, v)));
        }, m = h.forwardRef(l);
    ...
    var f = c('.....'), g = c('.....'), _h = function (i) {
            var j, k = i.className, l = i.customizeIcon, m = i.customizeIconProps, n = i.onMouseDown, o = i.onClick, p = i.children;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = function (l, m) {
            var n, o, p = l.prefixCls, q = l.id, r = l.inputElement, s = l.disabled, t = l.tabIndex, u = l.autoFocus, v = l.autoComplete, w = l.editable, x = l.activeDescendantId, y = l.value, z = l.maxLength, A = l.onKeyDown, B = l.onMouseDown, C = l.onChange, D = l.onPaste, E = l.onCompositionStart, F = l.onCompositionEnd, G = l.open, H = l.attrs, I = r || g.createElement('input', null), J = I, K = J.ref, L = J.props, M = L.onKeyDown, N = L.onChange, O = L.onMouseDown, P = L.onCompositionStart, Q = L.onCompositionEnd, R = L.style;
            return (0, j.warning)(!('maxLength' in I.props), 'Passing \'maxLength\' to input element directly may not work because input in BaseSelect is controlled.'), I = g.cloneElement(I, (0, f.default)((0, f.default)((0, f.default)({ type: 'search' }, L), {}, {
                id: q,
                ...
                style: (0, f.default)((0, f.default)({}, R), {}, { opacity: w ? null : 0 }),
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), _k = function (l) {
            var m = l.inputElement, n = l.prefixCls, o = l.id, p = l.inputRef, q = l.disabled, r = l.autoFocus, s = l.autoComplete, t = l.activeDescendantId, u = l.mode, v = l.open, w = l.values, x = l.placeholder, y = l.tabIndex, z = l.showSearch, A = l.searchValue, B = l.activeValue, C = l.maxLength, D = l.onInputKeyDown, E = l.onInputMouseDown, F = l.onInputChange, G = l.onInputPaste, H = l.onInputCompositionStart, I = l.onInputCompositionEnd, J = g.useState(!1), K = (0, f.default)(J, 2), L = K[0], M = K[1], N = 'combobox' === u, O = N || z, P = w[0], Q = A || '';
            ...
            var R = !('combobox' !== u && !v && !z) && !!Q, S = (0, j.getTitle)(P);
            return g.createElement(g.Fragment, null, g.createElement('span', { className: ''.concat(n, '-selection-search') }, g.createElement(i.default, {
                ref: p,
                prefixCls: n,
                id: o,
                open: v,
                ...
                if (P)
                    return null;
                var T = R ? { visibility: 'hidden' } : void 0;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = [
            'prefixCls',
            'disabled',
            'visible',
            'children',
            ...
            var q = o.prefixCls, r = (o.disabled, o.visible), s = o.children, t = o.popupElement, u = o.containerWidth, v = o.animation, w = o.transitionName, x = o.dropdownStyle, y = o.dropdownClassName, z = o.direction, A = void 0 === z ? 'ltr' : z, B = o.placement, C = o.dropdownMatchSelectWidth, D = o.dropdownRender, E = o.dropdownAlign, F = o.getPopupContainer, G = o.empty, H = o.getTriggerDOMNode, I = o.onPopupVisibleChange, J = o.onPopupMouseEnter, K = (0, i.default)(o, m), L = ''.concat(q, '-dropdown'), M = t;
            D && (M = D(t));
            var N = j.useMemo(function () {
                ...
                }, [C]), O = v ? ''.concat(L, '-').concat(v) : w, P = j.useRef(null);
            ...
            var Q = (0, h.default)({ minWidth: u }, x);
    ...
    function _o(p) {
        var q = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r = q.fieldNames, s = q.childrenAsData, t = [], u = _m(r, !1), v = u.label, w = u.value, x = u.options;
        function y(z, A) {
    ...
    function _z(A, B) {
        ...
        var D = function A(E, F) {
            var G = (0, u.default)(F), H = G[0], I = G.slice(1);
            if (!H)
                return [E];
            var J = E.split(H);
    ...
    var f = c('.....'), g = c('.....'), _h = function (i, j) {
            ...
            return [
                g.useMemo(function () {
                    var l = k.current, m = l.values, n = l.options, o = i.map(function (p) {
                            var q;
                            return void 0 === p.label ? (0, f.default)((0, f.default)({}, p), {}, { label: null === (q = m.get(p.value)) || void 0 === q ? void 0 : q.label }) : p;
                        }), p = new Map(), q = new Map();
    ...
    var _l = function (m, n, o, p, q) {
        return h.useMemo(function () {
            if (!o || !1 === p)
                return m;
            var r = n.options, s = n.label, t = n.value, u = [], v = 'function' == typeof p, w = o.toUpperCase(), x = v ? p : function (y, z) {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = 0, j = (0, h.default)();
    function _k(l) {
        var m = g.useState(), n = (0, f.default)(m, 2), o = n[0], p = n[1];
    ...
    function _h(i, j, k, l, m) {
        return f.useMemo(function () {
            ...
            var o = new Map(), p = new Map(), q = function (r, s, t) {
    ...
    function l(m) {
        var n = m, o = n.key, p = n.props, q = p.children, r = p.value, s = (0, g.default)(p, j);
        return (0, f.default)({
            key: o,
            value: void 0 !== r ? r : o,
            children: q
    ...
    function _s(t) {
        ...
        return (0, r.default)(t).map(function (v, w) {
            if (!q.isValidElement(v) || !v.type)
                return null;
            var x = v, y = x.type.isSelectOptGroup, z = x.key, A = x.props, B = A.children, C = (0, g.default)(A, s);
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = (q = c('.....'), c('.....')), s = c('.....'), t = c('.....'), u = c('.....'), v = [
            'disabled',
            'title',
            'children',
            'style',
    ...
    var x = function (y, z) {
            var A = (0, r.default)(), B = A.prefixCls, C = A.id, D = A.open, E = A.multiple, F = A.mode, G = A.searchValue, H = A.toggleOpen, I = A.notFoundContent, J = A.onPopupScroll, K = q.useContext(s.default), L = K.flattenOptions, M = K.onActiveValue, N = K.defaultActiveFirstOption, O = K.onSelect, P = K.menuItemSelectedIcon, Q = K.rawValues, R = K.fieldNames, S = K.virtual, T = K.listHeight, U = K.listItemHeight, V = ''.concat(B, '-item'), W = (0, l.default)(function () {
                    return L;
                }, [
                    D,
                    L
                    ...
                    return Y[0] && X[1] !== Y[1];
                }), X = q.useRef(null), Y = function (Z) {
                    Z.preventDefault();
                }, Z = function ($) {
                    X.current && X.current.scrollTo('number' == typeof $ ? { index: $ } : $);
                }, $ = function (ab) {
                    for (var bb = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, cb = W.length, db = 0; db < cb; db += 1) {
                        var eb = (ab + db * bb + cb) % cb, fb = W[eb], gb = fb.group, hb = fb.data;
                        if (!gb && !hb.disabled)
                            return eb;
                    }
                    return -1;
                    ...
                    return $(0);
                }), bb = (0, j.default)(ab, 2), cb = bb[0], db = bb[1], eb = function (fb) {
                    var gb = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                    db(fb);
                    var hb = { source: gb ? 'keyboard' : 'mouse' }, ib = W[fb];
            ...
            (0, q.useEffect)(function () {
                var gb, hb = setTimeout(function () {
                        if (!E && D && 1 === Q.size) {
                            var ib = Array.from(Q)[0], jb = W.findIndex(function (kb) {
            ...
            var gb = function (hb) {
                void 0 !== hb && O(hb, { selected: !Q.has(hb) }), E || H(!1);
            };
            if (q.useImperativeHandle(z, function () {
                    return {
                        onKeyDown: function (hb) {
                            var ib = hb.which, jb = hb.ctrlKey;
                            switch (ib) {
                            case m.default.N:
                            case m.default.P:
                            case m.default.UP:
            ...
            var kb = function (lb) {
                    ...
                    if (!mb)
                        return null;
                    var nb = mb.data || {}, ob = nb.value, pb = mb.group, qb = (0, o.default)(nb, !0), rb = ib(mb);
                    return mb ? q.createElement('div', (0, h.default)({ 'aria-label': 'string' != typeof rb || pb ? null : rb }, qb, { key: lb }, jb(mb, lb), { 'aria-selected': fb(ob) }), ob) : null;
                }, lb = {
                    role: 'listbox',
                    id: ''.concat(C, '_list')
                };
            return q.createElement(q.Fragment, null, S && q.createElement('div', (0, h.default)({}, lb, {
                ...
                var ob, pb = mb.group, qb = mb.groupOption, rb = mb.data, sb = mb.label, tb = mb.value, ub = rb.key;
                if (pb) {
                ...
                var xb = rb.disabled, yb = rb.title, zb = (rb.children, rb.style), Ab = rb.className, Bb = (0, g.default)(rb, v), Cb = (0, n.default)(Bb, hb), Db = fb(tb), Eb = ''.concat(V, '-option'), Fb = a(k)(V, Eb, Ab, (ob = {}, (0, f.default)(ob, ''.concat(Eb, '-grouped'), qb), (0, f.default)(ob, ''.concat(Eb, '-active'), cb === nb && !xb), (0, f.default)(ob, ''.concat(Eb, '-disabled'), xb), (0, f.default)(ob, ''.concat(Eb, '-selected'), Db), ob)), Gb = ib(mb), Hb = !P || 'function' == typeof P || Db, Ib = 'number' == typeof Gb ? Gb : Gb || tb, Jb = w(Ib) ? Ib.toString() : void 0;
                return void 0 !== yb && (Jb = yb), q.createElement('div', (0, h.default)({}, (0, o.default)(Cb), S ? {} : jb(mb, nb), {
                    ...
                    style: zb
                }), q.createElement('div', { className: ''.concat(Eb, '-content') }, Ib), q.isValidElement(P) || Db, Hb && q.createElement(t.default, {
                    className: ''.concat(V, '-option-state'),
                    customizeIcon: P,
                    customizeIconProps: { isSelected: Db }
                }, Db ? '\u2713' : null));
            }));
        }, y = q.forwardRef(x);
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = (k = c('.....'), c('.....')), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = [
            'prefixCls',
            'className',
            'height',
            'itemHeight',
    ...
    function z(A, B) {
        var C = A.prefixCls, D = void 0 === C ? 'rc-virtual-list' : C, E = A.className, F = A.height, _G = A.itemHeight, H = A.fullHeight, I = void 0 === H || H, J = A.style, K = A.data, L = A.children, M = A.itemKey, N = A.virtual, O = A.component, P = void 0 === O ? 'div' : O, Q = A.onScroll, R = A.onVisibleChange, S = A.innerProps, T = (0, j.default)(A, w), U = !(!1 === N || !F || !_G), V = U && K && _G * K.length > F, W = (0, k.useState)(0), X = (0, i.default)(W, 2), Y = X[0], Z = X[1], $ = (0, k.useState)(!1), ab = (0, i.default)($, 2), bb = ab[0], cb = ab[1], db = a(l)(D, z), eb = K || x, fb = (0, k.useRef)(), gb = (0, k.useRef)(), hb = (0, k.useRef)(), ib = k.useCallback(function (jb) {
        ...
        var lb = (0, k.useRef)({
            ...
            }), mb = (0, k.useRef)(), nb = (0, r.default)(eb, ib), ob = (0, i.default)(nb, 1)[0];
        mb.current = ob;
        var pb = (0, p.default)(ib, null, null), qb = (0, i.default)(pb, 4), rb = qb[0], sb = qb[1], tb = qb[2], ub = qb[3], vb = k.useMemo(function () {
                if (!U)
                    return {
                        scrollHeight: void 0,
                        start: 0,
                ...
                for (var xb, yb, zb, Ab = 0, Bb = eb.length, Cb = 0; Cb < Bb; Cb += 1) {
                    var Db = eb[Cb], Eb = ib(Db), Fb = tb.get(Eb), Gb = Ab + (void 0 === Fb ? _G : Fb);
                ...
                ub,
                F
            ]), wb = vb.scrollHeight, xb = vb.start, yb = vb.end, zb = vb.offset;
        lb.current.start = xb, lb.current.end = yb;
        var Ab = wb - F, _Bb = (0, k.useRef)(Ab);
        _Bb.current = Ab;
        var Cb = Y <= 0, Db = Y >= Ab, Eb = (0, u.default)(Cb, Db);
        var Fb = (0, s.default)(U, Cb, Db, function (Gb) {
                kb(function (Hb) {
                    return Hb + Gb;
                });
            }), Gb = (0, i.default)(Fb, 2), Hb = Gb[0], Ib = Gb[1];
        (0, t.default)(U, fb, function (Jb, Kb) {
            ...
            return fb.current.addEventListener('wheel', Hb), fb.current.addEventListener('DOMMouseScroll', Ib), fb.current.addEventListener('MozMousePixelScroll', Jb), function () {
        ...
        var Kb = (0, o.default)(eb, xb, yb, rb, L, jb), Lb = null;
        return F && (Lb = (0, h.default)((0, g.default)({}, I ? 'height' : 'maxHeight', F), y), U && (Lb.overflowY = 'hidden', bb && (Lb.pointerEvents = 'none'))), k.createElement('div', (0, f.default)({
            style: (0, h.default)((0, h.default)({}, J), {}, { position: 'relative' }),
            className: db
        }, T), k.createElement(P, {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = i.forwardRef(function (m, n) {
            var o = m.height, p = m.offset, q = m.children, r = m.prefixCls, s = m.onInnerResize, t = m.innerProps, u = {}, v = {
                    display: 'flex',
            ...
            return void 0 !== p && (u = {
                ...
                right: 0,
                top: 0
            })), i.createElement('div', { style: u }, i.createElement(j.default, {
                onResize: function (w) {
                    w.offsetHeight && s && s();
                }
    ...
    var _o = function (p) {
        ...
        function r() {
            ...
            return (s = q.call.apply(q, [this].concat(u))).moveRaf = null, s.scrollbarRef = k.createRef(), s.thumbRef = k.createRef(), s.visibleTimeout = null, s.state = {
                ...
                clearTimeout(s.visibleTimeout), s.setState({ visible: !0 }), s.visibleTimeout = setTimeout(function () {
                ...
                var x = s.state, y = x.dragging, z = x.pageY, A = x.startTop, B = s.props.onScroll;
                if (m.default.cancel(s.moveRaf), y) {
                    var C = A + (n(w) - z), D = s.getEnableScrollRange(), E = s.getEnableHeightRange(), F = E ? C / E : 0, G = Math.ceil(F * D);
                ...
                s.setState({ dragging: !1 }), w(), s.removeEvents();
            }, s.getSpinHeight = function () {
                var w = s.props, x = w.height, y = x / w.count * 10;
                ...
                var w = s.props.scrollTop, x = s.getEnableScrollRange(), y = s.getEnableHeightRange();
                return 0 === w || 0 === x ? 0 : w / x * y;
            }, s.showScroll = function () {
                var w = s.props, x = w.height;
        ...
        return (0, h.default)(r, [
            ...
            },
            {
                key: 'render',
                value: function () {
                    var w = this.state, x = w.dragging, y = w.visible, z = this.props.prefixCls, A = this.getSpinHeight(), B = this.getTop(), C = this.showScroll(), D = C && y;
    ...
    var f = c('.....');
    function _g(h) {
        var i = h.children, j = h.setRef, k = f.useCallback(function (l) {
                j(l);
            }, []);
        return f.cloneElement(i, { ref: k });
    }
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _k;
    ...
    function _k(l, m, n) {
        var o = g.useState(0), p = (0, f.default)(o, 2), q = _k[0], r = _k[1], s = (0, g.useRef)(new Map()), t = (0, g.useRef)(new (0, j.default)()), u = (0, g.useRef)();
        function v() {
        ...
        function w() {
            v(), u.current = (0, i.default)(function () {
                s.current.forEach(function (x, y) {
                    if (x && x.offsetParent) {
                        var z = (0, h.default)(x), A = z.offsetHeight;
        ...
        return function (s) {
            if (null != s) {
                if (h.default.cancel(r.current), 'number' == typeof s)
                    ...
                    var v = s.offset, w = void 0 === v ? 0 : v;
                    !function f(x, y) {
                        if (!(x < 0) && j.current) {
                            var z = j.current.clientHeight, A = !1, B = y;
                            if (z) {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....');
    function _i(j, k, l) {
        var m = g.useState(j), n = (0, f.default)(m, 2), o = _i[0], p = _i[1], q = g.useState(null), r = (0, f.default)(q, 2), s = r[0], t = r[1];
        return g.useEffect(function () {
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....');
    function _j(k, l, m, n) {
        var o = (0, f.useRef)(0), p = (0, f.useRef)(null), q = (0, f.useRef)(null), r = (0, f.useRef)(!1), s = (0, i.default)(l, m);
        return [
            function (t) {
                if (k) {
    ...
    var f = c('.....'), _g = 'object' === ('undefined' == typeof navigator ? 'undefined' : (0, f.default)(navigator)) && /Firefox/i.test(navigator.userAgent);
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _g;
    });
    var f = c('.....'), _g = function (h, i) {
            var j = (0, f.useRef)(!1), k = (0, f.useRef)(null);
            function l() {
            ...
            return m.current.top = h, m.current.bottom = i, function (n) {
                var o = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], p = n < 0 && m.current.top || n > 0 && m.current.bottom;
    ...
    var f = c('.....'), g = c('.....');
    function _h(i, j, k) {
        var l, m = (0, f.useRef)(!1), n = (0, f.useRef)(0), o = (0, f.useRef)(null), p = (0, f.useRef)(null), q = function (r) {
                if (_h.current) {
                    var s = Math.ceil(r.touches[0].pageY), t = n.current - s;
        ...
        l = function () {
            ...
            return i && j.current.addEventListener('touchstart', s), function () {
                var t;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....');
    var _i = j => {
        const {componentName: k} = j, {getPrefixCls: l} = (0, f.useContext)(g.ConfigContext), m = l('empty');
        switch (k) {
        case 'Table':
        case 'List':
            return a(f).createElement(h.default, { image: h.default.PRESENTED_IMAGE_SIMPLE });
        case 'Select':
        case 'TreeSelect':
        case 'Cascader':
        case 'Transfer':
    ...
    const n = g.createElement(j.default, null), o = g.createElement(k.default, null), p = q => {
            var {
                    className: r,
                    rootClassName: s,
                    prefixCls: t,
            ...
            return D(g.createElement(i.default, { componentName: 'Empty' }, F => {
                const G = void 0 !== w ? w : F.description, H = 'string' == typeof G ? G : 'empty';
                let I = null;
                return I = 'string' == typeof u ? g.createElement('img', {
                    ...
                    className: `${ C }-image`,
                    style: y
                }, I), G && g.createElement('div', { className: `${ C }-description` }, G), x && g.createElement('div', { className: `${ C }-footer` }, x));
            }));
        };
    ...
    var _i = () => {
        ...
        let k = {};
        return new (0, f.TinyColor)(j.colorBgBase).toHsl().l < 0.5 && (k = { opacity: 0.65 }), g.createElement('svg', {
            style: k,
            width: '184',
            height: '152',
            viewBox: '0 0 184 152',
            ...
            fill: 'none',
            fillRule: 'evenodd'
        }, g.createElement('g', { transform: 'translate(24 31.67)' }, g.createElement('ellipse', {
            fillOpacity: '.8',
            fill: '#F5F5F7',
            cx: '67.797',
            cy: '106.89',
    ...
    var _i = () => {
        ...
        return g.createElement('svg', {
            ...
            fillRule: 'nonzero',
            stroke: o
        }, g.createElement('path', { d: 'M55 12.76L44.854 1.258C44.367.474 43.656 0 42.907 0H21.093c-.749 0-1.46.474-1.947 1.257L9 12.761V22h46v-9.24z' }), g.createElement('path', {
    ...
    const h = i => {
        ...
        return {
            [j]: {
                ...
                [`${ j }-description`]: { color: i.colorText },
                [`${ j }-footer`]: { marginTop: k },
                '&-normal': {
                    marginBlock: m,
                    color: i.colorTextDisabled,
                    [`${ j }-description`]: { color: i.colorTextDisabled },
                    [`${ j }-image`]: { height: i.emptyImgHeightMD }
                },
                '&-small': {
                    marginBlock: l,
                    color: i.colorTextDisabled,
                    [`${ j }-image`]: { height: i.emptyImgHeightSM }
                }
            }
        };
    };
    ...
    function _m(n) {
        ...
        const y = null != p ? p : l.createElement(g.default, null), z = A => l.createElement(l.Fragment, null, !1 !== w && A, u && x);
        let A = null;
        if (void 0 !== o)
            A = z(o);
        else if (s)
            A = z(l.createElement(j.default, { spin: !0 }));
        else {
            const B = `${ v }-suffix`;
            A = C => {
                let {
                ...
                return z(D && E ? l.createElement(k.default, { className: n }) : l.createElement(i.default, { className: n }));
            };
        }
        let C = null;
    ...
    const m = n => {
            ...
            return {
                ...
                [`${ o }-disabled&`]: {
                    ...
                    cursor: 'not-allowed',
                    [`${ o }-multiple&`]: { background: n.colorBgContainerDisabled },
            ...
            const {
                    ...
                    outlineColor: t,
                    antCls: u
                } = p, v = q ? { [`${ r }-selector`]: { borderColor: s } } : {};
            return {
                [o]: {
                    [`&:not(${ r }-disabled):not(${ r }-customize-input):not(${ u }-pagination-size-changer)`]: Object.assign(Object.assign({}, v), {
                        ...
                        [`&:hover ${ r }-selector`]: { borderColor: s }
                    })
                }
            };
        }, o = p => {
                ...
                [r]: Object.assign(Object.assign({}, (0, k.resetComponent)(q)), {
                    ...
                    [`${ r }-arrow`]: Object.assign(Object.assign({}, (0, k.resetIcon)()), {
                        ...
                        [t]: {
                            ...
                            [`&:not(${ r }-suffix)`]: { pointerEvents: 'auto' }
                        },
                    ...
                    [`${ r }-clear`]: {
                        ...
                        '&:hover': { color: q.colorTextTertiary }
                    },
                    '&:hover': { [`${ r }-clear`]: { opacity: 1 } }
                }),
                [`${ r }-has-feedback`]: { [`${ r }-clear`]: { insetInlineEnd: s + q.fontSize + q.paddingXXS } }
            };
        }, q = r => {
            const {componentCls: s} = r;
            return [
                {
                    [s]: {
    ...
    var _r = (0, f.default)('Select', (s, t) => {
        let {rootPrefixCls: u} = t;
        const v = (0, g.merge)(s, {
            rootPrefixCls: u,
            inputPaddingHorizontalBase: s.paddingSM - 1
        });
        return [q(v)];
    }, s => ({ zIndexPopup: s.zIndexPopupBase + 50 }));
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _j;
    });
    var f = c('.....'), g = c('.....'), h = c('.....');
    const i = j => {
        const {controlPaddingHorizontal: k} = j;
        return {
            position: 'relative',
            display: 'block',
        ...
        return [
            {
                [`${ m }-dropdown`]: Object.assign(Object.assign({}, (0, h.resetComponent)(k)), {
                    ...
                    [`&${ l }-slide-up-leave${ l }-slide-up-leave-active${ m }-dropdown-placement-bottomLeft`]: { animationName: g.slideUpOut },
                    [`&${ l }-slide-up-leave${ l }-slide-up-leave-active${ m }-dropdown-placement-topLeft`]: { animationName: g.slideDownOut },
                    '&-hidden': { display: 'none' },
                    '&-empty': { color: k.colorTextDisabled },
                    [`${ n }-empty`]: Object.assign(Object.assign({}, i(k)), { color: k.colorTextDisabled }),
                    [`${ n }`]: Object.assign(Object.assign({}, i(k)), {
                        ...
                        '&-option': {
                            display: 'flex',
                            '&-content': Object.assign({ flex: 'auto' }, h.textEllipsis),
                            '&-state': { flex: 'none' },
                            [`&-active:not(${ n }-option-disabled)`]: { backgroundColor: k.controlItemBgHover },
                            [`&-selected:not(${ n }-option-disabled)`]: {
                                color: k.colorText,
                                fontWeight: k.fontWeightStrong,
                                backgroundColor: k.controlItemBgActive,
                                [`${ n }-option-state`]: { color: k.colorPrimary }
                            },
                            '&-disabled': {
                                [`&${ n }-option-selected`]: { backgroundColor: k.colorBgContainerDisabled },
                                color: k.colorTextDisabled,
                                cursor: 'not-allowed'
                            },
                            '&-grouped': { paddingInlineStart: 2 * k.controlPaddingHorizontal }
                        }
                    }),
                    '&-rtl': { direction: 'rtl' }
                })
            ...
            [`${ m }-multiple${ l ? `${ m }-${ l }` : '' }`]: {
                ...
                [`${ m }-selection-item`]: {
                    ...
                    '&-remove': Object.assign(Object.assign({}, (0, g.resetIcon)()), {
                        ...
                        '&:hover': { color: k.colorIconHover }
                    })
                },
                [`${ o }-item + ${ o }-item`]: { [`${ m }-selection-search`]: { marginInlineStart: 0 } },
                [`${ m }-selection-search`]: {
                    display: 'inline-flex',
                    position: 'relative',
                    maxWidth: '100%',
    ...
    function _o(p) {
        const {componentCls: q} = p, r = (0, o.merge)(p, {
        ...
        return [
            ...
            {
                [`${ q }-multiple${ q }-sm`]: {
                    [`${ q }-selection-placeholder`]: { insetInline: p.controlPaddingHorizontalSM - p.lineWidth },
                    [`${ q }-selection-search`]: { marginInlineStart: s }
                }
            },
            j((0, o.merge)(p, {
            ...
            [`${ k }-single${ j ? `${ k }-${ j }` : '' }`]: {
                ...
                [`${ k }-selector`]: Object.assign(Object.assign({}, (0, f.resetComponent)(i)), {
                    ...
                    [`\n          ${ k }-selection-item,\n          ${ k }-selection-placeholder\n        `]: {
                        ...
                        '@supports (-moz-appearance: meterbar)': { lineHeight: `${ h }px` }
                    },
                    [`${ k }-selection-item`]: {
                        position: 'relative',
                        userSelect: 'none'
                ...
                [`&${ k }-open ${ k }-selection-item`]: { color: i.colorTextPlaceholder },
                [`&:not(${ k }-customize-input)`]: {
                    [`${ k }-selector`]: {
                        width: '100%',
                        height: i.controlHeight,
                        padding: `0 ${ l }px`,
                        [`${ k }-selection-search-input`]: { height: h },
                        '&:after': { lineHeight: `${ h }px` }
                    }
                },
                [`&${ k }-customize-input`]: {
                    [`${ k }-selector`]: {
    ...
    function n(o) {
        const {componentCls: p} = o, q = o.controlPaddingHorizontalSM - o.lineWidth;
        return [
            h(o),
            h((0, m.merge)(o, {
            ...
            }), 'sm'),
            {
                [`${ p }-single${ p }-sm`]: {
                    [`&:not(${ p }-customize-input)`]: {
                        ...
                        [`${ p }-selector`]: { padding: `0 ${ q }px` },
                        [`&${ p }-show-arrow ${ p }-selection-search`]: { insetInlineEnd: q + 1.5 * o.fontSize },

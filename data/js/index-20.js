...
const Fe = (function(e, r) {
    if (e && r) {
        ...
        return i.some(function(s) {
            ...
            return /\/\*$/.test(o) ? t === o.replace(/\/.*$/, "") : a === o ? !0 : /^\w+$/.test(o) ? (pt(!1, "Upload takes an invalidate 'accept' type '".concat(o, "'.Skip for check.")), !0) : !1
        })
    }
    return !0
});
...
function Xe(e) {
    ...
    e.data && Object.keys(e.data).forEach(function(a) {
        ...
        return r.status < 200 || r.status >= 300 ? e.onError(zt(e, r), _e(r)) : e.onSuccess(_e(r), r)
...
var At = (function() {
        var e = re(A().mark(function r(i, n) {
            var a, t, s, o, p, c, u, m;
            return A().wrap(function(f) {
                for (;;) switch (f.prev = f.next) {
                    case 0:
                        c = function() {
                            return c = re(A().mark(function E(v) {
                            ...
                            return o = re(A().mark(function E(v) {
                                var F, S, $, w, d;
                                return A().wrap(function(I) {
                                    for (;;) switch (I.prev = I.next) {
                                        case 0:
                                            F = v.createReader(), S = [];
                                        case 2:
                                            return I.next = 5, new Promise(function(T) {
                                                F.readEntries(T, function() {
                                                    return T([])
                                                })
                                            });
                                        case 5:
                            ...
                            var C = re(A().mark(function E(v, F) {
                                var S, $;
...
function Oe() {
    return "rc-upload-".concat(Tt, "-").concat(++qt)
}
var Ht = ["component", "prefixCls", "className", "classNames", "disabled", "id", "name", "style", "styles", "multiple", "accept", "capture", "children", "directory", "folder", "openFileDialogOnClick", "onMouseEnter", "onMouseLeave", "hasControlInside"],
    Bt = (function(e) {
        We(i, e);
        var r = Ve(i);
        ...
        function i() {
            ...
            return n = r.call.apply(r, [this].concat(t)), P(z(n), "state", {
                uid: Oe()
            }), P(z(n), "reqs", {}), P(z(n), "fileInput", void 0), P(z(n), "_isMounted", void 0), P(z(n), "onChange", function(o) {
                var p = n.props,
                    c = p.accept,
                    u = p.directory,
                    m = o.target.files,
            ...
            }), P(z(n), "onKeyDown", function(o) {
                o.key === "Enter" && n.onClick(o)
            }), P(z(n), "onDataTransferFiles", (function() {
                var o = re(A().mark(function p(c, u) {
                    var m, h, f, C, E, v, F;
                    return A().wrap(function($) {
                        for (;;) switch ($.prev = $.next) {
                            case 0:
                                ...
                                return $.next = 7, At(Array.prototype.slice.call(E), function(w) {
            ...
            })()), P(z(n), "onFilePaste", (function() {
                var o = re(A().mark(function p(c) {
                    var u, m;
                    return A().wrap(function(f) {
                        for (;;) switch (f.prev = f.next) {
                            case 0:
            ...
            })()), P(z(n), "onFileDragOver", function(o) {
                o.preventDefault()
            }), P(z(n), "onFileDrop", (function() {
                var o = re(A().mark(function p(c) {
                    var u;
                    ...
                    return A().wrap(function(d) {
                        for (;;) switch (d.prev = d.next) {
                            ...
                            case 29:
                                v = E;
                            case 30:
                                return F = (ht(h) === "object" || typeof h == "string") && h ? h : c, F instanceof File ? S = F : S = new File([F], c.name, {
                                    type: c.type
            ...
            })()), P(z(n), "saveFileInput", function(o) {
                n.fileInput = o
            }), n
        }
        return ke(i, [{
            ...
            value: function() {
                var a = this.props,
                    ...
                    w = a.directory,
                    d = a.folder,
                    U = a.openFileDialogOnClick,
                    I = a.onMouseEnter,
                    T = a.onMouseLeave,
                    X = a.hasControlInside,
                    H = mt(a, Ht),
                    J = B(P(P(P({}, s, !0), "".concat(s, "-disabled"), u), o, o)),
                    Q = w || d ? {
                        directory: "directory",
                ...
                return Re.createElement(t, ve({}, Y, {
                    ...
                    style: f
                }), Re.createElement("input", ve({}, ft(H, {
                    aria: !0,
                    data: !0
                }), {
                    id: m,
...
var je = (function(e) {
    ...
    function i() {
        ...
        Ge(this, i);
        for (var a = arguments.length, t = new Array(a), s = 0; s < a; s++) t[s] = arguments[s];
        return n = r.call.apply(r, [this].concat(t)), P(z(n), "uploader", void 0), P(z(n), "saveUploader", function(o) {
            n.uploader = o
        }), n
    }
    return ke(i, [{
        ...
        key: "render",
        value: function() {
            return Re.createElement(Bt, ve({}, this.props, {
...
const _t = e => {
    ...
    Wt = e => {
        const {
            componentCls: r
        } = e, i = new ze("uploadAnimateInlineIn", {
            from: {
                width: 0,
                height: 0,
                padding: 0,
        ...
        }), n = new ze("uploadAnimateInlineOut", {
            to: {
                width: 0,
                height: 0,
                padding: 0,
    ...
    Kt = e => {
        ...
        return {
            [`${r}-wrapper`]: Object.assign(Object.assign({}, yt(e)), {
                [r]: {
                    outline: 0,
                    "input[type='file']": {
                        cursor: "pointer"
    ...
    Qt = vt("Upload", e => {
        ...
        return [Kt(s), _t(s), Vt(s), Gt(s), Xt(s), Wt(s), kt(s), Rt(s)]
    }, Jt);
var Yt = {
        icon: function(r, i) {
            return {
    ...
    Zt = function(r, i) {
        return l.createElement(Qe, ve({}, r, {
            ref: i,
            icon: Yt
        }))
    },
...
function sr(e) {
    return new Promise(r => {
        ...
        i.width = te, i.height = te, i.style.cssText = `position: fixed; left: 0; top: 0; width: ${te}px; height: ${te}px; z-index: 9999; display: none;`, document.body.appendChild(i);
        ...
        if (a.onload = () => {
                ...
                let o = te,
                    ...
                    c = 0,
                    u = 0;
                t > s ? (p = s * (te / t), u = -(p - o) / 2) : (o = t * (te / s), c = -(o - p) / 2), n.drawImage(a, c, u, o, p);
                const m = i.toDataURL();
...
const lr = l.forwardRef(({
        ...
        if (a === "picture" || a === "picture-card" || a === "picture-circle")
            ...
            W = typeof t.linkProps == "string" ? JSON.parse(t.linkProps) : t.linkProps,
            ...
            M = (typeof h == "function" ? h(t) : h) && (t.url || t.thumbUrl) ? l.createElement("a", {
                href: t.url || t.thumbUrl,
                target: "_blank",
                rel: "noopener noreferrer",
                onClick: x => $(t, x),
            ...
            oe = t.response && typeof t.response == "string" ? t.response : ((I = t.error) === null || I === void 0 ? void 0 : I.statusText) || ((T = t.error) === null || T === void 0 ? void 0 : T.message) || n.uploadError,
            ee = H === "error" ? l.createElement(Ut, {
                title: oe,
    ...
    cr = (e, r) => {
        const {
            ...
            itemRender: U,
            disabled: I
        } = e, [, T] = Mt(), [X, H] = l.useState(!1), J = ["picture-card", "picture-circle"].includes(i);
        l.useEffect(() => {
        ...
        const Q = (g, j) => {
            ...
            G = g => {
                ...
                if (i.startsWith("picture")) {
                    const M = i === "picture" ? l.createElement(He, null) : o.uploading,
                        K = c != null && c(g) ? l.createElement(nr, null) : l.createElement(er, null);
                    return j ? M : K
                }
                return j ? l.createElement(He, null) : l.createElement(jt, null)
            },
            me = (g, j, M, K, ue) => {
                const ae = {
                    type: "text",
                    ...
                    onClick: ie => {
                        var oe, ee;
                        j(), l.isValidElement(g) && ((ee = (oe = g.props).onClick) === null || ee === void 0 || ee.call(oe, ie))
                    },
                    className: `${M}-list-item-action`,
                    disabled: ue ? I : !1
                };
                return l.isValidElement(g) ? l.createElement(qe, Object.assign({}, ae, {
                    icon: Te(g, Object.assign(Object.assign({}, g.props), {
                        onClick: () => {}
                    }))
        ...
        const {
            getPrefixCls: W
        } = l.useContext(Le), k = W("upload", u), L = W(), fe = B(`${k}-list`, `${k}-list-${i}`), ce = l.useMemo(() => wt(St(L), ["onAppearEnd", "onEnterEnd", "onLeaveEnd"]), [L]), ne = Object.assign(Object.assign({}, J ? {} : ce), {
            motionDeadline: 2e3,
...
const be = `__LIST_IGNORE_${Date.now()}__`,
    pr = (e, r) => {
        ...
        const M = (b, O, R) => {
                let y = V(O),
                    D = !1;
                T === 1 ? y = y.slice(-1) : T && (D = y.length > T, y = y.slice(0, T)), Be.flushSync(() => {
                    fe(y)
                });
                const q = {
                    file: b,
            ...
            ee = b => {
                ...
                Promise.resolve(typeof t == "function" ? t(b) : t).then(R => {
                    ...
                    }), (y = g.current) === null || y === void 0 || y.abort(O), M(O, D))
                })
            },
            x = b => {
        ...
        delete he.className, delete he.style, (!d || W) && delete he.id;
        const Pe = `${N}-wrapper`,
            [Se, xe, rt] = Qt(N, Pe),
            [nt] = It("Upload", Dt.Upload),
            {
                showRemoveIcon: Ne,
                showPreviewIcon: at,
                showDownloadIcon: it,
            ...
            Ce = (b, O) => s ? l.createElement(ur, {
                ...
                iconRender: E,
                extra: ct,
                locale: Object.assign(Object.assign({}, nt), C),
                isImageUrl: v,
                progress: F,
                appendAction: b,
            ...
            Ee = B(Pe, $, G, xe, rt, de == null ? void 0 : de.className, {
                [`${N}-rtl`]: $e === "rtl",
...
const fr = l.forwardRef((e, r) => {
        const {
            ...
            children: t
        } = e, s = mr(e, ["style", "height", "hasControlInside", "children"]), o = Object.assign(Object.assign({}, i), {
            height: n
        });
        return l.createElement(et, Object.assign({
            ref: r,
            hasControlInside: a
        }, s, {
            style: o,

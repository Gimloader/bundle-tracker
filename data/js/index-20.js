...
const h = e => e ? typeof e == "function" ? e() : e : null,
    le = e => {
        ...
        }, oe(e, "var(--antd-arrow-background-color)"), {
            [`${o}-pure`]: {
                position: "relative",
                maxWidth: "none",
    ...
    ce = e => {
        ...
        return Object.assign(Object.assign(Object.assign({
            ...
            innerPadding: a ? 0 : 12,
            titleMarginBottom: a ? 0 : g,
            titlePadding: a ? `${f}px ${i}px ${b}px` : 0,
            titleBorderBottom: a ? `${o}px ${m} ${l}` : "none",
...
const I = ({
        ...
        content: o,
        prefixCls: n
    }) => !e && !o ? null : s.createElement(s.Fragment, null, e && s.createElement("div", {
        className: `${n}-title`
    ...
    pe = e => {
        const {
            ...
            content: p,
            children: g
        } = e, m = h(d), l = h(p), u = x(o, n, `${n}-pure`, `${n}-placement-${a}`, t);
    ...
    ge = e => {
        const {
            prefixCls: o,
            className: n
        } = e, t = de(e, ["prefixCls", "className"]), {
            getPrefixCls: r
        } = s.useContext(Y), a = r("popover", o), [d, p, g] = k(a);
        return d(s.createElement(pe, Object.assign({}, t, {
            prefixCls: a,
            hashId: p,
            className: x(n, g)
        })))
...
const ue = s.forwardRef((e, o) => {
        ...
        const {
            ...
            classNames: S,
            styles: $
        } = Z("popover"), O = N("popover", r), [W, z, D] = k(O), M = N(), R = x(p, z, D, T, S.root, y == null ? void 0 : y.root), V = x(S.body, y == null ? void 0 : y.body), [A, H] = q(!1, {
        ...
        return W(s.createElement(se, Object.assign({
            ...
            styles: {
                root: Object.assign(Object.assign(Object.assign(Object.assign({}, $.root), _), b), i == null ? void 0 : i.root),
                body: Object.assign(Object.assign({}, $.body), i == null ? void 0 : i.body)
            },
            ref: o,
            open: A,
            onOpenChange: K,
            overlay: E || B ? s.createElement(I, {
                prefixCls: O,
                title: E,
                content: B
            }) : null,
            ...
            onKeyDown: c => {
                var C, P;
                s.isValidElement(l) && ((P = l == null ? void 0 : (C = l.props).onKeyDown) === null || P === void 0 || P.call(C, c)), L(c)
            }
        })))
    }),
    fe = ue;
fe._InternalPanelDoNotUseOrYouWillBeFired = ge;
export {
    fe as P
};
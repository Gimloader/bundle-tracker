...
c.register('NLF0w', function(b, j) {
    ...
    var f = c('PjB0f'),
        ...
        i = c('ExtIT'),
        j = c('1//3g');
    var k = () => (0, e.jsxs)(g.LegalContainer, {
        children: [
            (0, e.jsx)(f.Title, {
...
}), c.register('DE+rh0', function(b, j) {
    a(b.exports, 'LegalContainer', function() {
        return j;
    }), a(b.exports, 'LegalContent', function() {
        return k;
    });
    var d = c('h99Nu'),
        e = c('lmfrI'),
...
`), e.default.Black, f.FontWeights.Bold);
}), c.register('V5E9U', function(b, j) {
    a(b.exports, 'default', function() {
        return k;
    });
    var d = c('8kSQZ');

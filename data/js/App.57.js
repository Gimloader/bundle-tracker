...
`));
    class D extends i.Component {
        ...
        constructor(...a) {
            super(...a), (0, g.default)(this, 'state', {
                ...
                this.setState({
                    ...
                    error: E => {
                        ...
                        F && (F.includes('redeemed') ? G = 'This gift card has already been redeemed' : F.includes('invalid') && (G = 'This gift card code is invalid')), m.default.error({
                            content: G
                        });
                    },
                    both: () => {
            ...
            }), (0, g.default)(this, 'onCardCodeChange', E => this.setState({
    ...
    var _D = E => (0, f.jsxs)(v, {
        children: [
            (0, f.jsxs)(z, {
                children: [
                    (0, f.jsx)(w, {
                        children: (0, m.centsToFormatedMoney)(E.value)
                    }),

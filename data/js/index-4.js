...
const ae = e => {
        const {
            ...
            contentPadding: O,
            contentBg: P
        } = e, h = `${n}-notice`, x = new M("MessageMoveIn", {
            "0%": {
                padding: 0,
      ...
      `]: {
            ...
            [n]: {
                [`${h}-wrapper`]: Object.assign({}, C)
            }
        }, {
            [`${n}-notice-pure-panel`]: Object.assign(Object.assign({}, C), {
                padding: 0,
                textAlign: "start"
            })
        }]
...
var ce = function(e, n) {
    ...
    if (e != null && typeof Object.getOwnPropertySymbols == "function")
        for (var o = 0, t = Object.getOwnPropertySymbols(e); o < t.length; o++) n.indexOf(t[o]) < 0 && Object.prototype.propertyIsEnumerable.call(e, t[o]) && (s[t[o]] = e[t[o]]);
    return s
};
const ie = {
    ...
    D = ({
        ...
        className: j(`${e}-custom-content`, `${e}-${n}`)
    }, s || ie[n], i.createElement("span", null, t)),
    le = e => {
        const {
            prefixCls: n,
            className: s,
            ...
            icon: o,
            content: a
        } = e, d = ce(e, ["prefixCls", "className", "type", "icon", "content"]), {
            getPrefixCls: p
        } = i.useContext(R), c = n || p("message"), r = T(c), [u, l, y] = H(c, r);
        return u(i.createElement(ne, Object.assign({}, d, {
            prefixCls: c,
...
function F(e) {
    ...
    return t.then = (o, a) => s.then(o, a), t.promise = s, t
}
var de = function(e, n) {
    var s = {};
    for (var t in e) Object.prototype.hasOwnProperty.call(e, t) && n.indexOf(t) < 0 && (s[t] = e[t]);
...
const pe = 8,
    ...
    ve = i.forwardRef((e, n) => {
        const {
            ...
            message: y,
            direction: f
        } = i.useContext(R), g = t || u("message"), v = () => ({
            left: "50%",
            ...
            closeIcon: h,
            duration: d,
            getContainer: () => (o == null ? void 0 : o()) || (l == null ? void 0 : l()) || document.body,
            maxCount: a,
            onAllRemoved: r,
            renderNotifications: fe
        });
        return i.useImperativeHandle(n, () => Object.assign(Object.assign({}, x), {
            prefixCls: g,
            message: y
        })), E
    });
        ...
        const t = c => {
            ...
            o = c => {
                ...
                const {
                    ...
                    style: h,
                    onClose: x
                } = c, E = de(c, ["content", "icon", "type", "key", "className", "style", "onClose"]);
                let C = O;
                return C == null && (_ += 1, C = `antd-message-${_}`), F(w => (r(Object.assign(Object.assign({}, E), {
                    ...
                    placement: "top",
                    className: j(v && `${y}-${v}`, P, l == null ? void 0 : l.className),
                    style: Object.assign(Object.assign({}, l == null ? void 0 : l.style), h),
                    onClose: () => {
                        x == null || x(), w()
                    }
                })), () => {
            ...
            d = {
                ...
                destroy: c => {
                    var r;
                    c !== void 0 ? t(c) : (r = n.current) === null || r === void 0 || r.destroy()
                }
            };
        return ["info", "success", "warning", "error", "loading"].forEach(c => {
            const r = (u, l, y) => {
                let f;
                u && typeof u == "object" && "content" in u ? f = u : f = {
                    content: u
                };
                let g, v;
                typeof l == "function" ? v = l : (g = l, v = y);
...
function A() {
    const {
        ...
        maxCount: t,
        top: o
    } = S, a = (e == null ? void 0 : e()) || document.body;
    return {
        getContainer: () => a,
        duration: n,
        rtl: s,
...
const Ce = b.forwardRef((e, n) => {
    ...
    be = b.forwardRef((e, n) => {
        const [s, t] = b.useState(A), o = () => {
            t(A)
        };
        b.useEffect(o, []);
        const a = J(),
            d = a.getRootPrefixCls(),
            p = a.getIconPrefixCls(),
            c = a.getTheme(),
...
function Oe(e) {
    S = Object.assign(Object.assign({}, S), e), $(() => {
        var n;
        (n = m == null ? void 0 : m.sync) === null || n === void 0 || n.call(m)
    })
}
...
const he = e => {
    ...
    Pe = ["success", "info", "warning", "error", "loading"],
    Ee = {
        open: xe,
        destroy: he,
        config: Oe,
        useMessage: ye,
        _InternalPanelDoNotUseOrYouWillBeFired: le
    },
    Ie = Ee;
Pe.forEach(e => {
    Ie[e] = (...n) => $e(e, n)

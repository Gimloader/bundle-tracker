...
var Ae = r.createContext({
    ...
    Qt = r.forwardRef(function(e, t) {
        ...
        return r.createElement(r.Fragment, null, g.map(function(p, k) {
            var $ = f === k;
    ...
    Zt = function(t) {
        ...
        return r.createElement("span", {
            className: fe(m, Se({}, "".concat(m, "-active"), b && S <= u && u <= y)),
            style: K(K({}, s), n),
    ...
    ta = function(t) {
        ...
        return m && (s = K(K({}, s), typeof u == "function" ? u(n) : u)), r.createElement("span", {
            className: fe(b, Se({}, "".concat(b, "-active"), m)),
            style: s
        })
    },
    aa = function(t) {
    ...
    kt = function(t) {
        ...
        var R = E || fe(a, Se(Se({}, "".concat(a, "-").concat(g + 1), g !== null && m), "".concat(o, "-track-draggable"), c), s.track);
        return r.createElement("div", {
            className: R,
            style: K(K({}, M), n),
            onMouseDown: C,
    ...
    ra = function(t) {
        ...
        if (!E) return null;
        var m = b != null && b.length && (y.tracks || S.tracks) ? r.createElement(kt, {
            index: null,
            prefixCls: o,
            start: b[0].start,
        ...
        return r.createElement(r.Fragment, null, m, b.map(function(s, a) {
            var d = s.start,
                l = s.end;
...
function oa(e, t, o, n, i, u, g, c, E, f, v) {
    ...
    jt(function() {
        ...
        return function() {
            document.removeEventListener("mousemove", j.current), document.removeEventListener("mouseup", V.current), F.current && (F.current.removeEventListener("touchmove", j.current), F.current.removeEventListener("touchend", V.current))
        }
    }, []);
    var de = function(x, L, A) {
        ...
        ke = function(x, L, A) {
            ...
            var he = function(ve) {
                ...
                be = function Ee(ve) {
                    ve.preventDefault(), document.removeEventListener("mouseup", Ee), document.removeEventListener("mousemove", he), F.current && (F.current.removeEventListener("touchmove", j.current), F.current.removeEventListener("touchend", V.current)), j.current = null, V.current = null, F.current = null, c(me), l(-1), B(!1)
                };
            document.addEventListener("mouseup", be), document.addEventListener("mousemove", he), x.currentTarget.addEventListener("touchend", be), x.currentTarget.addEventListener("touchmove", he), j.current = he, V.current = be, F.current = x.currentTarget
        },
...
function la(e, t, o, n, i, u) {
    var g = r.useCallback(function(b) {
        ...
        S = function(m) {
            return u === null && m === 0 || typeof u == "number" && m < u
        },
        y = function(m, s, a) {
            var d = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "unit",
                l = m.map(E),
...
var sa = r.forwardRef(function(e, t) {
    var o = e.prefixCls,
        ...
        G = r.useMemo(function() {
            return typeof F == "boolean" ? F ? Me : !1 : F >= 0 ? F : !1
        }, [F, Me]),
        ...
        ee = r.useMemo(function() {
            var O = Fe == null ? [] : Array.isArray(Fe) ? Fe : [Fe],
                h = ie(O, 1),
                P = h[0],
                T = P === void 0 ? le : P,
                I = Fe === null ? [] : [T];
            if (H) {
                if (I = we(O), D || Fe === void 0) {
                    var Ne = D >= 0 ? D + 1 : 2;
        ...
        Rt = function(h) {
            if (!(v || !Y || ee.length <= Ce)) {
                ...
                var T = Math.max(0, h - 1);
                ne.current.hideHelp(), ne.current.focus(T)
            }
        },
        Dt = oa(He, Be, ee, le, xe, Te, Ke, lt, We, Y, Ce),
        Ue = ie(Dt, 5),
        it = Ue[0],
        Ot = Ue[1],
        Pt = Ue[2],
        ...
        ct = function(h, P) {
            if (!v) {
                ...
                var De = I;
                Y && Re !== 0 && (!oe || ee.length < oe) ? (T.splice(Ne + 1, 0, h), De = Ne + 1) : T[I] = h, H && !ee.length && D === void 0 && T.push(h);
                var Oe = qe(T);
                if (k == null || k(Oe), Ke(T), P) {
                    var je, ze;
                    (je = document.activeElement) === null || je === void 0 || (ze = je.blur) === null || ze === void 0 || ze.call(je), ne.current.focus(De), st(P, De, T)
        ...
        Bt = function(h, P) {
            if (!v) {
                var T = We(ee, h, P);
                k == null || k(qe(ee)), Ke(T.values), dt(T.value)
            }
        };
    ...
    r.useImperativeHandle(t, function() {
        return {
            ...
            blur: function() {
                var h, P = document,
                    T = P.activeElement;
                (h = He.current) !== null && h !== void 0 && h.contains(T) && (T == null || T.blur())
            }
        }
    }), r.useEffect(function() {
    ...
    }, [le, xe, Be, v, y, Me, de, mt, ht, H, me, he, be, Ee, ve, c, g]);
    return r.createElement(Ae.Provider, {
        ...
        className: fe("".concat(n, "-rail"), g == null ? void 0 : g.rail),
...
const ca = r.createContext({}),
    $t = r.forwardRef((e, t) => {
        const {
            ...
            draggingDelete: n,
            value: i
        } = e, u = r.useRef(null), g = o && !n, c = r.useRef(null);
        ...
        return r.useEffect(() => (g ? f() : E(), E), [g, e.title, i]), r.createElement(Gt, Object.assign({
            ref: zt(u, t)
        }, e, {
            open: g
        }))
        ...
        return {
            [t]: Object.assign(Object.assign({}, Xt(e)), {
                ...
                "&:hover": {
                    ...
                    [`${t}-handle::after`]: {
                        boxShadow: `0 0 0 ${ue(m)} ${e.colorPrimaryBorderHover}`
                    },
                    [`${t}-dot-active`]: {
                ...
                [`${t}-handle`]: {
                    ...
                    "&::before": {
                        content: '""',
                        position: "absolute",
                        insetInlineStart: f(m).mul(-1).equal(),
                        insetBlockStart: f(m).mul(-1).equal(),
                        width: f(v).add(f(m).mul(2)).equal(),
                        height: f(v).add(f(m).mul(2)).equal(),
                    ...
                    "&::after": {
                        ...
                        boxShadow: `0 0 0 ${ue(m)} ${e.handleColor}`,
          ...
          `
                ...
                [`${t}-dot`]: {
                    ...
                    height: i,
                    backgroundColor: e.colorBgElevated,
                    border: `${ue(m)} solid ${e.dotBorderColor}`,
                    borderRadius: "50%",
                    cursor: "pointer",
    ...
    xt = (e, t) => {
        const {
            ...
            marginFull: g,
            calc: c
        } = e, E = t ? "paddingBlock" : "paddingInline", f = t ? "width" : "height", v = t ? "height" : "width", S = t ? "insetBlockStart" : "insetInlineStart", y = t ? "top" : "insetInlineStart", b = c(n).mul(3).sub(i).div(2).equal(), m = c(i).sub(n).div(2).equal(), s = t ? {
            borderWidth: `${ue(m)} 0`,
            transform: `translateY(${ue(c(m).mul(-1).equal())})`
        } : {
            borderWidth: `0 ${ue(m)}`,
            transform: `translateX(${ue(e.calc(m).mul(-1).equal())})`
        };
        return {
            [E]: n,
            [v]: c(n).mul(3).equal(),
...
const Sa = Pe.forwardRef((e, t) => {
    const {
        ...
        handleRender: $,
        direction: z
    } = Pe.useContext(ca), j = (z || M) === "rtl", [V, F] = tt(), [ye, te] = tt(), ge = Object.assign({}, b), {
        open: de,
        placement: ae,
    ...
    const ve = n && !x,
        ne = $ || ((H, Y) => {
            ...
            function oe(G, Z, Qe) {
                var Ie, Te, We, Xe;
                Qe && ((Te = (Ie = d)[G]) === null || Te === void 0 || Te.call(Ie, Z)), (Xe = (We = Ce)[G]) === null || Xe === void 0 || Xe.call(We, Z)
            }
            const le = Object.assign(Object.assign({}, Ce), {
                    onMouseEnter: G => {
                        F(!0), oe("onMouseEnter", G)
                    },
                    onMouseLeave: G => {
                        F(!1), oe("onMouseLeave", G)
                    },
                    onMouseDown: G => {
        ...
        Be = Object.assign(Object.assign(Object.assign(Object.assign({}, q.root), B), a == null ? void 0 : a.root), g),

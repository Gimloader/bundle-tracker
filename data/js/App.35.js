...
d.register('.....', function(e, f) {
    ...
    var g = d('.....'),
        h = d('.....');
    const i = {
            currentTab: d('.....').default.questions
        },
        {
            currentTab: j
        } = i;
    ...
    let F = class extends j.Component {
        ...
        constructor(...a) {
            super(...a), (0, g.default)(this, 'state', {
                ...
                upgradeModalOpen: !1
            }), (0, g.default)(this, 'changeRoute', G => this.props.navigation.currentTab = G), (0, g.default)(this, 'playKit', () => this.setState({
...
`)),
            ...
            },
            {
                ...
                value: function() {
                    var O = this.props,
                        ...
                        W = O.style,
                        X = O.tabIndex,
                        Y = b(r)('SocialMediaShareButton', 'SocialMediaShareButton--' + U, {
                            'SocialMediaShareButton--disabled': !!S,
                            disabled: !!S
                        }, R);
                    return b(G).createElement('div', (0, m.default)({
                        'aria-label': U
                    }, P, {
                        role: V,
                        tabIndex: X,
    ...
    var i, j, k = d('.....').codes,
        ...
        t = s.isPromise,
        u = s.isRegExp,
        v = Object.assign ? Object.assign : d('.....').assign,
        w = Object.is ? Object.is : d('.....');
    new Map();
    ...
    function Y(Z, $, ab, bb) {
        if ($ !== B) {
            if ('string' == typeof ab && (bb = ab, ab = void 0), !ab || P($, ab)) {
                var cb = bb ? ': '.concat(bb) : '.',
                    db = 'doesNotReject' === Z.name ? 'rejection' : 'exception';
                C({
                    actual: $,
                    expected: ab,
                    operator: Z.name,
    ...
    function _B(C, D, E, F, G, H) {
        var I, J, K;
        if ((_l = Object.getOwnPropertyDescriptor(D, G) || {
                value: D[G]
            }).get ? J = _l.set ? C.stylize('[Getter/Setter]', 'special') : C.stylize('[Getter]', 'special') : _l.set && (J = C.stylize('[Setter]', 'special')), _W(F, G) || (I = '[' + G + ']'), J || (C.seen.indexOf(_l.value) < 0 ? (J = _H(E) ? _q(C, _l.value, null) : _q(C, _l.value, E - 1)).indexOf('\n') > -1 && (J = H ? J.split('\n').map(function(L) {
                return '  ' + L;
            }).join('\n').slice(2) : '\n' + J.split('\n').map(function(L) {
                return '   ' + L;
    ...
    var u = function e(v) {
        ...
        w = d('.....'),
        x = d('.....'),
        y = w.call(Function.call, Array.prototype.concat),
        z = w.call(Function.apply, Array.prototype.splice),
    ...
    var u = m('.....').inspect,
        v = m('.....').codes.ERR_INVALID_ARG_TYPE;
    ...
    function C(D) {
        var E = Object.keys(D),
            F = Object.create(Object.getPrototypeOf(D));
    ...
    function G(H, I, J) {
        ...
        var Z = 0,
            $ = B[J] + '\n'.concat(y, '+ actual').concat(A, ' ').concat(z, '- expected').concat(A),
            ab = ' '.concat(x, '...').concat(A, ' Lines skipped');
        for (_s = 0; _s < X; _s++) {
            var bb = _s - l;
            if (_q.length < _s + 1)
                ...
                value: function(ub, vb) {
                    return nb(this, function(wb) {
                        for (var xb = 1; xb < arguments.length; xb++) {
                            var yb = null != arguments[xb] ? arguments[xb] : {},
                                zb = Object.keys(yb);
    ...
    var g = d('.....')('%Object.defineProperty%', !0),
        h = function() {
            if (g)
                try {
                    return g({}, 'a', {

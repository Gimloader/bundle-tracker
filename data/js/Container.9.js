...
c.register('.....', function (d, e) {
    ...
    const t = j.forwardRef((u, v) => {
            ...
            let U = j.createElement(g.default, { className: `${ P }-handler-up-inner` }), V = j.createElement(f.default, { className: `${ P }-handler-down-inner` });
            const W = 'boolean' == typeof N ? N : void 0;
            'object' == typeof N && (U = void 0 === N.upIcon ? U : j.createElement('span', { className: `${ P }-handler-up-inner` }, N.upIcon), V = void 0 === N.downIcon ? V : j.createElement('span', { className: `${ P }-handler-down-inner` }, N.downIcon));
            const {
                    hasFeedback: X,
                    status: Y,
                    isFormItemInput: Z,
            ...
            if (cb) {
                ...
                }, J && j.createElement('span', { className: `${ P }-prefix` }, J), (0, p.cloneElement)(hb, {
                    style: null,
                    value: u.value,
                    onFocus: jb => {
                        var kb;
                ...
                }), X && j.createElement('span', { className: `${ P }-suffix` }, $));
            }
            if (db) {
                const jb = `${ P }-group`, kb = `${ jb }-addon`, lb = H ? j.createElement('div', { className: kb }, H) : null, mb = I ? j.createElement('div', { className: kb }, I) : null, nb = a(h)(`${ P }-wrapper`, jb, R, { [`${ jb }-rtl`]: 'rtl' === x }), ob = a(h)(`${ P }-group-wrapper`, {
                ...
                hb = j.createElement('div', {
                    className: ob,
                    style: u.style
                }, j.createElement('div', { className: nb }, lb && j.createElement(o.NoCompactStyle, null, j.createElement(n.NoFormStyle, {
                    status: !0,
                    override: !0
    ...
    u._InternalPanelDoNotUseOrYouWillBeFired = v => j.createElement(k.default, { theme: { components: { InputNumber: { handleVisible: !0 } } } }, j.createElement(t, Object.assign({}, v)));
    var _v = u;
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _k;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....'), k = c('.....'), l = c('.....'), m = c('.....'), n = c('.....'), o = c('.....'), p = c('.....'), q = c('.....'), r = c('.....'), s = c('.....'), t = c('.....'), u = c('.....'), v = c('.....'), w = [
            'prefixCls',
            'className',
            'style',
            'min',
            ...
            var C, D = A.prefixCls, E = void 0 === D ? 'rc-input-number' : D, F = A.className, G = A.style, H = A.min, I = A.max, J = A.step, K = void 0 === J ? 1 : J, L = A.defaultValue, M = A.value, N = A.disabled, O = A.readOnly, P = A.upHandler, Q = A.downHandler, R = A.keyboard, S = A.controls, T = void 0 === S || S, U = A.stringMode, V = A.parser, W = A.formatter, X = A.precision, Y = A.decimalSeparator, Z = A.onChange, $ = A.onInput, ab = A.onPressEnter, bb = A.onStep, cb = (0, j.default)(A, w), db = ''.concat(E, '-input'), eb = k.useRef(null), fb = k.useState(!1), gb = (0, i.default)(fb, 2), hb = gb[0], ib = gb[1], jb = k.useRef(!1), kb = k.useRef(!1), lb = k.useRef(!1), mb = k.useState(function () {
                    return (0, p.default)(null != M ? M : L);
                }), nb = (0, i.default)(mb, 2), ob = nb[0], pb = nb[1];
            var qb = k.useCallback(function (rb, sb) {
                    ...
                    V,
                    Y
                ]), sb = k.useRef(''), tb = k.useCallback(function (ub, vb) {
                    if (W)
                        return W(ub, {
                            userTyping: vb,
                ...
                }), vb = (0, i.default)(ub, 2), wb = vb[0], xb = vb[1];
            function yb(zb, Ab) {
            ...
            var zb = k.useMemo(function () {
                    ...
                    Ab,
                    ob
                ]), Db = (0, u.default)(eb.current, hb), Eb = (0, i.default)(Db, 2), Fb = Eb[0], Gb = Eb[1], Hb = function (Ib) {
                    return zb && !Ib.lessEquals(zb) ? zb : Ab && !Ab.lessEquals(Ib) ? Ab : null;
                }, Ib = function (Jb) {
                    return !Hb(Jb);
                }, Jb = function (Kb, Lb) {
                    var Mb, Nb = Kb, Ob = Ib(Nb) || Nb.isEmpty();
                    if (Nb.isEmpty() || Lb || (Nb = Hb(Nb) || Nb, Ob = !0), !O && !N && Ob) {
                        var Pb = Nb.toString(), Qb = qb(Pb, Lb);
                    ...
                    return ob;
                }, Kb = (0, v.default)(), Lb = function a(Mb) {
                    if (Fb(), xb(Mb), !kb.current) {
                        var Nb = rb(Mb), Ob = (0, p.default)(Nb);
                        Ob.isNaN() || Jb(Ob, !0);
                    }
                    null == $ || $(Mb), Kb(function () {
                        var Pb = Mb;
                    ...
                    if (!(Nb && Bb || !Nb && Cb)) {
                        ...
                        Nb || (Pb = Pb.negate());
                        var Qb = (ob || (0, p.default)(0)).add(Pb.toString()), Rb = Jb(Qb, !1);
                        null == bb || bb(x(U, Rb), {
                    ...
                    var Pb = (0, p.default)(rb(wb)), Qb = Pb;
            ...
            return (0, n.useLayoutUpdateEffect)(function () {
                ...
                onKeyDown: function (Ob) {
                    var Pb = Ob.which, Qb = Ob.shiftKey;
                ...
                downDisabled: Cb,
                onStep: Mb
            }), k.createElement('div', { className: ''.concat(db, '-wrap') }, k.createElement('input', (0, f.default)({
                autoComplete: 'off',
                role: 'spinbutton',
                'aria-valuemin': H,
                'aria-valuemax': I,
            ...
            return (0, r.default)(n, [
                ...
                },
                {
                    ...
                    value: function (s) {
                        ...
                        if (t.isInvalidate())
                            return this;
                        var u = Math.max(this.getDecimalStr().length, t.getDecimalStr().length), v = (this.alignDecimal(u) + t.alignDecimal(u)).toString(), w = (0, i.trimNumber)(v), x = w.negativeStr, y = w.trimStr, z = ''.concat(x).concat(y.padStart(u + 1, '0'));
    ...
    function _o(p, q, r) {
        ...
        if ('' === p)
            return '';
        var t = (0, i.trimNumber)(p), u = t.negativeStr, v = t.integerStr, w = t.decimalStr, x = ''.concat(q).concat(w), y = ''.concat(u).concat(v);
        if (r >= 0) {
            var z = Number(w[r]);
            if (z >= 5 && !s) {
    ...
    function q(r) {
        var s = String(r);
        if (o(r)) {
            var t = Number(s.slice(s.indexOf('e-') + 2)), u = s.match(/\.(\d+)/);
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), i = c('.....'), j = c('.....');
    function _k(l) {
        var m = l.prefixCls, n = l.upNode, o = l.downNode, p = l.upDisabled, q = l.downDisabled, r = l.onStep, s = h.useRef(), t = h.useRef();
        t.current = r;
        var u = function (v, w) {
        ...
        if (h.useEffect(function () {
            ...
            return null;
        var w = ''.concat(m, '-handler'), x = a(i)(w, ''.concat(w, '-up'), (0, g.default)({}, ''.concat(w, '-up-disabled'), _k)), y = a(i)(w, ''.concat(w, '-down'), (0, g.default)({}, ''.concat(w, '-down-disabled'), q)), z = {
                unselectable: 'on',
                role: 'button',
                onMouseUp: v,
                onMouseLeave: v
            };
        return h.createElement('div', { className: ''.concat(w, '-wrap') }, h.createElement('span', (0, f.default)({}, z, {
    ...
    function _h(i, j) {
        ...
        return [
            function () {
                try {
                    var l = i.selectionStart, m = i.selectionEnd, n = i.value, o = n.substring(0, l), p = n.substring(m);
                    k.current = {
                        start: l,
                        end: m,
                        value: n,
            ...
            function () {
                if (i && k.current && j)
                    try {
                        var l = i.value, m = k.current, n = m.beforeTxt, o = m.afterTxt, p = m.start, q = l.length;
                        if (l.endsWith(o))
                            q = l.length - k.current.afterTxt.length;
                        else if (l.startsWith(n))
                            q = n.length;
                        else {
                            var r = n[p - 1], s = l.indexOf(r, p - 1);
                            -1 !== s && (q = s + 1);
                        }
    ...
    const j = k => {
            ...
            return [
                {
                    [l]: Object.assign(Object.assign(Object.assign(Object.assign({}, (0, h.resetComponent)(k)), (0, f.genBasicInputStyle)(k)), (0, f.genStatusStyle)(k, l)), {
                        ...
                        '&-rtl': {
                            direction: 'rtl',
                            [`${ l }-input`]: { direction: 'rtl' }
                        },
                        '&-lg': {
                            padding: 0,
                            fontSize: q,
                            borderRadius: D,
                            [`input${ l }-input`]: { height: r - 2 * m }
                        },
                        '&-sm': {
                            padding: 0,
                            borderRadius: C,
                        ...
                        '&-disabled': Object.assign(Object.assign({}, (0, f.genDisabledStyle)(k)), { [`${ l }-input`]: { cursor: 'not-allowed' } }),
                        '&-out-of-range': { input: { color: t } },
                        '&-group': Object.assign(Object.assign(Object.assign({}, (0, h.resetComponent)(k)), (0, f.genInputGroupStyle)(k)), {
                            '&-wrapper': {
                                display: 'inline-block',
                                textAlign: 'start',
                                verticalAlign: 'top',
                                [`${ l }-affix-wrapper`]: { width: '100%' },
                                '&-lg': { [`${ l }-group-addon`]: { borderRadius: D } },
                                '&-sm': { [`${ l }-group-addon`]: { borderRadius: C } }
                            }
                        }),
                        [l]: {
                ...
                {
                    [l]: {
                        [`&:hover ${ l }-handler-wrap, &-focused ${ l }-handler-wrap`]: { opacity: 1 },
                        [`${ l }-handler-wrap`]: {
                            position: 'absolute',
                            insetBlockStart: 0,
                            insetInlineEnd: 0,
                        ...
                        [`${ l }-handler`]: {
                            ...
                            transition: `all ${ w } linear`,
                            '&:active': { background: k.colorFillAlter },
                            '&:hover': {
                                height: '60%',
                                [`\n              ${ l }-handler-up-inner,\n              ${ l }-handler-down-inner\n            `]: { color: x }
                            },
                        ...
                        [`${ l }-handler-up`]: { borderStartEndRadius: p },
                        [`${ l }-handler-down`]: {
                            borderBlockStart: `${ m }px ${ n } ${ o }`,
                            borderEndEndRadius: p
                        },
                        '&-disabled, &-readonly': { [`${ l }-handler-wrap`]: { display: 'none' } },
                ...
                },
                {
                    [`${ l }-borderless`]: {
                        ...
                        boxShadow: 'none',
                        [`${ l }-handler-down`]: { borderBlockStartWidth: 0 }
                    }
                }
            ];
        }, k = l => {
            ...
            return {
                [`${ m }-affix-wrapper`]: Object.assign(Object.assign(Object.assign({}, (0, f.genBasicInputStyle)(l)), (0, f.genStatusStyle)(l, `${ m }-affix-wrapper`)), {
                    ...
                    '&-lg': { borderRadius: q },
                    '&-sm': { borderRadius: r },
                    [`&:not(${ m }-affix-wrapper-disabled):hover`]: Object.assign(Object.assign({}, (0, f.genHoverStyle)(l)), { zIndex: 1 }),
                    '&-focused, &:focus': { zIndex: 1 },
                    '&-disabled': { [`${ m }[disabled]`]: { background: 'transparent' } },
                    [`> div${ m }`]: {
                        width: '100%',
                        border: 'none',
                        outline: 'none',
                        [`&${ m }-focused`]: { boxShadow: 'none !important' }
                    },
                    [`input${ m }-input`]: { padding: 0 },
                    '&::before': {
                        width: 0,
                        visibility: 'hidden',
                        content: '"\\a0"'
                    },
                    [`${ m }-handler-wrap`]: { zIndex: 2 },
                    [m]: {
                        '&-prefix, &-suffix': {
                            display: 'flex',
                            flex: 'none',

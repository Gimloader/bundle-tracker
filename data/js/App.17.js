...
r.register("35vNf", (function(t, n) {
    ...
    let b, m, g, x = e => e;
    const _ = .2;
    var w = (0, p.withDeviceUIWrapper)((e => ((0, c.default)(Phaser.Input.Keyboard.KeyCodes.ESC, e.close, [e.close]), i.useEffect((() => {
        (0, y.default)({
            familyName: e.font
        })
    }), [e.font]), (0, a.jsx)(j, {
    ...
    const j = (0, s.default)(l.default).attrs({
            className: "maxAll"
        })(b || (b = x`
  overflow: hidden;
  z-index: ${0};
`), f.default.primaryContent),
        E = (0, s.default)(u.motion.div).attrs({
            className: "maxAll flex hc"
        })(m || (m = x`
  align-items: flex-end;
`)),
        O = (0, s.default)(u.motion.div).attrs({
...
`), h.default.White)
    ...
    var u = e => {
        ...
        return (0, o.jsxs)("div", {
            ...
            children: [(0, o.jsx)(a.default, {
                ...
                onTypewriterComplete: r
            }), (0, o.jsx)(i.default, {
                actions: e.actions,
                send: e.send,
                close: e.close,
                canShow: !e.typewriter || t
            })]
        })
    }
})), r.register("2KjXC", (function(n, o) {
    ...
    var y = e => (0, a.jsxs)(b, {
        onClick: s.default,
        children: [e.character ? (0, a.jsx)(m, {
            src: (0, f.default)(`characters/spine/normalized_preview/${e.character.replace("character_","")}.png`)
        }) : null, (0, a.jsx)("div", {
            style: {
            ...
            children: (() => {
                if (e.typewriter) {
                    const r = (0, c.Sanitize)({
                        inputText: e.message
                    });
                    return (0, a.jsx)("div", {
                        style: {
                            fontWeight: r.includes("<b>") ? l.FontWeights.Normal : l.FontWeights.Bold
                        },
                        children: (0, a.jsx)(t(u), {
                            options: {
                                delay: 16,
                                cursor: ""
                            },
                            onInit: t => {
                                t.typeString(r).callFunction((() => {
                ...
                return (0, a.jsx)(p.CustomMarkupLangComponent, {
                    inputText: e.message,
                    boldByDefault: !0,
                    display: "inline"
                })
...
`))
...
})), r.register("4b3WW", (function(e, t) {
    var n, o = r("hgOME");
    "undefined" != typeof self ? self : e.exports, n = e => (() => {
        var t = {
                7403: (e, t, r) => {
                    r.d(t, {
                        default: () => T
                    ...
                    const T = function() {
                        function e(t, r) {
                            ...
                            if (function(e, t) {
                                    ...
                                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                                    return a(e) ? g.typeOutHTMLString(e, t, !0) : (e && g.addEventToQueue(b, {
                                        character: e,
                                        node: t
                                    }), g)
                                    ...
                                    if (n.length > 0)
                                        for (var o = 0; o < n.length; o++) {
                                            ...
                                            a && 3 !== a.nodeType ? (a.innerHTML = "", g.addEventToQueue(d, {
                                                node: a,
                                                parentNode: t
                                            }), r ? g.pasteString(i, a) : g.typeString(i, a)) : a.textContent && (r ? g.pasteString(a.textContent, t) : g.typeString(a.textContent, t))
                                        }
                                    return g
                                    ...
                                    return g.state[n] = r ? [o].concat(w(g.state[n])) : [].concat(w(g.state[n]), [o]), g
                                    ...
                                    if (!g.state.eventQueue.length) {
                                        ...
                                        g.state.eventQueue = w(g.state.calledEvents), g.state.calledEvents = [], g.options = _({}, g.state.initialOptions)
                                    }
                                    if (g.state.eventLoop = o()(g.runEventLoop), !g.state.eventLoopPaused) {
                                        ...
                                        var r, n = w(g.state.eventQueue),
                                            a = n.shift();
                                        if (!(t <= (r = a.eventName === l || a.eventName === u ? "natural" === g.options.deleteSpeed ? i(40, 80) : g.options.deleteSpeed : "natural" === g.options.delay ? i(120, 160) : g.options.delay))) {
                                            var x = a.eventName,
                                                j = a.eventArgs;
                                            switch (g.logInDevMode({
                                                ...
                                                case s:
                                                    var E = j.character,
                                                        ...
                                                        S = T;
                                                    g.options.onCreateTextNode && "function" == typeof g.options.onCreateTextNode && (S = g.options.onCreateTextNode(E, T)), S && (O ? O.appendChild(S) : g.state.elements.wrapper.appendChild(S)), g.state.visibleNodes = [].concat(w(g.state.visibleNodes), [{
                                                        type: "TEXT_NODE",
                                                        character: E,
                                                        node: S
                                                    }]);
                                                ...
                                                case d:
                                                    var k = a.eventArgs,
                                                        M = k.node,
                                                        D = k.parentNode;
                                                    D ? D.appendChild(M) : g.state.elements.wrapper.appendChild(M), g.state.visibleNodes = [].concat(w(g.state.visibleNodes), [{
                                                        type: m,
                                                        node: M,
                                                ...
                                                case c:
                                                    ...
                                                    for (var z = 0, U = L.length; z < U; z++) R.push({
                                                        eventName: l,
                                                        eventArgs: {
                                                ...
                                                case l:
                                                    ...
                                                    if (g.state.visibleNodes.length) {
                                                        ...
                                                        g.options.onRemoveNode && "function" == typeof g.options.onRemoveNode && g.options.onRemoveNode({
                                                            node: B,
                                                            character: H
                                                        }), B && B.parentNode.removeChild(B), W === m && I && n.unshift({
                                                            eventName: l,
                                                            eventArgs: {}
                                                        })
                                                    }
                                            ...
                                            g.options.loop && (a.eventName === l || a.eventArgs && a.eventArgs.temp || (g.state.calledEvents = [].concat(w(g.state.calledEvents), [a]))), g.state.eventQueue = n, g.state.lastFrameTime = e
                                        }
                                    }
                                })), t)
                                if ("string" == typeof t) {
                        ...
                        return r = [{
                            ...
                            }((t = e).prototype, r), Object.defineProperty(t, "prototype", {
                                writable: !1
                            }), e
                    }()
                },
                ...
                4636: (e, t, r) => {
                    ...
                    e.exports = function(e, t) {
                        var r = a(e),
                            ...
                            h = v.length;
                        for (var y in e) !t && !c.call(e, y) || d && ("length" == y || p && ("offset" == y || "parent" == y) || f && ("buffer" == y || "byteLength" == y || "byteOffset" == y) || s(y, h)) || v.push(y);
                        return v
                    }
                },
                2488: e => {
                ...
                2492: (e, t, r) => {
                    ...
                    e.exports = function(e, t, r, h, y, b) {
                        ...
                        if (E && !w) return b || (b = new n), m || l(e) ? o(e, t, r, h, y, b) : a(e, t, x, r, h, y, b);
                        if (!(1 & r)) {
                ...
                7114: (e, t, r) => {
                    ...
                    e.exports = function(e, t, r, i, s, u) {
                        ...
                        for (u.set(e, t), u.set(t, e); ++v < l;) {
                            var b = e[v],
                                m = t[v];
                            if (i) var g = c ? i(m, b, v, t, e, u) : i(b, m, v, e, t, u);
                            if (void 0 !== g) {
                                if (g) continue;
                                h = !1;
                                break
                ...
                6096: (e, t, r) => {
                    ...
                    e.exports = function(e, t, r, a, i, s) {
                        ...
                        for (var y = u; ++p < l;) {
                            var b = e[f = c[p]],
                                m = t[f];
                            if (a) var g = u ? a(m, b, f, t, e, s) : a(b, m, f, e, t, s);
                ...
                4160: (e, t, r) => {
                    var n = r(8552),
                        ...
                        g = c(s),
                        x = u;
                    (n && x(new n(new ArrayBuffer(1))) != v || o && x(new o) != l || a && x(a.resolve()) != p || i && x(new i) != f || s && x(new s) != d) && (x = function(e) {
                        var t = u(e),
                ...
                75: function(e) {
                    (function() {
                        ...
                        })(), s = 1e9 * o.uptime(), i = a - s) : Date.now ? (e.exports = function() {
                            return Date.now() - n
        ...
        return (() => {
            ...
            var f = function(e) {
                ...
                function v() {
                    ...
                    return t = c(e = d.call.apply(d, [this].concat(a))), n = {
                        instance: null
                ...
                return o = [{
                    ...
                    }((n = v).prototype, o), Object.defineProperty(n, "prototype", {
                        writable: !1
                    }), v
            }(e.Component);
            f.defaultProps = {
    ...
    var l = e => e.actions.length ? (0, o.jsx)(p, {
        variants: c,
        initial: "hidden",
        animate: e.canShow ? "show" : "hidden",
        children: e.actions.map(((t, r) => (0, o.jsx)(a.default, {
            action: t,
            send: e.send,
            close: e.close
        }, t.text + r)))
    }) : null;
    const p = (0, i.default)(s.motion.div).attrs({
        className: "maxWidth"
    })(u || (u = (e => e)`
  display: inline-flex;
  flex-wrap: wrap;
...
`))
    ...
    var d = e => {
        ...
        return (0, o.jsx)(s.motion.div, {
            ...
            children: (0, o.jsx)(v, {
                onClick: n => {
                    (0, c.default)(n), r(u.Messages.action, {
                        index: t.index,
                        action: t.action
                    }), e.close()
                },
                children: (0, o.jsx)("div", {
                    children: (0, o.jsx)(l.CustomMarkupLangComponent, {
                        inputText: t.text,
                        boldByDefault: !0
                    })
                })
...
`), i.FontWeights.Bold)
})), r.register("jsPng", (function(t, r) {
    let n;
    e(t.exports, "Messages", (function() {
        return n
    })), (n || (n = {})).action = "action"
})), r.register("2BPYb", (function(n, o) {
    ...
    var u = e => {
        ...
        i.includes(r) ? n && n() : t(a).load({
            google: {
                families: [`${r}:400,700`]
            },
            fontactive: e => {
                i.includes(e) || i.push(e), r === e && n && n()
            }
        })
    }
}));
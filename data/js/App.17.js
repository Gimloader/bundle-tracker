...
`), q.default.White);
    ...
    var _q = r => (0, f.jsxs)(_r, {
        onClick: h.default,
        children: [
            r.character ? (0, f.jsx)(_s, {
                src: (0, m.default)(`characters/spine/normalized_preview/${ r.character.replace('character_', '') }.png`)
            }) : null,
            (0, f.jsx)('div', {
                style: {
                    paddingLeft: r.character ? 85 : 0
                },
                children: (() => {
                    if (r.typewriter) {
                        const s = (0, j.Sanitize)({
                            inputText: r.message
                        });
                        return (0, f.jsx)('div', {
                            style: {
                                fontWeight: s.includes('<b>') ? k.FontWeights.Normal : k.FontWeights.Bold
                            },
    ...
    'undefined' != typeof self ? self : d.exports, f = h => (() => {
        var i = {
                7403: (j, k, l) => {
                    ...
                    var q = 'TYPE_CHARACTER',
                        r = 'REMOVE_CHARACTER',
                        s = 'REMOVE_ALL',
                        t = 'REMOVE_LAST_VISIBLE_NODE',
                        u = 'PAUSE_FOR',
                        v = 'CALL_FUNCTION',
                    ...
                    const _Q = function() {
                        function R(S, T) {
                            ...
                            if (function(V, W) {
                                    ...
                                    if (V) {
                                        var X = (U.options || {}).stringSplitter,
                                            Y = 'function' == typeof X ? X(V) : V.split('');
                                    ...
                                    return U.addEventToQueue(s, {
                                        speed: V
                                    }), U;
                                }), _N(this, 'changeDeleteSpeed', function(V) {
                                    if (!V)
                                        throw new Error('Must provide new delete speed');
                                    return U.addEventToQueue(x, {
                                        speed: V
                                    }), U;
                                            ...
                                            switch (U.logInDevMode({
                                                ...
                                                case t:
                                                    ...
                                                    if (U.state.visibleNodes.length) {
                                                        var sb = U.state.visibleNodes.pop(),
                                                            tb = sb.type,
                                                            ub = sb.node,
                                                            vb = sb.character;
                        ...
                        return V = [{
                                    ...
                                    value: function() {
                                        var W;
                                        this.setupWrapperElement(), this.addEventToQueue(z, {
                            ...
                            }((U = R).prototype, V), Object.defineProperty(U, 'prototype', {
                                writable: !1
                            }), R;
                    }();
                },
                ...
                2492: (j, k, l) => {
                    ...
                    j.exports = function(y, z, A, B, C, D) {
                        ...
                        if (!(1 & A)) {
                            var L = I && x.call(y, '__wrapped__'),
                                M = J && x.call(z, '__wrapped__');
                            if (L || M) {
                                var N = L ? y.value() : y,
                                    O = M ? z.value() : z;
                ...
                8458: (j, k, l) => {
                    var m = l(3560),
                        ...
                        t = r.toString,
                        u = s.hasOwnProperty,
                        v = RegExp('^' + t.call(u).replace(/[\\^$.*+?()[\]{}|]/g, '\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$');
                ...
                4160: (j, k, l) => {
                    ...
                    (m && D(new m(new ArrayBuffer(1))) != x || n && D(new n()) != t || o && D(o.resolve()) != u || p && D(new p()) != v || q && D(new q()) != w) && (D = function(E) {
                        var F = r(E),
                            G = '[object Object]' == F ? E.constructor : void 0,
                            H = G ? s(G) : '';
                        if (H)
                            switch (H) {
                                case y:
                ...
                5346: (j, k, l) => {
                    var m, n = l(4429),
                        o = (m = /[^.]+$/.exec(n && n.keys && n.keys.IE_PROTO || '')) ? 'Symbol(src)_1.' + m : '';
                    j.exports = function(p) {
                        return !!o && o in p;
                    };
                },
                ...
                4144: (j, k, l) => {
                    ...
                    var m = l(5639),
                        ...
                        o = k && !k.nodeType && k,
                        p = o && j && !j.nodeType && j,
                        q = p && p.exports === o ? m.Buffer : void 0,
                        r = (q ? q.isBuffer : void 0) || n;
                    j.exports = r;
                },
                8446: (j, k, l) => {
                    var m = l(939);
                ...
                4087: (j, k, l) => {
                    ...
                    if (!q || !r) {
                        ...
                        q = function(w) {
                            if (0 === v.length) {
                                var x = m(),
                                    y = Math.max(0, 16.666666666666668 - (x - t));
            ...
            var z = function(A) {
                ...
                function _G() {
                    ...
                    for (var L = arguments.length, M = new Array(L), N = 0; N < L; N++)
                        M[N] = arguments[N];
                    return I = v(H = F.call.apply(F, [this].concat(M))), K = {
                        instance: null
                    }, (J = x(J = 'state')) in I ? Object.defineProperty(I, J, {
                        value: K,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
                ...
                return L = [{
                            ...
                            value: function() {
                                var O = this,
                                    P = new J.default(this.typewriter, this.props.options);
                                this.setState({
                                    instance: P
                                }, function() {
                        ...
                        },
                        {
                            ...
                            value: function(O) {
                                N()(this.props.options, O.options) || this.setState({
                                    instance: new J.default(this.typewriter, this.props.options)
                                });
                            }
                        },
                        {
                    ...
                    }((K = _G).prototype, L), Object.defineProperty(K, 'prototype', {
                        writable: !1
                    }), _G;
            }(o.Component);
            z.defaultProps = {

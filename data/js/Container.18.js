...
c.register('.....', function (d, e) {
    ...
    function q(r) {
        ...
        }), h.createElement(l.default, Object.assign({ prefixCls: K }, G, { onClose: B }))))));
    }
    q._InternalPanelDoNotUseOrYouWillBeFired = function (L) {
        ...
        const {getPrefixCls: R} = h.useContext(i.ConfigContext), S = R('drawer', M), [T, U] = (0, m.default)(S);
        return T(h.createElement('div', {
            className: a(f)(S, `${ S }-pure`, `${ S }-${ P }`, U, O),
            style: N
        }, h.createElement(l.default, Object.assign({ prefixCls: S }, Q))));
    };
    var _L = q;
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
    ...
    c('.....');
    var _k = function (l) {
        var m = l.open, n = void 0 !== m && m, o = l.prefixCls, p = void 0 === o ? 'rc-drawer' : o, q = l.placement, r = void 0 === q ? 'right' : q, s = l.autoFocus, t = void 0 === s || s, u = l.keyboard, v = void 0 === u || u, w = l.width, x = void 0 === w ? 378 : w, y = l.mask, z = void 0 === y || y, A = l.maskClosable, B = void 0 === A || A, C = l.getContainer, D = l.forceRender, E = l.afterOpenChange, F = l.destroyOnClose, G = h.useState(!1), H = (0, g.default)(G, 2), I = H[0], J = H[1];
        if (!D && !I && !n && F)
            return null;
    ...
    function _r(s) {
        var t, u, v, w, x = s.prefixCls, y = s.open, z = s.placement, A = s.inline, B = s.push, C = s.forceRender, D = s.autoFocus, E = s.keyboard, F = s.rootClassName, G = s.rootStyle, H = s.zIndex, I = s.className, J = s.style, K = s.motion, L = s.width, M = s.height, N = s.children, O = s.contentWrapperStyle, P = s.mask, Q = s.maskClosable, R = s.maskMotion, S = s.maskClassName, T = s.maskStyle, U = s.afterOpenChange, V = s.onClose, W = j.useRef(), X = j.useRef(), Y = j.useRef();
        j.useEffect(function () {
            var Z;
            y && D && (null === (Z = W.current) || void 0 === Z || Z.focus({ preventScroll: !0 }));
        }, [
            y,
            D
        ]);
        var Z = j.useState(!1), $ = (0, i.default)(Z, 2), ab = $[0], bb = $[1], cb = j.useContext(n.default), db = null !== (t = null !== (u = null === (v = !1 === B ? { distance: 0 } : !0 === B ? {} : B || {}) || void 0 === v ? void 0 : v.distance) && void 0 !== u ? u : null == cb ? void 0 : cb.pushDistance) && void 0 !== t ? t : 180, eb = j.useMemo(function () {
                return {
                    pushDistance: db,
                    push: function () {
                        bb(!0);
        ...
        var fb = P && j.createElement(l.default, (0, g.default)({ key: 'mask' }, R, { visible: y }), function (gb, hb) {
                var ib = gb.className, jb = gb.style;
        ...
        var ib = j.createElement(l.default, (0, g.default)({ key: 'panel' }, gb, {
                visible: y,
                forceRender: C,
                ...
                var lb = jb.className, mb = jb.style;
                return j.createElement('div', {
        ...
        return H && (jb.zIndex = H), j.createElement(n.default.Provider, { value: eb }, j.createElement('div', {
            ...
            onKeyDown: function (kb) {
                var lb = kb.keyCode, mb = kb.shiftKey;
                switch (lb) {
                case o.default.TAB:
                    var nb;
                    if (lb === o.default.TAB)
                        if (mb || document.activeElement !== Y.current) {
                            if (mb && document.activeElement === X.current) {
                                var ob;
                                null === (ob = Y.current) || void 0 === ob || ob.focus({ preventScroll: !0 });
                            }
                        } else
                            null === (nb = X.current) || void 0 === nb || nb.focus({ preventScroll: !0 });
                    break;
                case o.default.ESC:
                    V && E && V(kb);
                }
    ...
    !function (v) {
        var w = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : p.default, x = function (y) {
                (0, l.default)(p, y);
                var z = (0, m.default)(p);
                function A() {
                    var B;
                    ...
                    for (var C = arguments.length, D = new Array(C), E = 0; E < C; E++)
                        D[E] = arguments[E];
                    return B = z.call.apply(z, [this].concat(D)), (0, n.default)((0, k.default)(B), 'state', { keyEntities: [] }), (0, n.default)((0, k.default)(B), 'removeKey', function (F) {
                        var G = B.state.keyEntities.map(function (H) {
                            return H.key !== F ? H : (0, h.default)((0, h.default)({}, H), {}, { status: r.STATUS_REMOVED });
                        });
                        return B.setState({ keyEntities: G }), G.filter(function (H) {
                ...
                return (0, j.default)(A, [{
                        key: 'render',
                        value: function () {
                            var F = this, G = this.state.keyEntities, H = this.props, I = H.component, J = H.children, K = H.onVisibleChanged, L = H.onAllRemoved, M = (0, E.default)(H, s), N = I || o.Fragment, O = {};
                            return u.forEach(function (P) {
                                O[P] = M[P], delete M[P];
                            }), delete M.keys, o.createElement(N, M, G.map(function (P) {
                                var Q = P.status, R = (0, E.default)(P, t), S = Q === r.STATUS_ADD || Q === r.STATUS_KEEP;
                                return o.createElement(C, (0, D.default)({}, O, {
                                    key: R.key,
                                    visible: S,
                                    eventProps: R,
                                    onVisibleChanged: function (T) {
                                        (null == K || K(T, { key: R.key }), T) || 0 === F.removeKey(R.key) && L && L();
                                    }
                                }), J);
                            }));
                        }
                        ...
                        value: function (F, G) {
                            var H = F.keys, I = G.keyEntities, J = (0, r.parseKeys)(H);
                            return {
        ...
        (0, n.default)(x, 'defaultProps', { component: 'div' });
    }(q.supportTransition);
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _g;
    ...
    var f = c('.....'), g = c('.....'), h = c('.....'), _i = function (j) {
            var k = j.prefixCls, l = j.className, m = j.style, n = j.children, o = j.containerRef;
    ...
    function _i(j) {
        ...
        return f.createElement('div', {
            ...
            className: a(h)(`${ k }-header`, { [`${ k }-header-close-only`]: o && !l && !_i }),
            style: r
        }, f.createElement('div', { className: `${ k }-header-title` }, w, l && f.createElement('div', { className: `${ k }-title` }, l)), _i && f.createElement('div', { className: `${ k }-extra` }, _i)) : null, f.createElement('div', {
            className: `${ k }-body`,
            style: t
        }, v), function () {
            if (!m)
        ...
        return {
            [k]: {
                ...
                '&-pure': {
                    position: 'relative',
                    background: n,
                    [`&${ k }-left`]: { boxShadow: j.boxShadowDrawerLeft },
                    [`&${ k }-right`]: { boxShadow: j.boxShadowDrawerRight },
                    [`&${ k }-top`]: { boxShadow: j.boxShadowDrawerUp },
                    [`&${ k }-bottom`]: { boxShadow: j.boxShadowDrawerDown }
                },
    ...
    }, k => ({ zIndexPopup: k.zIndexPopupBase }));
}), c.register('.....', function (d, e) {
    b(d.exports, 'default', function () {
        return _f;
    });
    var _f = g => {
        const {
                ...
                '&-enter, &-appear, &-leave': {
                    ...
                    '&-active': { transition: `all ${ i }` }
                }
            };
        return {
            [h]: {
                [`${ h }-mask-motion`]: {
                    '&-enter, &-appear, &-leave': { '&-active': { transition: `all ${ i }` } },
                    '&-enter, &-appear': {
                        opacity: 0,
                        '&-active': { opacity: 1 }
                    },

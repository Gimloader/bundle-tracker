...
`, {
    ...
    const {
        ...
        u || (I.me.adding.terrain.currentlySelectedTerrain = n, I.me.adding.mode = W.terrain, H(z.adding), j() && Q(y.home), _({
...
const Qe = de(qe),
    ...
    Ue = e => {
        const {
            ...
            r || (I.me.adding.devices.selectedDeviceType = d.prop, I.me.adding.devices.currentlySelectedProp = n, I.me.adding.mode = W.device, H(z.adding), j() && Q(y.home), _({
...
`,
    ...
    ot = e => {
        const {
            ...
            u || (I.me.adding.devices.selectedDeviceType = n, I.me.adding.mode = W.device, I.me.currentAction = z.adding, j() && Q(y.home), _({

...
function ke() {
    return pe || (pe = 1, function(_e, ve) {
        ((ue, R) => {
            _e.exports = R()
        })(ye, function ue() {
            var R = typeof self < "u" ? self : typeof window < "u" ? window : R !== void 0 ? R : {},
                $, J = !R.document && !!R.postMessage,
                ne = R.IS_PAPA_WORKER || !1,
                V = {},
                ge = 0,
                u = {};
            ...
            function N(e) {
                this._handle = null, this._finished = !1, this._completed = !1, this._halted = !1, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = !0, this._completeResults = {
                    ...
                    var n = this._partialLine + t,
                        i = (this._partialLine = "", this._handle.parse(n, this._baseIndex, !this._finished));
                    if (!this._handle.paused() && !this._handle.aborted()) {
                        if (t = i.meta.cursor, n = (this._finished || (this._partialLine = n.substring(t - this._baseIndex), this._baseIndex = t), i && i.data && (this._rowCount += i.data.length), this._finished || this._config.preview && this._rowCount >= this._config.preview), ne) R.postMessage({
                            results: i,
                    ...
                    y(this._config.error) ? this._config.error(t) : ne && this._config.error && R.postMessage({
                        workerId: u.WORKER_ID,
                        error: t,
                        finished: !1
                    })
            ...
            function te(e) {
                ...
                this.stream = function(i) {
                    ...
                    var i = this._input,
                        l = (this._config.chunkSize && (l = Math.min(this._start + this._config.chunkSize, this._input.size), i = r.call(i, this._start, l)), t.readAsText(i, this._config.encoding));
                    n || this._chunkLoaded({
                        target: {
                            result: l
                        }
            ...
            function he(e) {
                ...
                function S() {
                    ...
                    function g(o, w) {
                        for (var O = e.header ? {} : [], m = 0; m < o.length; m++) {
                            var k = m,
                                _ = o[m],
                                _ = ((M, f) => (v => (e.dynamicTypingFunction && e.dynamicTyping[v] === void 0 && (e.dynamicTyping[v] = e.dynamicTypingFunction(v)), (e.dynamicTyping[v] || e.dynamicTyping) === !0))(M) ? f === "true" || f === "TRUE" || f !== "false" && f !== "FALSE" && ((v => {
                                    if (F.test(v) && (v = parseFloat(v), x < v && v < l)) return 1
                ...
                function z(p, g, b, o) {
                    p = {
                        ...
                        code: g,
                        message: b
                    }, o !== void 0 && (p.row = o), s.errors.push(p)
                }
                y(e.step) && (i = e.step, e.step = function(p) {
                    ...
                    var o = e.quoteChar || '"',
                        o = (e.newline || (e.newline = this.guessLineEndings(p, o)), n = !1, e.delimiter ? y(e.delimiter) && (e.delimiter = e.delimiter(p), s.meta.delimiter = e.delimiter) : ((o = ((w, O, m, k, _) => {
                            var M, f, v, W;
                            _ = _ || [",", "	", "|", ";", u.RECORD_SEP, u.UNIT_SEP];
                            for (var H = 0; H < _.length; H++) {
                                for (var P, Y = _[H], D = 0, U = 0, I = 0, L = (v = void 0, new se({
                                        comments: k,
                                        delimiter: Y,
                                        newline: O,
                                        preview: 10
                                    }).parse(w)), B = 0; B < L.data.length; B++) m && C(L.data[B]) ? I++ : (P = L.data[B].length, U += P, v === void 0 ? v = P : 0 < P && (D += Math.abs(P - v), v = P));
                                0 < L.data.length && (U /= L.data.length - I), (f === void 0 || D <= f) && (W === void 0 || W < U) && 1.99 < U && (f = D, M = Y, W = U)
                            }
                            return {
                                successful: !!(e.delimiter = M),
                                bestDelimiter: M
                            }
                    ...
                    return e.preview && e.header && o.preview++, t = p, r = new se(o), s = r.parse(t, g, b), S(), T ? {
                        meta: {
                            paused: !0
                        }
                    } : s || {
                    ...
                    var o = new RegExp(G(o) + "([^]*?)" + G(o), "gm"),
                        b = (w = w.replace(o, "")).split("\r"),
                        o = w.split(`
`),
...
` : "\r"
            ...
            function se(e) {
                var t = (e = e || {}).delimiter,
                    ...
                    F = null,
                    j = !1,
                    d = e.quoteChar == null ? '"' : e.quoteChar,
                    E = d;
...
`);
                ...
                this.parse = function(h, c, s) {
                    ...
                    for (var k = h.indexOf(t, a), _ = h.indexOf(r, a), M = new RegExp(G(E) + G(d), "g"), f = h.indexOf(d, a);;)
                        if (h[a] === d)
                            for (f = a, a++;;) {
                                if ((f = h.indexOf(d, f + 1)) === -1) return s || b.push({
                                    type: "Quotes",
                                    code: "MissingQuotes",
            ...
            return u.parse = function(e, t) {
                ...
                (r = (() => {
                    ...
                    return !!u.WORKERS_SUPPORTED && (n = (() => {
                        var i = R.URL || R.webkitURL || null,
                            l = ue.toString();
                        return u.BLOB_URL || (u.BLOB_URL = i.createObjectURL(new Blob(["var global = (function() { if (typeof self !== 'undefined') { return self; } if (typeof window !== 'undefined') { return window; } if (typeof global !== 'undefined') { return global; } return {}; })(); global.IS_PAPA_WORKER=true; ", "(", l, ")();"], {
                            type: "text/javascript"
                        })))
                    })(), (n = new R.Worker(n)).onmessage = me, n.id = ge++, V[n.id] = n)
                })()).userStep = t.step, r.userChunk = t.chunk, r.userComplete = t.complete, r.userError = t.error, t.step = y(t.step), t.chunk = y(t.chunk), t.complete = y(t.complete), t.error = y(t.error), delete t.worker, r.postMessage({
                    input: e,
                    config: t,
                    workerId: r.id
                })
...
`,
                ...
                function T(c, s, C) {
                    var S = "",
                        A = (typeof c == "string" && (c = JSON.parse(c)), typeof s == "string" && (s = JSON.parse(s)), Array.isArray(c) && 0 < c.length),
                        z = !Array.isArray(s[0]);
                    if (A && n) {
                    ...
                    for (var g = 0; g < s.length; g++) {
                        var b = (A ? c : s[g]).length,
                            o = !1,
                            w = A ? Object.keys(s[g]).length === 0 : s[g].length === 0;
...
`, '"', u.BYTE_ORDER_MARK], u.WORKERS_SUPPORTED = !J && !!R.Worker, u.NODE_STREAM_INPUT = 1, u.LocalChunkSize = 10485760, u.RemoteChunkSize = 5242880, u.DefaultDelimiter = ",", u.Parser = se, u.ParserHandle = he, u.NetworkStreamer = ee, u.FileStreamer = te, u.StringStreamer = Z, u.ReadableStreamStreamer = re, R.jQuery && (($ = R.jQuery).fn.parse = function(e) {
                ...
                return this.each(function(l) {
                    ...
                    for (var x = 0; x < this.files.length; x++) r.push({
                        file: this.files[x],
                        inputElem: this,
                ...
                function n() {
                    if (r.length === 0) y(e.complete) && e.complete();
                        ...
                        if (y(e.before)) {
                            ...
                            if (typeof E == "object") {
                                if (E.action === "abort") return l = "AbortError", x = d.file, F = d.inputElem, j = E.reason, void(y(e.error) && e.error({
                                    name: l
                                }, x, F, j));
                ...
                e = e.data, u.WORKER_ID === void 0 && e && (u.WORKER_ID = e.workerId), typeof e.input == "string" ? R.postMessage({
                    workerId: u.WORKER_ID,
                    results: u.parse(e.input, e.config),
                    finished: !0
                }) : (R.File && e.input instanceof File || e.input instanceof Object) && (e = u.parse(e.input, e.config)) && R.postMessage({
                    workerId: u.WORKER_ID,
                    results: e,
                    finished: !0
                })

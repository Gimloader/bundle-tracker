    ...
    class m extends j.default {
        constructor(n) {
            super(n), (0, f.default)(this, 'incorrectCounter', 0), (0, f.default)(this, 'guess', o => {
                this.sendToServerDevice(l.PasswordLockDeviceSentToServerMessages.guess, { password: o });
                ...
                'attempts' === o && this.deviceUI.update({ attempts: this.state.attempts });
            }), (0, f.default)(this, 'onMessage', o => {
                o.key === l.PasswordLockDeviceSentToClientMessages.incorrect && (null == o ? void 0 : o.data) === (0, g.default)() && (this.incorrectCounter += 1, this.deviceUI.update({ incorrectCounter: this.incorrectCounter }));

...
const re = () => {
        ...
        if (i) {
            ...
            m && (m.deviceOption.id === H.prop && (o = u(v.prop.singular), s = `Unknown ${o}`), s = z(i))
        }
    ...
    te = () => {
        ...
        return p.useEffect(() => {
            const e = V([() => h.me.removing.tilesToRemove, () => h.me.removing.deviceIdToRemove, () => h.me.removing.wireIdToRemove], () => {
                const a = re();

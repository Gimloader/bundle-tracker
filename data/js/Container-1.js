const __vite__mapDeps = (i, m = __vite__mapDeps, d = (m.f || (m.f = ["assets/SchoolLibrary-BVRhW2oh.js", "assets/index-JueF_e_O.js", "assets/index-BdOndhxL.css", "assets/KitPreview-CYll-wnr.js", "assets/ImagePreview-D1w737eq.js", "assets/getCloudinaryUrl-Drn97BLG.js", "assets/AccessibleAnchor-C5KFFiup.js", "assets/NavigateTo-B9Fkdix9.js", "assets/index.es-C7rPLWlk.js"]))) => i.map(i => d[i]);
import {
    r as l,
    I as ht,
    _ as mt,
...
`,
    ...
    _s = t => {
        ...
        const s = [],
            r = [],
            o = (c = t.folders) == null ? void 0 : c.find(d => d._id === t.selectedFolder);
        t.kits.forEach(d => {
            t.selectedFolder && (!o || !o.games.includes(d._id)) || (d.isArchived ? r.push(d) : s.push(d))
        });
        const n = [...s, ...r],
            i = () => !n.length && t.selectedFolder ? e.jsxs("div", {
        ...
        return e.jsxs(e.Fragment, {
            children: [e.jsx(B, {
                title: (o == null ? void 0 : o.title) ?? "Kits"
            }), i()]
        })
    },
    Ds = t => {
...
`,
    Us = l.lazy(() => jt(() => import("./SchoolLibrary-BVRhW2oh.js"), __vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7, 8]))),
    zs = () => {
        var d, x, m, j, f;
        const {
            data: t,
        ...
        return !c && !((f = t == null ? void 0 : t.games) != null && f.length) ? i() : e.jsx(H, {
            header: e.jsx("div", {
                className: "maxWidth",
                children: e.jsx(Y, {
                    title: "Kits",
                    customUnderTitleComponent: c ? e.jsx("div", {
                        style: {
                            marginTop: 13
                        },
                        children: e.jsx(Ds, {
...
`,
    ...
    hr = () => {
        const [t, s] = l.useState(!0), [r, o] = l.useState(!1), [n, i] = l.useState(null), [c, d] = l.useState([]), x = (u, M) => {
            ...
            n !== "nextSevenDays" && m() && (i("nextSevenDays"), x(p(), p().add(15, "days")))
        }, f = () => {
            n !== "nextFortyFiveDays" && m() && (i("nextFortyFiveDays"), x(p(), p().add(46, "days")))
        }, g = () => {
            n !== "lastThirtyDays" && m() && (i("lastThirtyDays"), x(p().subtract(31, "days"), p()))
        };
        return l.useEffect(() => {
            j()
        }, []), e.jsxs(xe, {
            children: [e.jsx(mr, {
                ...
                children: [e.jsx(X, {
                    onClick: j,
                    selected: n === "nextSevenDays",
                    children: "Next 14 days"
                }), e.jsx(X, {
                    onClick: f,
                    selected: n === "nextFortyFiveDays",
                    children: "Next 45 days"
                }), e.jsx(X, {
                    onClick: g,
                    selected: n === "lastThirtyDays",
            ...
            children: [e.jsx(B, {
                ...
                children: [e.jsx(Rr, {
                    ...
                    children: e.jsx(H, {
                        header: e.jsx(Y, {
                            title: "Reports",
                            customRightComponent: u ?? e.jsx(e.Fragment, {})
                        }),
                        contentStyle: {
                            padding: 0
                        },
...
const ie = "#0a2540",
    _r = t => {
        const [s, r] = l.useState(0), [o, n] = l.useState(""), i = () => {
            ...
            const d = p.duration(p(c.freeTrial.freeTrialExpiration).diff(p())),
                x = d.asDays(),
                m = d.asHours(),
                j = d.asMinutes(),
                f = d.asSeconds();
            if (x >= 1) {
                let g = x;
                x === 31 && (g = 30), n("day"), r(Math.ceil(g))
            } else m >= 1 && m < 24 ? (n("hour"), r(Math.ceil(m))) : j >= 1 && j < 60 ? (n("minute"), r(Math.ceil(j))) : f > 0 && f < 60 && (n("second"), r(Math.ceil(f)))
        };
        return l.useEffect(() => {
            i()

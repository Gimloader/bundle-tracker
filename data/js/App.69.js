...
c.register('.....', function (d, e) {
    ...
    var _w = () => {
        const x = (0, q.useParams)().id, [y, z] = j.useState(''), [A, B] = j.useState(''), [C, D] = j.useState(t.join), [E, F] = j.useState(!0), [G, H] = j.useState(''), [I, J] = j.useState(''), [K, L] = j.useState(!1), [M, N] = j.useState(!1), [O, P] = j.useState(''), Q = () => D(t.dashboard);
        j.useEffect(() => {
            (0, l.request)({
        ...
        return E ? (0, g.jsx)(_x, { children: (0, g.jsx)(o.default, { size: 'large' }) }) : (0, g.jsxs)(g.Fragment, {
            children: [
                (0, g.jsx)(_x, {
                    children: (0, g.jsx)(_y, {
                ...
                (0, g.jsx)(l.Title, { title: 'KitCollab' })
            ]
        });
    };
    const _x = k.default.div.attrs({ className: 'flex-center scroll-y' })(r || (r = u`
  flex: 1;
  background: ${ 0 };
  color: ${ 0 };
  font-family: ${ 0 };
`), h.default.Snow, h.default.Black, i.Fonts.SFPro), _y = (0, k.default)(p.default)(s || (s = u`
  width: 90%;
  max-width: 640px;
  border-radius: 8px;
  padding: 40px 30px;
...
`));
    ...
    var _q = r => {
        const [s, t] = j.useState([]), u = () => {
                (0, i.request)({
                    ...
                    data: { userSessionId: r.userSessionId },
                    success: v => {
                        t(v);
                    }
                });
    ...
    const _o = h.default.div(j || (j = m``)), _p = h.default.img.attrs({ src: '/client/img/svgLogo.svg' })(k || (k = m`
  height: 22px;
  opacity: 0.8;
...
`), g.FontWeights.UltraBold);
    ...
    let u, v, w, x = y => y;
    const y = z => {
        const A = h.useMemo(() => z.status === t.GameSubmittedQuestionStatus.accepted ? 'Accepted' : z.status === t.GameSubmittedQuestionStatus.rejected ? 'Rejected' : 'Waiting For Approval', [z.status]), B = h.useMemo(() => z.status === t.GameSubmittedQuestionStatus.accepted ? '#1b5e20' : z.status === t.GameSubmittedQuestionStatus.rejected ? '#b71c1c' : '#283593', [z.status]);
        return (0, f.jsxs)(_A, {
            style: { backgroundColor: B },
            children: [
                (0, f.jsx)(_B, { children: A }),
                (0, f.jsx)(_C, {
                        ...
                        children: [
                            ...
                            (0, f.jsx)(m.default, {
                                ...
                                children: (0, f.jsx)('div', {
                                    ...
                                    children: (0, f.jsx)(n.default, { name: 'far fa-trash-alt' })
                                })
                            })
                        ]
                    }) : null
    ...
    var _z = (0, r.observer)(A => {
        const B = (0, s.useLocalObservable)(() => ({
            ...
            })), [C, D, E] = (0, p.useBoolean)(!1), [F, G] = h.useState(A.status), [H, I, J] = (0, p.useBoolean)(!1), K = h.useCallback(() => {
                        ...
                        (0, p.request)({
                            ...
                            error: O => {
                                (0, p.throwMessageError)({
                                    e: O,
                                    default: { title: 'Error updating question. Try again later.' }
                                });
                            },
                            both: () => J()
                        });
    ...
    const _A = i.default.div.attrs({ className: 'maxWidth flex vc between' })(u || (u = x`
  transition: background 0.3s;
  color: ${ 0 };
  padding: 14px 24px;
  z-index: 999;
`), j.default.White), _B = i.default.div.attrs({ className: 'flex vc' })(v || (v = x`
  font-size: 16px;
  line-height: 1;
`)), _C = i.default.div.attrs({ className: 'flex vc' })(w || (w = x`
  font-size: 16px;
`));
}), c.register('.....', function (d, e) {
    a(d.exports, 'default', function () {
    ...
    let p, q, r, s = t => t;
    var _t = u => {
        const v = g.useRef(), [w, x, y] = (0, m.useBoolean)(!1), [z, A] = g.useState(!1), [B, C, D] = (0, m.useBoolean)(!1);
        return (0, f.jsxs)(f.Fragment, {
            children: [
                (0, f.jsx)(h.default, {
                    ...
                    children: (0, f.jsx)(_u, {
                        children: (0, f.jsxs)('div', {
                            ...
                            children: [
                                (0, f.jsx)(_v, { children: (0, f.jsx)(k.default, { name: 'fas fa-plus' }) }),
                                (0, f.jsx)(_w, { children: 'Contribute New Question' })
                            ]
                        })
                    })
                }),
                        ...
                        (0, m.request)({
                            ...
                            error: G => {
                                (0, m.throwMessageError)({
                                    e: G,
                                    default: { title: 'Error submitting question. Try again later.' }
                                });
                            },
                            both: () => D()
                        });
...
`), i.default.Black, j.Fonts.SFPro), _v = l.default.div.attrs({ className: 'flex-center' })(q || (q = s`
  font-size: 22px;
  background: #2e7d32;
  color: ${ 0 };
  height: 43px;
  width: 43px;
  border-radius: 50%;
`), i.default.White), _w = l.default.div(r || (r = s`
  font-size: 26px;
  line-height: 1;
  margin-top: 16px;
  font-weight: ${ 0 };
...
`), j.FontWeights.Bold);
    ...
    var _o = p => (0, f.jsxs)(_p, {
        children: [
            (0, f.jsx)(_q, {}),
            (0, f.jsx)(_r, { children: 'KitCollab' }),
            (0, f.jsxs)(_s, {
                children: [
                    (0, f.jsx)('b', { children: p.creatorName }),
                    ' invited you to contribute questions to their',
                    ' ',
                    (0, f.jsx)('b', { children: p.gameName }),
                    ' kit. Once you enter, you can submit questions to be added to the kit.'
                ]
            }),
            (0, f.jsx)(i.default, { style: { margin: '30px 0px' } })
        ]
    });
    const _p = h.default.div.attrs({ className: 'maxWidth flex-center flex-column' })(j || (j = n``)), _q = h.default.img.attrs({ src: '/client/img/svgLogo.svg' })(k || (k = n`
  height: 24px;
  opacity: 0.8;
`)), _r = h.default.div(l || (l = n`
  ...
  line-height: 1;
  margin-top: 10px;
`), g.FontWeights.UltraBold), _s = h.default.div(m || (m = n`
  font-size: 18px;
  margin-top: 15px;
`));
}), c.register('.....', function (d, e) {
    ...
    const q = r => (0, f.jsx)(g.default, {
            ...
            block: !0,
            type: 'primary',
            style: Object.assign({ height: 50 }, r.style || {}),
            onClick: r.onClick,
            loading: r.loading,
            disabled: r.disabled,
            children: r.label
                ...
                B || (C(!0), (0, i.request)({
                    ...
                    error: G => {
                        (0, i.throwMessageError)({
                            e: G,
                            default: { title: 'Error joining. Please try again later.' }
                        }), C(!1);
                    }
                }));
            };
        return (0, f.jsx)(_w, {
            children: (() => {
                ...
                return A || G ? G ? z ? (0, f.jsx)(s, {
                    join: F,
                    loading: B
                }) : (0, f.jsx)(u, { creatorName: y }) : (0, f.jsx)(t, { creatorName: y }) : (0, f.jsx)(r, {
                    join: F,
                    onNameChange: E,
                    loading: B
                });
    ...
    const _w = k.default.div.attrs({ className: 'maxWidth' })(m || (m = p``)), _x = k.default.div.attrs({ className: 'maxWidth' })(n || (n = p`
  font-size: 16px;
  text-align: center;
  color: rgba(0, 0, 0, 0.7);
`)), _y = k.default.div.attrs({ className: 'maxWidth' })(o || (o = p`
  font-size: 16px;
  text-align: center;
  padding: 20px 30px;
  border-radius: 50px;

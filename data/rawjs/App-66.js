...
`,U=s.div`
  ...
  font-style: italic;
  font-weight: ${S.Bold};
`,B=t=>{const{name:o,description:i,items:n}=t.list;return r.jsxs(d,{children:[r.jsx(H,{children:o}),r.jsx(I,{children:i}),r.jsx(c,{style:{marginTop:18},direction:"vertical",className:"maxWidth",size:14,children:n.map(e=>r.jsx(C,{listing:e},e._id))})]})},Y="useDiscoverySearch",G=t=>j({queryKey:[Y,{searchQuery:t}],enabled:!!t,queryFn:()=>g({url:"/api/created-map/listing/discovery/search",data:{query:t}})}),K=t=>{const[o]=T(),[i,n]=y.useState(o.get("q")),{data:e,isLoading:l}=G(i),p=!!(i&&l),w=a=>{const h=new URL(window.location.href);h.searchParams.set("q",a),window.history.pushState({},"",h),n(a)};return r.jsxs(r.Fragment,{children:[r.jsx(W,{theme:{algorithm:$.darkAlgorithm},children:r.jsx(P.Search,{onSearch:w,loading:p,placeholder:"Search for maps...",size:"large",style:{marginBottom:20}})}),!p&&i?r.jsx("div",{className:"maxWidth",style:{marginBottom:20},children:r.jsx(d,{className:"maxWidth",children:e.length?r.jsx(c,{direction:"vertical",size:14,className:"maxWidth",children:e.map(a=>r.jsx(C,{listing:a},a._id+"-search"))}):r.jsxs("div",{style:{opacity:.9,fontStyle:"italic"},children:[r.jsx("span",{style:{color:v.Yellow},children:"No results found."})," ","Try searching for something else!"]})})}):null,r.jsx(c,{className:"maxWidth",direction:"vertical",size:20,children:t.lists.map(a=>r.jsx(B,{list:a},a.name+"-list"))})]})},Q=8,J=16,V=()=>r.jsxs(X,{children:[r.jsx("img",{src:"/client/img/creative/banner.png",style:{height:200}}),r.jsx(Z,{children:"Discovery Is Closed During School Hours"}),r.jsxs(rr,{children:["Check back in after ",r.jsx("b",{style:{color:v.Yellow},children:"4pm"})," to view & play maps made by the Gimkit Creative community!"]})]}),X=s(d).attrs({className:"flex-column flex-center"})`
  max-width: 700px;
  font-family: ${m.FugazOne};
  overflow: hidden;
`,Z=s.div`
...
`,rr=s.div`
  ...
  font-size: 16px;
  margin-top: 3px;
`,Xr=()=>{const{isLoading:t,error:o,data:i}=L(),n=y.useMemo(()=>{const e=N();return e.day()===0||e.day()===6?!1:e.hour()>=Q&&e.hour()<J},[]);return z()&&n?r.jsx(u,{style:{padding:35},children:r.jsx(V,{})}):o?r.jsx("div",{className:"flex-center maxWidth",style:{marginTop:50},children:r.jsx("div",{className:"light-shadow",style:{background:"rgba(255,255,255,0.1)",padding:35,borderRadius:12,maxWidth:"90%"},children:"There was an error loading Discovery. Please refresh and try again."})}):t?r.jsx(u,{style:{marginTop:100},children:r.jsx(E,{style:{color:f.White}})}):r.jsxs(er,{children:[r.jsx(D,{title:`${k} Creative | Discovery`,override:!0}),r.jsx(tr,{children:r.jsx(K,{lists:i??[]})})]})},er=s.div.attrs({className:"maxWidth flex hc"})`
  padding: 35px 0px;
`,tr=s.div`
  width: ${x.width};

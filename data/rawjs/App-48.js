import{r as p,j as o,U as b,F as _,d as l,u as P,b5 as H,w as K,ay as X}from"./_index.js";import{S as q}from"./SixteenByNineScaler.js";import{M as z,C as $}from"./Button.js";import{o as y}from"./mobxreact.esm.js";import{a6 as J,a7 as Y,a8 as Z,a9 as Q,aa as tt,S as B,J as L,u as w,ab as et,ac as O,ad as k,ae as M,af as E,ag as A,ah as ot,o as nt,q as rt}from"./App-41.js";import{f as st,g as it,u as G,m as j,i as at,e as T}from"./motion.js";import{u as ct}from"./use-motion-value.js";import{u as mt}from"./use-transform.js";import{I as lt}from"./InventoryItemNameWithCount.js";import{s as C,g as ut,S as dt,P as pt}from"./FixSpinePlugin.js";import{G as xt}from"./GetAssetPath.js";import{p as ft}from"./playSound.js";import{D as gt}from"./index-6.js";import"./index-2.js";import"./index-20.js";import"./index-5.js";import"./index-22.js";import"./index-4.js";import"./context.js";import"./index-1.js";import"./polished.esm.js";import"./inheritsLoose.js";import"./index-21.js";import"./QuizTypes.js";import"./MapModeType.js";import"./TutorialConsts.js";import"./ActionButton.js";import"./index-18.js";import"./FontAwesomeIcon.js";import"./Centered.js";import"./CapitalizeFirstLetter.js";import"./index-14.js";import"./EditOutlined.js";import"./styleChecker.js";import"./index-3.js";import"./CheckOutlined.js";import"./CopyOutlined.js";import"./progress.js";import"./ElementIds.js";import"./SeasonTicketName.js";import"./useQuery.js";import"./___vite-browser-external_commonjs-proxy.js";import"./util-1.js";import"./util-2.js";import"./Shortcut.js";import"./Names.js";import"./useWillUnmount.js";import"./CircularProgress.js";import"./clsx.m.js";import"./AccessibleAnchor.js";import"./index-17.js";import"./use-force-update.js";import"./GimkitLiveQuestion.js";import"./Text.js";import"./getCloudinaryUrl.js";import"./LazyLatexRenderer.js";import"./Tooltip.js";import"./howler.js";import"./index-9.js";import"./index-23.js";import"./useIntervalWhen.js";import"./index-10.js";import"./move.js";import"./react-flip-move.es.js";import"./sounds.js";import"./MapSound.js";import"./App-5.js";import"./AnimatedBackground-2.js";import"./useDebouncedValue.js";import"./MapStyle.js";import"./FillRemainingSpace.js";import"./index-24.js";const V=p.createContext(null);function It(t,r,n,i){if(!i)return t;const e=t.findIndex(d=>d.value===r);if(e===-1)return t;const c=i>0?1:-1,s=t[e+c];if(!s)return t;const f=t[e],a=s.layout,m=st(a.min,a.max,.5);return c===1&&f.layout.max+n>m||c===-1&&f.layout.min+n<m?it(t,e,e+c):t}function ht({children:t,as:r="ul",axis:n="y",onReorder:i,values:e,...c},s){const f=G(()=>j(r)),a=[],m=p.useRef(!1),d={axis:n,registerItem:(g,u)=>{u&&a.findIndex(x=>g===x.value)===-1&&(a.push({value:g,layout:u[n]}),a.sort(yt))},updateOrder:(g,u,x)=>{if(m.current)return;const I=It(a,g,u,x);a!==I&&(m.current=!0,i(I.map(bt).filter(h=>e.indexOf(h)!==-1)))}};return p.useEffect(()=>{m.current=!1}),p.createElement(f,{...c,ref:s},p.createElement(V.Provider,{value:d},t))}const vt=p.forwardRef(ht);function bt(t){return t.value}function yt(t,r){return t.layout.min-r.layout.min}function F(t,r=0){return at(t)?t:ct(r)}function St({children:t,style:r={},value:n,as:i="li",onDrag:e,layout:c=!0,...s},f){const a=G(()=>j(i)),m=p.useContext(V),d={x:F(r.x),y:F(r.y)},g=mt([d.x,d.y],([v,S])=>v||S?1:"unset"),u=p.useRef(null),{axis:x,registerItem:I,updateOrder:h}=m;return p.useEffect(()=>{I(n,u.current)},[m]),p.createElement(a,{drag:x,...s,dragSnapToOrigin:!0,style:{...r,x:d.x,y:d.y,zIndex:g},layout:c,onDrag:(v,S)=>{const{velocity:R}=S;R[x]&&h(n,d[x].get(),R[x]),e&&e(v,S)},onLayoutMeasure:v=>{u.current=v},ref:f},t)}const wt=p.forwardRef(St),U={Group:vt,Item:wt},jt=()=>o.jsx(Ct,{children:"You have no items/resources in your inventory."}),Ct=l.div.attrs({className:"maxWidth"})`
  ...
  padding: 30px;
`,Dt=y(t=>{const r=p.useRef(null),[n,i,e]=P(!1),[c,s]=p.useState(0),f=p.useMemo(()=>n?"grabbing":t.empty?"grab":"pointer",[t.empty,n]),a=()=>{var g,u;i(),s((u=(g=r.current)==null?void 0:g.getBoundingClientRect())==null?void 0:u.x)},m=()=>{var u,x,I;const g=(x=(u=r.current)==null?void 0:u.getBoundingClientRect())==null?void 0:x.x;c===g&&((I=t.onSelect)==null||I.call(t)),e()},d=()=>t.empty?o.jsx(Mt,{}):o.jsxs($t,{style:{background:J(t.rarity)},children:[o.jsx(Ot,{src:t.previewImage}),Y({durability:t.durability})?o.jsx(Z,{durability:t.durability}):null,Q({count:t.count,itemId:t.id})?o.jsx(kt,{children:tt({count:t.count,itemId:t.id})}):null]});return o.jsx(Nt,{ref:r,style:{cursor:f},onMouseDown:a,onMouseUp:m,children:d()})}),Nt=l.div`
  height: 90px;
  width: 90px;
...
`,Ft=l(U.Group).attrs({className:"flex vc"})`
  ...
  padding: 0px;
  margin: 0px;
`,Wt=t=>{const r=p.useMemo(()=>{let n=t.name;return t.amount>1&&(n+=` (${H(t.amount)})`),n},[t.name,t.amount]);return o.jsxs(Pt,{onClick:t.onSelect,children:[o.jsx(Bt,{src:t.image}),o.jsx(Lt,{children:r})]})},Pt=l.div.attrs({className:"flex vc"})`
...
`,Lt=l.div`
  font-size: 14px;
  color: rgba(255, 255, 255, 0.9);
`,Gt=y(t=>{const{me:{inventory:r},worldOptions:n}=w(),i=[];return r.slots.forEach((e,c)=>{const s=n.itemOptions.find(f=>f.id===c);s&&!O(s.id)&&!k(s.id)&&i.push({id:s.id,previewImage:s.previewImage,name:s.name,amount:e.amount})}),o.jsxs(Tt,{children:[o.jsx(Vt,{children:"Resources"}),i.map(e=>o.jsx(Wt,{onSelect:()=>t.select(e.id),image:e.previewImage,name:M(e.id),amount:e.amount},e.id+"-resource"))]})}),Tt=l.div`
  font-family: ${b.FugazOne};
  line-height: 1;
  text-transform: uppercase;
  padding: 0px 30px;
`,Vt=l.div`
  font-size: 24px;
  margin-bottom: 14px;
`,Ut=t=>O(t)?!C.me.zoneDropOverrides.allowWeaponDrop:k(t)?!C.me.zoneDropOverrides.allowItemDrop:!C.me.zoneDropOverrides.allowResourceDrop,W=t=>{B(L.dropItem,{amount:t.amount,itemId:t.itemId,interactiveSlotNumber:t.interactiveSlotNumber})},_t=()=>{ft({path:xt("sounds/core/dropItem.mp3"),volume:ut({volume:.45,type:dt.soundEffect})})},Ht=t=>{const{info:r}=t,{slotNumber:n,itemId:i,count:e}=r;if(Ut(i))return null;const c=s=>{_t(),n?W({interactiveSlotNumber:n,amount:s}):i&&W({itemId:i,amount:s}),t.closeModal()};return o.jsxs(Kt,{children:[o.jsx(z,{onClick:()=>c(e),ariaLabel:"Drop",children:e===1?"Drop":"Drop All"}),e>1?o.jsx(z,{onClick:()=>c(Math.ceil(e/2)),style:{marginLeft:10},ariaLabel:"Drop Half",children:"Drop Half"}):null]})},Kt=l.div.attrs({className:"flex vc"})`
  margin-top: 15px;
`,Xt=t=>{const{info:r}=t,{name:n,count:i,description:e,previewImage:c}=r;return o.jsxs(qt,{children:[o.jsx(Jt,{src:c}),o.jsxs(Yt,{children:[o.jsx(Zt,{children:lt(n,i)}),o.jsx(Qt,{children:e}),o.jsx(Ht,{info:r,closeModal:t.closeModal})]})]})},qt=l.div.attrs({className:"maxWidth flex vc"})``,Jt=l.img`
  height: 80px;
  width: 80px;
`,Yt=l.div`
  line-height: 1;
...
`,oe=l.div.attrs({className:"maxWidth"})`
  color: ${$.White};
  font-family: ${b.ProductSans};
`,ne=y(t=>{const{me:{inventory:r}}=w(),[n,i,e]=P(!1),[c,s]=p.useState(),[f,a]=p.useState(0),m=u=>{a(0),s(u),i()},d=u=>{s(void 0),a(u),i()},g=()=>{const u=[];r.slots.forEach((h,v)=>{h.amount>0&&u.push(v)});const x=u.some(h=>!k(h)&&!O(h)),I=ot().interactiveItemsSlots>0;return!x&&!I?o.jsx(jt,{}):o.jsxs(o.Fragment,{children:[I?o.jsx(zt,{select:d}):null,I&&x?o.jsx("div",{style:{height:30,flexShrink:0}}):null,x?o.jsx(Gt,{select:m}):null]})};return o.jsxs(o.Fragment,{children:[g(),o.jsx(te,{selectedSlotNumber:f,selectedItemId:c,open:n,close:e,closeModal:t.close})]})}),D={out:{y:"100%",opacity:0},in:{y:0,opacity:1}},re=t=>{const r=T(),n=i=>{i.stopPropagation()};return o.jsx(se,{onClick:n,initial:D.out,animate:D.in,exit:D.out,transition:{duration:r?.3:.2,ease:"easeOut"},children:o.jsx(ne,{close:t.close})})},se=l(j.div).attrs({className:"medium-shadow flex-column scroll-y"})`
  ...
  border-radius: 10px;
  padding: 30px 0px;
`,N={out:{background:"rgba(0,0,0,0)"},in:{background:"rgba(0,0,0,0.6)"}},Do=t=>{const r=T(),n=()=>t.setToHomeScreen();return nt(pt.Input.Keyboard.KeyCodes.ESC,n,[n]),o.jsxs(q,{children:[o.jsx(ie,{onClick:n,initial:N.out,animate:N.in,exit:N.out,transition:{duration:r?.3:.2,ease:"easeOut"},children:o.jsx(re,{close:n})}),o.jsx(rt,{onClick:n})]})},ie=l(j.div).attrs({className:"maxAll flex-center flex-column"})`
  position: absolute;
  top: 0;
  left: 0;
  overflow: hidden;

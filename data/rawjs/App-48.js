...
`,Lt=l.div`
  font-size: 14px;
  color: rgba(255, 255, 255, 0.9);
`,Gt=y(t=>{const{me:{inventory:r},worldOptions:n}=w(),i=[];return r.slots.forEach((e,c)=>{const s=n.itemOptions.find(f=>f.id===c);s&&!k(s.id)&&!O(s.id)&&i.push({id:s.id,previewImage:s.previewImage,name:s.name,amount:e.amount})}),o.jsxs(Tt,{children:[o.jsx(Vt,{children:"Resources"}),i.map(e=>o.jsx(Wt,{onSelect:()=>t.select(e.id),image:e.previewImage,name:M(e.id),amount:e.amount},e.id+"-resource"))]})}),Tt=l.div`
  font-family: ${b.FugazOne};
  line-height: 1;
  text-transform: uppercase;
  padding: 0px 30px;

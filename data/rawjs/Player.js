...
`,T=e=>t.jsxs(U,{className:e.className,children:[e.header!==null&&t.jsx(N,{children:e.header}),e.content!==null&&t.jsx(P,{color:e.contentColor,children:e.content})]}),W=n.div`
  flex: 1;
  display: flex;
  flex-direction: column;
...
`,f=n(w).attrs({bodyStyle:{textAlign:"center",padding:0}})`
  text-align: center;
...
`,G=n(f)`
  ...
  margin-left: 10px !important;
`,H=e=>t.jsxs(q,{children:[t.jsx(h,{title:"Correct",children:t.jsx(_,{children:e.correct})}),t.jsx(h,{title:"Incorrect",children:t.jsx(F,{children:e.incorrect})}),t.jsx(h,{title:"Accuracy",children:t.jsx(G,{children:`${e.accuracy}%`})})]}),O=n.div`
  display: flex;
  width: 100%;
  justify-content: space-between;
`,L=n.div`
